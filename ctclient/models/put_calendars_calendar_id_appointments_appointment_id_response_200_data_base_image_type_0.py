...
if TYPE_CHECKING:
    from ..models.put_calendars_calendar_id_appointments_appointment_id_response_200_data_base_image_type_0_image_option import (
        PutCalendarsCalendarIdAppointmentsAppointmentIdResponse200DataBaseImageType0ImageOption,
    )
    from ..models.put_calendars_calendar_id_appointments_appointment_id_response_200_data_base_image_type_0_meta import (
...
T = TypeVar(
    "T",
    bound="PutCalendarsCalendarIdAppointmentsAppointmentIdResponse200DataBaseImageType0",
)


@_attrs_define
class PutCalendarsCalendarIdAppointmentsAppointmentIdResponse200DataBaseImageType0:
    """
    Attributes:
        ...
        id (int):  Example: 6071.
        image_option (PutCalendarsCalendarIdAppointmentsAppointmentIdResponse200DataBaseImageType0ImageOption):
        image_url (str):  Example:
            http://churchtools.test/images/6071/70987c31abdea3986f69a6d601222ac9a388c36a6510564a80fae29311faec89.
        meta (PutCalendarsCalendarIdAppointmentsAppointmentIdResponse200DataBaseImageType0Meta):  Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_option = PutCalendarsCalendarIdAppointmentsAppointmentIdResponse200DataBaseImageType0ImageOption.from_dict(
            d.pop("imageOption")
        )

        image_url = d.pop("imageUrl")

        meta = PutCalendarsCalendarIdAppointmentsAppointmentIdResponse200DataBaseImageType0Meta.from_dict(
            d.pop("meta")
        )
        ...
        put_calendars_calendar_id_appointments_appointment_id_response_200_data_base_image_type_0 = cls(
        ...
        put_calendars_calendar_id_appointments_appointment_id_response_200_data_base_image_type_0.additional_properties = d
        return put_calendars_calendar_id_appointments_appointment_id_response_200_data_base_image_type_0
