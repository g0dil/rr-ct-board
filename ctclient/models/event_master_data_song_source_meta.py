...
if TYPE_CHECKING:
    from ..models.event_master_data_song_source_meta_created_person import (
        EventMasterDataSongSourceMetaCreatedPerson,
    )
    from ..models.event_master_data_song_source_meta_modified_person import (
        EventMasterDataSongSourceMetaModifiedPerson,
    )


T = TypeVar("T", bound="EventMasterDataSongSourceMeta")


@_attrs_define
class EventMasterDataSongSourceMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (EventMasterDataSongSourceMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (EventMasterDataSongSourceMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: EventMasterDataSongSourceMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: EventMasterDataSongSourceMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = EventMasterDataSongSourceMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = EventMasterDataSongSourceMetaModifiedPerson.from_dict(
                _modified_person
            )

        event_master_data_song_source_meta = cls(
        ...
        event_master_data_song_source_meta.additional_properties = d
        return event_master_data_song_source_meta
