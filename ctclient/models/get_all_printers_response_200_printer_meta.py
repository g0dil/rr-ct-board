...
if TYPE_CHECKING:
    from ..models.get_all_printers_response_200_printer_meta_created_person import (
        GetAllPrintersResponse200PrinterMetaCreatedPerson,
    )
    from ..models.get_all_printers_response_200_printer_meta_modified_person import (
        GetAllPrintersResponse200PrinterMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetAllPrintersResponse200PrinterMeta")


@_attrs_define
class GetAllPrintersResponse200PrinterMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetAllPrintersResponse200PrinterMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetAllPrintersResponse200PrinterMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: GetAllPrintersResponse200PrinterMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: GetAllPrintersResponse200PrinterMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = GetAllPrintersResponse200PrinterMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                GetAllPrintersResponse200PrinterMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        get_all_printers_response_200_printer_meta = cls(
        ...
        get_all_printers_response_200_printer_meta.additional_properties = d
        return get_all_printers_response_200_printer_meta
