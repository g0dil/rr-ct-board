...
from ..models.get_all_for_service_response_200_item_requesting_person_invitation_status_type_0 import (
    GetAllForServiceResponse200ItemRequestingPersonInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_all_for_service_response_200_item_requesting_person_emails_item import (
        GetAllForServiceResponse200ItemRequestingPersonEmailsItem,
    )
    from ..models.get_all_for_service_response_200_item_requesting_person_meta import (
        GetAllForServiceResponse200ItemRequestingPersonMeta,
    )
    from ..models.get_all_for_service_response_200_item_requesting_person_privacy_policy_agreement import (
        GetAllForServiceResponse200ItemRequestingPersonPrivacyPolicyAgreement,
    )
    from ..models.get_all_for_service_response_200_item_requesting_person_tags_item import (
        GetAllForServiceResponse200ItemRequestingPersonTagsItem,
    )


T = TypeVar("T", bound="GetAllForServiceResponse200ItemRequestingPerson")


@_attrs_define
class GetAllForServiceResponse200ItemRequestingPerson:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[GetAllForServiceResponse200ItemRequestingPersonEmailsItem] | Unset):
            ...
            invitation_status (GetAllForServiceResponse200ItemRequestingPersonInvitationStatusType0 | None | Unset):
            ...
            meta (GetAllForServiceResponse200ItemRequestingPersonMeta | Unset):  Example: {'createdDate':
            ...
            privacy_policy_agreement (GetAllForServiceResponse200ItemRequestingPersonPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[GetAllForServiceResponse200ItemRequestingPersonTagsItem] | Unset):
            title (str | Unset):
    ...
    meta: GetAllForServiceResponse200ItemRequestingPersonMeta | Unset = UNSET
    ...
    privacy_policy_agreement: (
        GetAllForServiceResponse200ItemRequestingPersonPrivacyPolicyAgreement | Unset
    ) = UNSET
    ...
    tags: list[GetAllForServiceResponse200ItemRequestingPersonTagsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = (
                GetAllForServiceResponse200ItemRequestingPersonEmailsItem.from_dict(
                    emails_item_data
                )
            )
        ...
        def _parse_invitation_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                invitation_status_type_0 = GetAllForServiceResponse200ItemRequestingPersonInvitationStatusType0(
                    data
                )
        ...
        meta: GetAllForServiceResponse200ItemRequestingPersonMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = GetAllForServiceResponse200ItemRequestingPersonMeta.from_dict(_meta)
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = GetAllForServiceResponse200ItemRequestingPersonPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = (
                GetAllForServiceResponse200ItemRequestingPersonTagsItem.from_dict(
                    tags_item_data
                )
            )
        ...
        get_all_for_service_response_200_item_requesting_person = cls(
        ...
        get_all_for_service_response_200_item_requesting_person.additional_properties = d
        return get_all_for_service_response_200_item_requesting_person
