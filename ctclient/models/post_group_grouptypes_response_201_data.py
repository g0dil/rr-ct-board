...
T = TypeVar("T", bound="PostGroupGrouptypesResponse201Data")


@_attrs_define
class PostGroupGrouptypesResponse201Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_group_grouptypes_response_201_data = cls(
            name_plural_translated=name_plural_translated,
            name_translated=name_translated,
        )

        post_group_grouptypes_response_201_data.additional_properties = d
        return post_group_grouptypes_response_201_data
