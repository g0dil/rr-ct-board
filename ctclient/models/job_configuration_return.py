...
if TYPE_CHECKING:
    from ..models.job_configuration_return_create_defaults_es import (
        JobConfigurationReturnCreateDefaultsES,
    )
    from ..models.job_configuration_return_create_defaults_master import (
        JobConfigurationReturnCreateDefaultsMaster,
    )
    from ..models.job_configuration_return_external_system import (
        JobConfigurationReturnExternalSystem,
    )


T = TypeVar("T", bound="JobConfigurationReturn")


@_attrs_define
class JobConfigurationReturn:
    """
    Attributes:
        ...
        create_defaults_es (JobConfigurationReturnCreateDefaultsES | Unset):
        create_defaults_master (JobConfigurationReturnCreateDefaultsMaster | Unset):
        delete_behavior_es (str | Unset):
        delete_behavior_master (str | Unset):
        external_system (JobConfigurationReturnExternalSystem | Unset):
        id (int | Unset):
    ...
    create_defaults_es: JobConfigurationReturnCreateDefaultsES | Unset = UNSET
    create_defaults_master: JobConfigurationReturnCreateDefaultsMaster | Unset = UNSET
    delete_behavior_es: str | Unset = UNSET
    delete_behavior_master: str | Unset = UNSET
    external_system: JobConfigurationReturnExternalSystem | Unset = UNSET
    id: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_create_defaults_es, Unset):
            ...
            create_defaults_es = JobConfigurationReturnCreateDefaultsES.from_dict(
                _create_defaults_es
            )
        ...
        if isinstance(_create_defaults_master, Unset):
            ...
            create_defaults_master = (
                JobConfigurationReturnCreateDefaultsMaster.from_dict(
        ...
        if isinstance(_external_system, Unset):
            ...
            external_system = JobConfigurationReturnExternalSystem.from_dict(
                _external_system
            )
        ...
        job_configuration_return.additional_properties = d
        return job_configuration_return
