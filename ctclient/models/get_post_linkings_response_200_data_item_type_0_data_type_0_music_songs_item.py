...
T = TypeVar("T", bound="GetPostLinkingsResponse200DataItemType0DataType0MusicSongsItem")


@_attrs_define
class GetPostLinkingsResponse200DataItemType0DataType0MusicSongsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_post_linkings_response_200_data_item_type_0_data_type_0_music_songs_item = (
            cls(
                disc=disc,
                track=track,
                url=url,
        ...
        get_post_linkings_response_200_data_item_type_0_data_type_0_music_songs_item.additional_properties = d
        return (
            get_post_linkings_response_200_data_item_type_0_data_type_0_music_songs_item
        )
