...
T = TypeVar("T", bound="ResourceMasterDataResourcesItem")


@_attrs_define
class ResourceMasterDataResourcesItem:
    """
    Attributes:
        id (int):  Example: 7.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_master_data_resources_item = cls(
            id=id,
        ...
        resource_master_data_resources_item.additional_properties = d
        return resource_master_data_resources_item
