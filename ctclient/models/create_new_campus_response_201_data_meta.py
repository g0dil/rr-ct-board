...
if TYPE_CHECKING:
    from ..models.create_new_campus_response_201_data_meta_created_person import (
        CreateNewCampusResponse201DataMetaCreatedPerson,
    )
    from ..models.create_new_campus_response_201_data_meta_modified_person import (
        CreateNewCampusResponse201DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="CreateNewCampusResponse201DataMeta")


@_attrs_define
class CreateNewCampusResponse201DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (CreateNewCampusResponse201DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (CreateNewCampusResponse201DataMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: CreateNewCampusResponse201DataMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: CreateNewCampusResponse201DataMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = CreateNewCampusResponse201DataMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                CreateNewCampusResponse201DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        create_new_campus_response_201_data_meta = cls(
        ...
        create_new_campus_response_201_data_meta.additional_properties = d
        return create_new_campus_response_201_data_meta
