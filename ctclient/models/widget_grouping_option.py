...
T = TypeVar("T", bound="WidgetGroupingOption")


@_attrs_define
class WidgetGroupingOption:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        widget_grouping_option = cls(
            key=key,
            label=label,
            sort_key=sort_key,
        )

        widget_grouping_option.additional_properties = d
        return widget_grouping_option
