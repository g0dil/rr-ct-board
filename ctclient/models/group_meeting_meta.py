...
if TYPE_CHECKING:
    from ..models.group_meeting_meta_modified_person import (
        GroupMeetingMetaModifiedPerson,
    )


T = TypeVar("T", bound="GroupMeetingMeta")


@_attrs_define
class GroupMeetingMeta:
    """
    Attributes:
        ...
        modified_person (GroupMeetingMetaModifiedPerson | Unset):
    """

    modified_date: datetime.datetime | Unset = UNSET
    modified_person: GroupMeetingMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GroupMeetingMetaModifiedPerson.from_dict(_modified_person)

        group_meeting_meta = cls(
            modified_date=modified_date,
            modified_person=modified_person,
        )

        group_meeting_meta.additional_properties = d
        return group_meeting_meta
