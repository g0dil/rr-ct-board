...
T = TypeVar("T", bound="GetPostLinkingsResponse200DataItemType0DataType0Book")


@_attrs_define
class GetPostLinkingsResponse200DataItemType0DataType0Book:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_post_linkings_response_200_data_item_type_0_data_type_0_book = cls(
            authors=authors,
            isbn=isbn,
        ...
        get_post_linkings_response_200_data_item_type_0_data_type_0_book.additional_properties = d
        return get_post_linkings_response_200_data_item_type_0_data_type_0_book
