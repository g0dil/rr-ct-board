...
from ..models.post_songs_song_id_arrangements_body_key_type_0 import (
    PostSongsSongIdArrangementsBodyKeyType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostSongsSongIdArrangementsBody")


@_attrs_define
class PostSongsSongIdArrangementsBody:
    ...
    Attributes:
        ...
        key (None | PostSongsSongIdArrangementsBodyKeyType0 | Unset):
    ...
    key: None | PostSongsSongIdArrangementsBodyKeyType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.key, Unset):
            key = UNSET
        elif isinstance(self.key, PostSongsSongIdArrangementsBodyKeyType0):
            key = self.key.value
        else:
            key = self.key
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_key(
            data: object,
        ) -> None | PostSongsSongIdArrangementsBodyKeyType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                key_type_0 = PostSongsSongIdArrangementsBodyKeyType0(data)

                return key_type_0
            except:  # noqa: E722
                pass
            return cast(None | PostSongsSongIdArrangementsBodyKeyType0 | Unset, data)
        ...
        post_songs_song_id_arrangements_body = cls(
            name=name,
            beat=beat,
        ...
        post_songs_song_id_arrangements_body.additional_properties = d
        return post_songs_song_id_arrangements_body
