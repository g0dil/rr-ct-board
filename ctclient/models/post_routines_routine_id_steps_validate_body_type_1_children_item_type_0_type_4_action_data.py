...
T = TypeVar(
    "T",
    bound="PostRoutinesRoutineIdStepsValidateBodyType1ChildrenItemType0Type4ActionData",
)


@_attrs_define
class PostRoutinesRoutineIdStepsValidateBodyType1ChildrenItemType0Type4ActionData:
    """
    Attributes:
        num_days (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_routines_routine_id_steps_validate_body_type_1_children_item_type_0_type_4_action_data = cls(
            num_days=num_days,
            until_date=until_date,
        )

        post_routines_routine_id_steps_validate_body_type_1_children_item_type_0_type_4_action_data.additional_properties = d
        return post_routines_routine_id_steps_validate_body_type_1_children_item_type_0_type_4_action_data
