...
T = TypeVar("T", bound="PersonMasterDataStatusesItem")


@_attrs_define
class PersonMasterDataStatusesItem:
    """
    Attributes:
        id (int): ID of status
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_master_data_statuses_item = cls(
            id=id,
            is_member=is_member,
        ...
        person_master_data_statuses_item.additional_properties = d
        return person_master_data_statuses_item
