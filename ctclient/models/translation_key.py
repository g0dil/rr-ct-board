...
if TYPE_CHECKING:
    from ..models.translation_key_translations import TranslationKeyTranslations


T = TypeVar("T", bound="TranslationKey")
...
class TranslationKey:
    ...
    Attributes:
        ...
        translations (TranslationKeyTranslations | Unset):
    ...
    translations: TranslationKeyTranslations | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_translations, Unset):
            ...
            translations = TranslationKeyTranslations.from_dict(_translations)
        ...
        translation_key.additional_properties = d
