...
if TYPE_CHECKING:
    from ..models.get_all_for_person_response_200_item_requested_person_meta_created_person import (
        GetAllForPersonResponse200ItemRequestedPersonMetaCreatedPerson,
    )
    from ..models.get_all_for_person_response_200_item_requested_person_meta_modified_person import (
        GetAllForPersonResponse200ItemRequestedPersonMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetAllForPersonResponse200ItemRequestedPersonMeta")


@_attrs_define
class GetAllForPersonResponse200ItemRequestedPersonMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetAllForPersonResponse200ItemRequestedPersonMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetAllForPersonResponse200ItemRequestedPersonMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        GetAllForPersonResponse200ItemRequestedPersonMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            GetAllForPersonResponse200ItemRequestedPersonMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GetAllForPersonResponse200ItemRequestedPersonMetaModifiedPerson.from_dict(
                _modified_person
            )

        get_all_for_person_response_200_item_requested_person_meta = cls(
        ...
        get_all_for_person_response_200_item_requested_person_meta.additional_properties = d
        return get_all_for_person_response_200_item_requested_person_meta
