...
T = TypeVar("T", bound="DuplicateGroupResponse201DataSettingsNewMember")


@_attrs_define
class DuplicateGroupResponse201DataSettingsNewMember:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        duplicate_group_response_201_data_settings_new_member = cls(
            campus_id=campus_id,
            department_id=department_id,
            status_id=status_id,
        )

        duplicate_group_response_201_data_settings_new_member.additional_properties = d
        return duplicate_group_response_201_data_settings_new_member
