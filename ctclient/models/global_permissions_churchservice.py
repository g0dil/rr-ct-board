...
T = TypeVar("T", bound="GlobalPermissionsChurchservice")


@_attrs_define
class GlobalPermissionsChurchservice:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        global_permissions_churchservice = cls(
        ...
        global_permissions_churchservice.additional_properties = d
        return global_permissions_churchservice
