...
from ..models.routine_step_create_type_0_type_1_action_data_color import (
    RoutineStepCreateType0Type1ActionDataColor,
)
from ..models.routine_step_create_type_0_type_1_action_data_continuation_type import (
    RoutineStepCreateType0Type1ActionDataContinuationType,
)
from ..models.routine_step_create_type_0_type_1_action_data_success_group_member_status_type_0 import (
    RoutineStepCreateType0Type1ActionDataSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RoutineStepCreateType0Type1ActionData")


@_attrs_define
class RoutineStepCreateType0Type1ActionData:
    """
    Attributes:
        continuation_type (RoutineStepCreateType0Type1ActionDataContinuationType):
        description (None | str):
        title (str):
        color (RoutineStepCreateType0Type1ActionDataColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (None | RoutineStepCreateType0Type1ActionDataSuccessGroupMemberStatusType0 | Unset):
    ...
    description: None | str
    title: str
    color: RoutineStepCreateType0Type1ActionDataColor | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: RoutineStepCreateType0Type1ActionDataColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = RoutineStepCreateType0Type1ActionDataColor(_color)
        ...
        routine_step_create_type_0_type_1_action_data = cls(
        ...
        routine_step_create_type_0_type_1_action_data.additional_properties = d
        return routine_step_create_type_0_type_1_action_data
