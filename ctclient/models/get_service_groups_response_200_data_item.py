...
T = TypeVar("T", bound="GetServiceGroupsResponse200DataItem")


@_attrs_define
class GetServiceGroupsResponse200DataItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_service_groups_response_200_data_item = cls(
            campus_id=campus_id,
            id=id,
            name=name,
        ...
        get_service_groups_response_200_data_item.additional_properties = d
        return get_service_groups_response_200_data_item
