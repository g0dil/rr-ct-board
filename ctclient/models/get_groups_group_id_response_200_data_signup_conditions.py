...
from ..models.get_groups_group_id_response_200_data_signup_conditions_group_visibility import (
    GetGroupsGroupIdResponse200DataSignupConditionsGroupVisibility,
)

T = TypeVar("T", bound="GetGroupsGroupIdResponse200DataSignupConditions")


@_attrs_define
class GetGroupsGroupIdResponse200DataSignupConditions:
    """
    Attributes:
        ...
        group_visibility (GetGroupsGroupIdResponse200DataSignupConditionsGroupVisibility): The visibility of a group.
    ...
    group_is_open_for_members: bool
    group_is_public: bool
    group_visibility: GetGroupsGroupIdResponse200DataSignupConditionsGroupVisibility
    new_person_department_is_set: bool
    new_person_station_is_set: bool
    new_person_status_is_set: bool
    sign_up_role_set_in_group: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_groups_group_id_response_200_data_signup_conditions = cls(
        ...
        get_groups_group_id_response_200_data_signup_conditions.additional_properties = d
        return get_groups_group_id_response_200_data_signup_conditions
