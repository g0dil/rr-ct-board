...
T = TypeVar("T", bound="CreatePersonBodyPersonEmail")


@_attrs_define
class CreatePersonBodyPersonEmail:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_person_body_person_email = cls(
            contact_label_id=contact_label_id,
            email=email,
            is_default=is_default,
        )

        create_person_body_person_email.additional_properties = d
        return create_person_body_person_email
