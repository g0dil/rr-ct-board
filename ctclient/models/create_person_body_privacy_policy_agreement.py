...
T = TypeVar("T", bound="CreatePersonBodyPrivacyPolicyAgreement")


@_attrs_define
class CreatePersonBodyPrivacyPolicyAgreement:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_person_body_privacy_policy_agreement = cls(
            date=date,
            type_id=type_id,
            who_id=who_id,
        )

        create_person_body_privacy_policy_agreement.additional_properties = d
        return create_person_body_privacy_policy_agreement
