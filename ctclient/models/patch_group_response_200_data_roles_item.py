...
T = TypeVar("T", bound="PatchGroupResponse200DataRolesItem")


@_attrs_define
class PatchGroupResponse200DataRolesItem:
    """
    Attributes:
        can_read_chat (bool):
        can_write_chat (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_group_response_200_data_roles_item = cls(
        ...
        patch_group_response_200_data_roles_item.additional_properties = d
        return patch_group_response_200_data_roles_item
