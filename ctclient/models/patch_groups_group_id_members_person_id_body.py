...
from ..models.patch_groups_group_id_members_person_id_body_group_member_status import (
    PatchGroupsGroupIdMembersPersonIdBodyGroupMemberStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.patch_groups_group_id_members_person_id_body_fields_type_0 import (
        PatchGroupsGroupIdMembersPersonIdBodyFieldsType0,
    )
    from ..models.patch_groups_group_id_members_person_id_body_member_start_date import (
        PatchGroupsGroupIdMembersPersonIdBodyMemberStartDate,
    )


T = TypeVar("T", bound="PatchGroupsGroupIdMembersPersonIdBody")


@_attrs_define
class PatchGroupsGroupIdMembersPersonIdBody:
    """
    Attributes:
        comment (None | str | Unset):
        fields (None | PatchGroupsGroupIdMembersPersonIdBodyFieldsType0 | Unset): Group member fields as key value
            pairs, where the key is the ID of the field to be set. Example: {'12': True, '14': 'Text', '17': None}.
        group_member_status (PatchGroupsGroupIdMembersPersonIdBodyGroupMemberStatus | Unset):
        ...
        member_end_date (datetime.date | None | Unset): A simple date in ISO format, e.g. '2022-10-19' Example:
            2022-10-19.
        member_start_date (PatchGroupsGroupIdMembersPersonIdBodyMemberStartDate | Unset):
        waitinglist_position (int | None | Unset):
    """

    comment: None | str | Unset = UNSET
    fields: None | PatchGroupsGroupIdMembersPersonIdBodyFieldsType0 | Unset = UNSET
    group_member_status: (
        PatchGroupsGroupIdMembersPersonIdBodyGroupMemberStatus | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.fields, Unset):
            fields = UNSET
        elif isinstance(self.fields, PatchGroupsGroupIdMembersPersonIdBodyFieldsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_fields(
            data: object,
        ) -> None | PatchGroupsGroupIdMembersPersonIdBodyFieldsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                fields_type_0 = (
                    PatchGroupsGroupIdMembersPersonIdBodyFieldsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PatchGroupsGroupIdMembersPersonIdBodyFieldsType0 | Unset, data
            )
        ...
        if isinstance(_member_start_date, Unset):
            ...
            member_start_date = (
                PatchGroupsGroupIdMembersPersonIdBodyMemberStartDate.from_dict(
                    _member_start_date
                )
            )
        ...
        patch_groups_group_id_members_person_id_body = cls(
            comment=comment,
            fields=fields,
        ...
        patch_groups_group_id_members_person_id_body.additional_properties = d
        return patch_groups_group_id_members_person_id_body
