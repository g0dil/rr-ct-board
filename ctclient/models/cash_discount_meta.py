...
if TYPE_CHECKING:
    from ..models.cash_discount_meta_created_person import CashDiscountMetaCreatedPerson
    from ..models.cash_discount_meta_modified_person import (
        CashDiscountMetaModifiedPerson,
    )


T = TypeVar("T", bound="CashDiscountMeta")


@_attrs_define
class CashDiscountMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (CashDiscountMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (CashDiscountMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: CashDiscountMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: CashDiscountMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.cash_discount_meta_created_person import (
        ...
        created_person = CashDiscountMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = CashDiscountMetaModifiedPerson.from_dict(_modified_person)

        cash_discount_meta = cls(
        ...
        cash_discount_meta.additional_properties = d
        return cash_discount_meta
