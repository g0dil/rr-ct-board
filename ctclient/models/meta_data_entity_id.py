...
if TYPE_CHECKING:
    from ..models.meta_data_entity_id_created_person import (
        MetaDataEntityIdCreatedPerson,
    )
    from ..models.meta_data_entity_id_modified_person import (
        MetaDataEntityIdModifiedPerson,
    )


T = TypeVar("T", bound="MetaDataEntityId")
...
class MetaDataEntityId:
    ...
    Attributes:
        ...
        created_person (MetaDataEntityIdCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (MetaDataEntityIdModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: MetaDataEntityIdCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: MetaDataEntityIdModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = MetaDataEntityIdCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = MetaDataEntityIdModifiedPerson.from_dict(_modified_person)

        meta_data_entity_id = cls(
        ...
        meta_data_entity_id.additional_properties = d
        return meta_data_entity_id
