...
T = TypeVar("T", bound="GetPersonMasterdataResponse200DataStatusesItem")


@_attrs_define
class GetPersonMasterdataResponse200DataStatusesItem:
    """
    Attributes:
        id (int): ID of status
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_person_masterdata_response_200_data_statuses_item = cls(
            id=id,
            is_member=is_member,
        ...
        get_person_masterdata_response_200_data_statuses_item.additional_properties = d
        return get_person_masterdata_response_200_data_statuses_item
