...
if TYPE_CHECKING:
    from ..models.permission_meta_modified_person import PermissionMetaModifiedPerson


T = TypeVar("T", bound="PermissionMeta")
...
class PermissionMeta:
    ...
    Attributes:
        ...
        modified_person (PermissionMetaModifiedPerson | Unset):
    """

    modified_date: datetime.datetime | Unset = UNSET
    modified_person: PermissionMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.permission_meta_modified_person import (
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = PermissionMetaModifiedPerson.from_dict(_modified_person)
        ...
        permission_meta.additional_properties = d
