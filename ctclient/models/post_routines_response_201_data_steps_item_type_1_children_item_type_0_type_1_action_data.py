...
from ..models.post_routines_response_201_data_steps_item_type_1_children_item_type_0_type_1_action_data_color import (
    PostRoutinesResponse201DataStepsItemType1ChildrenItemType0Type1ActionDataColor,
)
from ..models.post_routines_response_201_data_steps_item_type_1_children_item_type_0_type_1_action_data_continuation_type import (
    PostRoutinesResponse201DataStepsItemType1ChildrenItemType0Type1ActionDataContinuationType,
)
from ..models.post_routines_response_201_data_steps_item_type_1_children_item_type_0_type_1_action_data_success_group_member_status_type_0 import (
...
T = TypeVar(
    "T",
    bound="PostRoutinesResponse201DataStepsItemType1ChildrenItemType0Type1ActionData",
)


@_attrs_define
class PostRoutinesResponse201DataStepsItemType1ChildrenItemType0Type1ActionData:
    """
    Attributes:
        continuation_type (PostRoutinesResponse201DataStepsItemType1ChildrenItemType0Type1ActionDataContinuationType):
        description (None | str):
        title (str):
        color (PostRoutinesResponse201DataStepsItemType1ChildrenItemType0Type1ActionDataColor | Unset): A color in
            ChurchTools
        ...
        success_group_member_status (None |
            PostRoutinesResponse201DataStepsItemType1ChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0 | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_color, Unset):
            ...
            color = PostRoutinesResponse201DataStepsItemType1ChildrenItemType0Type1ActionDataColor(
                _color
            )
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = PostRoutinesResponse201DataStepsItemType1ChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        post_routines_response_201_data_steps_item_type_1_children_item_type_0_type_1_action_data = cls(
        ...
        post_routines_response_201_data_steps_item_type_1_children_item_type_0_type_1_action_data.additional_properties = d
        return post_routines_response_201_data_steps_item_type_1_children_item_type_0_type_1_action_data
