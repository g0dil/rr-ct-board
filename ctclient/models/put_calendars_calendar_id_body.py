...
T = TypeVar("T", bound="PutCalendarsCalendarIdBody")


@_attrs_define
class PutCalendarsCalendarIdBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_calendars_calendar_id_body = cls(
            color=color,
            name=name,
            sort_key=sort_key,
            campus_id=campus_id,
        ...
        put_calendars_calendar_id_body.additional_properties = d
        return put_calendars_calendar_id_body
