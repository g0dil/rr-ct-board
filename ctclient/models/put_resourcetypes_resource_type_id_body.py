...
T = TypeVar("T", bound="PutResourcetypesResourceTypeIdBody")


@_attrs_define
class PutResourcetypesResourceTypeIdBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_resourcetypes_resource_type_id_body = cls(
            campus_id=campus_id,
            name=name,
        ...
        put_resourcetypes_resource_type_id_body.additional_properties = d
        return put_resourcetypes_resource_type_id_body
