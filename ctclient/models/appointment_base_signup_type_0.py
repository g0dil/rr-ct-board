...
T = TypeVar("T", bound="AppointmentBaseSignupType0")


@_attrs_define
class AppointmentBaseSignupType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appointment_base_signup_type_0 = cls(
        ...
        appointment_base_signup_type_0.additional_properties = d
        return appointment_base_signup_type_0
