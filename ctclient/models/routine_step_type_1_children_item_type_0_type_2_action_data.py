...
T = TypeVar("T", bound="RoutineStepType1ChildrenItemType0Type2ActionData")


@_attrs_define
class RoutineStepType1ChildrenItemType0Type2ActionData:
    """
    Attributes:
        group_id (int):
        comment (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        routine_step_type_1_children_item_type_0_type_2_action_data = cls(
            group_id=group_id,
            comment=comment,
        ...
        routine_step_type_1_children_item_type_0_type_2_action_data.additional_properties = d
        return routine_step_type_1_children_item_type_0_type_2_action_data
