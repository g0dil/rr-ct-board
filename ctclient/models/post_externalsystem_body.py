...
T = TypeVar("T", bound="PostExternalsystemBody")


@_attrs_define
class PostExternalsystemBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_externalsystem_body.additional_properties = d
        return post_externalsystem_body
