...
from ..models.get_groups_group_id_followups_response_200_data_item_color import (
    GetGroupsGroupIdFollowupsResponse200DataItemColor,
)
from ..models.get_groups_group_id_followups_response_200_data_item_origin import (
    GetGroupsGroupIdFollowupsResponse200DataItemOrigin,
)
from ..models.get_groups_group_id_followups_response_200_data_item_success_group_member_status_type_0 import (
    GetGroupsGroupIdFollowupsResponse200DataItemSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_groups_group_id_followups_response_200_data_item_meta import (
        GetGroupsGroupIdFollowupsResponse200DataItemMeta,
    )


T = TypeVar("T", bound="GetGroupsGroupIdFollowupsResponse200DataItem")


@_attrs_define
class GetGroupsGroupIdFollowupsResponse200DataItem:
    """
    Attributes:
        ...
        meta (GetGroupsGroupIdFollowupsResponse200DataItemMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            'createdPerson': {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        origin (GetGroupsGroupIdFollowupsResponse200DataItemOrigin):
        person_id (int):
        color (GetGroupsGroupIdFollowupsResponse200DataItemColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (GetGroupsGroupIdFollowupsResponse200DataItemSuccessGroupMemberStatusType0 | None |
            Unset):
    ...
    id: int
    membership_id: int | None
    meta: GetGroupsGroupIdFollowupsResponse200DataItemMeta
    origin: GetGroupsGroupIdFollowupsResponse200DataItemOrigin
    person_id: int
    color: GetGroupsGroupIdFollowupsResponse200DataItemColor | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = GetGroupsGroupIdFollowupsResponse200DataItemMeta.from_dict(d.pop("meta"))

        origin = GetGroupsGroupIdFollowupsResponse200DataItemOrigin(d.pop("origin"))

        person_id = d.pop("personId")

        _color = d.pop("color", UNSET)
        color: GetGroupsGroupIdFollowupsResponse200DataItemColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = GetGroupsGroupIdFollowupsResponse200DataItemColor(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = GetGroupsGroupIdFollowupsResponse200DataItemSuccessGroupMemberStatusType0(
                    data
                )
        ...
        get_groups_group_id_followups_response_200_data_item = cls(
            title=title,
            done_date=done_date,
        ...
        get_groups_group_id_followups_response_200_data_item.additional_properties = d
        return get_groups_group_id_followups_response_200_data_item
