...
if TYPE_CHECKING:
    from ..models.patch_group_response_200_data_meta_created_person import (
        PatchGroupResponse200DataMetaCreatedPerson,
    )
    from ..models.patch_group_response_200_data_meta_modified_person import (
        PatchGroupResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="PatchGroupResponse200DataMeta")


@_attrs_define
class PatchGroupResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (PatchGroupResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (PatchGroupResponse200DataMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: PatchGroupResponse200DataMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: PatchGroupResponse200DataMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = PatchGroupResponse200DataMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = PatchGroupResponse200DataMetaModifiedPerson.from_dict(
                _modified_person
            )

        patch_group_response_200_data_meta = cls(
        ...
        patch_group_response_200_data_meta.additional_properties = d
        return patch_group_response_200_data_meta
