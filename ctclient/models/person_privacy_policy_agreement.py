...
T = TypeVar("T", bound="PersonPrivacyPolicyAgreement")
...
class PersonPrivacyPolicyAgreement:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_privacy_policy_agreement = cls(
            date=date,
            type_id=type_id,
            who_id=who_id,
        )

        person_privacy_policy_agreement.additional_properties = d
        return person_privacy_policy_agreement
