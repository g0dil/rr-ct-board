...
if TYPE_CHECKING:
    from ..models.booking_create_additionals_type_0_item import (
        BookingCreateAdditionalsType0Item,
    )
    from ..models.booking_create_exceptions_type_0_item import (
...
class BookingCreate:
    ...
    Attributes:
        ...
        status_id (int):
        title (str):
        additionals (list[BookingCreateAdditionalsType0Item] | None | Unset):
        description (None | str | Unset):
        exceptions (list[BookingCreateExceptionsType0Item] | None | Unset):
    ...
    status_id: int
    title: str
    additionals: list[BookingCreateAdditionalsType0Item] | None | Unset = UNSET
    description: None | str | Unset = UNSET
    exceptions: list[BookingCreateExceptionsType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_additionals(
            data: object,
        ) -> list[BookingCreateAdditionalsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for additionals_type_0_item_data in _additionals_type_0:
                    additionals_type_0_item = (
                        BookingCreateAdditionalsType0Item.from_dict(
                ...
                pass
            return cast(list[BookingCreateAdditionalsType0Item] | None | Unset, data)
        ...
        def _parse_exceptions(
            data: object,
        ) -> list[BookingCreateExceptionsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for exceptions_type_0_item_data in _exceptions_type_0:
                    exceptions_type_0_item = BookingCreateExceptionsType0Item.from_dict(
                ...
                pass
            return cast(list[BookingCreateExceptionsType0Item] | None | Unset, data)
