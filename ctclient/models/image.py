...
if TYPE_CHECKING:
    from ..models.image_image_option import ImageImageOption
...
class Image:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_option = ImageImageOption.from_dict(d.pop("imageOption"))

        image_url = d.pop("imageUrl")

        meta = ImageMeta.from_dict(d.pop("meta"))
