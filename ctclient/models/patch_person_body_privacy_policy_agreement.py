...
T = TypeVar("T", bound="PatchPersonBodyPrivacyPolicyAgreement")


@_attrs_define
class PatchPersonBodyPrivacyPolicyAgreement:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_person_body_privacy_policy_agreement = cls(
            date=date,
            type_id=type_id,
            who_id=who_id,
        )

        patch_person_body_privacy_policy_agreement.additional_properties = d
        return patch_person_body_privacy_policy_agreement
