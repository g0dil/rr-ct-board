...
if TYPE_CHECKING:
    from ..models.post_login_response_200_data import PostLoginResponse200Data
...
class PostLoginResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = PostLoginResponse200Data.from_dict(d.pop("data"))
