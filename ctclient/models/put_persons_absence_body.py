...
T = TypeVar("T", bound="PutPersonsAbsenceBody")


@_attrs_define
class PutPersonsAbsenceBody:
    """
    Attributes:
        absence_reason_id (int):
        comment (str):
        end_date (datetime.date | Unset): If endTime is present, endDate is ignored. Example: 2020-11-15.
        end_time (datetime.datetime | Unset):  Example: 2020-11-30T15:00:00Z.
        start_date (datetime.date | Unset): If startTime is present, startDate is ignored. Example: 2020-11-12.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_persons_absence_body.additional_properties = d
        return put_persons_absence_body
