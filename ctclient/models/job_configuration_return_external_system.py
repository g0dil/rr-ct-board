...
T = TypeVar("T", bound="JobConfigurationReturnExternalSystem")


@_attrs_define
class JobConfigurationReturnExternalSystem:
    """
    Attributes:
        adapter (str | Unset):
        id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        job_configuration_return_external_system = cls(
            adapter=adapter,
            id=id,
        ...
        job_configuration_return_external_system.additional_properties = d
        return job_configuration_return_external_system
