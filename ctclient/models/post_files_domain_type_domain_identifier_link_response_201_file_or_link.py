...
if TYPE_CHECKING:
    from ..models.post_files_domain_type_domain_identifier_link_response_201_file_or_link_meta import (
        PostFilesDomainTypeDomainIdentifierLinkResponse201FileOrLinkMeta,
    )


T = TypeVar("T", bound="PostFilesDomainTypeDomainIdentifierLinkResponse201FileOrLink")


@_attrs_define
class PostFilesDomainTypeDomainIdentifierLinkResponse201FileOrLink:
    ...
    Attributes:
        ...
        meta (PostFilesDomainTypeDomainIdentifierLinkResponse201FileOrLinkMeta | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = PostFilesDomainTypeDomainIdentifierLinkResponse201FileOrLinkMeta.from_dict(
                _meta
            )

        name = d.pop("name", UNSET)

        post_files_domain_type_domain_identifier_link_response_201_file_or_link = cls(
            domain_id=domain_id,
        ...
        post_files_domain_type_domain_identifier_link_response_201_file_or_link.additional_properties = d
        return post_files_domain_type_domain_identifier_link_response_201_file_or_link
