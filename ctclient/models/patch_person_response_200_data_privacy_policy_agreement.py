...
T = TypeVar("T", bound="PatchPersonResponse200DataPrivacyPolicyAgreement")


@_attrs_define
class PatchPersonResponse200DataPrivacyPolicyAgreement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_person_response_200_data_privacy_policy_agreement = cls(
            date=date,
            type_id=type_id,
            who_id=who_id,
        )

        patch_person_response_200_data_privacy_policy_agreement.additional_properties = d
        return patch_person_response_200_data_privacy_policy_agreement
