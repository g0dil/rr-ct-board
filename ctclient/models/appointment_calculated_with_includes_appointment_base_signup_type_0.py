...
T = TypeVar("T", bound="AppointmentCalculatedWithIncludesAppointmentBaseSignupType0")


@_attrs_define
class AppointmentCalculatedWithIncludesAppointmentBaseSignupType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appointment_calculated_with_includes_appointment_base_signup_type_0 = cls(
        ...
        appointment_calculated_with_includes_appointment_base_signup_type_0.additional_properties = d
        return appointment_calculated_with_includes_appointment_base_signup_type_0
