...
if TYPE_CHECKING:
    from ..models.transaction_purpose_meta import TransactionPurposeMeta


T = TypeVar("T", bound="TransactionPurpose")
...
class TransactionPurpose:
    ...
    Attributes:
        ...
        meta (TransactionPurposeMeta | Unset):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson': {'id':
    ...
    meta: TransactionPurposeMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta: TransactionPurposeMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = TransactionPurposeMeta.from_dict(_meta)
        ...
        transaction_purpose.additional_properties = d
