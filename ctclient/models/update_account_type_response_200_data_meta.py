...
if TYPE_CHECKING:
    from ..models.update_account_type_response_200_data_meta_created_person import (
        UpdateAccountTypeResponse200DataMetaCreatedPerson,
    )
    from ..models.update_account_type_response_200_data_meta_modified_person import (
        UpdateAccountTypeResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="UpdateAccountTypeResponse200DataMeta")


@_attrs_define
class UpdateAccountTypeResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (UpdateAccountTypeResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (UpdateAccountTypeResponse200DataMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: UpdateAccountTypeResponse200DataMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: UpdateAccountTypeResponse200DataMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = UpdateAccountTypeResponse200DataMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                UpdateAccountTypeResponse200DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        update_account_type_response_200_data_meta = cls(
        ...
        update_account_type_response_200_data_meta.additional_properties = d
        return update_account_type_response_200_data_meta
