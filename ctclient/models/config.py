...
from ..models.config_allowcheckin import ConfigAllowcheckin
from ..models.config_allowfinance import ConfigAllowfinance
from ..models.config_allowldap import ConfigAllowldap
from ..models.config_allowoptigemsync import ConfigAllowoptigemsync
from ..models.config_allowsync import ConfigAllowsync
from ..models.config_brand import ConfigBrand
from ..models.config_chrome_active import ConfigChromeActive
from ..models.config_churchcustommodule_active import ConfigChurchcustommoduleActive
from ..models.config_currently_mail_sending import ConfigCurrentlyMailSending
from ..models.config_email_server import ConfigEmailServer
from ..models.config_feature_custommodule import ConfigFeatureCustommodule
from ..models.config_finance_inmenu import ConfigFinanceInmenu
from ..models.config_hostingservice import ConfigHostingservice
from ..models.config_https_only import ConfigHttpsOnly
from ..models.config_language import ConfigLanguage
from ..models.config_log_debug import ConfigLogDebug
from ..models.config_mail_sending_in_background import ConfigMailSendingInBackground
from ..models.config_memberlist_birthday_full import ConfigMemberlistBirthdayFull
from ..models.config_memberlist_email import ConfigMemberlistEmail
from ..models.config_memberlist_fax import ConfigMemberlistFax
from ..models.config_memberlist_group_couples import ConfigMemberlistGroupCouples
from ..models.config_memberlist_picture import ConfigMemberlistPicture
from ..models.config_memberlist_salutation import ConfigMemberlistSalutation
from ..models.config_memberlist_telefongeschaeftlich import (
    ConfigMemberlistTelefongeschaeftlich,
)
from ..models.config_memberlist_telefonhandy import ConfigMemberlistTelefonhandy
from ..models.config_memberlist_telefonprivat import ConfigMemberlistTelefonprivat
from ..models.config_orderstatus import ConfigOrderstatus
from ..models.config_prevent_change_security_settings import (
    ConfigPreventChangeSecuritySettings,
)
from ..models.config_safe_mode_enable_authorized_persons import (
    ConfigSafeModeEnableAuthorizedPersons,
)
from ..models.config_safe_mode_enable_chat_sync import ConfigSafeModeEnableChatSync
from ..models.config_safe_mode_enable_consolidation import (
    ConfigSafeModeEnableConsolidation,
)
from ..models.config_safe_mode_enable_guid_sync import ConfigSafeModeEnableGuidSync
from ..models.config_safe_mode_enable_job_queueing import (
    ConfigSafeModeEnableJobQueueing,
)
from ..models.config_safe_mode_enable_mail import ConfigSafeModeEnableMail
from ..models.config_safe_mode_enable_newsletter import ConfigSafeModeEnableNewsletter
from ..models.config_safe_mode_enable_notification import (
    ConfigSafeModeEnableNotification,
)
from ..models.config_test import ConfigTest
from ..models.config_verification_status import ConfigVerificationStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.config_license_settings import ConfigLicenseSettings
...
class Config:
    ...
    Attributes:
        ...
        verification_status (ConfigVerificationStatus):
        webchat_link (str):
        ...
        allowcheckin (ConfigAllowcheckin | Unset): This is a string that can only be true or false.
        ...
        allowfinance (ConfigAllowfinance | Unset): This is a string that can only be true or false.
        allowldap (ConfigAllowldap | Unset): This is a string that can only be true or false.
        allowoptigemsync (ConfigAllowoptigemsync | Unset): This is a string that can only be true or false.
        allowsync (ConfigAllowsync | Unset): This is a string that can only be true or false.
        ...
        chrome_active (ConfigChromeActive | Unset): This is a string that can only be true or false.
        ...
        churchcustommodule_active (ConfigChurchcustommoduleActive | Unset): This is a string that can only be true or
            false.
        ...
        currently_mail_sending (ConfigCurrentlyMailSending | Unset): This is a string that can only be true or false.
        ...
        email_server (ConfigEmailServer | Unset):
        ...
        feature_custommodule (ConfigFeatureCustommodule | Unset): This is a string that can only be true or false.
        finance_active (bool | Unset):
        finance_inmenu (ConfigFinanceInmenu | Unset): This is a string that can only be true or false.
        ...
        hostingservice (ConfigHostingservice | Unset): This is a string that can only be true or false.
        https_only (ConfigHttpsOnly | Unset): This is a string that can only be true or false.
        ...
        language (ConfigLanguage | Unset): The language code is a two-letter code that represents the language. For
            example, "en" for English, "de" for German, and "fr" for French.
        last_cron (str | Unset):
        last_cron_finished (str | Unset):
        last_import_clear (str | Unset):
        last_translation_update (str | Unset):
        ldap_otp_enabled (bool | Unset):
        license_settings (ConfigLicenseSettings | Unset):
        log_debug (ConfigLogDebug | Unset): This is a string that can only be true or false.
        login_message (str | Unset):
        mail_enabled (bool | Unset):
        mail_sending_in_background (ConfigMailSendingInBackground | Unset): This is a string that can only be true or
            false.
        ...
        memberlist_birthday_full (ConfigMemberlistBirthdayFull | Unset): This is a string that can only be true or
            false.
        memberlist_email (ConfigMemberlistEmail | Unset): This is a string that can only be true or false.
        memberlist_fax (ConfigMemberlistFax | Unset): This is a string that can only be true or false.
        memberlist_group_couples (ConfigMemberlistGroupCouples | Unset): This is a string that can only be true or
            false.
        memberlist_picture (ConfigMemberlistPicture | Unset): This is a string that can only be true or false.
        memberlist_salutation (ConfigMemberlistSalutation | Unset): This is a string that can only be true or false.
        memberlist_telefongeschaeftlich (ConfigMemberlistTelefongeschaeftlich | Unset): This is a string that can only
            be true or false.
        memberlist_telefonhandy (ConfigMemberlistTelefonhandy | Unset): This is a string that can only be true or false.
        memberlist_telefonprivat (ConfigMemberlistTelefonprivat | Unset): This is a string that can only be true or
            false.
        ...
        orderstatus (ConfigOrderstatus | Unset):
        ...
        prevent_change_security_settings (ConfigPreventChangeSecuritySettings | Unset):
        ...
        safe_mode_enable_authorized_persons (ConfigSafeModeEnableAuthorizedPersons | Unset): This is a string that can
            only be true or false.
        safe_mode_enable_chat_sync (ConfigSafeModeEnableChatSync | Unset): This is a string that can only be true or
            false.
        safe_mode_enable_consolidation (ConfigSafeModeEnableConsolidation | Unset): This is a string that can only be
            true or false.
        safe_mode_enable_guid_sync (ConfigSafeModeEnableGuidSync | Unset): This is a string that can only be true or
            false.
        safe_mode_enable_job_queueing (ConfigSafeModeEnableJobQueueing | Unset): This is a string that can only be true
            or false.
        safe_mode_enable_mail (ConfigSafeModeEnableMail | Unset): This is a string that can only be true or false.
        safe_mode_enable_newsletter (ConfigSafeModeEnableNewsletter | Unset): This is a string that can only be true or
            false.
        safe_mode_enable_notification (ConfigSafeModeEnableNotification | Unset): This is a string that can only be true
            or false.
        ...
        test (ConfigTest | Unset): This is a string that can only be true or false.
        timezone (str | Unset):
        version (str | Unset):
    ...
    allowcheckin: ConfigAllowcheckin | Unset = UNSET
    ...
    allowfinance: ConfigAllowfinance | Unset = UNSET
    allowldap: ConfigAllowldap | Unset = UNSET
    allowoptigemsync: ConfigAllowoptigemsync | Unset = UNSET
    allowsync: ConfigAllowsync | Unset = UNSET
    ...
    chrome_active: ConfigChromeActive | Unset = UNSET
    ...
    churchcustommodule_active: ConfigChurchcustommoduleActive | Unset = UNSET
    ...
    currently_mail_sending: ConfigCurrentlyMailSending | Unset = UNSET
    ...
    email_server: ConfigEmailServer | Unset = UNSET
    ...
    feature_custommodule: ConfigFeatureCustommodule | Unset = UNSET
    finance_active: bool | Unset = UNSET
    finance_inmenu: ConfigFinanceInmenu | Unset = UNSET
    ...
    hostingservice: ConfigHostingservice | Unset = UNSET
    https_only: ConfigHttpsOnly | Unset = UNSET
    ...
    language: ConfigLanguage | Unset = UNSET
    ...
    license_settings: ConfigLicenseSettings | Unset = UNSET
    log_debug: ConfigLogDebug | Unset = UNSET
    login_message: str | Unset = UNSET
    mail_enabled: bool | Unset = UNSET
    mail_sending_in_background: ConfigMailSendingInBackground | Unset = UNSET
    ...
    memberlist_birthday_full: ConfigMemberlistBirthdayFull | Unset = UNSET
    memberlist_email: ConfigMemberlistEmail | Unset = UNSET
    memberlist_fax: ConfigMemberlistFax | Unset = UNSET
    memberlist_group_couples: ConfigMemberlistGroupCouples | Unset = UNSET
    memberlist_picture: ConfigMemberlistPicture | Unset = UNSET
    memberlist_salutation: ConfigMemberlistSalutation | Unset = UNSET
    memberlist_telefongeschaeftlich: ConfigMemberlistTelefongeschaeftlich | Unset = (
        UNSET
    )
    memberlist_telefonhandy: ConfigMemberlistTelefonhandy | Unset = UNSET
    memberlist_telefonprivat: ConfigMemberlistTelefonprivat | Unset = UNSET
    onboarding_start: datetime.datetime | Unset = UNSET
    openstreetmaps_enabled: bool | Unset = UNSET
    orderstatus: ConfigOrderstatus | Unset = UNSET
    ...
    safe_mode_enable_authorized_persons: (
        ConfigSafeModeEnableAuthorizedPersons | Unset
    ) = UNSET
    safe_mode_enable_chat_sync: ConfigSafeModeEnableChatSync | Unset = UNSET
    safe_mode_enable_consolidation: ConfigSafeModeEnableConsolidation | Unset = UNSET
    safe_mode_enable_guid_sync: ConfigSafeModeEnableGuidSync | Unset = UNSET
    safe_mode_enable_job_queueing: ConfigSafeModeEnableJobQueueing | Unset = UNSET
    safe_mode_enable_mail: ConfigSafeModeEnableMail | Unset = UNSET
    safe_mode_enable_newsletter: ConfigSafeModeEnableNewsletter | Unset = UNSET
    safe_mode_enable_notification: ConfigSafeModeEnableNotification | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        verification_status = ConfigVerificationStatus(d.pop("verificationStatus"))
        ...
        allowcheckin: ConfigAllowcheckin | Unset
        if isinstance(_allowcheckin, Unset):
            allowcheckin = UNSET
        else:
            allowcheckin = ConfigAllowcheckin(_allowcheckin)
        ...
        allowfinance: ConfigAllowfinance | Unset
        if isinstance(_allowfinance, Unset):
            allowfinance = UNSET
        else:
            allowfinance = ConfigAllowfinance(_allowfinance)

        _allowldap = d.pop("allowldap", UNSET)
        allowldap: ConfigAllowldap | Unset
        if isinstance(_allowldap, Unset):
            allowldap = UNSET
        else:
            allowldap = ConfigAllowldap(_allowldap)

        _allowoptigemsync = d.pop("allowoptigemsync", UNSET)
        allowoptigemsync: ConfigAllowoptigemsync | Unset
        if isinstance(_allowoptigemsync, Unset):
            allowoptigemsync = UNSET
        else:
            allowoptigemsync = ConfigAllowoptigemsync(_allowoptigemsync)

        _allowsync = d.pop("allowsync", UNSET)
        allowsync: ConfigAllowsync | Unset
        if isinstance(_allowsync, Unset):
            allowsync = UNSET
        else:
            allowsync = ConfigAllowsync(_allowsync)
        ...
        chrome_active: ConfigChromeActive | Unset
        if isinstance(_chrome_active, Unset):
            chrome_active = UNSET
        else:
            chrome_active = ConfigChromeActive(_chrome_active)
        ...
        churchcustommodule_active: ConfigChurchcustommoduleActive | Unset
        if isinstance(_churchcustommodule_active, Unset):
            churchcustommodule_active = UNSET
        else:
            churchcustommodule_active = ConfigChurchcustommoduleActive(
        ...
        currently_mail_sending: ConfigCurrentlyMailSending | Unset
        if isinstance(_currently_mail_sending, Unset):
            currently_mail_sending = UNSET
        else:
            currently_mail_sending = ConfigCurrentlyMailSending(_currently_mail_sending)
        ...
        if isinstance(_email_server, Unset):
            ...
            email_server = ConfigEmailServer(_email_server)
        ...
        feature_custommodule: ConfigFeatureCustommodule | Unset
        if isinstance(_feature_custommodule, Unset):
            feature_custommodule = UNSET
        else:
            feature_custommodule = ConfigFeatureCustommodule(_feature_custommodule)

        finance_active = d.pop("finance_active", UNSET)

        _finance_inmenu = d.pop("finance_inmenu", UNSET)
        finance_inmenu: ConfigFinanceInmenu | Unset
        if isinstance(_finance_inmenu, Unset):
            finance_inmenu = UNSET
        else:
            finance_inmenu = ConfigFinanceInmenu(_finance_inmenu)
        ...
        hostingservice: ConfigHostingservice | Unset
        if isinstance(_hostingservice, Unset):
            hostingservice = UNSET
        else:
            hostingservice = ConfigHostingservice(_hostingservice)

        _https_only = d.pop("https_only", UNSET)
        https_only: ConfigHttpsOnly | Unset
        if isinstance(_https_only, Unset):
            https_only = UNSET
        else:
            https_only = ConfigHttpsOnly(_https_only)
        ...
        language: ConfigLanguage | Unset
        if isinstance(_language, Unset):
            language = UNSET
        else:
            language = ConfigLanguage(_language)
        ...
        if isinstance(_license_settings, Unset):
            ...
            license_settings = ConfigLicenseSettings.from_dict(_license_settings)

        _log_debug = d.pop("log_debug", UNSET)
        log_debug: ConfigLogDebug | Unset
        if isinstance(_log_debug, Unset):
            log_debug = UNSET
        else:
            log_debug = ConfigLogDebug(_log_debug)
        ...
        mail_sending_in_background: ConfigMailSendingInBackground | Unset
        if isinstance(_mail_sending_in_background, Unset):
            mail_sending_in_background = UNSET
        else:
            mail_sending_in_background = ConfigMailSendingInBackground(
        ...
        if isinstance(_orderstatus, Unset):
            ...
            orderstatus = ConfigOrderstatus(_orderstatus)
        ...
        if isinstance(_prevent_change_security_settings, Unset):
            ...
            prevent_change_security_settings = ConfigPreventChangeSecuritySettings(
        ...
        test: ConfigTest | Unset
        if isinstance(_test, Unset):
            test = UNSET
        else:
            test = ConfigTest(_test)
