...
T = TypeVar("T", bound="GroupPublicPostsStatistic")


@_attrs_define
class GroupPublicPostsStatistic:
    """
    Attributes:
        count (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group_public_posts_statistic = cls(
            count=count,
            last_post_date=last_post_date,
        )

        group_public_posts_statistic.additional_properties = d
        return group_public_posts_statistic
