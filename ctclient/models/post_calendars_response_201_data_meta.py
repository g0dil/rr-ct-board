...
T = TypeVar("T", bound="PostCalendarsResponse201DataMeta")


@_attrs_define
class PostCalendarsResponse201DataMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_calendars_response_201_data_meta = cls(
            modified_date=modified_date,
            modified_pid=modified_pid,
        )

        post_calendars_response_201_data_meta.additional_properties = d
        return post_calendars_response_201_data_meta
