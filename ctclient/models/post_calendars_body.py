...
from ..models.post_calendars_body_type import PostCalendarsBodyType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostCalendarsBody")


@_attrs_define
class PostCalendarsBody:
    """
    Attributes:
        color (str): The color of the calendar in any css3 color format. mostly hex Example: #FF0000.
        name (str):
        sort_key (int):
        type_ (PostCalendarsBodyType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = PostCalendarsBodyType(d.pop("type"))
        ...
        post_calendars_body.additional_properties = d
        return post_calendars_body
