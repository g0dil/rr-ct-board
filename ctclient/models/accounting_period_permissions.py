...
T = TypeVar("T", bound="AccountingPeriodPermissions")


@_attrs_define
class AccountingPeriodPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        accounting_period_permissions = cls(
            can_use_expert_mode=can_use_expert_mode,
            edit_accounting_period=edit_accounting_period,
        )

        accounting_period_permissions.additional_properties = d
        return accounting_period_permissions
