...
T = TypeVar("T", bound="AppointmentCalculatedBaseSignupType0")


@_attrs_define
class AppointmentCalculatedBaseSignupType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appointment_calculated_base_signup_type_0 = cls(
        ...
        appointment_calculated_base_signup_type_0.additional_properties = d
        return appointment_calculated_base_signup_type_0
