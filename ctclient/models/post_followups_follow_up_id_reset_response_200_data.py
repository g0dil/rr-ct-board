...
from ..models.post_followups_follow_up_id_reset_response_200_data_color import (
    PostFollowupsFollowUpIdResetResponse200DataColor,
)
from ..models.post_followups_follow_up_id_reset_response_200_data_origin import (
    PostFollowupsFollowUpIdResetResponse200DataOrigin,
)
from ..models.post_followups_follow_up_id_reset_response_200_data_success_group_member_status_type_0 import (
    PostFollowupsFollowUpIdResetResponse200DataSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_followups_follow_up_id_reset_response_200_data_meta import (
        PostFollowupsFollowUpIdResetResponse200DataMeta,
    )


T = TypeVar("T", bound="PostFollowupsFollowUpIdResetResponse200Data")


@_attrs_define
class PostFollowupsFollowUpIdResetResponse200Data:
    """
    Attributes:
        ...
        meta (PostFollowupsFollowUpIdResetResponse200DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            'createdPerson': {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        origin (PostFollowupsFollowUpIdResetResponse200DataOrigin):
        person_id (int):
        color (PostFollowupsFollowUpIdResetResponse200DataColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (None | PostFollowupsFollowUpIdResetResponse200DataSuccessGroupMemberStatusType0 |
            Unset):
    ...
    id: int
    membership_id: int | None
    meta: PostFollowupsFollowUpIdResetResponse200DataMeta
    origin: PostFollowupsFollowUpIdResetResponse200DataOrigin
    person_id: int
    color: PostFollowupsFollowUpIdResetResponse200DataColor | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = PostFollowupsFollowUpIdResetResponse200DataMeta.from_dict(d.pop("meta"))

        origin = PostFollowupsFollowUpIdResetResponse200DataOrigin(d.pop("origin"))

        person_id = d.pop("personId")

        _color = d.pop("color", UNSET)
        color: PostFollowupsFollowUpIdResetResponse200DataColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = PostFollowupsFollowUpIdResetResponse200DataColor(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = PostFollowupsFollowUpIdResetResponse200DataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        post_followups_follow_up_id_reset_response_200_data = cls(
            title=title,
            done_date=done_date,
        ...
        post_followups_follow_up_id_reset_response_200_data.additional_properties = d
        return post_followups_follow_up_id_reset_response_200_data
