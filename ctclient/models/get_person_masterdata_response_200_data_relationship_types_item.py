...
from ..models.get_person_masterdata_response_200_data_relationship_types_item_function_keys_item import (
    GetPersonMasterdataResponse200DataRelationshipTypesItemFunctionKeysItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPersonMasterdataResponse200DataRelationshipTypesItem")


@_attrs_define
class GetPersonMasterdataResponse200DataRelationshipTypesItem:
    """
    Attributes:
        degree_name_a (str):
        degree_name_b (str):
        ...
        function_keys (list[GetPersonMasterdataResponse200DataRelationshipTypesItemFunctionKeysItem] | Unset):
    """
    ...
    function_keys: (
        list[GetPersonMasterdataResponse200DataRelationshipTypesItemFunctionKeysItem]
        | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_person_masterdata_response_200_data_relationship_types_item = cls(
        ...
        get_person_masterdata_response_200_data_relationship_types_item.additional_properties = d
        return get_person_masterdata_response_200_data_relationship_types_item
