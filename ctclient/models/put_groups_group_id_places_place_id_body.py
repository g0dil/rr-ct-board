...
from ..models.put_groups_group_id_places_place_id_body_marker_color_type_0 import (
    PutGroupsGroupIdPlacesPlaceIdBodyMarkerColorType0,
)
from ..models.put_groups_group_id_places_place_id_body_marker_color_type_1 import (
    PutGroupsGroupIdPlacesPlaceIdBodyMarkerColorType1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutGroupsGroupIdPlacesPlaceIdBody")


@_attrs_define
class PutGroupsGroupIdPlacesPlaceIdBody:
    """
    Attributes:
        ...
        marker_color (PutGroupsGroupIdPlacesPlaceIdBodyMarkerColorType0 |
            PutGroupsGroupIdPlacesPlaceIdBodyMarkerColorType1 | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.marker_color, Unset):
            ...
            self.marker_color, PutGroupsGroupIdPlacesPlaceIdBodyMarkerColorType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_marker_color(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                marker_color_type_0 = PutGroupsGroupIdPlacesPlaceIdBodyMarkerColorType0(
                    data
                )
            ...
            if not isinstance(data, str):
                raise TypeError()
            marker_color_type_1 = PutGroupsGroupIdPlacesPlaceIdBodyMarkerColorType1(
                data
            )
        ...
        put_groups_group_id_places_place_id_body = cls(
            city=city,
            district=district,
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        put_groups_group_id_places_place_id_body.additional_properties = d
        return put_groups_group_id_places_place_id_body
