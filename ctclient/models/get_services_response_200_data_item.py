...
T = TypeVar("T", bound="GetServicesResponse200DataItem")


@_attrs_define
class GetServicesResponse200DataItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_response_200_data_item = cls(
        ...
        get_services_response_200_data_item.additional_properties = d
        return get_services_response_200_data_item
