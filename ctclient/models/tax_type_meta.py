...
if TYPE_CHECKING:
    from ..models.tax_type_meta_created_person import TaxTypeMetaCreatedPerson
    from ..models.tax_type_meta_modified_person import TaxTypeMetaModifiedPerson


T = TypeVar("T", bound="TaxTypeMeta")
...
class TaxTypeMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = TaxTypeMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = TaxTypeMetaModifiedPerson.from_dict(_modified_person)
        ...
        tax_type_meta.additional_properties = d
        return tax_type_meta
