...
T = TypeVar("T", bound="GetOauthclientsResponse200DataItem")


@_attrs_define
class GetOauthclientsResponse200DataItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_oauthclients_response_200_data_item = cls(
        ...
        get_oauthclients_response_200_data_item.additional_properties = d
        return get_oauthclients_response_200_data_item
