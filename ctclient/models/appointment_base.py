...
from ..models.appointment_base_repeat_id import AppointmentBaseRepeatId
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.appointment_base_additionals_item import (
        AppointmentBaseAdditionalsItem,
    )
    from ..models.appointment_base_additions_item import AppointmentBaseAdditionsItem
    from ..models.appointment_base_address import AppointmentBaseAddress
    from ..models.appointment_base_calendar import AppointmentBaseCalendar
    from ..models.appointment_base_exceptions_item import AppointmentBaseExceptionsItem
    from ..models.appointment_base_image_type_0 import AppointmentBaseImageType0
    from ..models.appointment_base_meta import AppointmentBaseMeta
    from ..models.appointment_base_signup_type_0 import AppointmentBaseSignupType0


T = TypeVar("T", bound="AppointmentBase")
...
class AppointmentBase:
    """
    Attributes:
        additionals (list[AppointmentBaseAdditionalsItem]):
        address (AppointmentBaseAddress):
        all_day (bool):
        calendar (AppointmentBaseCalendar):
        description (None | str):
        end_date (datetime.date | datetime.datetime):
        exceptions (list[AppointmentBaseExceptionsItem]):
        id (int):
        image (AppointmentBaseImageType0 | None):
        is_internal (bool):
        link (None | str):
        meta (AppointmentBaseMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson': {'id': 1},
            'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        on_behalf_of_pid (int | None):
        repeat_frequency (int | None):
        repeat_id (AppointmentBaseRepeatId): ID of the repeat pattern, NONE = 0, DAILY = 1, WEEKLY = 7, MONTHLY_BY_DATE
            = 31, MONTHLY_BY_WEEKDAY = 32, YEARLY = 365, MANUALLY = 999
        repeat_option (int | None):
        repeat_until (datetime.date | None): A simple date in ISO format, e.g. '2022-10-19' Example: 2022-10-19.
        signup (AppointmentBaseSignupType0 | None):
        start_date (datetime.date | datetime.datetime):
        subtitle (None | str):
        title (str):
        version (int):
        additions (list[AppointmentBaseAdditionsItem] | Unset): Use 'additionals' instead
    ...
    is_internal: bool
    link: None | str
    meta: AppointmentBaseMeta
    on_behalf_of_pid: int | None
    repeat_frequency: int | None
    repeat_id: AppointmentBaseRepeatId
    repeat_option: int | None
    ...
    title: str
    version: int
    additions: list[AppointmentBaseAdditionsItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.image, AppointmentBaseImageType0):
        ...
        if isinstance(self.signup, AppointmentBaseSignupType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.appointment_base_additions_item import (
            AppointmentBaseAdditionsItem,
        )
        from ..models.appointment_base_address import AppointmentBaseAddress
        from ..models.appointment_base_calendar import AppointmentBaseCalendar
        from ..models.appointment_base_exceptions_item import (
        ...
        for additionals_item_data in _additionals:
            additionals_item = AppointmentBaseAdditionalsItem.from_dict(
                additionals_item_data
            )

            additionals.append(additionals_item)

        address = AppointmentBaseAddress.from_dict(d.pop("address"))

        all_day = d.pop("allDay")

        calendar = AppointmentBaseCalendar.from_dict(d.pop("calendar"))
        ...
        for exceptions_item_data in _exceptions:
            exceptions_item = AppointmentBaseExceptionsItem.from_dict(
        ...
        def _parse_image(data: object) -> AppointmentBaseImageType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image_type_0 = AppointmentBaseImageType0.from_dict(data)

                return image_type_0
            except:  # noqa: E722
                pass
            return cast(AppointmentBaseImageType0 | None, data)
        ...
        meta = AppointmentBaseMeta.from_dict(d.pop("meta"))
        ...
        repeat_id = AppointmentBaseRepeatId(d.pop("repeatId"))
        ...
        def _parse_signup(data: object) -> AppointmentBaseSignupType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                signup_type_0 = AppointmentBaseSignupType0.from_dict(data)

                return signup_type_0
            except:  # noqa: E722
                pass
            return cast(AppointmentBaseSignupType0 | None, data)
        ...
        for additions_item_data in _additions or []:
            additions_item = AppointmentBaseAdditionsItem.from_dict(additions_item_data)
        ...
        appointment_base.additional_properties = d
        return appointment_base
