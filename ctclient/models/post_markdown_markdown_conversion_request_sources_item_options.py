...
T = TypeVar("T", bound="PostMarkdownMarkdownConversionRequestSourcesItemOptions")


@_attrs_define
class PostMarkdownMarkdownConversionRequestSourcesItemOptions:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_markdown_markdown_conversion_request_sources_item_options = cls(
            allow_html=allow_html,
            max_length=max_length,
            language=language,
        )

        return post_markdown_markdown_conversion_request_sources_item_options
