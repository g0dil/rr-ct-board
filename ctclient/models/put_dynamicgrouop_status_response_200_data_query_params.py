...
if TYPE_CHECKING:
    from ..models.put_dynamicgrouop_status_response_200_data_query_params_computed_fields_item import (
        PutDynamicgrouopStatusResponse200DataQueryParamsComputedFieldsItem,
    )
    from ..models.put_dynamicgrouop_status_response_200_data_query_params_filter import (
        PutDynamicgrouopStatusResponse200DataQueryParamsFilter,
    )


T = TypeVar("T", bound="PutDynamicgrouopStatusResponse200DataQueryParams")


@_attrs_define
class PutDynamicgrouopStatusResponse200DataQueryParams:
    """
    Attributes:
        computed_fields (list[PutDynamicgrouopStatusResponse200DataQueryParamsComputedFieldsItem] | Unset):
        description (str | Unset):
        filter_ (PutDynamicgrouopStatusResponse200DataQueryParamsFilter | Unset):
    ...
    computed_fields: (
        list[PutDynamicgrouopStatusResponse200DataQueryParamsComputedFieldsItem] | Unset
    ) = UNSET
    description: str | Unset = UNSET
    filter_: PutDynamicgrouopStatusResponse200DataQueryParamsFilter | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for computed_fields_item_data in _computed_fields or []:
            computed_fields_item = PutDynamicgrouopStatusResponse200DataQueryParamsComputedFieldsItem.from_dict(
        ...
        if isinstance(_filter_, Unset):
            ...
            filter_ = PutDynamicgrouopStatusResponse200DataQueryParamsFilter.from_dict(
                _filter_
            )
        ...
        put_dynamicgrouop_status_response_200_data_query_params = cls(
        ...
        put_dynamicgrouop_status_response_200_data_query_params.additional_properties = d
        return put_dynamicgrouop_status_response_200_data_query_params
