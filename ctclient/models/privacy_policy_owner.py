...
T = TypeVar("T", bound="PrivacyPolicyOwner")


@_attrs_define
class PrivacyPolicyOwner:
    """
    Attributes:
        accepted (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        privacy_policy_owner.additional_properties = d
        return privacy_policy_owner
