...
T = TypeVar("T", bound="DeleteTaxRateResponse409DataReferencesItem")


@_attrs_define
class DeleteTaxRateResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_tax_rate_response_409_data_references_item = cls(
        ...
        delete_tax_rate_response_409_data_references_item.additional_properties = d
        return delete_tax_rate_response_409_data_references_item
