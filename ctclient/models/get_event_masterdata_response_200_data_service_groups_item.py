...
T = TypeVar("T", bound="GetEventMasterdataResponse200DataServiceGroupsItem")


@_attrs_define
class GetEventMasterdataResponse200DataServiceGroupsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_event_masterdata_response_200_data_service_groups_item = cls(
            campus_id=campus_id,
            id=id,
            name=name,
        ...
        get_event_masterdata_response_200_data_service_groups_item.additional_properties = d
        return get_event_masterdata_response_200_data_service_groups_item
