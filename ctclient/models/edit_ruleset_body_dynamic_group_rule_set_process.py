...
if TYPE_CHECKING:
    from ..models.edit_ruleset_body_dynamic_group_rule_set_process_group_and_query_result import (
        EditRulesetBodyDynamicGroupRuleSetProcessGroupAndQueryResult,
    )
    from ..models.edit_ruleset_body_dynamic_group_rule_set_process_group_only import (
        EditRulesetBodyDynamicGroupRuleSetProcessGroupOnly,
    )
    from ..models.edit_ruleset_body_dynamic_group_rule_set_process_query_result_only import (
        EditRulesetBodyDynamicGroupRuleSetProcessQueryResultOnly,
    )


T = TypeVar("T", bound="EditRulesetBodyDynamicGroupRuleSetProcess")


@_attrs_define
class EditRulesetBodyDynamicGroupRuleSetProcess:
    """
    Attributes:
        group_and_query_result (EditRulesetBodyDynamicGroupRuleSetProcessGroupAndQueryResult | Unset):
        group_only (EditRulesetBodyDynamicGroupRuleSetProcessGroupOnly | Unset):
        query_result_only (EditRulesetBodyDynamicGroupRuleSetProcessQueryResultOnly | Unset):
    """

    group_and_query_result: (
        EditRulesetBodyDynamicGroupRuleSetProcessGroupAndQueryResult | Unset
    ) = UNSET
    group_only: EditRulesetBodyDynamicGroupRuleSetProcessGroupOnly | Unset = UNSET
    query_result_only: (
        EditRulesetBodyDynamicGroupRuleSetProcessQueryResultOnly | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_group_and_query_result, Unset):
            ...
            group_and_query_result = (
                EditRulesetBodyDynamicGroupRuleSetProcessGroupAndQueryResult.from_dict(
        ...
        if isinstance(_group_only, Unset):
            ...
            group_only = EditRulesetBodyDynamicGroupRuleSetProcessGroupOnly.from_dict(
                _group_only
            )
        ...
        if isinstance(_query_result_only, Unset):
            ...
            query_result_only = (
                EditRulesetBodyDynamicGroupRuleSetProcessQueryResultOnly.from_dict(
                    _query_result_only
                )
            )

        edit_ruleset_body_dynamic_group_rule_set_process = cls(
            group_and_query_result=group_and_query_result,
            group_only=group_only,
            query_result_only=query_result_only,
        )

        edit_ruleset_body_dynamic_group_rule_set_process.additional_properties = d
        return edit_ruleset_body_dynamic_group_rule_set_process
