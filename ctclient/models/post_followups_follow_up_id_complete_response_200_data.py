...
from ..models.post_followups_follow_up_id_complete_response_200_data_color import (
    PostFollowupsFollowUpIdCompleteResponse200DataColor,
)
from ..models.post_followups_follow_up_id_complete_response_200_data_origin import (
    PostFollowupsFollowUpIdCompleteResponse200DataOrigin,
)
from ..models.post_followups_follow_up_id_complete_response_200_data_success_group_member_status_type_0 import (
    PostFollowupsFollowUpIdCompleteResponse200DataSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_followups_follow_up_id_complete_response_200_data_meta import (
        PostFollowupsFollowUpIdCompleteResponse200DataMeta,
    )


T = TypeVar("T", bound="PostFollowupsFollowUpIdCompleteResponse200Data")


@_attrs_define
class PostFollowupsFollowUpIdCompleteResponse200Data:
    """
    Attributes:
        ...
        meta (PostFollowupsFollowUpIdCompleteResponse200DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            'createdPerson': {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        origin (PostFollowupsFollowUpIdCompleteResponse200DataOrigin):
        person_id (int):
        color (PostFollowupsFollowUpIdCompleteResponse200DataColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (None | PostFollowupsFollowUpIdCompleteResponse200DataSuccessGroupMemberStatusType0
            | Unset):
    ...
    id: int
    membership_id: int | None
    meta: PostFollowupsFollowUpIdCompleteResponse200DataMeta
    origin: PostFollowupsFollowUpIdCompleteResponse200DataOrigin
    person_id: int
    color: PostFollowupsFollowUpIdCompleteResponse200DataColor | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = PostFollowupsFollowUpIdCompleteResponse200DataMeta.from_dict(
            d.pop("meta")
        )

        origin = PostFollowupsFollowUpIdCompleteResponse200DataOrigin(d.pop("origin"))

        person_id = d.pop("personId")

        _color = d.pop("color", UNSET)
        color: PostFollowupsFollowUpIdCompleteResponse200DataColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = PostFollowupsFollowUpIdCompleteResponse200DataColor(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = PostFollowupsFollowUpIdCompleteResponse200DataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        post_followups_follow_up_id_complete_response_200_data = cls(
            title=title,
            done_date=done_date,
        ...
        post_followups_follow_up_id_complete_response_200_data.additional_properties = d
        return post_followups_follow_up_id_complete_response_200_data
