...
if TYPE_CHECKING:
    from ..models.follow_up_2_meta_created_person import FollowUp2MetaCreatedPerson
    from ..models.follow_up_2_meta_modified_person import FollowUp2MetaModifiedPerson


T = TypeVar("T", bound="FollowUp2Meta")
...
class FollowUp2Meta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.follow_up_2_meta_created_person import FollowUp2MetaCreatedPerson
        from ..models.follow_up_2_meta_modified_person import (
        ...
        created_person = FollowUp2MetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = FollowUp2MetaModifiedPerson.from_dict(_modified_person)

        follow_up_2_meta = cls(
        ...
        follow_up_2_meta.additional_properties = d
        return follow_up_2_meta
