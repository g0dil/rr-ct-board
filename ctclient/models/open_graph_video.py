...
if TYPE_CHECKING:
    from ..models.open_graph_video_actors_item import OpenGraphVideoActorsItem


T = TypeVar("T", bound="OpenGraphVideo")
...
class OpenGraphVideo:
    ...
    Attributes:
        actors (list[OpenGraphVideoActorsItem] | Unset):
    ...
    actors: list[OpenGraphVideoActorsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for actors_item_data in _actors or []:
            actors_item = OpenGraphVideoActorsItem.from_dict(actors_item_data)
        ...
        open_graph_video.additional_properties = d
        return open_graph_video
