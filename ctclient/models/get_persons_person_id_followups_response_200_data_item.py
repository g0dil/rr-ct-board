...
from ..models.get_persons_person_id_followups_response_200_data_item_color import (
    GetPersonsPersonIdFollowupsResponse200DataItemColor,
)
from ..models.get_persons_person_id_followups_response_200_data_item_origin import (
    GetPersonsPersonIdFollowupsResponse200DataItemOrigin,
)
from ..models.get_persons_person_id_followups_response_200_data_item_success_group_member_status_type_0 import (
    GetPersonsPersonIdFollowupsResponse200DataItemSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_persons_person_id_followups_response_200_data_item_meta import (
        GetPersonsPersonIdFollowupsResponse200DataItemMeta,
    )


T = TypeVar("T", bound="GetPersonsPersonIdFollowupsResponse200DataItem")


@_attrs_define
class GetPersonsPersonIdFollowupsResponse200DataItem:
    """
    Attributes:
        ...
        meta (GetPersonsPersonIdFollowupsResponse200DataItemMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            'createdPerson': {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        origin (GetPersonsPersonIdFollowupsResponse200DataItemOrigin):
        person_id (int):
        color (GetPersonsPersonIdFollowupsResponse200DataItemColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (GetPersonsPersonIdFollowupsResponse200DataItemSuccessGroupMemberStatusType0 | None
            | Unset):
    ...
    id: int
    membership_id: int | None
    meta: GetPersonsPersonIdFollowupsResponse200DataItemMeta
    origin: GetPersonsPersonIdFollowupsResponse200DataItemOrigin
    person_id: int
    color: GetPersonsPersonIdFollowupsResponse200DataItemColor | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = GetPersonsPersonIdFollowupsResponse200DataItemMeta.from_dict(
            d.pop("meta")
        )

        origin = GetPersonsPersonIdFollowupsResponse200DataItemOrigin(d.pop("origin"))

        person_id = d.pop("personId")

        _color = d.pop("color", UNSET)
        color: GetPersonsPersonIdFollowupsResponse200DataItemColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = GetPersonsPersonIdFollowupsResponse200DataItemColor(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = GetPersonsPersonIdFollowupsResponse200DataItemSuccessGroupMemberStatusType0(
                    data
                )
        ...
        get_persons_person_id_followups_response_200_data_item = cls(
            title=title,
            done_date=done_date,
        ...
        get_persons_person_id_followups_response_200_data_item.additional_properties = d
        return get_persons_person_id_followups_response_200_data_item
