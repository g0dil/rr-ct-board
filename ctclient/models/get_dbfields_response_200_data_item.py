...
if TYPE_CHECKING:
    from ..models.get_dbfields_response_200_data_item_field_category import (
        GetDbfieldsResponse200DataItemFieldCategory,
    )
    from ..models.get_dbfields_response_200_data_item_field_type import (
        GetDbfieldsResponse200DataItemFieldType,
    )
    from ..models.get_dbfields_response_200_data_item_options_item import (
        GetDbfieldsResponse200DataItemOptionsItem,
    )


T = TypeVar("T", bound="GetDbfieldsResponse200DataItem")


@_attrs_define
class GetDbfieldsResponse200DataItem:
    """
    Attributes:
        ...
        field_category (GetDbfieldsResponse200DataItemFieldCategory):
        field_type (GetDbfieldsResponse200DataItemFieldType):
        ...
        shorty (str | Unset):
        options (list[GetDbfieldsResponse200DataItemOptionsItem] | Unset):
    """
    ...
    options: list[GetDbfieldsResponse200DataItemOptionsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_category = GetDbfieldsResponse200DataItemFieldCategory.from_dict(
            d.pop("fieldCategory")
        )

        field_type = GetDbfieldsResponse200DataItemFieldType.from_dict(
            d.pop("fieldType")
        )
        ...
        for options_item_data in _options or []:
            options_item = GetDbfieldsResponse200DataItemOptionsItem.from_dict(
                options_item_data
            )

            options.append(options_item)

        get_dbfields_response_200_data_item = cls(
        ...
        get_dbfields_response_200_data_item.additional_properties = d
        return get_dbfields_response_200_data_item
