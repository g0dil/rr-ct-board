...
if TYPE_CHECKING:
    from ..models.create_new_transaction_purpose_response_201_data_item_meta import (
        CreateNewTransactionPurposeResponse201DataItemMeta,
    )


T = TypeVar("T", bound="CreateNewTransactionPurposeResponse201DataItem")


@_attrs_define
class CreateNewTransactionPurposeResponse201DataItem:
    """
    Example:
    ...
    Attributes:
        ...
        meta (CreateNewTransactionPurposeResponse201DataItemMeta | Unset):  Example: {'createdDate':
    ...
    meta: CreateNewTransactionPurposeResponse201DataItemMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta: CreateNewTransactionPurposeResponse201DataItemMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = CreateNewTransactionPurposeResponse201DataItemMeta.from_dict(_meta)
        ...
        create_new_transaction_purpose_response_201_data_item = cls(
        ...
        create_new_transaction_purpose_response_201_data_item.additional_properties = d
        return create_new_transaction_purpose_response_201_data_item
