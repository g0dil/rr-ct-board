...
T = TypeVar("T", bound="GetPersonsPersonIdFollowupsStatisticsResponse200Data")


@_attrs_define
class GetPersonsPersonIdFollowupsStatisticsResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_persons_person_id_followups_statistics_response_200_data = cls(
        ...
        get_persons_person_id_followups_statistics_response_200_data.additional_properties = d
        return get_persons_person_id_followups_statistics_response_200_data
