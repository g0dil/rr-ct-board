...
T = TypeVar("T", bound="AppointmentAdditionalsMeta")


@_attrs_define
class AppointmentAdditionalsMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appointment_additionals_meta = cls(
            modified_date=modified_date,
            modified_pid=modified_pid,
        )

        appointment_additionals_meta.additional_properties = d
        return appointment_additionals_meta
