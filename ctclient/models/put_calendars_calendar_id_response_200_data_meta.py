...
T = TypeVar("T", bound="PutCalendarsCalendarIdResponse200DataMeta")


@_attrs_define
class PutCalendarsCalendarIdResponse200DataMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_calendars_calendar_id_response_200_data_meta = cls(
            modified_date=modified_date,
            modified_pid=modified_pid,
        )

        put_calendars_calendar_id_response_200_data_meta.additional_properties = d
        return put_calendars_calendar_id_response_200_data_meta
