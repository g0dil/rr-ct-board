...
from ..models.membership_new_group_member_status import MembershipNewGroupMemberStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.membership_new_fields_type_0 import MembershipNewFieldsType0
    from ..models.membership_new_member_start_date import MembershipNewMemberStartDate


T = TypeVar("T", bound="MembershipNew")
...
class MembershipNew:
    ...
    Attributes:
        ...
        fields (MembershipNewFieldsType0 | None | Unset): Group member fields as key value pairs, where the key is the
            ID of the field to be set. Example: {'12': True, '14': 'Text', '17': None}.
        group_member_status (MembershipNewGroupMemberStatus | Unset):  Default: MembershipNewGroupMemberStatus.ACTIVE.
        ...
        member_end_date (datetime.date | None | Unset): A simple date in ISO format, e.g. '2022-10-19' Example:
            2022-10-19.
        member_start_date (MembershipNewMemberStartDate | Unset):
        only_add (bool | None | Unset):
        waitinglist_position (int | None | Unset):
    """

    comment: None | str | Unset = UNSET
    fields: MembershipNewFieldsType0 | None | Unset = UNSET
    group_member_status: MembershipNewGroupMemberStatus | Unset = (
        MembershipNewGroupMemberStatus.ACTIVE
    )
    ...
    member_start_date: MembershipNewMemberStartDate | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.fields, Unset):
            fields = UNSET
        elif isinstance(self.fields, MembershipNewFieldsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.membership_new_fields_type_0 import MembershipNewFieldsType0
        from ..models.membership_new_member_start_date import (
        ...
        def _parse_fields(data: object) -> MembershipNewFieldsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                fields_type_0 = MembershipNewFieldsType0.from_dict(data)

                return fields_type_0
            except:  # noqa: E722
                pass
            return cast(MembershipNewFieldsType0 | None | Unset, data)
        ...
        if isinstance(_group_member_status, Unset):
            ...
            group_member_status = MembershipNewGroupMemberStatus(_group_member_status)
        ...
        if isinstance(_member_start_date, Unset):
            ...
            member_start_date = MembershipNewMemberStartDate.from_dict(
                _member_start_date
            )
        ...
        membership_new.additional_properties = d
