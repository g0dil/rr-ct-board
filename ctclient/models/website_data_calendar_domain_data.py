...
if TYPE_CHECKING:
    from ..models.website_data_calendar_domain_data_meta import (
        WebsiteDataCalendarDomainDataMeta,
    )


T = TypeVar("T", bound="WebsiteDataCalendarDomainData")


@_attrs_define
class WebsiteDataCalendarDomainData:
    """
    Attributes:
        id (int):
        meta (WebsiteDataCalendarDomainDataMeta):
        name_translated (str):
        random_url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = WebsiteDataCalendarDomainDataMeta.from_dict(d.pop("meta"))
        ...
        website_data_calendar_domain_data = cls(
            id=id,
            meta=meta,
        ...
        website_data_calendar_domain_data.additional_properties = d
        return website_data_calendar_domain_data
