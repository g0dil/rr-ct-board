...
T = TypeVar("T", bound="GetGroupGrouptypesResponse200DataItem")


@_attrs_define
class GetGroupGrouptypesResponse200DataItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_group_grouptypes_response_200_data_item = cls(
            name_plural_translated=name_plural_translated,
            name_translated=name_translated,
        )

        get_group_grouptypes_response_200_data_item.additional_properties = d
        return get_group_grouptypes_response_200_data_item
