...
from ..models.get_whoami_response_200_data_invitation_status_type_0 import (
    GetWhoamiResponse200DataInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_whoami_response_200_data_emails_item import (
        GetWhoamiResponse200DataEmailsItem,
    )
    from ..models.get_whoami_response_200_data_meta import GetWhoamiResponse200DataMeta
    from ..models.get_whoami_response_200_data_privacy_policy_agreement import (
        GetWhoamiResponse200DataPrivacyPolicyAgreement,
    )
    from ..models.get_whoami_response_200_data_tags_item import (
        GetWhoamiResponse200DataTagsItem,
    )


T = TypeVar("T", bound="GetWhoamiResponse200Data")


@_attrs_define
class GetWhoamiResponse200Data:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[GetWhoamiResponse200DataEmailsItem] | Unset):
            ...
            invitation_status (GetWhoamiResponse200DataInvitationStatusType0 | None | Unset):
            ...
            meta (GetWhoamiResponse200DataMeta | Unset):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson':
            ...
            privacy_policy_agreement (GetWhoamiResponse200DataPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[GetWhoamiResponse200DataTagsItem] | Unset):
            title (str | Unset):
    ...
    emails: list[GetWhoamiResponse200DataEmailsItem] | Unset = UNSET
    ...
    meta: GetWhoamiResponse200DataMeta | Unset = UNSET
    ...
    tags: list[GetWhoamiResponse200DataTagsItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.invitation_status, Unset):
            ...
            self.invitation_status, GetWhoamiResponse200DataInvitationStatusType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.get_whoami_response_200_data_meta import (
        ...
        for emails_item_data in _emails or []:
            emails_item = GetWhoamiResponse200DataEmailsItem.from_dict(emails_item_data)
        ...
        def _parse_invitation_status(
            data: object,
        ) -> GetWhoamiResponse200DataInvitationStatusType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                invitation_status_type_0 = (
                    GetWhoamiResponse200DataInvitationStatusType0(data)
                )
                ...
                pass
            return cast(
                GetWhoamiResponse200DataInvitationStatusType0 | None | Unset, data
            )
        ...
        meta: GetWhoamiResponse200DataMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = GetWhoamiResponse200DataMeta.from_dict(_meta)
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = (
                GetWhoamiResponse200DataPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = GetWhoamiResponse200DataTagsItem.from_dict(tags_item_data)
        ...
        get_whoami_response_200_data = cls(
        ...
        get_whoami_response_200_data.additional_properties = d
        return get_whoami_response_200_data
