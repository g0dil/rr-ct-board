...
from ..models.follow_up_2_color import FollowUp2Color
from ..models.follow_up_2_origin import FollowUp2Origin
from ..models.follow_up_2_success_group_member_status_type_0 import (
    FollowUp2SuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.follow_up_2_meta import FollowUp2Meta


T = TypeVar("T", bound="FollowUp2")
...
class FollowUp2:
    ...
    Attributes:
        ...
        meta (FollowUp2Meta):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson': {'id': 1},
            'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        origin (FollowUp2Origin):
        person_id (int):
        color (FollowUp2Color | Unset): A color in ChurchTools
        ...
        success_group_member_status (FollowUp2SuccessGroupMemberStatusType0 | None | Unset):
    ...
    origin: FollowUp2Origin
    person_id: int
    color: FollowUp2Color | Unset = UNSET
    ...
    success_group_member_status: (
        FollowUp2SuccessGroupMemberStatusType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.success_group_member_status, Unset):
            ...
            self.success_group_member_status, FollowUp2SuccessGroupMemberStatusType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = FollowUp2Meta.from_dict(d.pop("meta"))

        origin = FollowUp2Origin(d.pop("origin"))

        person_id = d.pop("personId")

        _color = d.pop("color", UNSET)
        color: FollowUp2Color | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = FollowUp2Color(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                ...
                success_group_member_status_type_0 = (
                    FollowUp2SuccessGroupMemberStatusType0(data)
                )

                return success_group_member_status_type_0
            except:  # noqa: E722
                pass
            return cast(FollowUp2SuccessGroupMemberStatusType0 | None | Unset, data)
        ...
        follow_up_2.additional_properties = d
        return follow_up_2
