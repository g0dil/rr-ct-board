...
from ..models.get_followups_follow_up_id_response_200_data_color import (
    GetFollowupsFollowUpIdResponse200DataColor,
)
from ..models.get_followups_follow_up_id_response_200_data_origin import (
    GetFollowupsFollowUpIdResponse200DataOrigin,
)
from ..models.get_followups_follow_up_id_response_200_data_success_group_member_status_type_0 import (
    GetFollowupsFollowUpIdResponse200DataSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_followups_follow_up_id_response_200_data_meta import (
        GetFollowupsFollowUpIdResponse200DataMeta,
    )


T = TypeVar("T", bound="GetFollowupsFollowUpIdResponse200Data")


@_attrs_define
class GetFollowupsFollowUpIdResponse200Data:
    """
    Attributes:
        ...
        meta (GetFollowupsFollowUpIdResponse200DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            'createdPerson': {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        origin (GetFollowupsFollowUpIdResponse200DataOrigin):
        person_id (int):
        color (GetFollowupsFollowUpIdResponse200DataColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (GetFollowupsFollowUpIdResponse200DataSuccessGroupMemberStatusType0 | None | Unset):
    ...
    id: int
    membership_id: int | None
    meta: GetFollowupsFollowUpIdResponse200DataMeta
    origin: GetFollowupsFollowUpIdResponse200DataOrigin
    person_id: int
    color: GetFollowupsFollowUpIdResponse200DataColor | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = GetFollowupsFollowUpIdResponse200DataMeta.from_dict(d.pop("meta"))

        origin = GetFollowupsFollowUpIdResponse200DataOrigin(d.pop("origin"))

        person_id = d.pop("personId")

        _color = d.pop("color", UNSET)
        color: GetFollowupsFollowUpIdResponse200DataColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = GetFollowupsFollowUpIdResponse200DataColor(_color)
        ...
        get_followups_follow_up_id_response_200_data = cls(
            title=title,
            done_date=done_date,
        ...
        get_followups_follow_up_id_response_200_data.additional_properties = d
        return get_followups_follow_up_id_response_200_data
