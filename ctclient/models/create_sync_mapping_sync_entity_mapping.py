...
from ..models.create_sync_mapping_sync_entity_mapping_status import (
    CreateSyncMappingSyncEntityMappingStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_sync_mapping_sync_entity_mapping_meta import (
        CreateSyncMappingSyncEntityMappingMeta,
    )


T = TypeVar("T", bound="CreateSyncMappingSyncEntityMapping")


@_attrs_define
class CreateSyncMappingSyncEntityMapping:
    ...
    Attributes:
        ...
        meta (CreateSyncMappingSyncEntityMappingMeta | Unset):
        ...
        status (CreateSyncMappingSyncEntityMappingStatus | Unset): Status of Relationship Example: synced.
    """
    ...
    meta: CreateSyncMappingSyncEntityMappingMeta | Unset = UNSET
    scope: None | str | Unset = UNSET
    source_entity_id: str | Unset = UNSET
    source_id: int | Unset = UNSET
    status: CreateSyncMappingSyncEntityMappingStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = CreateSyncMappingSyncEntityMappingMeta.from_dict(_meta)
        ...
        status: CreateSyncMappingSyncEntityMappingStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = CreateSyncMappingSyncEntityMappingStatus(_status)

        create_sync_mapping_sync_entity_mapping = cls(
            domain_id=domain_id,
        ...
        create_sync_mapping_sync_entity_mapping.additional_properties = d
        return create_sync_mapping_sync_entity_mapping
