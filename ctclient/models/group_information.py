...
from ..models.group_information_chat_status import GroupInformationChatStatus
from ..models.group_information_color import GroupInformationColor

if TYPE_CHECKING:
    from ..models.group_information_date_of_foundation import (
        GroupInformationDateOfFoundation,
    )
    from ..models.group_information_end_date import GroupInformationEndDate


T = TypeVar("T", bound="GroupInformation")
...
class GroupInformation:
    ...
    Attributes:
        ...
        campus_id (int | None):
        chat_status (GroupInformationChatStatus): status of chat room Example: STARTED.
        color (GroupInformationColor): A color in ChurchTools
        date_of_foundation (GroupInformationDateOfFoundation):
        end_date (GroupInformationEndDate):
    ...
    campus_id: int | None
    chat_status: GroupInformationChatStatus
    color: GroupInformationColor
    date_of_foundation: GroupInformationDateOfFoundation
    end_date: GroupInformationEndDate
    group_category_id: int | None
    group_homepage_url: None | str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chat_status = GroupInformationChatStatus(d.pop("chatStatus"))

        color = GroupInformationColor(d.pop("color"))

        date_of_foundation = GroupInformationDateOfFoundation.from_dict(
            d.pop("dateOfFoundation")
        )

        end_date = GroupInformationEndDate.from_dict(d.pop("endDate"))
        ...
        group_information.additional_properties = d
