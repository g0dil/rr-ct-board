...
if TYPE_CHECKING:
    from ..models.create_new_account_response_200_data_item_meta_created_person import (
        CreateNewAccountResponse200DataItemMetaCreatedPerson,
    )
    from ..models.create_new_account_response_200_data_item_meta_modified_person import (
        CreateNewAccountResponse200DataItemMetaModifiedPerson,
    )


T = TypeVar("T", bound="CreateNewAccountResponse200DataItemMeta")


@_attrs_define
class CreateNewAccountResponse200DataItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (CreateNewAccountResponse200DataItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (CreateNewAccountResponse200DataItemMetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = CreateNewAccountResponse200DataItemMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                CreateNewAccountResponse200DataItemMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        create_new_account_response_200_data_item_meta = cls(
        ...
        create_new_account_response_200_data_item_meta.additional_properties = d
        return create_new_account_response_200_data_item_meta
