...
T = TypeVar("T", bound="PutExternalloginExternalLoginIdResponse200Data")


@_attrs_define
class PutExternalloginExternalLoginIdResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_externallogin_external_login_id_response_200_data = cls(
            name=name,
        ...
        put_externallogin_external_login_id_response_200_data.additional_properties = d
        return put_externallogin_external_login_id_response_200_data
