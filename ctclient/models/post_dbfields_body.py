...
from ..models.post_dbfields_body_field_category_intern_code import (
    PostDbfieldsBodyFieldCategoryInternCode,
)
from ..models.post_dbfields_body_field_type_intern_code import (
    PostDbfieldsBodyFieldTypeInternCode,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostDbfieldsBody")


@_attrs_define
class PostDbfieldsBody:
    """
    Attributes:
        ...
        field_category_intern_code (PostDbfieldsBodyFieldCategoryInternCode): The intern code of the field category the
            field belongs to. This is used to define the category of the field.
        field_type_intern_code (PostDbfieldsBodyFieldTypeInternCode): The intern code of the field type the field
    ...
    sort_key: int
    use_as_placeholder: bool
    field_category_intern_code: PostDbfieldsBodyFieldCategoryInternCode
    field_type_intern_code: PostDbfieldsBodyFieldTypeInternCode
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_dbfields_body.additional_properties = d
        return post_dbfields_body
