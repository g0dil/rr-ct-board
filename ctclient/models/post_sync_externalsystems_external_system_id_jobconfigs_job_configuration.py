...
if TYPE_CHECKING:
    from ..models.post_sync_externalsystems_external_system_id_jobconfigs_job_configuration_create_defaults_es import (
        PostSyncExternalsystemsExternalSystemIdJobconfigsJobConfigurationCreateDefaultsES,
    )
    from ..models.post_sync_externalsystems_external_system_id_jobconfigs_job_configuration_create_defaults_master import (
        PostSyncExternalsystemsExternalSystemIdJobconfigsJobConfigurationCreateDefaultsMaster,
    )


T = TypeVar(
    "T", bound="PostSyncExternalsystemsExternalSystemIdJobconfigsJobConfiguration"
)


@_attrs_define
class PostSyncExternalsystemsExternalSystemIdJobconfigsJobConfiguration:
    """
    Attributes:
        ...
        create_defaults_es (PostSyncExternalsystemsExternalSystemIdJobconfigsJobConfigurationCreateDefaultsES | Unset):
        create_defaults_master (PostSyncExternalsystemsExternalSystemIdJobconfigsJobConfigurationCreateDefaultsMaster |
            Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_create_defaults_es, Unset):
            ...
            create_defaults_es = PostSyncExternalsystemsExternalSystemIdJobconfigsJobConfigurationCreateDefaultsES.from_dict(
                _create_defaults_es
            )
        ...
        if isinstance(_create_defaults_master, Unset):
            ...
            create_defaults_master = PostSyncExternalsystemsExternalSystemIdJobconfigsJobConfigurationCreateDefaultsMaster.from_dict(
        ...
        post_sync_externalsystems_external_system_id_jobconfigs_job_configuration = cls(
        ...
        post_sync_externalsystems_external_system_id_jobconfigs_job_configuration.additional_properties = d
        return post_sync_externalsystems_external_system_id_jobconfigs_job_configuration
