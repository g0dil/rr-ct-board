...
T = TypeVar("T", bound="CreateNewAccountGroupBody")


@_attrs_define
class CreateNewAccountGroupBody:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_new_account_group_body = cls(
        ...
        create_new_account_group_body.additional_properties = d
        return create_new_account_group_body
