...
T = TypeVar("T", bound="GetResourcetypesResourceTypeIdResponse200Data")


@_attrs_define
class GetResourcetypesResourceTypeIdResponse200Data:
    """
    Attributes:
        id (int):  Example: 3.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_resourcetypes_resource_type_id_response_200_data = cls(
            id=id,
        ...
        get_resourcetypes_resource_type_id_response_200_data.additional_properties = d
        return get_resourcetypes_resource_type_id_response_200_data
