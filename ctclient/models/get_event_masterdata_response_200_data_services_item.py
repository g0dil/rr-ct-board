...
T = TypeVar("T", bound="GetEventMasterdataResponse200DataServicesItem")


@_attrs_define
class GetEventMasterdataResponse200DataServicesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_event_masterdata_response_200_data_services_item = cls(
        ...
        get_event_masterdata_response_200_data_services_item.additional_properties = d
        return get_event_masterdata_response_200_data_services_item
