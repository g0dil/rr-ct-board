...
T = TypeVar("T", bound="PersonMasterDataContactLabelsItem")


@_attrs_define
class PersonMasterDataContactLabelsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_master_data_contact_labels_item = cls(
            id=id,
        ...
        person_master_data_contact_labels_item.additional_properties = d
        return person_master_data_contact_labels_item
