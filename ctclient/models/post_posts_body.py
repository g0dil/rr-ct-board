...
from ..models.post_posts_body_visibility import PostPostsBodyVisibility
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostPostsBody")
...
class PostPostsBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        visibility = PostPostsBodyVisibility(d.pop("visibility"))
        ...
        post_posts_body.additional_properties = d
        return post_posts_body
