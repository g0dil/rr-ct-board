...
if TYPE_CHECKING:
    from ..models.appointment_calculated_base_exceptions_item_meta_created_person import (
        AppointmentCalculatedBaseExceptionsItemMetaCreatedPerson,
    )
    from ..models.appointment_calculated_base_exceptions_item_meta_modified_person import (
        AppointmentCalculatedBaseExceptionsItemMetaModifiedPerson,
    )


T = TypeVar("T", bound="AppointmentCalculatedBaseExceptionsItemMeta")


@_attrs_define
class AppointmentCalculatedBaseExceptionsItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (AppointmentCalculatedBaseExceptionsItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (AppointmentCalculatedBaseExceptionsItemMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        AppointmentCalculatedBaseExceptionsItemMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            AppointmentCalculatedBaseExceptionsItemMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                AppointmentCalculatedBaseExceptionsItemMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        appointment_calculated_base_exceptions_item_meta = cls(
        ...
        appointment_calculated_base_exceptions_item_meta.additional_properties = d
        return appointment_calculated_base_exceptions_item_meta
