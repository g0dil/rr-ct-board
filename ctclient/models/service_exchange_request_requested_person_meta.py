...
if TYPE_CHECKING:
    from ..models.service_exchange_request_requested_person_meta_created_person import (
        ServiceExchangeRequestRequestedPersonMetaCreatedPerson,
    )
    from ..models.service_exchange_request_requested_person_meta_modified_person import (
        ServiceExchangeRequestRequestedPersonMetaModifiedPerson,
    )


T = TypeVar("T", bound="ServiceExchangeRequestRequestedPersonMeta")


@_attrs_define
class ServiceExchangeRequestRequestedPersonMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (ServiceExchangeRequestRequestedPersonMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (ServiceExchangeRequestRequestedPersonMetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            ServiceExchangeRequestRequestedPersonMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                ServiceExchangeRequestRequestedPersonMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        service_exchange_request_requested_person_meta = cls(
        ...
        service_exchange_request_requested_person_meta.additional_properties = d
        return service_exchange_request_requested_person_meta
