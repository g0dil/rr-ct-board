...
T = TypeVar(
    "T",
    bound="PutGroupsGroupIdMembersRoutinesRoleIdGroupMemberStatusResponse200RoutineStepsItemType1ChildrenItemType0Type2ActionData",
)


@_attrs_define
class PutGroupsGroupIdMembersRoutinesRoleIdGroupMemberStatusResponse200RoutineStepsItemType1ChildrenItemType0Type2ActionData:
    """
    Attributes:
        group_id (int):
        comment (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_groups_group_id_members_routines_role_id_group_member_status_response_200_routine_steps_item_type_1_children_item_type_0_type_2_action_data = cls(
            group_id=group_id,
            comment=comment,
        ...
        put_groups_group_id_members_routines_role_id_group_member_status_response_200_routine_steps_item_type_1_children_item_type_0_type_2_action_data.additional_properties = d
        return put_groups_group_id_members_routines_role_id_group_member_status_response_200_routine_steps_item_type_1_children_item_type_0_type_2_action_data
