...
T = TypeVar("T", bound="GroupStatisticsUnfiltered")


@_attrs_define
class GroupStatisticsUnfiltered:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group_statistics_unfiltered = cls(
        ...
        group_statistics_unfiltered.additional_properties = d
        return group_statistics_unfiltered
