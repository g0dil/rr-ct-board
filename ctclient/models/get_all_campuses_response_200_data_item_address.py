...
T = TypeVar("T", bound="GetAllCampusesResponse200DataItemAddress")


@_attrs_define
class GetAllCampusesResponse200DataItemAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_campuses_response_200_data_item_address = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        get_all_campuses_response_200_data_item_address.additional_properties = d
        return get_all_campuses_response_200_data_item_address
