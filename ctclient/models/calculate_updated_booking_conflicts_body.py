...
if TYPE_CHECKING:
    from ..models.calculate_updated_booking_conflicts_body_additionals_type_0_item import (
        CalculateUpdatedBookingConflictsBodyAdditionalsType0Item,
    )
    from ..models.calculate_updated_booking_conflicts_body_exceptions_type_0_item import (
        CalculateUpdatedBookingConflictsBodyExceptionsType0Item,
    )


T = TypeVar("T", bound="CalculateUpdatedBookingConflictsBody")


@_attrs_define
class CalculateUpdatedBookingConflictsBody:
    """
    Attributes:
        end_date (datetime.date | datetime.datetime):
        resource_id (int):
        start_date (datetime.date | datetime.datetime):
        additionals (list[CalculateUpdatedBookingConflictsBodyAdditionalsType0Item] | None | Unset):
        exceptions (list[CalculateUpdatedBookingConflictsBodyExceptionsType0Item] | None | Unset):
    ...
    start_date: datetime.date | datetime.datetime
    additionals: (
        list[CalculateUpdatedBookingConflictsBodyAdditionalsType0Item] | None | Unset
    ) = UNSET
    exceptions: (
        list[CalculateUpdatedBookingConflictsBodyExceptionsType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_additionals(
            ...
            list[CalculateUpdatedBookingConflictsBodyAdditionalsType0Item]
            | None
            | Unset
        ):
            if data is None:
            ...
            try:
                ...
                for additionals_type_0_item_data in _additionals_type_0:
                    additionals_type_0_item = CalculateUpdatedBookingConflictsBodyAdditionalsType0Item.from_dict(
        ...
        def _parse_exceptions(
            ...
            try:
                ...
                for exceptions_type_0_item_data in _exceptions_type_0:
                    exceptions_type_0_item = CalculateUpdatedBookingConflictsBodyExceptionsType0Item.from_dict(
                ...
                pass
            return cast(
                list[CalculateUpdatedBookingConflictsBodyExceptionsType0Item]
                | None
                | Unset,
                data,
            )
        ...
        calculate_updated_booking_conflicts_body = cls(
            end_date=end_date,
        ...
        calculate_updated_booking_conflicts_body.additional_properties = d
        return calculate_updated_booking_conflicts_body
