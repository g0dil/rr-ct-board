...
T = TypeVar("T", bound="AppointmentBaseImageType0ImageOptionCrop")


@_attrs_define
class AppointmentBaseImageType0ImageOptionCrop:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appointment_base_image_type_0_image_option_crop = cls(
            bottom=bottom,
            left=left,
            right=right,
            top=top,
        ...
        appointment_base_image_type_0_image_option_crop.additional_properties = d
        return appointment_base_image_type_0_image_option_crop
