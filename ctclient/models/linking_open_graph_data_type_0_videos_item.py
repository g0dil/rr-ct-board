...
if TYPE_CHECKING:
    from ..models.linking_open_graph_data_type_0_videos_item_actors_item import (
        LinkingOpenGraphDataType0VideosItemActorsItem,
    )


T = TypeVar("T", bound="LinkingOpenGraphDataType0VideosItem")


@_attrs_define
class LinkingOpenGraphDataType0VideosItem:
    """
    Example:
    ...
    Attributes:
        actors (list[LinkingOpenGraphDataType0VideosItemActorsItem] | Unset):
    ...
    actors: list[LinkingOpenGraphDataType0VideosItemActorsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for actors_item_data in _actors or []:
            actors_item = LinkingOpenGraphDataType0VideosItemActorsItem.from_dict(
                actors_item_data
            )
        ...
        linking_open_graph_data_type_0_videos_item = cls(
            actors=actors,
            directors=directors,
            duration=duration,
            height=height,
        ...
        linking_open_graph_data_type_0_videos_item.additional_properties = d
        return linking_open_graph_data_type_0_videos_item
