...
if TYPE_CHECKING:
    from ..models.group_meta_created_person import GroupMetaCreatedPerson
    from ..models.group_meta_modified_person import GroupMetaModifiedPerson


T = TypeVar("T", bound="GroupMeta")
...
class GroupMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = GroupMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GroupMetaModifiedPerson.from_dict(_modified_person)
        ...
        group_meta.additional_properties = d
        return group_meta
