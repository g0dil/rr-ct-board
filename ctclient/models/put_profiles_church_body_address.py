...
T = TypeVar("T", bound="PutProfilesChurchBodyAddress")


@_attrs_define
class PutProfilesChurchBodyAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_profiles_church_body_address = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        put_profiles_church_body_address.additional_properties = d
        return put_profiles_church_body_address
