...
from ..models.get_entity_mapping_sync_entity_mapping_status import (
    GetEntityMappingSyncEntityMappingStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_entity_mapping_sync_entity_mapping_meta import (
        GetEntityMappingSyncEntityMappingMeta,
    )


T = TypeVar("T", bound="GetEntityMappingSyncEntityMapping")


@_attrs_define
class GetEntityMappingSyncEntityMapping:
    ...
    Attributes:
        ...
        meta (GetEntityMappingSyncEntityMappingMeta | Unset):
        ...
        status (GetEntityMappingSyncEntityMappingStatus | Unset): Status of Relationship Example: synced.
    """
    ...
    meta: GetEntityMappingSyncEntityMappingMeta | Unset = UNSET
    scope: None | str | Unset = UNSET
    source_entity_id: str | Unset = UNSET
    source_id: int | Unset = UNSET
    status: GetEntityMappingSyncEntityMappingStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = GetEntityMappingSyncEntityMappingMeta.from_dict(_meta)
        ...
        status: GetEntityMappingSyncEntityMappingStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = GetEntityMappingSyncEntityMappingStatus(_status)

        get_entity_mapping_sync_entity_mapping = cls(
            domain_id=domain_id,
        ...
        get_entity_mapping_sync_entity_mapping.additional_properties = d
        return get_entity_mapping_sync_entity_mapping
