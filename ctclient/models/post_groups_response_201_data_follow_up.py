...
T = TypeVar("T", bound="PostGroupsResponse201DataFollowUp")


@_attrs_define
class PostGroupsResponse201DataFollowUp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_groups_response_201_data_follow_up = cls(
        ...
        post_groups_response_201_data_follow_up.additional_properties = d
        return post_groups_response_201_data_follow_up
