...
if TYPE_CHECKING:
    from ..models.update_accounting_period_response_200_data_meta import (
        UpdateAccountingPeriodResponse200DataMeta,
    )
    from ..models.update_accounting_period_response_200_data_permissions import (
        UpdateAccountingPeriodResponse200DataPermissions,
    )


T = TypeVar("T", bound="UpdateAccountingPeriodResponse200Data")


@_attrs_define
class UpdateAccountingPeriodResponse200Data:
    """
    Attributes:
        client_id (int):
        ...
        id (int):
        meta (UpdateAccountingPeriodResponse200DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            'createdPerson': {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        permissions (UpdateAccountingPeriodResponse200DataPermissions):
    """
    ...
    donation_receipts_created: str
    id: int
    meta: UpdateAccountingPeriodResponse200DataMeta
    permissions: UpdateAccountingPeriodResponse200DataPermissions
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = UpdateAccountingPeriodResponse200DataMeta.from_dict(d.pop("meta"))

        permissions = UpdateAccountingPeriodResponse200DataPermissions.from_dict(
            d.pop("permissions")
        )

        update_accounting_period_response_200_data = cls(
            client_id=client_id,
            end_date=end_date,
        ...
        update_accounting_period_response_200_data.additional_properties = d
        return update_accounting_period_response_200_data
