...
if TYPE_CHECKING:
    from ..models.appointment_calculated_base_meta_created_person import (
        AppointmentCalculatedBaseMetaCreatedPerson,
    )
    from ..models.appointment_calculated_base_meta_modified_person import (
        AppointmentCalculatedBaseMetaModifiedPerson,
    )


T = TypeVar("T", bound="AppointmentCalculatedBaseMeta")


@_attrs_define
class AppointmentCalculatedBaseMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (AppointmentCalculatedBaseMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (AppointmentCalculatedBaseMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: AppointmentCalculatedBaseMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: AppointmentCalculatedBaseMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = AppointmentCalculatedBaseMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = AppointmentCalculatedBaseMetaModifiedPerson.from_dict(
                _modified_person
            )

        appointment_calculated_base_meta = cls(
        ...
        appointment_calculated_base_meta.additional_properties = d
        return appointment_calculated_base_meta
