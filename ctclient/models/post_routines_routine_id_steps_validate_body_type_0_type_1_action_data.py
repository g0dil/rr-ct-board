...
from ..models.post_routines_routine_id_steps_validate_body_type_0_type_1_action_data_color import (
    PostRoutinesRoutineIdStepsValidateBodyType0Type1ActionDataColor,
)
from ..models.post_routines_routine_id_steps_validate_body_type_0_type_1_action_data_continuation_type import (
    PostRoutinesRoutineIdStepsValidateBodyType0Type1ActionDataContinuationType,
)
from ..models.post_routines_routine_id_steps_validate_body_type_0_type_1_action_data_success_group_member_status_type_0 import (
    PostRoutinesRoutineIdStepsValidateBodyType0Type1ActionDataSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostRoutinesRoutineIdStepsValidateBodyType0Type1ActionData")


@_attrs_define
class PostRoutinesRoutineIdStepsValidateBodyType0Type1ActionData:
    """
    Attributes:
        continuation_type (PostRoutinesRoutineIdStepsValidateBodyType0Type1ActionDataContinuationType):
        description (None | str):
        title (str):
        color (PostRoutinesRoutineIdStepsValidateBodyType0Type1ActionDataColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (None |
            PostRoutinesRoutineIdStepsValidateBodyType0Type1ActionDataSuccessGroupMemberStatusType0 | Unset):
    ...
    description: None | str
    title: str
    color: PostRoutinesRoutineIdStepsValidateBodyType0Type1ActionDataColor | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_color, Unset):
            ...
            color = PostRoutinesRoutineIdStepsValidateBodyType0Type1ActionDataColor(
                _color
            )
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = PostRoutinesRoutineIdStepsValidateBodyType0Type1ActionDataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        post_routines_routine_id_steps_validate_body_type_0_type_1_action_data = cls(
        ...
        post_routines_routine_id_steps_validate_body_type_0_type_1_action_data.additional_properties = d
        return post_routines_routine_id_steps_validate_body_type_0_type_1_action_data
