...
T = TypeVar("T", bound="PostResourcetypesResponse201Data")


@_attrs_define
class PostResourcetypesResponse201Data:
    """
    Attributes:
        id (int):  Example: 3.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_resourcetypes_response_201_data = cls(
            id=id,
        ...
        post_resourcetypes_response_201_data.additional_properties = d
        return post_resourcetypes_response_201_data
