...
if TYPE_CHECKING:
    from ..models.account_group_meta_created_person import AccountGroupMetaCreatedPerson
    from ..models.account_group_meta_modified_person import (
        AccountGroupMetaModifiedPerson,
    )


T = TypeVar("T", bound="AccountGroupMeta")


@_attrs_define
class AccountGroupMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (AccountGroupMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (AccountGroupMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: AccountGroupMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: AccountGroupMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.account_group_meta_created_person import (
        ...
        created_person = AccountGroupMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = AccountGroupMetaModifiedPerson.from_dict(_modified_person)

        account_group_meta = cls(
        ...
        account_group_meta.additional_properties = d
        return account_group_meta
