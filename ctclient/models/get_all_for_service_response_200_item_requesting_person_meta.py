...
if TYPE_CHECKING:
    from ..models.get_all_for_service_response_200_item_requesting_person_meta_created_person import (
        GetAllForServiceResponse200ItemRequestingPersonMetaCreatedPerson,
    )
    from ..models.get_all_for_service_response_200_item_requesting_person_meta_modified_person import (
        GetAllForServiceResponse200ItemRequestingPersonMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetAllForServiceResponse200ItemRequestingPersonMeta")


@_attrs_define
class GetAllForServiceResponse200ItemRequestingPersonMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetAllForServiceResponse200ItemRequestingPersonMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetAllForServiceResponse200ItemRequestingPersonMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        GetAllForServiceResponse200ItemRequestingPersonMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            GetAllForServiceResponse200ItemRequestingPersonMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GetAllForServiceResponse200ItemRequestingPersonMetaModifiedPerson.from_dict(
                _modified_person
            )

        get_all_for_service_response_200_item_requesting_person_meta = cls(
        ...
        get_all_for_service_response_200_item_requesting_person_meta.additional_properties = d
        return get_all_for_service_response_200_item_requesting_person_meta
