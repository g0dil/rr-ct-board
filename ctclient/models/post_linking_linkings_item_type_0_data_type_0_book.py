...
T = TypeVar("T", bound="PostLinkingLinkingsItemType0DataType0Book")


@_attrs_define
class PostLinkingLinkingsItemType0DataType0Book:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_linking_linkings_item_type_0_data_type_0_book = cls(
            authors=authors,
            isbn=isbn,
        ...
        post_linking_linkings_item_type_0_data_type_0_book.additional_properties = d
        return post_linking_linkings_item_type_0_data_type_0_book
