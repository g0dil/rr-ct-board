...
T = TypeVar("T", bound="PostAddressesDomainTypeDomainIdentifierResponse200Data")


@_attrs_define
class PostAddressesDomainTypeDomainIdentifierResponse200Data:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_addresses_domain_type_domain_identifier_response_200_data = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        post_addresses_domain_type_domain_identifier_response_200_data.additional_properties = d
        return post_addresses_domain_type_domain_identifier_response_200_data
