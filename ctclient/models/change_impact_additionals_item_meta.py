...
T = TypeVar("T", bound="ChangeImpactAdditionalsItemMeta")


@_attrs_define
class ChangeImpactAdditionalsItemMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        change_impact_additionals_item_meta = cls(
            modified_date=modified_date,
            modified_pid=modified_pid,
        )

        change_impact_additionals_item_meta.additional_properties = d
        return change_impact_additionals_item_meta
