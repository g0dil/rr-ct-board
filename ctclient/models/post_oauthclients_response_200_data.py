...
T = TypeVar("T", bound="PostOauthclientsResponse200Data")


@_attrs_define
class PostOauthclientsResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_oauthclients_response_200_data = cls(
        ...
        post_oauthclients_response_200_data.additional_properties = d
        return post_oauthclients_response_200_data
