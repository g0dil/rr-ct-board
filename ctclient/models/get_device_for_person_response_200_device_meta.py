...
if TYPE_CHECKING:
    from ..models.get_device_for_person_response_200_device_meta_created_person import (
        GetDeviceForPersonResponse200DeviceMetaCreatedPerson,
    )
    from ..models.get_device_for_person_response_200_device_meta_modified_person import (
        GetDeviceForPersonResponse200DeviceMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetDeviceForPersonResponse200DeviceMeta")


@_attrs_define
class GetDeviceForPersonResponse200DeviceMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetDeviceForPersonResponse200DeviceMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetDeviceForPersonResponse200DeviceMetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = GetDeviceForPersonResponse200DeviceMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                GetDeviceForPersonResponse200DeviceMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        get_device_for_person_response_200_device_meta = cls(
        ...
        get_device_for_person_response_200_device_meta.additional_properties = d
        return get_device_for_person_response_200_device_meta
