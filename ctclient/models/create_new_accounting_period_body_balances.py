...
T = TypeVar("T", bound="CreateNewAccountingPeriodBodyBalances")


@_attrs_define
class CreateNewAccountingPeriodBodyBalances:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_new_accounting_period_body_balances = cls(
            from_=from_,
            opening_balance_account=opening_balance_account,
        )

        create_new_accounting_period_body_balances.additional_properties = d
        return create_new_accounting_period_body_balances
