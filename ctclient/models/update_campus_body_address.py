...
T = TypeVar("T", bound="UpdateCampusBodyAddress")


@_attrs_define
class UpdateCampusBodyAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_campus_body_address = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        update_campus_body_address.additional_properties = d
        return update_campus_body_address
