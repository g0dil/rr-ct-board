...
T = TypeVar(
    "T", bound="GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseAddress"
)


@_attrs_define
class GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_calendars_calendar_id_appointments_response_200_data_item_base_address = (
            cls(
                geo_lat=geo_lat,
                geo_lng=geo_lng,
        ...
        get_calendars_calendar_id_appointments_response_200_data_item_base_address.additional_properties = d
        return (
            get_calendars_calendar_id_appointments_response_200_data_item_base_address
        )
