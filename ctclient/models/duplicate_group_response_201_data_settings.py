...
from ..models.duplicate_group_response_201_data_settings_default_post_notification_scope_type_1 import (
    DuplicateGroupResponse201DataSettingsDefaultPostNotificationScopeType1,
)
from ..models.duplicate_group_response_201_data_settings_default_post_notification_scope_type_2_type_1 import (
    DuplicateGroupResponse201DataSettingsDefaultPostNotificationScopeType2Type1,
)
from ..models.duplicate_group_response_201_data_settings_default_post_notification_scope_type_3_type_1 import (
    DuplicateGroupResponse201DataSettingsDefaultPostNotificationScopeType3Type1,
)
from ..models.duplicate_group_response_201_data_settings_default_post_visibility import (
    DuplicateGroupResponse201DataSettingsDefaultPostVisibility,
)
from ..models.duplicate_group_response_201_data_settings_dynamic_group_status_type_1 import (
    DuplicateGroupResponse201DataSettingsDynamicGroupStatusType1,
)
from ..models.duplicate_group_response_201_data_settings_dynamic_group_status_type_2_type_1 import (
    DuplicateGroupResponse201DataSettingsDynamicGroupStatusType2Type1,
)
from ..models.duplicate_group_response_201_data_settings_dynamic_group_status_type_3_type_1 import (
    DuplicateGroupResponse201DataSettingsDynamicGroupStatusType3Type1,
)
from ..models.duplicate_group_response_201_data_settings_visibility import (
    DuplicateGroupResponse201DataSettingsVisibility,
)

if TYPE_CHECKING:
    from ..models.duplicate_group_response_201_data_settings_dynamic_group_rule_set_type_0_item import (
        DuplicateGroupResponse201DataSettingsDynamicGroupRuleSetType0Item,
    )
    from ..models.duplicate_group_response_201_data_settings_group_meeting import (
        DuplicateGroupResponse201DataSettingsGroupMeeting,
    )
    from ..models.duplicate_group_response_201_data_settings_new_member import (
        DuplicateGroupResponse201DataSettingsNewMember,
    )


T = TypeVar("T", bound="DuplicateGroupResponse201DataSettings")


@_attrs_define
class DuplicateGroupResponse201DataSettings:
    """
    Attributes:
        ...
        default_post_notification_scope (DuplicateGroupResponse201DataSettingsDefaultPostNotificationScopeType1 |
            DuplicateGroupResponse201DataSettingsDefaultPostNotificationScopeType2Type1 |
            DuplicateGroupResponse201DataSettingsDefaultPostNotificationScopeType3Type1 | None): Default value for post
            notification scope.
        default_post_placeholder_text (None | str): Default placeholder text for entering post content.
        default_post_visibility (DuplicateGroupResponse201DataSettingsDefaultPostVisibility):
        dynamic_group_rule_set (list[DuplicateGroupResponse201DataSettingsDynamicGroupRuleSetType0Item] | None): Rule
            set for dynamic group update.
        dynamic_group_status (DuplicateGroupResponse201DataSettingsDynamicGroupStatusType1 |
            DuplicateGroupResponse201DataSettingsDynamicGroupStatusType2Type1 |
            DuplicateGroupResponse201DataSettingsDynamicGroupStatusType3Type1 | None): Status of dynamic group update.
        ...
        group_meeting (DuplicateGroupResponse201DataSettingsGroupMeeting):
        in_statistic (bool):
        ...
        new_member (DuplicateGroupResponse201DataSettingsNewMember): Campus, status, and department for newly created
            persons.
        posts_enabled (bool):
        ...
        sign_up_opening_date (datetime.datetime | None): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z'
            Example: 2022-10-19T12:00:00Z.
        visibility (DuplicateGroupResponse201DataSettingsVisibility): The visibility of a group.
    ...
    dynamic_group_rule_set: (
        list[DuplicateGroupResponse201DataSettingsDynamicGroupRuleSetType0Item] | None
    )
    ...
    new_member: DuplicateGroupResponse201DataSettingsNewMember
    posts_enabled: bool
    ...
    visibility: DuplicateGroupResponse201DataSettingsVisibility
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_default_post_notification_scope(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                default_post_notification_scope_type_1 = DuplicateGroupResponse201DataSettingsDefaultPostNotificationScopeType1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                default_post_notification_scope_type_2_type_1 = DuplicateGroupResponse201DataSettingsDefaultPostNotificationScopeType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                default_post_notification_scope_type_3_type_1 = DuplicateGroupResponse201DataSettingsDefaultPostNotificationScopeType3Type1(
                    data
                )
        ...
        def _parse_dynamic_group_rule_set(
            ...
            list[DuplicateGroupResponse201DataSettingsDynamicGroupRuleSetType0Item]
            | None
        ):
            if data is None:
                return data
            try:
                ...
                for (
                    ...
                    dynamic_group_rule_set_type_0_item = DuplicateGroupResponse201DataSettingsDynamicGroupRuleSetType0Item.from_dict(
                        dynamic_group_rule_set_type_0_item_data
                    )
        ...
        def _parse_dynamic_group_status(
            ...
            try:
                ...
                dynamic_group_status_type_1 = (
                    DuplicateGroupResponse201DataSettingsDynamicGroupStatusType1(data)
                )
        ...
        group_meeting = DuplicateGroupResponse201DataSettingsGroupMeeting.from_dict(
            d.pop("groupMeeting")
        )
        ...
        new_member = DuplicateGroupResponse201DataSettingsNewMember.from_dict(
            d.pop("newMember")
        )
        ...
        duplicate_group_response_201_data_settings = cls(
        ...
        duplicate_group_response_201_data_settings.additional_properties = d
        return duplicate_group_response_201_data_settings
