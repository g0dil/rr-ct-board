...
if TYPE_CHECKING:
    from ..models.get_transaction_purpose_by_id_response_200_data_meta_created_person import (
        GetTransactionPurposeByIdResponse200DataMetaCreatedPerson,
    )
    from ..models.get_transaction_purpose_by_id_response_200_data_meta_modified_person import (
        GetTransactionPurposeByIdResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetTransactionPurposeByIdResponse200DataMeta")


@_attrs_define
class GetTransactionPurposeByIdResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetTransactionPurposeByIdResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetTransactionPurposeByIdResponse200DataMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        GetTransactionPurposeByIdResponse200DataMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            GetTransactionPurposeByIdResponse200DataMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                GetTransactionPurposeByIdResponse200DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        get_transaction_purpose_by_id_response_200_data_meta = cls(
        ...
        get_transaction_purpose_by_id_response_200_data_meta.additional_properties = d
        return get_transaction_purpose_by_id_response_200_data_meta
