...
if TYPE_CHECKING:
    from ..models.update_booking_body_additionals_type_0_item import (
        UpdateBookingBodyAdditionalsType0Item,
    )
    from ..models.update_booking_body_exceptions_type_0_item import (
...
class UpdateBookingBody:
    ...
    Attributes:
        ...
        title (str):
        booking_id (int):
        additionals (list[UpdateBookingBodyAdditionalsType0Item] | None | Unset):
        description (None | str | Unset):
        exceptions (list[UpdateBookingBodyExceptionsType0Item] | None | Unset):
    ...
    title: str
    booking_id: int
    additionals: list[UpdateBookingBodyAdditionalsType0Item] | None | Unset = UNSET
    description: None | str | Unset = UNSET
    exceptions: list[UpdateBookingBodyExceptionsType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_additionals(
            data: object,
        ) -> list[UpdateBookingBodyAdditionalsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for additionals_type_0_item_data in _additionals_type_0:
                    additionals_type_0_item = (
                        UpdateBookingBodyAdditionalsType0Item.from_dict(
                ...
                pass
            return cast(
                list[UpdateBookingBodyAdditionalsType0Item] | None | Unset, data
            )
        ...
        def _parse_exceptions(
            data: object,
        ) -> list[UpdateBookingBodyExceptionsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for exceptions_type_0_item_data in _exceptions_type_0:
                    exceptions_type_0_item = (
                        UpdateBookingBodyExceptionsType0Item.from_dict(
                ...
                pass
            return cast(list[UpdateBookingBodyExceptionsType0Item] | None | Unset, data)
