...
T = TypeVar("T", bound="GetStatusResponse200Data")


@_attrs_define
class GetStatusResponse200Data:
    """
    Attributes:
        id (int): ID of status
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_status_response_200_data = cls(
            id=id,
            is_member=is_member,
        ...
        get_status_response_200_data.additional_properties = d
        return get_status_response_200_data
