...
if TYPE_CHECKING:
    from ..models.post_linking_linkings_item_type_0_data_type_0_music_album import (
        PostLinkingLinkingsItemType0DataType0MusicAlbum,
    )
    from ..models.post_linking_linkings_item_type_0_data_type_0_music_songs_item import (
        PostLinkingLinkingsItemType0DataType0MusicSongsItem,
    )


T = TypeVar("T", bound="PostLinkingLinkingsItemType0DataType0Music")


@_attrs_define
class PostLinkingLinkingsItemType0DataType0Music:
    """
    Attributes:
        album (PostLinkingLinkingsItemType0DataType0MusicAlbum | Unset):
        ...
        songs (list[PostLinkingLinkingsItemType0DataType0MusicSongsItem] | Unset):
    """

    album: PostLinkingLinkingsItemType0DataType0MusicAlbum | Unset = UNSET
    creators: list[str] | Unset = UNSET
    duration: int | Unset = UNSET
    musicians: list[str] | Unset = UNSET
    release_date: datetime.datetime | Unset = UNSET
    songs: list[PostLinkingLinkingsItemType0DataType0MusicSongsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_album, Unset):
            ...
            album = PostLinkingLinkingsItemType0DataType0MusicAlbum.from_dict(_album)
        ...
        for songs_item_data in _songs or []:
            songs_item = PostLinkingLinkingsItemType0DataType0MusicSongsItem.from_dict(
                songs_item_data
            )

            songs.append(songs_item)

        post_linking_linkings_item_type_0_data_type_0_music = cls(
            album=album,
            creators=creators,
            duration=duration,
            musicians=musicians,
        ...
        post_linking_linkings_item_type_0_data_type_0_music.additional_properties = d
        return post_linking_linkings_item_type_0_data_type_0_music
