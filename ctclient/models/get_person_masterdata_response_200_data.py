...
if TYPE_CHECKING:
    from ..models.get_person_masterdata_response_200_data_age_groups_item import (
        GetPersonMasterdataResponse200DataAgeGroupsItem,
    )
    from ..models.get_person_masterdata_response_200_data_campuses_item import (
        GetPersonMasterdataResponse200DataCampusesItem,
    )
    from ..models.get_person_masterdata_response_200_data_comment_viewers_item import (
        GetPersonMasterdataResponse200DataCommentViewersItem,
    )
    from ..models.get_person_masterdata_response_200_data_contact_labels_item import (
        GetPersonMasterdataResponse200DataContactLabelsItem,
    )
    from ..models.get_person_masterdata_response_200_data_departments_item import (
        GetPersonMasterdataResponse200DataDepartmentsItem,
    )
    from ..models.get_person_masterdata_response_200_data_follow_up_intervals_item import (
        GetPersonMasterdataResponse200DataFollowUpIntervalsItem,
    )
    from ..models.get_person_masterdata_response_200_data_follow_ups_item import (
        GetPersonMasterdataResponse200DataFollowUpsItem,
    )
    from ..models.get_person_masterdata_response_200_data_group_categories_item import (
        GetPersonMasterdataResponse200DataGroupCategoriesItem,
    )
    from ..models.get_person_masterdata_response_200_data_group_meeting_templates_item import (
        GetPersonMasterdataResponse200DataGroupMeetingTemplatesItem,
    )
    from ..models.get_person_masterdata_response_200_data_group_statuses_item import (
        GetPersonMasterdataResponse200DataGroupStatusesItem,
    )
    from ..models.get_person_masterdata_response_200_data_group_types_item import (
        GetPersonMasterdataResponse200DataGroupTypesItem,
    )
    from ..models.get_person_masterdata_response_200_data_grow_paths_item import (
        GetPersonMasterdataResponse200DataGrowPathsItem,
    )
    from ..models.get_person_masterdata_response_200_data_relationship_types_item import (
        GetPersonMasterdataResponse200DataRelationshipTypesItem,
    )
    from ..models.get_person_masterdata_response_200_data_roles_item import (
        GetPersonMasterdataResponse200DataRolesItem,
    )
    from ..models.get_person_masterdata_response_200_data_sexes_item import (
        GetPersonMasterdataResponse200DataSexesItem,
    )
    from ..models.get_person_masterdata_response_200_data_statuses_item import (
        GetPersonMasterdataResponse200DataStatusesItem,
    )
    from ..models.get_person_masterdata_response_200_data_target_groups_item import (
        GetPersonMasterdataResponse200DataTargetGroupsItem,
    )


T = TypeVar("T", bound="GetPersonMasterdataResponse200Data")


@_attrs_define
class GetPersonMasterdataResponse200Data:
    """
    Attributes:
        age_groups (list[GetPersonMasterdataResponse200DataAgeGroupsItem] | Unset):
        campuses (list[GetPersonMasterdataResponse200DataCampusesItem] | Unset):
        comment_viewers (list[GetPersonMasterdataResponse200DataCommentViewersItem] | Unset):
        contact_labels (list[GetPersonMasterdataResponse200DataContactLabelsItem] | Unset):
        departments (list[GetPersonMasterdataResponse200DataDepartmentsItem] | Unset):
        follow_up_intervals (list[GetPersonMasterdataResponse200DataFollowUpIntervalsItem] | Unset):
        follow_ups (list[GetPersonMasterdataResponse200DataFollowUpsItem] | Unset):
        group_categories (list[GetPersonMasterdataResponse200DataGroupCategoriesItem] | Unset):
        group_meeting_templates (list[GetPersonMasterdataResponse200DataGroupMeetingTemplatesItem] | Unset):
        group_statuses (list[GetPersonMasterdataResponse200DataGroupStatusesItem] | Unset):
        group_types (list[GetPersonMasterdataResponse200DataGroupTypesItem] | Unset):
        grow_paths (list[GetPersonMasterdataResponse200DataGrowPathsItem] | Unset):
        relationship_types (list[GetPersonMasterdataResponse200DataRelationshipTypesItem] | Unset):
        roles (list[GetPersonMasterdataResponse200DataRolesItem] | Unset):
        sexes (list[GetPersonMasterdataResponse200DataSexesItem] | Unset):
        statuses (list[GetPersonMasterdataResponse200DataStatusesItem] | Unset):
        target_groups (list[GetPersonMasterdataResponse200DataTargetGroupsItem] | Unset):
    """

    age_groups: list[GetPersonMasterdataResponse200DataAgeGroupsItem] | Unset = UNSET
    campuses: list[GetPersonMasterdataResponse200DataCampusesItem] | Unset = UNSET
    comment_viewers: (
        list[GetPersonMasterdataResponse200DataCommentViewersItem] | Unset
    ) = UNSET
    contact_labels: (
        list[GetPersonMasterdataResponse200DataContactLabelsItem] | Unset
    ) = UNSET
    departments: list[GetPersonMasterdataResponse200DataDepartmentsItem] | Unset = UNSET
    follow_up_intervals: (
        list[GetPersonMasterdataResponse200DataFollowUpIntervalsItem] | Unset
    ) = UNSET
    follow_ups: list[GetPersonMasterdataResponse200DataFollowUpsItem] | Unset = UNSET
    group_categories: (
        list[GetPersonMasterdataResponse200DataGroupCategoriesItem] | Unset
    ) = UNSET
    group_meeting_templates: (
        list[GetPersonMasterdataResponse200DataGroupMeetingTemplatesItem] | Unset
    ) = UNSET
    group_statuses: (
        list[GetPersonMasterdataResponse200DataGroupStatusesItem] | Unset
    ) = UNSET
    group_types: list[GetPersonMasterdataResponse200DataGroupTypesItem] | Unset = UNSET
    grow_paths: list[GetPersonMasterdataResponse200DataGrowPathsItem] | Unset = UNSET
    relationship_types: (
        list[GetPersonMasterdataResponse200DataRelationshipTypesItem] | Unset
    ) = UNSET
    roles: list[GetPersonMasterdataResponse200DataRolesItem] | Unset = UNSET
    sexes: list[GetPersonMasterdataResponse200DataSexesItem] | Unset = UNSET
    statuses: list[GetPersonMasterdataResponse200DataStatusesItem] | Unset = UNSET
    target_groups: list[GetPersonMasterdataResponse200DataTargetGroupsItem] | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for age_groups_item_data in _age_groups or []:
            age_groups_item = GetPersonMasterdataResponse200DataAgeGroupsItem.from_dict(
        ...
        for campuses_item_data in _campuses or []:
            campuses_item = GetPersonMasterdataResponse200DataCampusesItem.from_dict(
                campuses_item_data
            )
        ...
        for comment_viewers_item_data in _comment_viewers or []:
            comment_viewers_item = (
                GetPersonMasterdataResponse200DataCommentViewersItem.from_dict(
        ...
        for contact_labels_item_data in _contact_labels or []:
            contact_labels_item = (
                GetPersonMasterdataResponse200DataContactLabelsItem.from_dict(
        ...
        for departments_item_data in _departments or []:
            departments_item = (
                GetPersonMasterdataResponse200DataDepartmentsItem.from_dict(
        ...
        for follow_up_intervals_item_data in _follow_up_intervals or []:
            follow_up_intervals_item = (
                GetPersonMasterdataResponse200DataFollowUpIntervalsItem.from_dict(
        ...
        for follow_ups_item_data in _follow_ups or []:
            follow_ups_item = GetPersonMasterdataResponse200DataFollowUpsItem.from_dict(
        ...
        for group_categories_item_data in _group_categories or []:
            group_categories_item = (
                GetPersonMasterdataResponse200DataGroupCategoriesItem.from_dict(
        ...
        for group_meeting_templates_item_data in _group_meeting_templates or []:
            group_meeting_templates_item = (
                GetPersonMasterdataResponse200DataGroupMeetingTemplatesItem.from_dict(
        ...
        for group_statuses_item_data in _group_statuses or []:
            group_statuses_item = (
                GetPersonMasterdataResponse200DataGroupStatusesItem.from_dict(
        ...
        for group_types_item_data in _group_types or []:
            group_types_item = (
                GetPersonMasterdataResponse200DataGroupTypesItem.from_dict(
        ...
        for grow_paths_item_data in _grow_paths or []:
            grow_paths_item = GetPersonMasterdataResponse200DataGrowPathsItem.from_dict(
        ...
        for relationship_types_item_data in _relationship_types or []:
            relationship_types_item = (
                GetPersonMasterdataResponse200DataRelationshipTypesItem.from_dict(
        ...
        for roles_item_data in _roles or []:
            roles_item = GetPersonMasterdataResponse200DataRolesItem.from_dict(
                roles_item_data
            )
        ...
        for sexes_item_data in _sexes or []:
            sexes_item = GetPersonMasterdataResponse200DataSexesItem.from_dict(
                sexes_item_data
            )
        ...
        for statuses_item_data in _statuses or []:
            statuses_item = GetPersonMasterdataResponse200DataStatusesItem.from_dict(
                statuses_item_data
            )
        ...
        for target_groups_item_data in _target_groups or []:
            target_groups_item = (
                GetPersonMasterdataResponse200DataTargetGroupsItem.from_dict(
        ...
        get_person_masterdata_response_200_data = cls(
        ...
        get_person_masterdata_response_200_data.additional_properties = d
        return get_person_masterdata_response_200_data
