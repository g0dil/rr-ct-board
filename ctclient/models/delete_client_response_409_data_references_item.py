...
T = TypeVar("T", bound="DeleteClientResponse409DataReferencesItem")


@_attrs_define
class DeleteClientResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_client_response_409_data_references_item = cls(
        ...
        delete_client_response_409_data_references_item.additional_properties = d
        return delete_client_response_409_data_references_item
