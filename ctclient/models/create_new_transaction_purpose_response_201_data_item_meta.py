...
if TYPE_CHECKING:
    from ..models.create_new_transaction_purpose_response_201_data_item_meta_created_person import (
        CreateNewTransactionPurposeResponse201DataItemMetaCreatedPerson,
    )
    from ..models.create_new_transaction_purpose_response_201_data_item_meta_modified_person import (
        CreateNewTransactionPurposeResponse201DataItemMetaModifiedPerson,
    )


T = TypeVar("T", bound="CreateNewTransactionPurposeResponse201DataItemMeta")


@_attrs_define
class CreateNewTransactionPurposeResponse201DataItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (CreateNewTransactionPurposeResponse201DataItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (CreateNewTransactionPurposeResponse201DataItemMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        CreateNewTransactionPurposeResponse201DataItemMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            CreateNewTransactionPurposeResponse201DataItemMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = CreateNewTransactionPurposeResponse201DataItemMetaModifiedPerson.from_dict(
                _modified_person
            )

        create_new_transaction_purpose_response_201_data_item_meta = cls(
        ...
        create_new_transaction_purpose_response_201_data_item_meta.additional_properties = d
        return create_new_transaction_purpose_response_201_data_item_meta
