...
from ..models.follow_up_create_color import FollowUpCreateColor
from ..models.follow_up_create_success_group_member_status_type_0 import (
    FollowUpCreateSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FollowUpCreate")
...
class FollowUpCreate:
    ...
    Attributes:
        ...
        color (FollowUpCreateColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (FollowUpCreateSuccessGroupMemberStatusType0 | None | Unset):
        success_group_of_group_type_id (int | None | Unset):
        success_role_id (int | None | Unset):
    """

    title: str
    color: FollowUpCreateColor | Unset = UNSET
    ...
    success_group_member_status: (
        FollowUpCreateSuccessGroupMemberStatusType0 | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: FollowUpCreateColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = FollowUpCreateColor(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                ...
                success_group_member_status_type_0 = (
                    FollowUpCreateSuccessGroupMemberStatusType0(data)
                )
                ...
                pass
            return cast(
                FollowUpCreateSuccessGroupMemberStatusType0 | None | Unset, data
            )
        ...
        follow_up_create.additional_properties = d
        return follow_up_create
