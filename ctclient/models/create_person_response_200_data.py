...
from ..models.create_person_response_200_data_invitation_status_type_0 import (
    CreatePersonResponse200DataInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_person_response_200_data_emails_item import (
        CreatePersonResponse200DataEmailsItem,
    )
    from ..models.create_person_response_200_data_meta import (
        CreatePersonResponse200DataMeta,
    )
    from ..models.create_person_response_200_data_privacy_policy_agreement import (
        CreatePersonResponse200DataPrivacyPolicyAgreement,
    )
    from ..models.create_person_response_200_data_tags_item import (
        CreatePersonResponse200DataTagsItem,
    )


T = TypeVar("T", bound="CreatePersonResponse200Data")


@_attrs_define
class CreatePersonResponse200Data:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[CreatePersonResponse200DataEmailsItem] | Unset):
            ...
            invitation_status (CreatePersonResponse200DataInvitationStatusType0 | None | Unset):
            ...
            meta (CreatePersonResponse200DataMeta | Unset):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            ...
            privacy_policy_agreement (CreatePersonResponse200DataPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[CreatePersonResponse200DataTagsItem] | Unset):
            title (str | Unset):
    ...
    emails: list[CreatePersonResponse200DataEmailsItem] | Unset = UNSET
    ...
    invitation_status: (
        CreatePersonResponse200DataInvitationStatusType0 | None | Unset
    ) = UNSET
    ...
    meta: CreatePersonResponse200DataMeta | Unset = UNSET
    ...
    privacy_policy_agreement: (
        CreatePersonResponse200DataPrivacyPolicyAgreement | Unset
    ) = UNSET
    ...
    tags: list[CreatePersonResponse200DataTagsItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.invitation_status, Unset):
            ...
            self.invitation_status, CreatePersonResponse200DataInvitationStatusType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = CreatePersonResponse200DataEmailsItem.from_dict(
                emails_item_data
            )
        ...
        def _parse_invitation_status(
            ...
            try:
                ...
                invitation_status_type_0 = (
                    CreatePersonResponse200DataInvitationStatusType0(data)
                )
                ...
                pass
            return cast(
                CreatePersonResponse200DataInvitationStatusType0 | None | Unset, data
            )
        ...
        meta: CreatePersonResponse200DataMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = CreatePersonResponse200DataMeta.from_dict(_meta)
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = (
                CreatePersonResponse200DataPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = CreatePersonResponse200DataTagsItem.from_dict(tags_item_data)
        ...
        create_person_response_200_data = cls(
        ...
        create_person_response_200_data.additional_properties = d
        return create_person_response_200_data
