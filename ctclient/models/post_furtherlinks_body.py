...
T = TypeVar("T", bound="PostFurtherlinksBody")


@_attrs_define
class PostFurtherlinksBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_furtherlinks_body.additional_properties = d
        return post_furtherlinks_body
