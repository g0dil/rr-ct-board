...
from ..models.put_group_roles_role_id_body_type import PutGroupRolesRoleIdBodyType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutGroupRolesRoleIdBody")


@_attrs_define
class PutGroupRolesRoleIdBody:
    """
    Attributes:
        ...
        type_ (PutGroupRolesRoleIdBodyType):
        id (int):  Example: 16.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = PutGroupRolesRoleIdBodyType(d.pop("type"))

        id = d.pop("id")

        is_leader = d.pop("isLeader", UNSET)

        put_group_roles_role_id_body = cls(
        ...
        put_group_roles_role_id_body.additional_properties = d
        return put_group_roles_role_id_body
