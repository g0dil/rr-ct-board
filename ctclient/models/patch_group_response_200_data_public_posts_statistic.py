...
T = TypeVar("T", bound="PatchGroupResponse200DataPublicPostsStatistic")


@_attrs_define
class PatchGroupResponse200DataPublicPostsStatistic:
    """
    Attributes:
        count (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_group_response_200_data_public_posts_statistic = cls(
            count=count,
            last_post_date=last_post_date,
        )

        patch_group_response_200_data_public_posts_statistic.additional_properties = d
        return patch_group_response_200_data_public_posts_statistic
