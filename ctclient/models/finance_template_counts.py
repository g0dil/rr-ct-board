...
T = TypeVar("T", bound="FinanceTemplateCounts")


@_attrs_define
class FinanceTemplateCounts:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        finance_template_counts.additional_properties = d
        return finance_template_counts
