...
from ..models.group_signup_conditions_group_visibility import (
    GroupSignupConditionsGroupVisibility,
)

T = TypeVar("T", bound="GroupSignupConditions")


@_attrs_define
class GroupSignupConditions:
    """
    Attributes:
        ...
        group_visibility (GroupSignupConditionsGroupVisibility): The visibility of a group.
    ...
    group_is_open_for_members: bool
    group_is_public: bool
    group_visibility: GroupSignupConditionsGroupVisibility
    new_person_department_is_set: bool
    new_person_station_is_set: bool
    new_person_status_is_set: bool
    sign_up_role_set_in_group: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group_signup_conditions.additional_properties = d
        return group_signup_conditions
