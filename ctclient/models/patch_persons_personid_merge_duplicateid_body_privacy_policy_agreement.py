...
T = TypeVar("T", bound="PatchPersonsPersonidMergeDuplicateidBodyPrivacyPolicyAgreement")


@_attrs_define
class PatchPersonsPersonidMergeDuplicateidBodyPrivacyPolicyAgreement:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_persons_personid_merge_duplicateid_body_privacy_policy_agreement = cls(
            date=date,
            type_id=type_id,
            who_id=who_id,
        )

        patch_persons_personid_merge_duplicateid_body_privacy_policy_agreement.additional_properties = d
        return patch_persons_personid_merge_duplicateid_body_privacy_policy_agreement
