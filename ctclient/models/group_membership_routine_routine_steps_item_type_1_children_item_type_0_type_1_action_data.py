...
from ..models.group_membership_routine_routine_steps_item_type_1_children_item_type_0_type_1_action_data_color import (
    GroupMembershipRoutineRoutineStepsItemType1ChildrenItemType0Type1ActionDataColor,
)
from ..models.group_membership_routine_routine_steps_item_type_1_children_item_type_0_type_1_action_data_continuation_type import (
    GroupMembershipRoutineRoutineStepsItemType1ChildrenItemType0Type1ActionDataContinuationType,
)
from ..models.group_membership_routine_routine_steps_item_type_1_children_item_type_0_type_1_action_data_success_group_member_status_type_0 import (
...
T = TypeVar(
    "T",
    bound="GroupMembershipRoutineRoutineStepsItemType1ChildrenItemType0Type1ActionData",
)


@_attrs_define
class GroupMembershipRoutineRoutineStepsItemType1ChildrenItemType0Type1ActionData:
    """
    Attributes:
        continuation_type (GroupMembershipRoutineRoutineStepsItemType1ChildrenItemType0Type1ActionDataContinuationType):
        description (None | str):
        title (str):
        color (GroupMembershipRoutineRoutineStepsItemType1ChildrenItemType0Type1ActionDataColor | Unset): A color in
            ChurchTools
        ...
        success_group_member_status
            (GroupMembershipRoutineRoutineStepsItemType1ChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0 | None
            | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_color, Unset):
            ...
            color = GroupMembershipRoutineRoutineStepsItemType1ChildrenItemType0Type1ActionDataColor(
                _color
            )
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = GroupMembershipRoutineRoutineStepsItemType1ChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        group_membership_routine_routine_steps_item_type_1_children_item_type_0_type_1_action_data = cls(
        ...
        group_membership_routine_routine_steps_item_type_1_children_item_type_0_type_1_action_data.additional_properties = d
        return group_membership_routine_routine_steps_item_type_1_children_item_type_0_type_1_action_data
