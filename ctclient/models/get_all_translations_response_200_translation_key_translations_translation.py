...
T = TypeVar(
    "T", bound="GetAllTranslationsResponse200TranslationKeyTranslationsTranslation"
)


@_attrs_define
class GetAllTranslationsResponse200TranslationKeyTranslationsTranslation:
    """Translation object
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_translations_response_200_translation_key_translations_translation = (
            cls(
        ...
        get_all_translations_response_200_translation_key_translations_translation.additional_properties = d
        return (
            get_all_translations_response_200_translation_key_translations_translation
        )
