...
T = TypeVar("T", bound="PutResourcetypesResourceTypeIdResponse200Data")


@_attrs_define
class PutResourcetypesResourceTypeIdResponse200Data:
    """
    Attributes:
        id (int):  Example: 3.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_resourcetypes_resource_type_id_response_200_data = cls(
            id=id,
        ...
        put_resourcetypes_resource_type_id_response_200_data.additional_properties = d
        return put_resourcetypes_resource_type_id_response_200_data
