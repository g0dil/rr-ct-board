...
T = TypeVar(
    "T",
    bound="GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAdditionsItemMeta",
)


@_attrs_define
class GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAdditionsItemMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_calendars_appointments_response_200_data_item_appointment_base_additions_item_meta = cls(
            modified_date=modified_date,
            modified_pid=modified_pid,
        )

        get_calendars_appointments_response_200_data_item_appointment_base_additions_item_meta.additional_properties = d
        return get_calendars_appointments_response_200_data_item_appointment_base_additions_item_meta
