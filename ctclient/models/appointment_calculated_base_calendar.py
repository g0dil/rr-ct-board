...
if TYPE_CHECKING:
    from ..models.appointment_calculated_base_calendar_meta import (
        AppointmentCalculatedBaseCalendarMeta,
    )


T = TypeVar("T", bound="AppointmentCalculatedBaseCalendar")


@_attrs_define
class AppointmentCalculatedBaseCalendar:
    """
    Attributes:
        id (int):
        meta (AppointmentCalculatedBaseCalendarMeta):
        name_translated (str):
        random_url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = AppointmentCalculatedBaseCalendarMeta.from_dict(d.pop("meta"))
        ...
        appointment_calculated_base_calendar = cls(
            id=id,
            meta=meta,
        ...
        appointment_calculated_base_calendar.additional_properties = d
        return appointment_calculated_base_calendar
