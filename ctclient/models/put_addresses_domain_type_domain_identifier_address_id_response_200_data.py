...
T = TypeVar("T", bound="PutAddressesDomainTypeDomainIdentifierAddressIdResponse200Data")


@_attrs_define
class PutAddressesDomainTypeDomainIdentifierAddressIdResponse200Data:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_addresses_domain_type_domain_identifier_address_id_response_200_data = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        put_addresses_domain_type_domain_identifier_address_id_response_200_data.additional_properties = d
        return put_addresses_domain_type_domain_identifier_address_id_response_200_data
