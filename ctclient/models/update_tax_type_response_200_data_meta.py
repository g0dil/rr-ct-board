...
if TYPE_CHECKING:
    from ..models.update_tax_type_response_200_data_meta_created_person import (
        UpdateTaxTypeResponse200DataMetaCreatedPerson,
    )
    from ..models.update_tax_type_response_200_data_meta_modified_person import (
        UpdateTaxTypeResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="UpdateTaxTypeResponse200DataMeta")


@_attrs_define
class UpdateTaxTypeResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (UpdateTaxTypeResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (UpdateTaxTypeResponse200DataMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: UpdateTaxTypeResponse200DataMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: UpdateTaxTypeResponse200DataMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = UpdateTaxTypeResponse200DataMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = UpdateTaxTypeResponse200DataMetaModifiedPerson.from_dict(
                _modified_person
            )

        update_tax_type_response_200_data_meta = cls(
        ...
        update_tax_type_response_200_data_meta.additional_properties = d
        return update_tax_type_response_200_data_meta
