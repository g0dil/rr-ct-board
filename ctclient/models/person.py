...
from ..models.person_invitation_status_type_0 import PersonInvitationStatusType0
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.person_emails_item import PersonEmailsItem
    from ..models.person_meta import PersonMeta
    from ..models.person_privacy_policy_agreement import PersonPrivacyPolicyAgreement
    from ..models.person_tags_item import PersonTagsItem
...
class Person:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[PersonEmailsItem] | Unset):
            ...
            invitation_status (None | PersonInvitationStatusType0 | Unset):
            ...
            meta (PersonMeta | Unset):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson': {'id': 1},
            ...
            privacy_policy_agreement (PersonPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[PersonTagsItem] | Unset):
            title (str | Unset):
    ...
    emails: list[PersonEmailsItem] | Unset = UNSET
    ...
    invitation_status: None | PersonInvitationStatusType0 | Unset = UNSET
    ...
    privacy_policy_agreement: PersonPrivacyPolicyAgreement | Unset = UNSET
    ...
    tags: list[PersonTagsItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.invitation_status, PersonInvitationStatusType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.person_emails_item import PersonEmailsItem
        from ..models.person_meta import PersonMeta
        from ..models.person_privacy_policy_agreement import (
        ...
        for emails_item_data in _emails or []:
            emails_item = PersonEmailsItem.from_dict(emails_item_data)
        ...
        def _parse_invitation_status(
            data: object,
        ) -> None | PersonInvitationStatusType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                invitation_status_type_0 = PersonInvitationStatusType0(data)

                return invitation_status_type_0
            except:  # noqa: E722
                pass
            return cast(None | PersonInvitationStatusType0 | Unset, data)
        ...
        meta: PersonMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = PersonMeta.from_dict(_meta)
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = PersonPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = PersonTagsItem.from_dict(tags_item_data)
