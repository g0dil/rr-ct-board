...
from ..models.get_all_for_person_response_200_item_requested_person_invitation_status_type_0 import (
    GetAllForPersonResponse200ItemRequestedPersonInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_all_for_person_response_200_item_requested_person_emails_item import (
        GetAllForPersonResponse200ItemRequestedPersonEmailsItem,
    )
    from ..models.get_all_for_person_response_200_item_requested_person_meta import (
        GetAllForPersonResponse200ItemRequestedPersonMeta,
    )
    from ..models.get_all_for_person_response_200_item_requested_person_privacy_policy_agreement import (
        GetAllForPersonResponse200ItemRequestedPersonPrivacyPolicyAgreement,
    )
    from ..models.get_all_for_person_response_200_item_requested_person_tags_item import (
        GetAllForPersonResponse200ItemRequestedPersonTagsItem,
    )


T = TypeVar("T", bound="GetAllForPersonResponse200ItemRequestedPerson")


@_attrs_define
class GetAllForPersonResponse200ItemRequestedPerson:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[GetAllForPersonResponse200ItemRequestedPersonEmailsItem] | Unset):
            ...
            invitation_status (GetAllForPersonResponse200ItemRequestedPersonInvitationStatusType0 | None | Unset):
            ...
            meta (GetAllForPersonResponse200ItemRequestedPersonMeta | Unset):  Example: {'createdDate':
            ...
            privacy_policy_agreement (GetAllForPersonResponse200ItemRequestedPersonPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[GetAllForPersonResponse200ItemRequestedPersonTagsItem] | Unset):
            title (str | Unset):
    ...
    meta: GetAllForPersonResponse200ItemRequestedPersonMeta | Unset = UNSET
    ...
    privacy_policy_agreement: (
        GetAllForPersonResponse200ItemRequestedPersonPrivacyPolicyAgreement | Unset
    ) = UNSET
    ...
    tags: list[GetAllForPersonResponse200ItemRequestedPersonTagsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = (
                GetAllForPersonResponse200ItemRequestedPersonEmailsItem.from_dict(
                    emails_item_data
                )
            )
        ...
        meta: GetAllForPersonResponse200ItemRequestedPersonMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = GetAllForPersonResponse200ItemRequestedPersonMeta.from_dict(_meta)
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = GetAllForPersonResponse200ItemRequestedPersonPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = GetAllForPersonResponse200ItemRequestedPersonTagsItem.from_dict(
                tags_item_data
            )
        ...
        get_all_for_person_response_200_item_requested_person = cls(
        ...
        get_all_for_person_response_200_item_requested_person.additional_properties = d
        return get_all_for_person_response_200_item_requested_person
