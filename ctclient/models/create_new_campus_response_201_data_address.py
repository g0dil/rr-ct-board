...
T = TypeVar("T", bound="CreateNewCampusResponse201DataAddress")


@_attrs_define
class CreateNewCampusResponse201DataAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_new_campus_response_201_data_address = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        create_new_campus_response_201_data_address.additional_properties = d
        return create_new_campus_response_201_data_address
