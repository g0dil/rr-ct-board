...
if TYPE_CHECKING:
    from ..models.get_subscriptions_person_id_subject_response_200_data_item_type_5_meta_type_0_created_person import (
        GetSubscriptionsPersonIdSubjectResponse200DataItemType5MetaType0CreatedPerson,
    )
    from ..models.get_subscriptions_person_id_subject_response_200_data_item_type_5_meta_type_0_modified_person import (
        GetSubscriptionsPersonIdSubjectResponse200DataItemType5MetaType0ModifiedPerson,
    )


T = TypeVar(
    "T", bound="GetSubscriptionsPersonIdSubjectResponse200DataItemType5MetaType0"
)


@_attrs_define
class GetSubscriptionsPersonIdSubjectResponse200DataItemType5MetaType0:
    """
    Attributes:
        ...
        created_person (GetSubscriptionsPersonIdSubjectResponse200DataItemType5MetaType0CreatedPerson | Unset):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetSubscriptionsPersonIdSubjectResponse200DataItemType5MetaType0ModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_created_person, Unset):
            ...
            created_person = GetSubscriptionsPersonIdSubjectResponse200DataItemType5MetaType0CreatedPerson.from_dict(
                _created_person
            )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GetSubscriptionsPersonIdSubjectResponse200DataItemType5MetaType0ModifiedPerson.from_dict(
                _modified_person
            )

        get_subscriptions_person_id_subject_response_200_data_item_type_5_meta_type_0 = cls(
        ...
        get_subscriptions_person_id_subject_response_200_data_item_type_5_meta_type_0.additional_properties = d
        return get_subscriptions_person_id_subject_response_200_data_item_type_5_meta_type_0
