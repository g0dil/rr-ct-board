...
if TYPE_CHECKING:
    from ..models.get_account_class_by_id_response_200_data_meta import (
        GetAccountClassByIdResponse200DataMeta,
    )


T = TypeVar("T", bound="GetAccountClassByIdResponse200Data")


@_attrs_define
class GetAccountClassByIdResponse200Data:
    """
    Attributes:
        ...
        include_profit_loss (bool): If true, an additional row is added to that class in the report, which lists the
            profit-loss sum.
        meta (GetAccountClassByIdResponse200DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
    ...
    meta: GetAccountClassByIdResponse200DataMeta
    name: str
    sort_key: int = 0
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = GetAccountClassByIdResponse200DataMeta.from_dict(d.pop("meta"))

        name = d.pop("name")

        sort_key = d.pop("sortKey")

        get_account_class_by_id_response_200_data = cls(
        ...
        get_account_class_by_id_response_200_data.additional_properties = d
        return get_account_class_by_id_response_200_data
