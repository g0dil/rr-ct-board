...
T = TypeVar("T", bound="LinkingType0DataType0Article")


@_attrs_define
class LinkingType0DataType0Article:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linking_type_0_data_type_0_article = cls(
            authors=authors,
        ...
        linking_type_0_data_type_0_article.additional_properties = d
        return linking_type_0_data_type_0_article
