...
from ..models.group_settings_default_post_notification_scope_type_1 import (
    GroupSettingsDefaultPostNotificationScopeType1,
)
from ..models.group_settings_default_post_notification_scope_type_2_type_1 import (
    GroupSettingsDefaultPostNotificationScopeType2Type1,
)
from ..models.group_settings_default_post_notification_scope_type_3_type_1 import (
    GroupSettingsDefaultPostNotificationScopeType3Type1,
)
from ..models.group_settings_default_post_visibility import (
    GroupSettingsDefaultPostVisibility,
)
from ..models.group_settings_dynamic_group_status_type_1 import (
    GroupSettingsDynamicGroupStatusType1,
)
from ..models.group_settings_dynamic_group_status_type_2_type_1 import (
    GroupSettingsDynamicGroupStatusType2Type1,
)
from ..models.group_settings_dynamic_group_status_type_3_type_1 import (
    GroupSettingsDynamicGroupStatusType3Type1,
)
from ..models.group_settings_visibility import GroupSettingsVisibility

if TYPE_CHECKING:
    from ..models.group_settings_dynamic_group_rule_set_type_0_item import (
        GroupSettingsDynamicGroupRuleSetType0Item,
    )
    from ..models.group_settings_group_meeting import GroupSettingsGroupMeeting
    from ..models.group_settings_new_member import GroupSettingsNewMember


T = TypeVar("T", bound="GroupSettings")
...
class GroupSettings:
    ...
    Attributes:
        ...
        default_post_notification_scope (GroupSettingsDefaultPostNotificationScopeType1 |
            GroupSettingsDefaultPostNotificationScopeType2Type1 | GroupSettingsDefaultPostNotificationScopeType3Type1 |
            None): Default value for post notification scope.
        default_post_placeholder_text (None | str): Default placeholder text for entering post content.
        default_post_visibility (GroupSettingsDefaultPostVisibility):
        dynamic_group_rule_set (list[GroupSettingsDynamicGroupRuleSetType0Item] | None): Rule set for dynamic group
            update.
        dynamic_group_status (GroupSettingsDynamicGroupStatusType1 | GroupSettingsDynamicGroupStatusType2Type1 |
            GroupSettingsDynamicGroupStatusType3Type1 | None): Status of dynamic group update.
        ...
        group_meeting (GroupSettingsGroupMeeting):
        in_statistic (bool):
        ...
        new_member (GroupSettingsNewMember): Campus, status, and department for newly created persons.
        posts_enabled (bool):
        ...
        sign_up_opening_date (datetime.datetime | None): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z'
            Example: 2022-10-19T12:00:00Z.
        visibility (GroupSettingsVisibility): The visibility of a group.
    ...
    default_post_visibility: GroupSettingsDefaultPostVisibility
    dynamic_group_rule_set: list[GroupSettingsDynamicGroupRuleSetType0Item] | None
    ...
    new_member: GroupSettingsNewMember
    posts_enabled: bool
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.dynamic_group_status, GroupSettingsDynamicGroupStatusType1):
            dynamic_group_status = self.dynamic_group_status.value
        elif isinstance(
            self.dynamic_group_status, GroupSettingsDynamicGroupStatusType2Type1
        ):
            dynamic_group_status = self.dynamic_group_status.value
        elif isinstance(
            self.dynamic_group_status, GroupSettingsDynamicGroupStatusType3Type1
        ):
            dynamic_group_status = self.dynamic_group_status.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_default_post_notification_scope(
            ...
            try:
                ...
                default_post_notification_scope_type_1 = (
                    GroupSettingsDefaultPostNotificationScopeType1(data)
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                default_post_notification_scope_type_2_type_1 = (
                    GroupSettingsDefaultPostNotificationScopeType2Type1(data)
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                default_post_notification_scope_type_3_type_1 = (
                    GroupSettingsDefaultPostNotificationScopeType3Type1(data)
                )
        ...
        def _parse_dynamic_group_rule_set(
            data: object,
        ) -> list[GroupSettingsDynamicGroupRuleSetType0Item] | None:
            if data is None:
                return data
            try:
                ...
                for (
                    ...
                    dynamic_group_rule_set_type_0_item = (
                        GroupSettingsDynamicGroupRuleSetType0Item.from_dict(
                            dynamic_group_rule_set_type_0_item_data
                        )
                    )
                ...
                pass
            return cast(list[GroupSettingsDynamicGroupRuleSetType0Item] | None, data)
        ...
        def _parse_dynamic_group_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                dynamic_group_status_type_1 = GroupSettingsDynamicGroupStatusType1(data)
            ...
            try:
                ...
                dynamic_group_status_type_2_type_1 = (
                    GroupSettingsDynamicGroupStatusType2Type1(data)
                )
            ...
            try:
                ...
                dynamic_group_status_type_3_type_1 = (
                    GroupSettingsDynamicGroupStatusType3Type1(data)
                )
        ...
        group_meeting = GroupSettingsGroupMeeting.from_dict(d.pop("groupMeeting"))
        ...
        new_member = GroupSettingsNewMember.from_dict(d.pop("newMember"))
        ...
        visibility = GroupSettingsVisibility(d.pop("visibility"))
        ...
        group_settings.additional_properties = d
