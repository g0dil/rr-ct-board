...
if TYPE_CHECKING:
    from ..models.get_calendars_calendar_id_appointments_response_200_data_item_base_meta_created_person import (
        GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseMetaCreatedPerson,
    )
    from ..models.get_calendars_calendar_id_appointments_response_200_data_item_base_meta_modified_person import (
        GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseMeta")


@_attrs_define
class GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseMetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseMetaModifiedPerson.from_dict(
                _modified_person
            )

        get_calendars_calendar_id_appointments_response_200_data_item_base_meta = cls(
        ...
        get_calendars_calendar_id_appointments_response_200_data_item_base_meta.additional_properties = d
        return get_calendars_calendar_id_appointments_response_200_data_item_base_meta
