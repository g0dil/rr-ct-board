...
T = TypeVar("T", bound="GetApiInfoResponse200Address")


@_attrs_define
class GetApiInfoResponse200Address:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_info_response_200_address = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        get_api_info_response_200_address.additional_properties = d
        return get_api_info_response_200_address
