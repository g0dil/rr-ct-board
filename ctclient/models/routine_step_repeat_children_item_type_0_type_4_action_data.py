...
T = TypeVar("T", bound="RoutineStepRepeatChildrenItemType0Type4ActionData")


@_attrs_define
class RoutineStepRepeatChildrenItemType0Type4ActionData:
    """
    Attributes:
        num_days (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        routine_step_repeat_children_item_type_0_type_4_action_data = cls(
            num_days=num_days,
            until_date=until_date,
        )

        routine_step_repeat_children_item_type_0_type_4_action_data.additional_properties = d
        return routine_step_repeat_children_item_type_0_type_4_action_data
