...
from ..models.post_groups_group_id_qrcodecheckin_person_id_send_response_200_data_domain_type import (
    PostGroupsGroupIdQrcodecheckinPersonIdSendResponse200DataDomainType,
)

T = TypeVar("T", bound="PostGroupsGroupIdQrcodecheckinPersonIdSendResponse200Data")


@_attrs_define
class PostGroupsGroupIdQrcodecheckinPersonIdSendResponse200Data:
    """
    Attributes:
        domain_id (int):
        domain_type (PostGroupsGroupIdQrcodecheckinPersonIdSendResponse200DataDomainType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_groups_group_id_qrcodecheckin_person_id_send_response_200_data = cls(
            domain_id=domain_id,
        ...
        post_groups_group_id_qrcodecheckin_person_id_send_response_200_data.additional_properties = d
        return post_groups_group_id_qrcodecheckin_person_id_send_response_200_data
