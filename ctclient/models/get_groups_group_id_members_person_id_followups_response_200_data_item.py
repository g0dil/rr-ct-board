...
from ..models.get_groups_group_id_members_person_id_followups_response_200_data_item_color import (
    GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemColor,
)
from ..models.get_groups_group_id_members_person_id_followups_response_200_data_item_origin import (
    GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemOrigin,
)
from ..models.get_groups_group_id_members_person_id_followups_response_200_data_item_success_group_member_status_type_0 import (
    GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_groups_group_id_members_person_id_followups_response_200_data_item_meta import (
        GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemMeta,
    )


T = TypeVar("T", bound="GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItem")


@_attrs_define
class GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItem:
    """
    Attributes:
        ...
        meta (GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemMeta):  Example: {'createdDate':
            '2020-01-01T00:00:00Z', 'createdPerson': {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson':
            {'id': 1}}.
        origin (GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemOrigin):
        person_id (int):
        color (GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemColor | Unset): A color in ChurchTools
        ...
        success_group_member_status
            (GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemSuccessGroupMemberStatusType0 | None | Unset):
    ...
    id: int
    membership_id: int | None
    meta: GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemMeta
    origin: GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemOrigin
    person_id: int
    color: GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemColor | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = (
            GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemMeta.from_dict(
                d.pop("meta")
            )
        )
        ...
        if isinstance(_color, Unset):
            ...
            color = GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemColor(
                _color
            )
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemSuccessGroupMemberStatusType0(
                    data
                )
        ...
        get_groups_group_id_members_person_id_followups_response_200_data_item = cls(
            title=title,
            done_date=done_date,
        ...
        get_groups_group_id_members_person_id_followups_response_200_data_item.additional_properties = d
        return get_groups_group_id_members_person_id_followups_response_200_data_item
