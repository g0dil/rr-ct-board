...
from ..models.get_group_qr_code_checkin_person_response_200_data_domain_type import (
    GetGroupQRCodeCheckinPersonResponse200DataDomainType,
)

T = TypeVar("T", bound="GetGroupQRCodeCheckinPersonResponse200Data")


@_attrs_define
class GetGroupQRCodeCheckinPersonResponse200Data:
    """
    Attributes:
        domain_id (int):
        domain_type (GetGroupQRCodeCheckinPersonResponse200DataDomainType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_group_qr_code_checkin_person_response_200_data = cls(
            domain_id=domain_id,
        ...
        get_group_qr_code_checkin_person_response_200_data.additional_properties = d
        return get_group_qr_code_checkin_person_response_200_data
