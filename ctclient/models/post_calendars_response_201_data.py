...
if TYPE_CHECKING:
    from ..models.post_calendars_response_201_data_meta import (
        PostCalendarsResponse201DataMeta,
    )


T = TypeVar("T", bound="PostCalendarsResponse201Data")


@_attrs_define
class PostCalendarsResponse201Data:
    """
    Attributes:
        id (int):
        meta (PostCalendarsResponse201DataMeta):
        name_translated (str):
        random_url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = PostCalendarsResponse201DataMeta.from_dict(d.pop("meta"))
        ...
        post_calendars_response_201_data = cls(
            id=id,
            meta=meta,
        ...
        post_calendars_response_201_data.additional_properties = d
        return post_calendars_response_201_data
