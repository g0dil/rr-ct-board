...
T = TypeVar("T", bound="PersonUpdateablePersonEmail")


@_attrs_define
class PersonUpdateablePersonEmail:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_updateable_person_email = cls(
            contact_label_id=contact_label_id,
            email=email,
            is_default=is_default,
        )

        person_updateable_person_email.additional_properties = d
        return person_updateable_person_email
