...
if TYPE_CHECKING:
    from ..models.open_graph_music_album import OpenGraphMusicAlbum
    from ..models.open_graph_music_songs_item import OpenGraphMusicSongsItem


T = TypeVar("T", bound="OpenGraphMusic")


@_attrs_define
class OpenGraphMusic:
    """
    Attributes:
        album (OpenGraphMusicAlbum | Unset):
        ...
        songs (list[OpenGraphMusicSongsItem] | Unset):
    """

    album: OpenGraphMusicAlbum | Unset = UNSET
    creators: list[str] | Unset = UNSET
    duration: int | Unset = UNSET
    musicians: list[str] | Unset = UNSET
    release_date: datetime.datetime | Unset = UNSET
    songs: list[OpenGraphMusicSongsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_album, Unset):
            ...
            album = OpenGraphMusicAlbum.from_dict(_album)
        ...
        for songs_item_data in _songs or []:
            songs_item = OpenGraphMusicSongsItem.from_dict(songs_item_data)

            songs.append(songs_item)

        open_graph_music = cls(
            album=album,
            creators=creators,
            duration=duration,
            musicians=musicians,
        ...
        open_graph_music.additional_properties = d
        return open_graph_music
