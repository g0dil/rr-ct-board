...
if TYPE_CHECKING:
    from ..models.tax_rate_meta_created_person import TaxRateMetaCreatedPerson
    from ..models.tax_rate_meta_modified_person import TaxRateMetaModifiedPerson


T = TypeVar("T", bound="TaxRateMeta")
...
class TaxRateMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = TaxRateMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = TaxRateMetaModifiedPerson.from_dict(_modified_person)
        ...
        tax_rate_meta.additional_properties = d
        return tax_rate_meta
