...
T = TypeVar("T", bound="PostGroupsResponse201DataRolesItem")


@_attrs_define
class PostGroupsResponse201DataRolesItem:
    """
    Attributes:
        can_read_chat (bool):
        can_write_chat (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_groups_response_201_data_roles_item = cls(
        ...
        post_groups_response_201_data_roles_item.additional_properties = d
        return post_groups_response_201_data_roles_item
