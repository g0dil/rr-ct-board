...
T = TypeVar("T", bound="LinkingOpenGraphDataType0ImagesItem")


@_attrs_define
class LinkingOpenGraphDataType0ImagesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linking_open_graph_data_type_0_images_item = cls(
            height=height,
        ...
        linking_open_graph_data_type_0_images_item.additional_properties = d
        return linking_open_graph_data_type_0_images_item
