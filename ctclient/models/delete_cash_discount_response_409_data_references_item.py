...
T = TypeVar("T", bound="DeleteCashDiscountResponse409DataReferencesItem")


@_attrs_define
class DeleteCashDiscountResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_cash_discount_response_409_data_references_item = cls(
        ...
        delete_cash_discount_response_409_data_references_item.additional_properties = d
        return delete_cash_discount_response_409_data_references_item
