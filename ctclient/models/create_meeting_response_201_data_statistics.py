...
T = TypeVar("T", bound="CreateMeetingResponse201DataStatistics")


@_attrs_define
class CreateMeetingResponse201DataStatistics:
    """
    Attributes:
        absent (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_meeting_response_201_data_statistics = cls(
            absent=absent,
        ...
        create_meeting_response_201_data_statistics.additional_properties = d
        return create_meeting_response_201_data_statistics
