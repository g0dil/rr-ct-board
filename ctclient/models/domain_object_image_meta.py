...
if TYPE_CHECKING:
    from ..models.domain_object_image_meta_created_person import (
        DomainObjectImageMetaCreatedPerson,
    )
    from ..models.domain_object_image_meta_modified_person import (
        DomainObjectImageMetaModifiedPerson,
    )


T = TypeVar("T", bound="DomainObjectImageMeta")


@_attrs_define
class DomainObjectImageMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (DomainObjectImageMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (DomainObjectImageMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: DomainObjectImageMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: DomainObjectImageMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = DomainObjectImageMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = DomainObjectImageMetaModifiedPerson.from_dict(
                _modified_person
            )

        domain_object_image_meta = cls(
        ...
        domain_object_image_meta.additional_properties = d
        return domain_object_image_meta
