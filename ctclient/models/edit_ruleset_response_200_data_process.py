...
if TYPE_CHECKING:
    from ..models.edit_ruleset_response_200_data_process_group_and_query_result import (
        EditRulesetResponse200DataProcessGroupAndQueryResult,
    )
    from ..models.edit_ruleset_response_200_data_process_group_only import (
        EditRulesetResponse200DataProcessGroupOnly,
    )
    from ..models.edit_ruleset_response_200_data_process_query_result_only import (
        EditRulesetResponse200DataProcessQueryResultOnly,
    )


T = TypeVar("T", bound="EditRulesetResponse200DataProcess")


@_attrs_define
class EditRulesetResponse200DataProcess:
    """
    Attributes:
        group_and_query_result (EditRulesetResponse200DataProcessGroupAndQueryResult | Unset):
        group_only (EditRulesetResponse200DataProcessGroupOnly | Unset):
        query_result_only (EditRulesetResponse200DataProcessQueryResultOnly | Unset):
    """

    group_and_query_result: (
        EditRulesetResponse200DataProcessGroupAndQueryResult | Unset
    ) = UNSET
    group_only: EditRulesetResponse200DataProcessGroupOnly | Unset = UNSET
    query_result_only: EditRulesetResponse200DataProcessQueryResultOnly | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_group_and_query_result, Unset):
            ...
            group_and_query_result = (
                EditRulesetResponse200DataProcessGroupAndQueryResult.from_dict(
        ...
        if isinstance(_group_only, Unset):
            ...
            group_only = EditRulesetResponse200DataProcessGroupOnly.from_dict(
                _group_only
            )
        ...
        if isinstance(_query_result_only, Unset):
            ...
            query_result_only = (
                EditRulesetResponse200DataProcessQueryResultOnly.from_dict(
                    _query_result_only
                )
            )

        edit_ruleset_response_200_data_process = cls(
            group_and_query_result=group_and_query_result,
            group_only=group_only,
            query_result_only=query_result_only,
        )

        edit_ruleset_response_200_data_process.additional_properties = d
        return edit_ruleset_response_200_data_process
