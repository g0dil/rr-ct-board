...
T = TypeVar("T", bound="ProfileUpdateAddress")


@_attrs_define
class ProfileUpdateAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        profile_update_address.additional_properties = d
        return profile_update_address
