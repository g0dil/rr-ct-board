...
T = TypeVar("T", bound="GetAddressesDomainTypeDomainIdentifierResponse200DataItem")


@_attrs_define
class GetAddressesDomainTypeDomainIdentifierResponse200DataItem:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_addresses_domain_type_domain_identifier_response_200_data_item = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        get_addresses_domain_type_domain_identifier_response_200_data_item.additional_properties = d
        return get_addresses_domain_type_domain_identifier_response_200_data_item
