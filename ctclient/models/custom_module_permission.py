...
T = TypeVar("T", bound="CustomModulePermission")


@_attrs_define
class CustomModulePermission:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_module_permission.additional_properties = d
        return custom_module_permission
