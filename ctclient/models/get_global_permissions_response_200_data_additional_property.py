...
T = TypeVar("T", bound="GetGlobalPermissionsResponse200DataAdditionalProperty")


@_attrs_define
class GetGlobalPermissionsResponse200DataAdditionalProperty:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_global_permissions_response_200_data_additional_property = cls(
        ...
        get_global_permissions_response_200_data_additional_property.additional_properties = d
        return get_global_permissions_response_200_data_additional_property
