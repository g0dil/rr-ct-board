...
T = TypeVar("T", bound="GetCalendarsResponse200DataItemMeta")


@_attrs_define
class GetCalendarsResponse200DataItemMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_calendars_response_200_data_item_meta = cls(
            modified_date=modified_date,
            modified_pid=modified_pid,
        )

        get_calendars_response_200_data_item_meta.additional_properties = d
        return get_calendars_response_200_data_item_meta
