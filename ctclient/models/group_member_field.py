...
from ..models.group_member_field_field_type_code import GroupMemberFieldFieldTypeCode

if TYPE_CHECKING:
    from ..models.group_member_field_options_item import GroupMemberFieldOptionsItem


T = TypeVar("T", bound="GroupMemberField")


@_attrs_define
class GroupMemberField:
    """
    Attributes:
        default_value (str):
        field_name (str):
        field_type_code (GroupMemberFieldFieldTypeCode): The intern code of the field type the field belongs to. This is
            used to define the type of the field.
        field_type_id (int):
        max_length (int):
        name (str):
        ...
        options (list[GroupMemberFieldOptionsItem]):
        reference_name (str):
    ...
    default_value: str
    field_name: str
    field_type_code: GroupMemberFieldFieldTypeCode
    field_type_id: int
    max_length: int
    name: str
    name_in_signup_form: None | str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_type_code = GroupMemberFieldFieldTypeCode(d.pop("fieldTypeCode"))
        ...
        for options_item_data in _options:
            options_item = GroupMemberFieldOptionsItem.from_dict(options_item_data)
        ...
        group_member_field.additional_properties = d
        return group_member_field
