...
if TYPE_CHECKING:
    from ..models.duplicate_group_response_201_data_settings_dynamic_group_rule_set_type_0_item_query_params_computed_fields_item import (
        DuplicateGroupResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParamsComputedFieldsItem,
    )
    from ..models.duplicate_group_response_201_data_settings_dynamic_group_rule_set_type_0_item_query_params_filter import (
...
T = TypeVar(
    "T",
    bound="DuplicateGroupResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParams",
)


@_attrs_define
class DuplicateGroupResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParams:
    """
    Attributes:
        computed_fields
            (list[DuplicateGroupResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParamsComputedFieldsItem] | Unset):
        description (str | Unset):
        filter_ (DuplicateGroupResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParamsFilter | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for computed_fields_item_data in _computed_fields or []:
            computed_fields_item = DuplicateGroupResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParamsComputedFieldsItem.from_dict(
        ...
        if isinstance(_filter_, Unset):
            ...
            filter_ = DuplicateGroupResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParamsFilter.from_dict(
                _filter_
            )
        ...
        duplicate_group_response_201_data_settings_dynamic_group_rule_set_type_0_item_query_params = cls(
        ...
        duplicate_group_response_201_data_settings_dynamic_group_rule_set_type_0_item_query_params.additional_properties = d
        return duplicate_group_response_201_data_settings_dynamic_group_rule_set_type_0_item_query_params
