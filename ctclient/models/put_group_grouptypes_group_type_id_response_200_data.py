...
T = TypeVar("T", bound="PutGroupGrouptypesGroupTypeIdResponse200Data")


@_attrs_define
class PutGroupGrouptypesGroupTypeIdResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_group_grouptypes_group_type_id_response_200_data = cls(
            name_plural_translated=name_plural_translated,
            name_translated=name_translated,
        )

        put_group_grouptypes_group_type_id_response_200_data.additional_properties = d
        return put_group_grouptypes_group_type_id_response_200_data
