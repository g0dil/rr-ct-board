...
T = TypeVar("T", bound="GlobalPermissionsChurchresource")


@_attrs_define
class GlobalPermissionsChurchresource:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        global_permissions_churchresource = cls(
        ...
        global_permissions_churchresource.additional_properties = d
        return global_permissions_churchresource
