...
if TYPE_CHECKING:
    ...
    from ..models.account_permissions import AccountPermissions
...
class Account:
    ...
    Attributes:
        ...
        meta (AccountMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson': {'id': 1},
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = AccountMeta.from_dict(d.pop("meta"))

        name = d.pop("name")

        number = d.pop("number")

        permissions = AccountPermissions.from_dict(d.pop("permissions"))
