...
if TYPE_CHECKING:
    from ..models.person_master_data_campuses_item_meta_created_person import (
        PersonMasterDataCampusesItemMetaCreatedPerson,
    )
    from ..models.person_master_data_campuses_item_meta_modified_person import (
        PersonMasterDataCampusesItemMetaModifiedPerson,
    )


T = TypeVar("T", bound="PersonMasterDataCampusesItemMeta")


@_attrs_define
class PersonMasterDataCampusesItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (PersonMasterDataCampusesItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (PersonMasterDataCampusesItemMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: PersonMasterDataCampusesItemMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: PersonMasterDataCampusesItemMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = PersonMasterDataCampusesItemMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = PersonMasterDataCampusesItemMetaModifiedPerson.from_dict(
                _modified_person
            )

        person_master_data_campuses_item_meta = cls(
        ...
        person_master_data_campuses_item_meta.additional_properties = d
        return person_master_data_campuses_item_meta
