...
if TYPE_CHECKING:
    from ..models.get_persons_person_id_devices_response_200_device_meta_created_person import (
        GetPersonsPersonIdDevicesResponse200DeviceMetaCreatedPerson,
    )
    from ..models.get_persons_person_id_devices_response_200_device_meta_modified_person import (
        GetPersonsPersonIdDevicesResponse200DeviceMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetPersonsPersonIdDevicesResponse200DeviceMeta")


@_attrs_define
class GetPersonsPersonIdDevicesResponse200DeviceMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetPersonsPersonIdDevicesResponse200DeviceMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetPersonsPersonIdDevicesResponse200DeviceMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        GetPersonsPersonIdDevicesResponse200DeviceMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            GetPersonsPersonIdDevicesResponse200DeviceMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                GetPersonsPersonIdDevicesResponse200DeviceMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        get_persons_person_id_devices_response_200_device_meta = cls(
        ...
        get_persons_person_id_devices_response_200_device_meta.additional_properties = d
        return get_persons_person_id_devices_response_200_device_meta
