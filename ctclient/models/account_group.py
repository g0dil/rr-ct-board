...
if TYPE_CHECKING:
    from ..models.account_group_meta import AccountGroupMeta
...
class AccountGroup:
    ...
    Attributes:
        ...
        meta (AccountGroupMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson': {'id': 1},
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = AccountGroupMeta.from_dict(d.pop("meta"))
