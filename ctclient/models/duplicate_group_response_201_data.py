...
if TYPE_CHECKING:
    from ..models.duplicate_group_response_201_data_follow_up import (
        DuplicateGroupResponse201DataFollowUp,
    )
    from ..models.duplicate_group_response_201_data_information import (
        DuplicateGroupResponse201DataInformation,
    )
    from ..models.duplicate_group_response_201_data_member_statistics import (
        DuplicateGroupResponse201DataMemberStatistics,
    )
    from ..models.duplicate_group_response_201_data_meta import (
        DuplicateGroupResponse201DataMeta,
    )
    from ..models.duplicate_group_response_201_data_modified_person import (
        DuplicateGroupResponse201DataModifiedPerson,
    )
    from ..models.duplicate_group_response_201_data_permissions import (
        DuplicateGroupResponse201DataPermissions,
    )
    from ..models.duplicate_group_response_201_data_places_item import (
        DuplicateGroupResponse201DataPlacesItem,
    )
    from ..models.duplicate_group_response_201_data_public_posts_statistic import (
        DuplicateGroupResponse201DataPublicPostsStatistic,
    )
    from ..models.duplicate_group_response_201_data_roles_item import (
        DuplicateGroupResponse201DataRolesItem,
    )
    from ..models.duplicate_group_response_201_data_settings import (
        DuplicateGroupResponse201DataSettings,
    )
    from ..models.duplicate_group_response_201_data_signup_conditions import (
        DuplicateGroupResponse201DataSignupConditions,
    )
    from ..models.duplicate_group_response_201_data_tags_item import (
        DuplicateGroupResponse201DataTagsItem,
    )


T = TypeVar("T", bound="DuplicateGroupResponse201Data")


@_attrs_define
class DuplicateGroupResponse201Data:
    ...
    Custom group fields are added to the root level of this model.
        ...
        Attributes:
            follow_up (DuplicateGroupResponse201DataFollowUp):
            guid (str):  Example: 681F54E3-2EB7-40A4-84F0-EFF8E8F05727.
            id (int):  Example: 42.
            information (DuplicateGroupResponse201DataInformation):
            meta (DuplicateGroupResponse201DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson':
                {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
            name (str):  Example: Smallgroup West.
            permissions (DuplicateGroupResponse201DataPermissions):
            security_level_for_group (int): You can see group fields up to this security level. Example: 3.
            settings (DuplicateGroupResponse201DataSettings):
            has_permissions (bool | Unset):
            member_statistics (DuplicateGroupResponse201DataMemberStatistics | Unset):
            modified_date (str | Unset):
            modified_person (DuplicateGroupResponse201DataModifiedPerson | Unset):
            places (list[DuplicateGroupResponse201DataPlacesItem] | Unset):
            public_posts_statistic (DuplicateGroupResponse201DataPublicPostsStatistic | Unset):
            roles (list[DuplicateGroupResponse201DataRolesItem] | Unset):
            signup_conditions (DuplicateGroupResponse201DataSignupConditions | Unset):
            tags (list[DuplicateGroupResponse201DataTagsItem] | Unset):
    """
    ...
    id: int
    information: DuplicateGroupResponse201DataInformation
    meta: DuplicateGroupResponse201DataMeta
    name: str
    permissions: DuplicateGroupResponse201DataPermissions
    security_level_for_group: int
    settings: DuplicateGroupResponse201DataSettings
    has_permissions: bool | Unset = UNSET
    member_statistics: DuplicateGroupResponse201DataMemberStatistics | Unset = UNSET
    modified_date: str | Unset = UNSET
    modified_person: DuplicateGroupResponse201DataModifiedPerson | Unset = UNSET
    places: list[DuplicateGroupResponse201DataPlacesItem] | Unset = UNSET
    public_posts_statistic: (
        DuplicateGroupResponse201DataPublicPostsStatistic | Unset
    ) = UNSET
    roles: list[DuplicateGroupResponse201DataRolesItem] | Unset = UNSET
    signup_conditions: DuplicateGroupResponse201DataSignupConditions | Unset = UNSET
    tags: list[DuplicateGroupResponse201DataTagsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        follow_up = DuplicateGroupResponse201DataFollowUp.from_dict(d.pop("followUp"))

        guid = d.pop("guid")

        id = d.pop("id")

        information = DuplicateGroupResponse201DataInformation.from_dict(
            d.pop("information")
        )

        meta = DuplicateGroupResponse201DataMeta.from_dict(d.pop("meta"))

        name = d.pop("name")

        permissions = DuplicateGroupResponse201DataPermissions.from_dict(
            d.pop("permissions")
        )

        security_level_for_group = d.pop("securityLevelForGroup")

        settings = DuplicateGroupResponse201DataSettings.from_dict(d.pop("settings"))
        ...
        if isinstance(_member_statistics, Unset):
            ...
            member_statistics = DuplicateGroupResponse201DataMemberStatistics.from_dict(
                _member_statistics
            )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = DuplicateGroupResponse201DataModifiedPerson.from_dict(
                _modified_person
            )
        ...
        for places_item_data in _places or []:
            places_item = DuplicateGroupResponse201DataPlacesItem.from_dict(
                places_item_data
            )
        ...
        if isinstance(_public_posts_statistic, Unset):
            ...
            public_posts_statistic = (
                DuplicateGroupResponse201DataPublicPostsStatistic.from_dict(
        ...
        for roles_item_data in _roles or []:
            roles_item = DuplicateGroupResponse201DataRolesItem.from_dict(
                roles_item_data
            )
        ...
        if isinstance(_signup_conditions, Unset):
            ...
            signup_conditions = DuplicateGroupResponse201DataSignupConditions.from_dict(
                _signup_conditions
            )
        ...
        for tags_item_data in _tags or []:
            tags_item = DuplicateGroupResponse201DataTagsItem.from_dict(tags_item_data)

            tags.append(tags_item)

        duplicate_group_response_201_data = cls(
            follow_up=follow_up,
            guid=guid,
            id=id,
            information=information,
        ...
        duplicate_group_response_201_data.additional_properties = d
        return duplicate_group_response_201_data
