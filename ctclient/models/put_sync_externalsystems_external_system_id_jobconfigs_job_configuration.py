...
if TYPE_CHECKING:
    from ..models.put_sync_externalsystems_external_system_id_jobconfigs_job_configuration_create_defaults_es import (
        PutSyncExternalsystemsExternalSystemIdJobconfigsJobConfigurationCreateDefaultsES,
    )
    from ..models.put_sync_externalsystems_external_system_id_jobconfigs_job_configuration_create_defaults_master import (
        PutSyncExternalsystemsExternalSystemIdJobconfigsJobConfigurationCreateDefaultsMaster,
    )


T = TypeVar(
    "T", bound="PutSyncExternalsystemsExternalSystemIdJobconfigsJobConfiguration"
)


@_attrs_define
class PutSyncExternalsystemsExternalSystemIdJobconfigsJobConfiguration:
    """
    Attributes:
        ...
        create_defaults_es (PutSyncExternalsystemsExternalSystemIdJobconfigsJobConfigurationCreateDefaultsES | Unset):
        create_defaults_master (PutSyncExternalsystemsExternalSystemIdJobconfigsJobConfigurationCreateDefaultsMaster |
            Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_create_defaults_es, Unset):
            ...
            create_defaults_es = PutSyncExternalsystemsExternalSystemIdJobconfigsJobConfigurationCreateDefaultsES.from_dict(
                _create_defaults_es
            )
        ...
        if isinstance(_create_defaults_master, Unset):
            ...
            create_defaults_master = PutSyncExternalsystemsExternalSystemIdJobconfigsJobConfigurationCreateDefaultsMaster.from_dict(
        ...
        put_sync_externalsystems_external_system_id_jobconfigs_job_configuration = cls(
        ...
        put_sync_externalsystems_external_system_id_jobconfigs_job_configuration.additional_properties = d
        return put_sync_externalsystems_external_system_id_jobconfigs_job_configuration
