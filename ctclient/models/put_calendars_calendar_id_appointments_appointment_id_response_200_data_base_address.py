...
T = TypeVar(
    "T",
    bound="PutCalendarsCalendarIdAppointmentsAppointmentIdResponse200DataBaseAddress",
)


@_attrs_define
class PutCalendarsCalendarIdAppointmentsAppointmentIdResponse200DataBaseAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_calendars_calendar_id_appointments_appointment_id_response_200_data_base_address = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        put_calendars_calendar_id_appointments_appointment_id_response_200_data_base_address.additional_properties = d
        return put_calendars_calendar_id_appointments_appointment_id_response_200_data_base_address
