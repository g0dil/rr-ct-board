...
if TYPE_CHECKING:
    from ..models.put_followups_follow_up_id_response_200_data_meta_created_person import (
        PutFollowupsFollowUpIdResponse200DataMetaCreatedPerson,
    )
    from ..models.put_followups_follow_up_id_response_200_data_meta_modified_person import (
        PutFollowupsFollowUpIdResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="PutFollowupsFollowUpIdResponse200DataMeta")


@_attrs_define
class PutFollowupsFollowUpIdResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (PutFollowupsFollowUpIdResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (PutFollowupsFollowUpIdResponse200DataMetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            PutFollowupsFollowUpIdResponse200DataMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                PutFollowupsFollowUpIdResponse200DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        put_followups_follow_up_id_response_200_data_meta = cls(
        ...
        put_followups_follow_up_id_response_200_data_meta.additional_properties = d
        return put_followups_follow_up_id_response_200_data_meta
