...
T = TypeVar("T", bound="CreatePersonResponse200DataPrivacyPolicyAgreement")


@_attrs_define
class CreatePersonResponse200DataPrivacyPolicyAgreement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_person_response_200_data_privacy_policy_agreement = cls(
            date=date,
            type_id=type_id,
            who_id=who_id,
        )

        create_person_response_200_data_privacy_policy_agreement.additional_properties = d
        return create_person_response_200_data_privacy_policy_agreement
