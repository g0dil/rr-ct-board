...
T = TypeVar(
    "T", bound="AppointmentCalculatedWithIncludesAppointmentBaseAdditionalsItemMeta"
)


@_attrs_define
class AppointmentCalculatedWithIncludesAppointmentBaseAdditionalsItemMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appointment_calculated_with_includes_appointment_base_additionals_item_meta = (
            cls(
        ...
        appointment_calculated_with_includes_appointment_base_additionals_item_meta.additional_properties = d
        return (
            appointment_calculated_with_includes_appointment_base_additionals_item_meta
        )
