...
if TYPE_CHECKING:
    from ..models.update_transaction_purpose_response_200_data_meta import (
        UpdateTransactionPurposeResponse200DataMeta,
    )


T = TypeVar("T", bound="UpdateTransactionPurposeResponse200Data")


@_attrs_define
class UpdateTransactionPurposeResponse200Data:
    """
    Example:
    ...
    Attributes:
        ...
        meta (UpdateTransactionPurposeResponse200DataMeta | Unset):  Example: {'createdDate': '2020-01-01T00:00:00Z',
    ...
    meta: UpdateTransactionPurposeResponse200DataMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta: UpdateTransactionPurposeResponse200DataMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = UpdateTransactionPurposeResponse200DataMeta.from_dict(_meta)
        ...
        update_transaction_purpose_response_200_data = cls(
        ...
        update_transaction_purpose_response_200_data.additional_properties = d
        return update_transaction_purpose_response_200_data
