...
if TYPE_CHECKING:
    from ..models.get_dbfields_field_id_response_200_data_field_category import (
        GetDbfieldsFieldIdResponse200DataFieldCategory,
    )
    from ..models.get_dbfields_field_id_response_200_data_field_type import (
        GetDbfieldsFieldIdResponse200DataFieldType,
    )
    from ..models.get_dbfields_field_id_response_200_data_options_item import (
        GetDbfieldsFieldIdResponse200DataOptionsItem,
    )


T = TypeVar("T", bound="GetDbfieldsFieldIdResponse200Data")


@_attrs_define
class GetDbfieldsFieldIdResponse200Data:
    """
    Attributes:
        ...
        field_category (GetDbfieldsFieldIdResponse200DataFieldCategory):
        field_type (GetDbfieldsFieldIdResponse200DataFieldType):
        ...
        shorty (str | Unset):
        options (list[GetDbfieldsFieldIdResponse200DataOptionsItem] | Unset):
    """
    ...
    options: list[GetDbfieldsFieldIdResponse200DataOptionsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_category = GetDbfieldsFieldIdResponse200DataFieldCategory.from_dict(
            d.pop("fieldCategory")
        )

        field_type = GetDbfieldsFieldIdResponse200DataFieldType.from_dict(
            d.pop("fieldType")
        )
        ...
        for options_item_data in _options or []:
            options_item = GetDbfieldsFieldIdResponse200DataOptionsItem.from_dict(
                options_item_data
            )

            options.append(options_item)

        get_dbfields_field_id_response_200_data = cls(
        ...
        get_dbfields_field_id_response_200_data.additional_properties = d
        return get_dbfields_field_id_response_200_data
