...
T = TypeVar(
    "T",
    bound="GetRoutinesResponse200DataItemStepsItemType1ChildrenItemType0Type4ActionData",
)


@_attrs_define
class GetRoutinesResponse200DataItemStepsItemType1ChildrenItemType0Type4ActionData:
    """
    Attributes:
        num_days (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_routines_response_200_data_item_steps_item_type_1_children_item_type_0_type_4_action_data = cls(
            num_days=num_days,
            until_date=until_date,
        )

        get_routines_response_200_data_item_steps_item_type_1_children_item_type_0_type_4_action_data.additional_properties = d
        return get_routines_response_200_data_item_steps_item_type_1_children_item_type_0_type_4_action_data
