...
if TYPE_CHECKING:
    from ..models.group_settings_dynamic_group_rule_set_type_0_item_query_params_computed_fields_item import (
        GroupSettingsDynamicGroupRuleSetType0ItemQueryParamsComputedFieldsItem,
    )
    from ..models.group_settings_dynamic_group_rule_set_type_0_item_query_params_filter import (
        GroupSettingsDynamicGroupRuleSetType0ItemQueryParamsFilter,
    )


T = TypeVar("T", bound="GroupSettingsDynamicGroupRuleSetType0ItemQueryParams")


@_attrs_define
class GroupSettingsDynamicGroupRuleSetType0ItemQueryParams:
    """
    Attributes:
        computed_fields (list[GroupSettingsDynamicGroupRuleSetType0ItemQueryParamsComputedFieldsItem] | Unset):
        description (str | Unset):
        filter_ (GroupSettingsDynamicGroupRuleSetType0ItemQueryParamsFilter | Unset):
    ...
    computed_fields: (
        list[GroupSettingsDynamicGroupRuleSetType0ItemQueryParamsComputedFieldsItem]
        | Unset
    ) = UNSET
    description: str | Unset = UNSET
    filter_: GroupSettingsDynamicGroupRuleSetType0ItemQueryParamsFilter | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for computed_fields_item_data in _computed_fields or []:
            computed_fields_item = GroupSettingsDynamicGroupRuleSetType0ItemQueryParamsComputedFieldsItem.from_dict(
        ...
        if isinstance(_filter_, Unset):
            ...
            filter_ = (
                GroupSettingsDynamicGroupRuleSetType0ItemQueryParamsFilter.from_dict(
                    _filter_
                )
            )
        ...
        group_settings_dynamic_group_rule_set_type_0_item_query_params = cls(
        ...
        group_settings_dynamic_group_rule_set_type_0_item_query_params.additional_properties = d
        return group_settings_dynamic_group_rule_set_type_0_item_query_params
