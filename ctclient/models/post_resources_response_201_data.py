...
T = TypeVar("T", bound="PostResourcesResponse201Data")


@_attrs_define
class PostResourcesResponse201Data:
    """
    Attributes:
        id (int):  Example: 7.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_resources_response_201_data = cls(
            id=id,
        ...
        post_resources_response_201_data.additional_properties = d
        return post_resources_response_201_data
