...
T = TypeVar("T", bound="GetPersonMasterdataResponse200DataContactLabelsItem")


@_attrs_define
class GetPersonMasterdataResponse200DataContactLabelsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_person_masterdata_response_200_data_contact_labels_item = cls(
            id=id,
        ...
        get_person_masterdata_response_200_data_contact_labels_item.additional_properties = d
        return get_person_masterdata_response_200_data_contact_labels_item
