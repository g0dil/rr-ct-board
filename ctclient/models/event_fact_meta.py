...
if TYPE_CHECKING:
    from ..models.event_fact_meta_created_person import EventFactMetaCreatedPerson
    from ..models.event_fact_meta_modified_person import EventFactMetaModifiedPerson


T = TypeVar("T", bound="EventFactMeta")
...
class EventFactMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = EventFactMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = EventFactMetaModifiedPerson.from_dict(_modified_person)
        ...
        event_fact_meta.additional_properties = d
        return event_fact_meta
