...
if TYPE_CHECKING:
    from ..models.post_sync_externalsystems_external_system_id_jobconfigs_response_201_job_configuration_return_create_defaults_es import (
        PostSyncExternalsystemsExternalSystemIdJobconfigsResponse201JobConfigurationReturnCreateDefaultsES,
    )
    from ..models.post_sync_externalsystems_external_system_id_jobconfigs_response_201_job_configuration_return_create_defaults_master import (
        PostSyncExternalsystemsExternalSystemIdJobconfigsResponse201JobConfigurationReturnCreateDefaultsMaster,
    )
    from ..models.post_sync_externalsystems_external_system_id_jobconfigs_response_201_job_configuration_return_external_system import (
...
T = TypeVar(
    "T",
    bound="PostSyncExternalsystemsExternalSystemIdJobconfigsResponse201JobConfigurationReturn",
)


@_attrs_define
class PostSyncExternalsystemsExternalSystemIdJobconfigsResponse201JobConfigurationReturn:
    """
    Attributes:
        ...
        create_defaults_es
            (PostSyncExternalsystemsExternalSystemIdJobconfigsResponse201JobConfigurationReturnCreateDefaultsES | Unset):
        ...
        external_system
            (PostSyncExternalsystemsExternalSystemIdJobconfigsResponse201JobConfigurationReturnExternalSystem | Unset):
        id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_create_defaults_es, Unset):
            ...
            create_defaults_es = PostSyncExternalsystemsExternalSystemIdJobconfigsResponse201JobConfigurationReturnCreateDefaultsES.from_dict(
                _create_defaults_es
            )
        ...
        if isinstance(_create_defaults_master, Unset):
            ...
            create_defaults_master = PostSyncExternalsystemsExternalSystemIdJobconfigsResponse201JobConfigurationReturnCreateDefaultsMaster.from_dict(
        ...
        if isinstance(_external_system, Unset):
            ...
            external_system = PostSyncExternalsystemsExternalSystemIdJobconfigsResponse201JobConfigurationReturnExternalSystem.from_dict(
                _external_system
            )
        ...
        post_sync_externalsystems_external_system_id_jobconfigs_response_201_job_configuration_return = cls(
        ...
        post_sync_externalsystems_external_system_id_jobconfigs_response_201_job_configuration_return.additional_properties = d
        return post_sync_externalsystems_external_system_id_jobconfigs_response_201_job_configuration_return
