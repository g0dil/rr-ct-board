...
if TYPE_CHECKING:
    from ..models.get_followups_response_200_data_item_meta_created_person import (
        GetFollowupsResponse200DataItemMetaCreatedPerson,
    )
    from ..models.get_followups_response_200_data_item_meta_modified_person import (
        GetFollowupsResponse200DataItemMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetFollowupsResponse200DataItemMeta")


@_attrs_define
class GetFollowupsResponse200DataItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetFollowupsResponse200DataItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetFollowupsResponse200DataItemMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: GetFollowupsResponse200DataItemMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: GetFollowupsResponse200DataItemMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = GetFollowupsResponse200DataItemMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                GetFollowupsResponse200DataItemMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        get_followups_response_200_data_item_meta = cls(
        ...
        get_followups_response_200_data_item_meta.additional_properties = d
        return get_followups_response_200_data_item_meta
