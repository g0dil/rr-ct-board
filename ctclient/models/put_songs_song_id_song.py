...
T = TypeVar("T", bound="PutSongsSongIdSong")


@_attrs_define
class PutSongsSongIdSong:
    """Song information
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_songs_song_id_song.additional_properties = d
        return put_songs_song_id_song
