...
if TYPE_CHECKING:
    from ..models.patch_persons_personid_merge_duplicateid_body_person_email import (
        PatchPersonsPersonidMergeDuplicateidBodyPersonEmail,
    )
    from ..models.patch_persons_personid_merge_duplicateid_body_privacy_policy_agreement import (
        PatchPersonsPersonidMergeDuplicateidBodyPrivacyPolicyAgreement,
    )


T = TypeVar("T", bound="PatchPersonsPersonidMergeDuplicateidBody")


@_attrs_define
class PatchPersonsPersonidMergeDuplicateidBody:
    ...
    Attributes:
        ...
        email (str | Unset):
        emails (list[PatchPersonsPersonidMergeDuplicateidBodyPersonEmail] | Unset): Save many eMail addresses for
            person. If `emails` is present in request `email` is ignored.
        ...
        privacy_policy_agreement (PatchPersonsPersonidMergeDuplicateidBodyPrivacyPolicyAgreement | Unset): This object
            can be optional or required. Depending on your ChurchTools data security settings.
    ...
    emails: list[PatchPersonsPersonidMergeDuplicateidBodyPersonEmail] | Unset = UNSET
    ...
    privacy_policy_agreement: (
        PatchPersonsPersonidMergeDuplicateidBodyPrivacyPolicyAgreement | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = PatchPersonsPersonidMergeDuplicateidBodyPersonEmail.from_dict(
                emails_item_data
            )
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = PatchPersonsPersonidMergeDuplicateidBodyPrivacyPolicyAgreement.from_dict(
        ...
        patch_persons_personid_merge_duplicateid_body = cls(
        ...
        patch_persons_personid_merge_duplicateid_body.additional_properties = d
        return patch_persons_personid_merge_duplicateid_body
