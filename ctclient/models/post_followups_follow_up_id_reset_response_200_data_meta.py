...
if TYPE_CHECKING:
    from ..models.post_followups_follow_up_id_reset_response_200_data_meta_created_person import (
        PostFollowupsFollowUpIdResetResponse200DataMetaCreatedPerson,
    )
    from ..models.post_followups_follow_up_id_reset_response_200_data_meta_modified_person import (
        PostFollowupsFollowUpIdResetResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="PostFollowupsFollowUpIdResetResponse200DataMeta")


@_attrs_define
class PostFollowupsFollowUpIdResetResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (PostFollowupsFollowUpIdResetResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (PostFollowupsFollowUpIdResetResponse200DataMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        PostFollowupsFollowUpIdResetResponse200DataMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            PostFollowupsFollowUpIdResetResponse200DataMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                PostFollowupsFollowUpIdResetResponse200DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        post_followups_follow_up_id_reset_response_200_data_meta = cls(
        ...
        post_followups_follow_up_id_reset_response_200_data_meta.additional_properties = d
        return post_followups_follow_up_id_reset_response_200_data_meta
