...
T = TypeVar("T", bound="ExternalLoginCreate")


@_attrs_define
class ExternalLoginCreate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        external_login_create.additional_properties = d
        return external_login_create
