...
T = TypeVar("T", bound="UpdateTransactionPurposeBody")


@_attrs_define
class UpdateTransactionPurposeBody:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_transaction_purpose_body = cls(
        ...
        update_transaction_purpose_body.additional_properties = d
        return update_transaction_purpose_body
