...
from ..models.put_groups_group_id_places_place_id_response_200_data_marker_color_type_0 import (
    PutGroupsGroupIdPlacesPlaceIdResponse200DataMarkerColorType0,
)
from ..models.put_groups_group_id_places_place_id_response_200_data_marker_color_type_1 import (
    PutGroupsGroupIdPlacesPlaceIdResponse200DataMarkerColorType1,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.put_groups_group_id_places_place_id_response_200_data_meta import (
        PutGroupsGroupIdPlacesPlaceIdResponse200DataMeta,
    )


T = TypeVar("T", bound="PutGroupsGroupIdPlacesPlaceIdResponse200Data")


@_attrs_define
class PutGroupsGroupIdPlacesPlaceIdResponse200Data:
    """Place wehre e.g. a group meeting takes place

    Attributes:
        id (int):
        meta (PutGroupsGroupIdPlacesPlaceIdResponse200DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
        ...
        marker_color (PutGroupsGroupIdPlacesPlaceIdResponse200DataMarkerColorType0 |
            PutGroupsGroupIdPlacesPlaceIdResponse200DataMarkerColorType1 | Unset):
    ...
    id: int
    meta: PutGroupsGroupIdPlacesPlaceIdResponse200DataMeta
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = PutGroupsGroupIdPlacesPlaceIdResponse200DataMeta.from_dict(d.pop("meta"))
        ...
        def _parse_marker_color(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                marker_color_type_0 = (
                    PutGroupsGroupIdPlacesPlaceIdResponse200DataMarkerColorType0(data)
                )
            ...
            if not isinstance(data, str):
                raise TypeError()
            marker_color_type_1 = (
                PutGroupsGroupIdPlacesPlaceIdResponse200DataMarkerColorType1(data)
            )
        ...
        put_groups_group_id_places_place_id_response_200_data = cls(
            id=id,
            meta=meta,
            city=city,
            district=district,
        ...
        put_groups_group_id_places_place_id_response_200_data.additional_properties = d
        return put_groups_group_id_places_place_id_response_200_data
