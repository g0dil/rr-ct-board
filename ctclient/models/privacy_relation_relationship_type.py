...
T = TypeVar("T", bound="PrivacyRelationRelationshipType")


@_attrs_define
class PrivacyRelationRelationshipType:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        privacy_relation_relationship_type = cls(
        ...
        privacy_relation_relationship_type.additional_properties = d
        return privacy_relation_relationship_type
