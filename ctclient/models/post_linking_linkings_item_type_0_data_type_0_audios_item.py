...
T = TypeVar("T", bound="PostLinkingLinkingsItemType0DataType0AudiosItem")


@_attrs_define
class PostLinkingLinkingsItemType0DataType0AudiosItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_linking_linkings_item_type_0_data_type_0_audios_item = cls(
            secure_url=secure_url,
            type_=type_,
            url=url,
        )

        post_linking_linkings_item_type_0_data_type_0_audios_item.additional_properties = d
        return post_linking_linkings_item_type_0_data_type_0_audios_item
