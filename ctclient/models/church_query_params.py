...
if TYPE_CHECKING:
    from ..models.church_query_params_computed_fields_item import (
        ChurchQueryParamsComputedFieldsItem,
    )
    from ..models.church_query_params_filter import ChurchQueryParamsFilter


T = TypeVar("T", bound="ChurchQueryParams")


@_attrs_define
class ChurchQueryParams:
    """
    Attributes:
        computed_fields (list[ChurchQueryParamsComputedFieldsItem] | Unset):
        description (str | Unset):
        filter_ (ChurchQueryParamsFilter | Unset):
    ...
    computed_fields: list[ChurchQueryParamsComputedFieldsItem] | Unset = UNSET
    description: str | Unset = UNSET
    filter_: ChurchQueryParamsFilter | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for computed_fields_item_data in _computed_fields or []:
            computed_fields_item = ChurchQueryParamsComputedFieldsItem.from_dict(
        ...
        if isinstance(_filter_, Unset):
            ...
            filter_ = ChurchQueryParamsFilter.from_dict(_filter_)
        ...
        church_query_params.additional_properties = d
        return church_query_params
