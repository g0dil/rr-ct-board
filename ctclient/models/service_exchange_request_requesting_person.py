...
from ..models.service_exchange_request_requesting_person_invitation_status_type_0 import (
    ServiceExchangeRequestRequestingPersonInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.service_exchange_request_requesting_person_emails_item import (
        ServiceExchangeRequestRequestingPersonEmailsItem,
    )
    from ..models.service_exchange_request_requesting_person_meta import (
        ServiceExchangeRequestRequestingPersonMeta,
    )
    from ..models.service_exchange_request_requesting_person_privacy_policy_agreement import (
        ServiceExchangeRequestRequestingPersonPrivacyPolicyAgreement,
    )
    from ..models.service_exchange_request_requesting_person_tags_item import (
        ServiceExchangeRequestRequestingPersonTagsItem,
    )


T = TypeVar("T", bound="ServiceExchangeRequestRequestingPerson")


@_attrs_define
class ServiceExchangeRequestRequestingPerson:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[ServiceExchangeRequestRequestingPersonEmailsItem] | Unset):
            ...
            invitation_status (None | ServiceExchangeRequestRequestingPersonInvitationStatusType0 | Unset):
            ...
            meta (ServiceExchangeRequestRequestingPersonMeta | Unset):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            ...
            privacy_policy_agreement (ServiceExchangeRequestRequestingPersonPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[ServiceExchangeRequestRequestingPersonTagsItem] | Unset):
            title (str | Unset):
    ...
    emails: list[ServiceExchangeRequestRequestingPersonEmailsItem] | Unset = UNSET
    ...
    invitation_status: (
        None | ServiceExchangeRequestRequestingPersonInvitationStatusType0 | Unset
    ) = UNSET
    ...
    meta: ServiceExchangeRequestRequestingPersonMeta | Unset = UNSET
    ...
    privacy_policy_agreement: (
        ServiceExchangeRequestRequestingPersonPrivacyPolicyAgreement | Unset
    ) = UNSET
    ...
    tags: list[ServiceExchangeRequestRequestingPersonTagsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = ServiceExchangeRequestRequestingPersonEmailsItem.from_dict(
                emails_item_data
            )
        ...
        def _parse_invitation_status(
            ...
            try:
                ...
                invitation_status_type_0 = (
                    ServiceExchangeRequestRequestingPersonInvitationStatusType0(data)
                )
        ...
        meta: ServiceExchangeRequestRequestingPersonMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = ServiceExchangeRequestRequestingPersonMeta.from_dict(_meta)
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = (
                ServiceExchangeRequestRequestingPersonPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = ServiceExchangeRequestRequestingPersonTagsItem.from_dict(
                tags_item_data
            )
        ...
        service_exchange_request_requesting_person = cls(
        ...
        service_exchange_request_requesting_person.additional_properties = d
        return service_exchange_request_requesting_person
