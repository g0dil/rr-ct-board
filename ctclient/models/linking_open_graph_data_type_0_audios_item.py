...
T = TypeVar("T", bound="LinkingOpenGraphDataType0AudiosItem")


@_attrs_define
class LinkingOpenGraphDataType0AudiosItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linking_open_graph_data_type_0_audios_item = cls(
            secure_url=secure_url,
            type_=type_,
            url=url,
        )

        linking_open_graph_data_type_0_audios_item.additional_properties = d
        return linking_open_graph_data_type_0_audios_item
