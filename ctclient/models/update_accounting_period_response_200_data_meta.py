...
if TYPE_CHECKING:
    from ..models.update_accounting_period_response_200_data_meta_created_person import (
        UpdateAccountingPeriodResponse200DataMetaCreatedPerson,
    )
    from ..models.update_accounting_period_response_200_data_meta_modified_person import (
        UpdateAccountingPeriodResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="UpdateAccountingPeriodResponse200DataMeta")


@_attrs_define
class UpdateAccountingPeriodResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (UpdateAccountingPeriodResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (UpdateAccountingPeriodResponse200DataMetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            UpdateAccountingPeriodResponse200DataMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                UpdateAccountingPeriodResponse200DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        update_accounting_period_response_200_data_meta = cls(
        ...
        update_accounting_period_response_200_data_meta.additional_properties = d
        return update_accounting_period_response_200_data_meta
