...
from ..models.patch_person_response_200_data_invitation_status_type_0 import (
    PatchPersonResponse200DataInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.patch_person_response_200_data_emails_item import (
        PatchPersonResponse200DataEmailsItem,
    )
    from ..models.patch_person_response_200_data_meta import (
        PatchPersonResponse200DataMeta,
    )
    from ..models.patch_person_response_200_data_privacy_policy_agreement import (
        PatchPersonResponse200DataPrivacyPolicyAgreement,
    )
    from ..models.patch_person_response_200_data_tags_item import (
        PatchPersonResponse200DataTagsItem,
    )


T = TypeVar("T", bound="PatchPersonResponse200Data")


@_attrs_define
class PatchPersonResponse200Data:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[PatchPersonResponse200DataEmailsItem] | Unset):
            ...
            invitation_status (None | PatchPersonResponse200DataInvitationStatusType0 | Unset):
            ...
            meta (PatchPersonResponse200DataMeta | Unset):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            ...
            privacy_policy_agreement (PatchPersonResponse200DataPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[PatchPersonResponse200DataTagsItem] | Unset):
            title (str | Unset):
    ...
    emails: list[PatchPersonResponse200DataEmailsItem] | Unset = UNSET
    ...
    invitation_status: (
        None | PatchPersonResponse200DataInvitationStatusType0 | Unset
    ) = UNSET
    ...
    meta: PatchPersonResponse200DataMeta | Unset = UNSET
    ...
    privacy_policy_agreement: (
        PatchPersonResponse200DataPrivacyPolicyAgreement | Unset
    ) = UNSET
    ...
    tags: list[PatchPersonResponse200DataTagsItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.invitation_status, Unset):
            ...
            self.invitation_status, PatchPersonResponse200DataInvitationStatusType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = PatchPersonResponse200DataEmailsItem.from_dict(
                emails_item_data
            )
        ...
        def _parse_invitation_status(
            ...
            try:
                ...
                invitation_status_type_0 = (
                    PatchPersonResponse200DataInvitationStatusType0(data)
                )
                ...
                pass
            return cast(
                None | PatchPersonResponse200DataInvitationStatusType0 | Unset, data
            )
        ...
        meta: PatchPersonResponse200DataMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = PatchPersonResponse200DataMeta.from_dict(_meta)
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = (
                PatchPersonResponse200DataPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = PatchPersonResponse200DataTagsItem.from_dict(tags_item_data)
        ...
        patch_person_response_200_data = cls(
        ...
        patch_person_response_200_data.additional_properties = d
        return patch_person_response_200_data
