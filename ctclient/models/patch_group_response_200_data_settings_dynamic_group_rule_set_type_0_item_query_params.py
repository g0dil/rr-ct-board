...
if TYPE_CHECKING:
    from ..models.patch_group_response_200_data_settings_dynamic_group_rule_set_type_0_item_query_params_computed_fields_item import (
        PatchGroupResponse200DataSettingsDynamicGroupRuleSetType0ItemQueryParamsComputedFieldsItem,
    )
    from ..models.patch_group_response_200_data_settings_dynamic_group_rule_set_type_0_item_query_params_filter import (
...
T = TypeVar(
    "T",
    bound="PatchGroupResponse200DataSettingsDynamicGroupRuleSetType0ItemQueryParams",
)


@_attrs_define
class PatchGroupResponse200DataSettingsDynamicGroupRuleSetType0ItemQueryParams:
    """
    Attributes:
        computed_fields
            (list[PatchGroupResponse200DataSettingsDynamicGroupRuleSetType0ItemQueryParamsComputedFieldsItem] | Unset):
        description (str | Unset):
        filter_ (PatchGroupResponse200DataSettingsDynamicGroupRuleSetType0ItemQueryParamsFilter | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for computed_fields_item_data in _computed_fields or []:
            computed_fields_item = PatchGroupResponse200DataSettingsDynamicGroupRuleSetType0ItemQueryParamsComputedFieldsItem.from_dict(
        ...
        if isinstance(_filter_, Unset):
            ...
            filter_ = PatchGroupResponse200DataSettingsDynamicGroupRuleSetType0ItemQueryParamsFilter.from_dict(
                _filter_
            )
        ...
        patch_group_response_200_data_settings_dynamic_group_rule_set_type_0_item_query_params = cls(
        ...
        patch_group_response_200_data_settings_dynamic_group_rule_set_type_0_item_query_params.additional_properties = d
        return patch_group_response_200_data_settings_dynamic_group_rule_set_type_0_item_query_params
