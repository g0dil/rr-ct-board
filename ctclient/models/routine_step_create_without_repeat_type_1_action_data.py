...
from ..models.routine_step_create_without_repeat_type_1_action_data_color import (
    RoutineStepCreateWithoutRepeatType1ActionDataColor,
)
from ..models.routine_step_create_without_repeat_type_1_action_data_continuation_type import (
    RoutineStepCreateWithoutRepeatType1ActionDataContinuationType,
)
from ..models.routine_step_create_without_repeat_type_1_action_data_success_group_member_status_type_0 import (
    RoutineStepCreateWithoutRepeatType1ActionDataSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RoutineStepCreateWithoutRepeatType1ActionData")


@_attrs_define
class RoutineStepCreateWithoutRepeatType1ActionData:
    """
    Attributes:
        continuation_type (RoutineStepCreateWithoutRepeatType1ActionDataContinuationType):
        description (None | str):
        title (str):
        color (RoutineStepCreateWithoutRepeatType1ActionDataColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (None | RoutineStepCreateWithoutRepeatType1ActionDataSuccessGroupMemberStatusType0 |
            Unset):
    ...
    description: None | str
    title: str
    color: RoutineStepCreateWithoutRepeatType1ActionDataColor | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: RoutineStepCreateWithoutRepeatType1ActionDataColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = RoutineStepCreateWithoutRepeatType1ActionDataColor(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = RoutineStepCreateWithoutRepeatType1ActionDataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        routine_step_create_without_repeat_type_1_action_data = cls(
        ...
        routine_step_create_without_repeat_type_1_action_data.additional_properties = d
        return routine_step_create_without_repeat_type_1_action_data
