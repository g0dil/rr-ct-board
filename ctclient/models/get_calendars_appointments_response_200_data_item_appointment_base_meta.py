...
if TYPE_CHECKING:
    from ..models.get_calendars_appointments_response_200_data_item_appointment_base_meta_created_person import (
        GetCalendarsAppointmentsResponse200DataItemAppointmentBaseMetaCreatedPerson,
    )
    from ..models.get_calendars_appointments_response_200_data_item_appointment_base_meta_modified_person import (
        GetCalendarsAppointmentsResponse200DataItemAppointmentBaseMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetCalendarsAppointmentsResponse200DataItemAppointmentBaseMeta")


@_attrs_define
class GetCalendarsAppointmentsResponse200DataItemAppointmentBaseMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetCalendarsAppointmentsResponse200DataItemAppointmentBaseMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetCalendarsAppointmentsResponse200DataItemAppointmentBaseMetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = GetCalendarsAppointmentsResponse200DataItemAppointmentBaseMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GetCalendarsAppointmentsResponse200DataItemAppointmentBaseMetaModifiedPerson.from_dict(
                _modified_person
            )

        get_calendars_appointments_response_200_data_item_appointment_base_meta = cls(
        ...
        get_calendars_appointments_response_200_data_item_appointment_base_meta.additional_properties = d
        return get_calendars_appointments_response_200_data_item_appointment_base_meta
