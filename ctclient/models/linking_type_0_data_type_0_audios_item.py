...
T = TypeVar("T", bound="LinkingType0DataType0AudiosItem")


@_attrs_define
class LinkingType0DataType0AudiosItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linking_type_0_data_type_0_audios_item = cls(
            secure_url=secure_url,
            type_=type_,
            url=url,
        )

        linking_type_0_data_type_0_audios_item.additional_properties = d
        return linking_type_0_data_type_0_audios_item
