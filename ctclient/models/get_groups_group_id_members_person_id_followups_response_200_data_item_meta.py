...
if TYPE_CHECKING:
    from ..models.get_groups_group_id_members_person_id_followups_response_200_data_item_meta_created_person import (
        GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemMetaCreatedPerson,
    )
    from ..models.get_groups_group_id_members_person_id_followups_response_200_data_item_meta_modified_person import (
        GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemMetaModifiedPerson,
    )


T = TypeVar(
    "T", bound="GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemMeta"
)


@_attrs_define
class GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemMetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GetGroupsGroupIdMembersPersonIdFollowupsResponse200DataItemMetaModifiedPerson.from_dict(
                _modified_person
            )

        get_groups_group_id_members_person_id_followups_response_200_data_item_meta = (
            cls(
        ...
        get_groups_group_id_members_person_id_followups_response_200_data_item_meta.additional_properties = d
        return (
            get_groups_group_id_members_person_id_followups_response_200_data_item_meta
        )
