...
if TYPE_CHECKING:
    from ..models.get_dynamicgroup_ruleset_response_200_data_query_params_computed_fields_item import (
        GetDynamicgroupRulesetResponse200DataQueryParamsComputedFieldsItem,
    )
    from ..models.get_dynamicgroup_ruleset_response_200_data_query_params_filter import (
        GetDynamicgroupRulesetResponse200DataQueryParamsFilter,
    )


T = TypeVar("T", bound="GetDynamicgroupRulesetResponse200DataQueryParams")


@_attrs_define
class GetDynamicgroupRulesetResponse200DataQueryParams:
    """
    Attributes:
        computed_fields (list[GetDynamicgroupRulesetResponse200DataQueryParamsComputedFieldsItem] | Unset):
        description (str | Unset):
        filter_ (GetDynamicgroupRulesetResponse200DataQueryParamsFilter | Unset):
    ...
    computed_fields: (
        list[GetDynamicgroupRulesetResponse200DataQueryParamsComputedFieldsItem] | Unset
    ) = UNSET
    description: str | Unset = UNSET
    filter_: GetDynamicgroupRulesetResponse200DataQueryParamsFilter | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for computed_fields_item_data in _computed_fields or []:
            computed_fields_item = GetDynamicgroupRulesetResponse200DataQueryParamsComputedFieldsItem.from_dict(
        ...
        if isinstance(_filter_, Unset):
            ...
            filter_ = GetDynamicgroupRulesetResponse200DataQueryParamsFilter.from_dict(
                _filter_
            )
        ...
        get_dynamicgroup_ruleset_response_200_data_query_params = cls(
        ...
        get_dynamicgroup_ruleset_response_200_data_query_params.additional_properties = d
        return get_dynamicgroup_ruleset_response_200_data_query_params
