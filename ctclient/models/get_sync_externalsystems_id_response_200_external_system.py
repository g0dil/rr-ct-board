...
T = TypeVar("T", bound="GetSyncExternalsystemsIdResponse200ExternalSystem")


@_attrs_define
class GetSyncExternalsystemsIdResponse200ExternalSystem:
    """
    Attributes:
        adapter (str | Unset):
        id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_sync_externalsystems_id_response_200_external_system = cls(
            adapter=adapter,
            id=id,
        ...
        get_sync_externalsystems_id_response_200_external_system.additional_properties = d
        return get_sync_externalsystems_id_response_200_external_system
