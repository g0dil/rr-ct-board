...
T = TypeVar(
    "T", bound="GetGroupsGroupIdMembersPersonIdFollowupsStatisticsResponse200Data"
)


@_attrs_define
class GetGroupsGroupIdMembersPersonIdFollowupsStatisticsResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_groups_group_id_members_person_id_followups_statistics_response_200_data = (
            cls(
        ...
        get_groups_group_id_members_person_id_followups_statistics_response_200_data.additional_properties = d
        return (
            get_groups_group_id_members_person_id_followups_statistics_response_200_data
        )
