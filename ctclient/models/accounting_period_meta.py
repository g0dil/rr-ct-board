...
if TYPE_CHECKING:
    from ..models.accounting_period_meta_created_person import (
        AccountingPeriodMetaCreatedPerson,
    )
    from ..models.accounting_period_meta_modified_person import (
        AccountingPeriodMetaModifiedPerson,
    )


T = TypeVar("T", bound="AccountingPeriodMeta")


@_attrs_define
class AccountingPeriodMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (AccountingPeriodMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (AccountingPeriodMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: AccountingPeriodMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: AccountingPeriodMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = AccountingPeriodMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = AccountingPeriodMetaModifiedPerson.from_dict(
                _modified_person
            )

        accounting_period_meta = cls(
        ...
        accounting_period_meta.additional_properties = d
        return accounting_period_meta
