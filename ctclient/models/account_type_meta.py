...
if TYPE_CHECKING:
    from ..models.account_type_meta_created_person import AccountTypeMetaCreatedPerson
    from ..models.account_type_meta_modified_person import AccountTypeMetaModifiedPerson


T = TypeVar("T", bound="AccountTypeMeta")
...
class AccountTypeMeta:
    ...
    Attributes:
        ...
        created_person (AccountTypeMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (AccountTypeMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: AccountTypeMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: AccountTypeMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.account_type_meta_created_person import (
            AccountTypeMetaCreatedPerson,
        )
        from ..models.account_type_meta_modified_person import (
        ...
        created_person = AccountTypeMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = AccountTypeMetaModifiedPerson.from_dict(_modified_person)

        account_type_meta = cls(
        ...
        account_type_meta.additional_properties = d
        return account_type_meta
