...
if TYPE_CHECKING:
    from ..models.create_new_account_class_response_200_data_item_meta import (
        CreateNewAccountClassResponse200DataItemMeta,
    )


T = TypeVar("T", bound="CreateNewAccountClassResponse200DataItem")


@_attrs_define
class CreateNewAccountClassResponse200DataItem:
    """
    Attributes:
        ...
        include_profit_loss (bool): If true, an additional row is added to that class in the report, which lists the
            profit-loss sum.
        meta (CreateNewAccountClassResponse200DataItemMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
    ...
    meta: CreateNewAccountClassResponse200DataItemMeta
    name: str
    sort_key: int = 0
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = CreateNewAccountClassResponse200DataItemMeta.from_dict(d.pop("meta"))

        name = d.pop("name")

        sort_key = d.pop("sortKey")

        create_new_account_class_response_200_data_item = cls(
        ...
        create_new_account_class_response_200_data_item.additional_properties = d
        return create_new_account_class_response_200_data_item
