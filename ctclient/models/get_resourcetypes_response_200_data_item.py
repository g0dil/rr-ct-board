...
T = TypeVar("T", bound="GetResourcetypesResponse200DataItem")


@_attrs_define
class GetResourcetypesResponse200DataItem:
    """
    Attributes:
        id (int):  Example: 3.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_resourcetypes_response_200_data_item = cls(
            id=id,
        ...
        get_resourcetypes_response_200_data_item.additional_properties = d
        return get_resourcetypes_response_200_data_item
