...
if TYPE_CHECKING:
    from ..models.get_events_event_id_facts_fact_id_response_200_event_fact_meta_created_person import (
        GetEventsEventIdFactsFactIdResponse200EventFactMetaCreatedPerson,
    )
    from ..models.get_events_event_id_facts_fact_id_response_200_event_fact_meta_modified_person import (
        GetEventsEventIdFactsFactIdResponse200EventFactMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetEventsEventIdFactsFactIdResponse200EventFactMeta")


@_attrs_define
class GetEventsEventIdFactsFactIdResponse200EventFactMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetEventsEventIdFactsFactIdResponse200EventFactMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetEventsEventIdFactsFactIdResponse200EventFactMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        GetEventsEventIdFactsFactIdResponse200EventFactMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            GetEventsEventIdFactsFactIdResponse200EventFactMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GetEventsEventIdFactsFactIdResponse200EventFactMetaModifiedPerson.from_dict(
                _modified_person
            )

        get_events_event_id_facts_fact_id_response_200_event_fact_meta = cls(
        ...
        get_events_event_id_facts_fact_id_response_200_event_fact_meta.additional_properties = d
        return get_events_event_id_facts_fact_id_response_200_event_fact_meta
