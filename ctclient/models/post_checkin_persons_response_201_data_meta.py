...
if TYPE_CHECKING:
    from ..models.post_checkin_persons_response_201_data_meta_created_person import (
        PostCheckinPersonsResponse201DataMetaCreatedPerson,
    )
    from ..models.post_checkin_persons_response_201_data_meta_modified_person import (
        PostCheckinPersonsResponse201DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="PostCheckinPersonsResponse201DataMeta")


@_attrs_define
class PostCheckinPersonsResponse201DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (PostCheckinPersonsResponse201DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (PostCheckinPersonsResponse201DataMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: PostCheckinPersonsResponse201DataMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: PostCheckinPersonsResponse201DataMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = PostCheckinPersonsResponse201DataMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                PostCheckinPersonsResponse201DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        post_checkin_persons_response_201_data_meta = cls(
        ...
        post_checkin_persons_response_201_data_meta.additional_properties = d
        return post_checkin_persons_response_201_data_meta
