...
T = TypeVar("T", bound="ResourceMasterDataResourceTypesItem")


@_attrs_define
class ResourceMasterDataResourceTypesItem:
    """
    Attributes:
        id (int):  Example: 3.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_master_data_resource_types_item = cls(
            id=id,
        ...
        resource_master_data_resource_types_item.additional_properties = d
        return resource_master_data_resource_types_item
