...
if TYPE_CHECKING:
    from ..models.calculate_booking_conflicts_body_additionals_type_0_item import (
        CalculateBookingConflictsBodyAdditionalsType0Item,
    )
    from ..models.calculate_booking_conflicts_body_exceptions_type_0_item import (
        CalculateBookingConflictsBodyExceptionsType0Item,
    )


T = TypeVar("T", bound="CalculateBookingConflictsBody")


@_attrs_define
class CalculateBookingConflictsBody:
    """
    Attributes:
        end_date (datetime.date | datetime.datetime):
        resource_id (int):
        start_date (datetime.date | datetime.datetime):
        additionals (list[CalculateBookingConflictsBodyAdditionalsType0Item] | None | Unset):
        exceptions (list[CalculateBookingConflictsBodyExceptionsType0Item] | None | Unset):
    ...
    start_date: datetime.date | datetime.datetime
    additionals: (
        list[CalculateBookingConflictsBodyAdditionalsType0Item] | None | Unset
    ) = UNSET
    exceptions: (
        list[CalculateBookingConflictsBodyExceptionsType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
            ...
            try:
                ...
                for additionals_type_0_item_data in _additionals_type_0:
                    additionals_type_0_item = (
                        CalculateBookingConflictsBodyAdditionalsType0Item.from_dict(
            ...
            try:
                ...
                for exceptions_type_0_item_data in _exceptions_type_0:
                    exceptions_type_0_item = (
                        CalculateBookingConflictsBodyExceptionsType0Item.from_dict(
        ...
        calculate_booking_conflicts_body = cls(
            end_date=end_date,
        ...
        calculate_booking_conflicts_body.additional_properties = d
        return calculate_booking_conflicts_body
