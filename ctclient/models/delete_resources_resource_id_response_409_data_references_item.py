...
T = TypeVar("T", bound="DeleteResourcesResourceIdResponse409DataReferencesItem")


@_attrs_define
class DeleteResourcesResourceIdResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_resources_resource_id_response_409_data_references_item = cls(
        ...
        delete_resources_resource_id_response_409_data_references_item.additional_properties = d
        return delete_resources_resource_id_response_409_data_references_item
