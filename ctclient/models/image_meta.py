...
if TYPE_CHECKING:
    from ..models.image_meta_created_person import ImageMetaCreatedPerson
    from ..models.image_meta_modified_person import ImageMetaModifiedPerson


T = TypeVar("T", bound="ImageMeta")
...
class ImageMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = ImageMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = ImageMetaModifiedPerson.from_dict(_modified_person)
        ...
        image_meta.additional_properties = d
        return image_meta
