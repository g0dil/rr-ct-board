...
if TYPE_CHECKING:
    from ..models.get_registrationconfig_id_response_200_data_campuses_item import (
        GetRegistrationconfigIdResponse200DataCampusesItem,
    )
    from ..models.get_registrationconfig_id_response_200_data_fields_item import (
        GetRegistrationconfigIdResponse200DataFieldsItem,
    )
    from ..models.get_registrationconfig_id_response_200_data_meta import (
        GetRegistrationconfigIdResponse200DataMeta,
    )


T = TypeVar("T", bound="GetRegistrationconfigIdResponse200Data")


@_attrs_define
class GetRegistrationconfigIdResponse200Data:
    """
    Attributes:
        blacklist (list[str]):
        campuses (list[GetRegistrationconfigIdResponse200DataCampusesItem]):
        department_ids (list[int]):
        fields (list[GetRegistrationconfigIdResponse200DataFieldsItem]):
        guid (str):
        id (int):
        is_active (bool):
        ...
        meta (GetRegistrationconfigIdResponse200DataMeta | Unset):  Example: {'createdDate': '2020-01-01T00:00:00Z',
    ...
    tags_for_existing_persons: list[str]
    tags_for_new_persons: list[str]
    meta: GetRegistrationconfigIdResponse200DataMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for campuses_item_data in _campuses:
            campuses_item = (
                GetRegistrationconfigIdResponse200DataCampusesItem.from_dict(
                    campuses_item_data
                )
            )
        ...
        for fields_item_data in _fields:
            fields_item = GetRegistrationconfigIdResponse200DataFieldsItem.from_dict(
                fields_item_data
            )
        ...
        meta: GetRegistrationconfigIdResponse200DataMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = GetRegistrationconfigIdResponse200DataMeta.from_dict(_meta)

        get_registrationconfig_id_response_200_data = cls(
            blacklist=blacklist,
            campuses=campuses,
        ...
        get_registrationconfig_id_response_200_data.additional_properties = d
        return get_registrationconfig_id_response_200_data
