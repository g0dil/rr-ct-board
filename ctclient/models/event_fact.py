...
if TYPE_CHECKING:
    from ..models.event_fact_meta import EventFactMeta


T = TypeVar("T", bound="EventFact")
...
class EventFact:
    ...
    Attributes:
        event_id (int):
        fact_id (int):
        meta (EventFactMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson': {'id': 1},
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = EventFactMeta.from_dict(d.pop("meta"))
        ...
        event_fact.additional_properties = d
        return event_fact
