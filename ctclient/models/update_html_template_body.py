...
T = TypeVar("T", bound="UpdateHtmlTemplateBody")


@_attrs_define
class UpdateHtmlTemplateBody:
    """
    Attributes:
        html (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_html_template_body.additional_properties = d
        return update_html_template_body
