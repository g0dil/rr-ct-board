...
T = TypeVar("T", bound="PatchGroupResponse200DataPlacesItem")


@_attrs_define
class PatchGroupResponse200DataPlacesItem:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_group_response_200_data_places_item = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        patch_group_response_200_data_places_item.additional_properties = d
        return patch_group_response_200_data_places_item
