...
T = TypeVar("T", bound="StartStopGroupChatBody")


@_attrs_define
class StartStopGroupChatBody:
    """
    Attributes:
        enabled (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        start_stop_group_chat_body = cls(
            enabled=enabled,
            trigger_chat_invite_mail=trigger_chat_invite_mail,
        )

        start_stop_group_chat_body.additional_properties = d
        return start_stop_group_chat_body
