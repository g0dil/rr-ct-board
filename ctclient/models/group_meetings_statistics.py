...
T = TypeVar("T", bound="GroupMeetingsStatistics")


@_attrs_define
class GroupMeetingsStatistics:
    """
    Attributes:
        canceled (float):
        completed (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group_meetings_statistics.additional_properties = d
        return group_meetings_statistics
