...
T = TypeVar("T", bound="ProfileUpdateSocialMedia")


@_attrs_define
class ProfileUpdateSocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        profile_update_social_media = cls(
            social_network_name=social_network_name,
        )

        profile_update_social_media.additional_properties = d
        return profile_update_social_media
