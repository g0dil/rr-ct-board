...
if TYPE_CHECKING:
    from ..models.get_whoami_response_200_data_meta_created_person import (
        GetWhoamiResponse200DataMetaCreatedPerson,
    )
    from ..models.get_whoami_response_200_data_meta_modified_person import (
        GetWhoamiResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetWhoamiResponse200DataMeta")


@_attrs_define
class GetWhoamiResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetWhoamiResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetWhoamiResponse200DataMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: GetWhoamiResponse200DataMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: GetWhoamiResponse200DataMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = GetWhoamiResponse200DataMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GetWhoamiResponse200DataMetaModifiedPerson.from_dict(
                _modified_person
            )

        get_whoami_response_200_data_meta = cls(
        ...
        get_whoami_response_200_data_meta.additional_properties = d
        return get_whoami_response_200_data_meta
