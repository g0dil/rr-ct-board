...
T = TypeVar(
    "T", bound="GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAddress"
)


@_attrs_define
class GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_calendars_appointments_response_200_data_item_appointment_base_address = (
            cls(
                geo_lat=geo_lat,
                geo_lng=geo_lng,
        ...
        get_calendars_appointments_response_200_data_item_appointment_base_address.additional_properties = d
        return (
            get_calendars_appointments_response_200_data_item_appointment_base_address
        )
