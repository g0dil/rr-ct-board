...
from ..models.get_groups_group_id_memberfields_response_200_data_item_type_1_field_field_type_code import (
    GetGroupsGroupIdMemberfieldsResponse200DataItemType1FieldFieldTypeCode,
)

if TYPE_CHECKING:
    from ..models.get_groups_group_id_memberfields_response_200_data_item_type_1_field_options_item import (
        GetGroupsGroupIdMemberfieldsResponse200DataItemType1FieldOptionsItem,
    )


T = TypeVar("T", bound="GetGroupsGroupIdMemberfieldsResponse200DataItemType1Field")


@_attrs_define
class GetGroupsGroupIdMemberfieldsResponse200DataItemType1Field:
    """
    Attributes:
        default_value (str):
        field_name (str):
        field_type_code (GetGroupsGroupIdMemberfieldsResponse200DataItemType1FieldFieldTypeCode): The intern code of the
            field type the field belongs to. This is used to define the type of the field.
        field_type_id (int):
        max_length (int):
        name (str):
        ...
        options (list[GetGroupsGroupIdMemberfieldsResponse200DataItemType1FieldOptionsItem]):
        reference_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for options_item_data in _options:
            options_item = GetGroupsGroupIdMemberfieldsResponse200DataItemType1FieldOptionsItem.from_dict(
                options_item_data
            )
        ...
        get_groups_group_id_memberfields_response_200_data_item_type_1_field = cls(
        ...
        get_groups_group_id_memberfields_response_200_data_item_type_1_field.additional_properties = d
        return get_groups_group_id_memberfields_response_200_data_item_type_1_field
