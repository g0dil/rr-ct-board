...
T = TypeVar("T", bound="GetGroupsGroupIdResponse200DataPublicPostsStatistic")


@_attrs_define
class GetGroupsGroupIdResponse200DataPublicPostsStatistic:
    """
    Attributes:
        count (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_groups_group_id_response_200_data_public_posts_statistic = cls(
            count=count,
            last_post_date=last_post_date,
        )

        get_groups_group_id_response_200_data_public_posts_statistic.additional_properties = d
        return get_groups_group_id_response_200_data_public_posts_statistic
