...
T = TypeVar("T", bound="PostGroupsResponse201DataPublicPostsStatistic")


@_attrs_define
class PostGroupsResponse201DataPublicPostsStatistic:
    """
    Attributes:
        count (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_groups_response_201_data_public_posts_statistic = cls(
            count=count,
            last_post_date=last_post_date,
        )

        post_groups_response_201_data_public_posts_statistic.additional_properties = d
        return post_groups_response_201_data_public_posts_statistic
