...
if TYPE_CHECKING:
    from ..models.get_calendars_response_200_data_item_meta import (
        GetCalendarsResponse200DataItemMeta,
    )


T = TypeVar("T", bound="GetCalendarsResponse200DataItem")


@_attrs_define
class GetCalendarsResponse200DataItem:
    """
    Attributes:
        id (int):
        meta (GetCalendarsResponse200DataItemMeta):
        name_translated (str):
        random_url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = GetCalendarsResponse200DataItemMeta.from_dict(d.pop("meta"))
        ...
        get_calendars_response_200_data_item = cls(
            id=id,
            meta=meta,
        ...
        get_calendars_response_200_data_item.additional_properties = d
        return get_calendars_response_200_data_item
