...
T = TypeVar("T", bound="CreateNewAccountClassBody")


@_attrs_define
class CreateNewAccountClassBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_new_account_class_body = cls(
        ...
        create_new_account_class_body.additional_properties = d
        return create_new_account_class_body
