...
if TYPE_CHECKING:
    from ..models.get_post_linkings_response_200_data_item_type_0_data_type_0_videos_item_actors_item import (
        GetPostLinkingsResponse200DataItemType0DataType0VideosItemActorsItem,
    )


T = TypeVar("T", bound="GetPostLinkingsResponse200DataItemType0DataType0VideosItem")


@_attrs_define
class GetPostLinkingsResponse200DataItemType0DataType0VideosItem:
    """
    Example:
    ...
    Attributes:
        actors (list[GetPostLinkingsResponse200DataItemType0DataType0VideosItemActorsItem] | Unset):
    ...
    actors: (
        list[GetPostLinkingsResponse200DataItemType0DataType0VideosItemActorsItem]
        | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for actors_item_data in _actors or []:
            actors_item = GetPostLinkingsResponse200DataItemType0DataType0VideosItemActorsItem.from_dict(
                actors_item_data
            )
        ...
        get_post_linkings_response_200_data_item_type_0_data_type_0_videos_item = cls(
            actors=actors,
            directors=directors,
            duration=duration,
            height=height,
        ...
        get_post_linkings_response_200_data_item_type_0_data_type_0_videos_item.additional_properties = d
        return get_post_linkings_response_200_data_item_type_0_data_type_0_videos_item
