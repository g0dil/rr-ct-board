...
T = TypeVar("T", bound="GroupPostStatistics")


@_attrs_define
class GroupPostStatistics:
    """
    Attributes:
        group_intern (float):
        group_visible (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group_post_statistics = cls(
            group_intern=group_intern,
            group_visible=group_visible,
        )

        group_post_statistics.additional_properties = d
        return group_post_statistics
