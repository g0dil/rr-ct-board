...
if TYPE_CHECKING:
    from ..models.get_all_tax_types_response_200_data_item_meta_created_person import (
        GetAllTaxTypesResponse200DataItemMetaCreatedPerson,
    )
    from ..models.get_all_tax_types_response_200_data_item_meta_modified_person import (
        GetAllTaxTypesResponse200DataItemMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetAllTaxTypesResponse200DataItemMeta")


@_attrs_define
class GetAllTaxTypesResponse200DataItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetAllTaxTypesResponse200DataItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetAllTaxTypesResponse200DataItemMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: GetAllTaxTypesResponse200DataItemMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: GetAllTaxTypesResponse200DataItemMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = GetAllTaxTypesResponse200DataItemMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                GetAllTaxTypesResponse200DataItemMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        get_all_tax_types_response_200_data_item_meta = cls(
        ...
        get_all_tax_types_response_200_data_item_meta.additional_properties = d
        return get_all_tax_types_response_200_data_item_meta
