...
T = TypeVar("T", bound="GetResourceMasterdataResponse200DataResourcesItem")


@_attrs_define
class GetResourceMasterdataResponse200DataResourcesItem:
    """
    Attributes:
        id (int):  Example: 7.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_resource_masterdata_response_200_data_resources_item = cls(
            id=id,
        ...
        get_resource_masterdata_response_200_data_resources_item.additional_properties = d
        return get_resource_masterdata_response_200_data_resources_item
