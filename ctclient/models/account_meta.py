...
if TYPE_CHECKING:
    from ..models.account_meta_created_person import AccountMetaCreatedPerson
    from ..models.account_meta_modified_person import AccountMetaModifiedPerson
...
class AccountMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = AccountMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = AccountMetaModifiedPerson.from_dict(_modified_person)
