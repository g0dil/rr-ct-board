...
if TYPE_CHECKING:
    from ..models.search_result_domain_attributes import SearchResultDomainAttributes
...
class SearchResult:
    ...
    Attributes:
        ...
        domain_attributes (SearchResultDomainAttributes | Unset):
    ...
    domain_attributes: SearchResultDomainAttributes | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.search_result_domain_attributes import (
        ...
        if isinstance(_domain_attributes, Unset):
            ...
            domain_attributes = SearchResultDomainAttributes.from_dict(
                _domain_attributes
            )
