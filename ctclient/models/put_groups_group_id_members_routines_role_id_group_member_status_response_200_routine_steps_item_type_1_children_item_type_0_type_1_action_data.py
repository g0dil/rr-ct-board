...
from ..models.put_groups_group_id_members_routines_role_id_group_member_status_response_200_routine_steps_item_type_1_children_item_type_0_type_1_action_data_color import (
...
from ..models.put_groups_group_id_members_routines_role_id_group_member_status_response_200_routine_steps_item_type_1_children_item_type_0_type_1_action_data_continuation_type import (
...
from ..models.put_groups_group_id_members_routines_role_id_group_member_status_response_200_routine_steps_item_type_1_children_item_type_0_type_1_action_data_success_group_member_status_type_0 import (
...
T = TypeVar(
    "T",
    bound="PutGroupsGroupIdMembersRoutinesRoleIdGroupMemberStatusResponse200RoutineStepsItemType1ChildrenItemType0Type1ActionData",
)


@_attrs_define
class PutGroupsGroupIdMembersRoutinesRoleIdGroupMemberStatusResponse200RoutineStepsItemType1ChildrenItemType0Type1ActionData:
    """
    Attributes:
        continuation_type (PutGroupsGroupIdMembersRoutinesRoleIdGroupMemberStatusResponse200RoutineStepsItemType1Childre
            nItemType0Type1ActionDataContinuationType):
        description (None | str):
        title (str):
        color (PutGroupsGroupIdMembersRoutinesRoleIdGroupMemberStatusResponse200RoutineStepsItemType1ChildrenItemType0Ty
            pe1ActionDataColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (None | PutGroupsGroupIdMembersRoutinesRoleIdGroupMemberStatusResponse200RoutineStep
            sItemType1ChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0 | Unset):
        success_group_of_group_type_id (int | None | Unset):
        success_role_id (int | None | Unset):
    """

    continuation_type: PutGroupsGroupIdMembersRoutinesRoleIdGroupMemberStatusResponse200RoutineStepsItemType1ChildrenItemType0Type1ActionDataContinuationType
    description: None | str
    title: str
    color: (
        PutGroupsGroupIdMembersRoutinesRoleIdGroupMemberStatusResponse200RoutineStepsItemType1ChildrenItemType0Type1ActionDataColor
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_color, Unset):
            ...
            color = PutGroupsGroupIdMembersRoutinesRoleIdGroupMemberStatusResponse200RoutineStepsItemType1ChildrenItemType0Type1ActionDataColor(
                _color
            )
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = PutGroupsGroupIdMembersRoutinesRoleIdGroupMemberStatusResponse200RoutineStepsItemType1ChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        put_groups_group_id_members_routines_role_id_group_member_status_response_200_routine_steps_item_type_1_children_item_type_0_type_1_action_data = cls(
        ...
        put_groups_group_id_members_routines_role_id_group_member_status_response_200_routine_steps_item_type_1_children_item_type_0_type_1_action_data.additional_properties = d
        return put_groups_group_id_members_routines_role_id_group_member_status_response_200_routine_steps_item_type_1_children_item_type_0_type_1_action_data
