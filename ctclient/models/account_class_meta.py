...
if TYPE_CHECKING:
    from ..models.account_class_meta_created_person import AccountClassMetaCreatedPerson
    from ..models.account_class_meta_modified_person import (
        AccountClassMetaModifiedPerson,
    )


T = TypeVar("T", bound="AccountClassMeta")


@_attrs_define
class AccountClassMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (AccountClassMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (AccountClassMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: AccountClassMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: AccountClassMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.account_class_meta_created_person import (
        ...
        created_person = AccountClassMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = AccountClassMetaModifiedPerson.from_dict(_modified_person)

        account_class_meta = cls(
        ...
        account_class_meta.additional_properties = d
        return account_class_meta
