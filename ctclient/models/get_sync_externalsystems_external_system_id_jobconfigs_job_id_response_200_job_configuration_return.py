...
if TYPE_CHECKING:
    from ..models.get_sync_externalsystems_external_system_id_jobconfigs_job_id_response_200_job_configuration_return_create_defaults_es import (
        GetSyncExternalsystemsExternalSystemIdJobconfigsJobIdResponse200JobConfigurationReturnCreateDefaultsES,
    )
    from ..models.get_sync_externalsystems_external_system_id_jobconfigs_job_id_response_200_job_configuration_return_create_defaults_master import (
        GetSyncExternalsystemsExternalSystemIdJobconfigsJobIdResponse200JobConfigurationReturnCreateDefaultsMaster,
    )
    from ..models.get_sync_externalsystems_external_system_id_jobconfigs_job_id_response_200_job_configuration_return_external_system import (
...
T = TypeVar(
    "T",
    bound="GetSyncExternalsystemsExternalSystemIdJobconfigsJobIdResponse200JobConfigurationReturn",
)


@_attrs_define
class GetSyncExternalsystemsExternalSystemIdJobconfigsJobIdResponse200JobConfigurationReturn:
    """
    Attributes:
        ...
        external_system
            (GetSyncExternalsystemsExternalSystemIdJobconfigsJobIdResponse200JobConfigurationReturnExternalSystem | Unset):
        id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_create_defaults_es, Unset):
            ...
            create_defaults_es = GetSyncExternalsystemsExternalSystemIdJobconfigsJobIdResponse200JobConfigurationReturnCreateDefaultsES.from_dict(
                _create_defaults_es
            )
        ...
        if isinstance(_create_defaults_master, Unset):
            ...
            create_defaults_master = GetSyncExternalsystemsExternalSystemIdJobconfigsJobIdResponse200JobConfigurationReturnCreateDefaultsMaster.from_dict(
        ...
        if isinstance(_external_system, Unset):
            ...
            external_system = GetSyncExternalsystemsExternalSystemIdJobconfigsJobIdResponse200JobConfigurationReturnExternalSystem.from_dict(
                _external_system
            )
        ...
        get_sync_externalsystems_external_system_id_jobconfigs_job_id_response_200_job_configuration_return = cls(
        ...
        get_sync_externalsystems_external_system_id_jobconfigs_job_id_response_200_job_configuration_return.additional_properties = d
        return get_sync_externalsystems_external_system_id_jobconfigs_job_id_response_200_job_configuration_return
