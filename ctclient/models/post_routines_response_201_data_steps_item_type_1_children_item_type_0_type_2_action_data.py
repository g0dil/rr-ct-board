...
T = TypeVar(
    "T",
    bound="PostRoutinesResponse201DataStepsItemType1ChildrenItemType0Type2ActionData",
)


@_attrs_define
class PostRoutinesResponse201DataStepsItemType1ChildrenItemType0Type2ActionData:
    """
    Attributes:
        group_id (int):
        comment (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_routines_response_201_data_steps_item_type_1_children_item_type_0_type_2_action_data = cls(
            group_id=group_id,
            comment=comment,
        ...
        post_routines_response_201_data_steps_item_type_1_children_item_type_0_type_2_action_data.additional_properties = d
        return post_routines_response_201_data_steps_item_type_1_children_item_type_0_type_2_action_data
