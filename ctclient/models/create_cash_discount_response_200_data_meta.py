...
if TYPE_CHECKING:
    from ..models.create_cash_discount_response_200_data_meta_created_person import (
        CreateCashDiscountResponse200DataMetaCreatedPerson,
    )
    from ..models.create_cash_discount_response_200_data_meta_modified_person import (
        CreateCashDiscountResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="CreateCashDiscountResponse200DataMeta")


@_attrs_define
class CreateCashDiscountResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (CreateCashDiscountResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (CreateCashDiscountResponse200DataMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: CreateCashDiscountResponse200DataMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: CreateCashDiscountResponse200DataMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = CreateCashDiscountResponse200DataMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                CreateCashDiscountResponse200DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        create_cash_discount_response_200_data_meta = cls(
        ...
        create_cash_discount_response_200_data_meta.additional_properties = d
        return create_cash_discount_response_200_data_meta
