...
T = TypeVar("T", bound="GetGroupsGroupIdResponse200DataPlacesItem")


@_attrs_define
class GetGroupsGroupIdResponse200DataPlacesItem:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_groups_group_id_response_200_data_places_item = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        get_groups_group_id_response_200_data_places_item.additional_properties = d
        return get_groups_group_id_response_200_data_places_item
