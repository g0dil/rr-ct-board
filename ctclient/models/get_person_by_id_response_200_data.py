...
from ..models.get_person_by_id_response_200_data_invitation_status_type_0 import (
    GetPersonByIdResponse200DataInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_person_by_id_response_200_data_emails_item import (
        GetPersonByIdResponse200DataEmailsItem,
    )
    from ..models.get_person_by_id_response_200_data_meta import (
        GetPersonByIdResponse200DataMeta,
    )
    from ..models.get_person_by_id_response_200_data_privacy_policy_agreement import (
        GetPersonByIdResponse200DataPrivacyPolicyAgreement,
    )
    from ..models.get_person_by_id_response_200_data_tags_item import (
        GetPersonByIdResponse200DataTagsItem,
    )


T = TypeVar("T", bound="GetPersonByIdResponse200Data")


@_attrs_define
class GetPersonByIdResponse200Data:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[GetPersonByIdResponse200DataEmailsItem] | Unset):
            ...
            invitation_status (GetPersonByIdResponse200DataInvitationStatusType0 | None | Unset):
            ...
            meta (GetPersonByIdResponse200DataMeta | Unset):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            ...
            privacy_policy_agreement (GetPersonByIdResponse200DataPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[GetPersonByIdResponse200DataTagsItem] | Unset):
            title (str | Unset):
    ...
    emails: list[GetPersonByIdResponse200DataEmailsItem] | Unset = UNSET
    ...
    invitation_status: (
        GetPersonByIdResponse200DataInvitationStatusType0 | None | Unset
    ) = UNSET
    ...
    meta: GetPersonByIdResponse200DataMeta | Unset = UNSET
    ...
    privacy_policy_agreement: (
        GetPersonByIdResponse200DataPrivacyPolicyAgreement | Unset
    ) = UNSET
    ...
    tags: list[GetPersonByIdResponse200DataTagsItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.invitation_status, Unset):
            ...
            self.invitation_status, GetPersonByIdResponse200DataInvitationStatusType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = GetPersonByIdResponse200DataEmailsItem.from_dict(
                emails_item_data
            )
        ...
        def _parse_invitation_status(
            ...
            try:
                ...
                invitation_status_type_0 = (
                    GetPersonByIdResponse200DataInvitationStatusType0(data)
                )
                ...
                pass
            return cast(
                GetPersonByIdResponse200DataInvitationStatusType0 | None | Unset, data
            )
        ...
        meta: GetPersonByIdResponse200DataMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = GetPersonByIdResponse200DataMeta.from_dict(_meta)
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = (
                GetPersonByIdResponse200DataPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = GetPersonByIdResponse200DataTagsItem.from_dict(tags_item_data)
        ...
        get_person_by_id_response_200_data = cls(
        ...
        get_person_by_id_response_200_data.additional_properties = d
        return get_person_by_id_response_200_data
