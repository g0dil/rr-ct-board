...
T = TypeVar("T", bound="GetContactlabelResponse200Data")


@_attrs_define
class GetContactlabelResponse200Data:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_contactlabel_response_200_data = cls(
            id=id,
        ...
        get_contactlabel_response_200_data.additional_properties = d
        return get_contactlabel_response_200_data
