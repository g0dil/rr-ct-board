...
if TYPE_CHECKING:
    from ..models.put_dynamicgrouop_status_response_200_data_process import (
        PutDynamicgrouopStatusResponse200DataProcess,
    )
    from ..models.put_dynamicgrouop_status_response_200_data_query import (
        PutDynamicgrouopStatusResponse200DataQuery,
    )


T = TypeVar("T", bound="PutDynamicgrouopStatusResponse200Data")


@_attrs_define
class PutDynamicgrouopStatusResponse200Data:
    """
    Attributes:
        description (str | Unset):
        importance (int | Unset):
        person_id_field_name (str | Unset):
        process (PutDynamicgrouopStatusResponse200DataProcess | Unset):
        query (PutDynamicgrouopStatusResponse200DataQuery | Unset):
        shorty (str | Unset):
    """
    ...
    process: PutDynamicgrouopStatusResponse200DataProcess | Unset = UNSET
    query: PutDynamicgrouopStatusResponse200DataQuery | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_process, Unset):
            ...
            process = PutDynamicgrouopStatusResponse200DataProcess.from_dict(_process)
        ...
        if isinstance(_query, Unset):
            ...
            query = PutDynamicgrouopStatusResponse200DataQuery.from_dict(_query)

        shorty = d.pop("shorty", UNSET)

        put_dynamicgrouop_status_response_200_data = cls(
        ...
        put_dynamicgrouop_status_response_200_data.additional_properties = d
        return put_dynamicgrouop_status_response_200_data
