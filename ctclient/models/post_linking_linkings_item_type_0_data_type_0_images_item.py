...
T = TypeVar("T", bound="PostLinkingLinkingsItemType0DataType0ImagesItem")


@_attrs_define
class PostLinkingLinkingsItemType0DataType0ImagesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_linking_linkings_item_type_0_data_type_0_images_item = cls(
            height=height,
        ...
        post_linking_linkings_item_type_0_data_type_0_images_item.additional_properties = d
        return post_linking_linkings_item_type_0_data_type_0_images_item
