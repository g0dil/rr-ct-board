...
T = TypeVar("T", bound="GetPersonMasterdataResponse200DataFollowUpsItem")


@_attrs_define
class GetPersonMasterdataResponse200DataFollowUpsItem:
    """
    Attributes:
        id (int):  Example: 1.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_person_masterdata_response_200_data_follow_ups_item = cls(
            id=id,
            name=name,
        ...
        get_person_masterdata_response_200_data_follow_ups_item.additional_properties = d
        return get_person_masterdata_response_200_data_follow_ups_item
