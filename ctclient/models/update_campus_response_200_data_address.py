...
T = TypeVar("T", bound="UpdateCampusResponse200DataAddress")


@_attrs_define
class UpdateCampusResponse200DataAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_campus_response_200_data_address = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        update_campus_response_200_data_address.additional_properties = d
        return update_campus_response_200_data_address
