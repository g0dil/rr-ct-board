...
from ..models.get_all_for_service_response_200_item_requested_person_invitation_status_type_0 import (
    GetAllForServiceResponse200ItemRequestedPersonInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_all_for_service_response_200_item_requested_person_emails_item import (
        GetAllForServiceResponse200ItemRequestedPersonEmailsItem,
    )
    from ..models.get_all_for_service_response_200_item_requested_person_meta import (
        GetAllForServiceResponse200ItemRequestedPersonMeta,
    )
    from ..models.get_all_for_service_response_200_item_requested_person_privacy_policy_agreement import (
        GetAllForServiceResponse200ItemRequestedPersonPrivacyPolicyAgreement,
    )
    from ..models.get_all_for_service_response_200_item_requested_person_tags_item import (
        GetAllForServiceResponse200ItemRequestedPersonTagsItem,
    )


T = TypeVar("T", bound="GetAllForServiceResponse200ItemRequestedPerson")


@_attrs_define
class GetAllForServiceResponse200ItemRequestedPerson:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[GetAllForServiceResponse200ItemRequestedPersonEmailsItem] | Unset):
            ...
            invitation_status (GetAllForServiceResponse200ItemRequestedPersonInvitationStatusType0 | None | Unset):
            ...
            meta (GetAllForServiceResponse200ItemRequestedPersonMeta | Unset):  Example: {'createdDate':
            ...
            privacy_policy_agreement (GetAllForServiceResponse200ItemRequestedPersonPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[GetAllForServiceResponse200ItemRequestedPersonTagsItem] | Unset):
            title (str | Unset):
    ...
    meta: GetAllForServiceResponse200ItemRequestedPersonMeta | Unset = UNSET
    ...
    privacy_policy_agreement: (
        GetAllForServiceResponse200ItemRequestedPersonPrivacyPolicyAgreement | Unset
    ) = UNSET
    ...
    tags: list[GetAllForServiceResponse200ItemRequestedPersonTagsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = (
                GetAllForServiceResponse200ItemRequestedPersonEmailsItem.from_dict(
                    emails_item_data
                )
            )
        ...
        meta: GetAllForServiceResponse200ItemRequestedPersonMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = GetAllForServiceResponse200ItemRequestedPersonMeta.from_dict(_meta)
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = GetAllForServiceResponse200ItemRequestedPersonPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = (
                GetAllForServiceResponse200ItemRequestedPersonTagsItem.from_dict(
                    tags_item_data
                )
            )
        ...
        get_all_for_service_response_200_item_requested_person = cls(
        ...
        get_all_for_service_response_200_item_requested_person.additional_properties = d
        return get_all_for_service_response_200_item_requested_person
