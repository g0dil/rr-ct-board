...
from ..models.post_groups_response_201_data_information_chat_status import (
    PostGroupsResponse201DataInformationChatStatus,
)
from ..models.post_groups_response_201_data_information_color import (
    PostGroupsResponse201DataInformationColor,
)

if TYPE_CHECKING:
    from ..models.post_groups_response_201_data_information_date_of_foundation import (
        PostGroupsResponse201DataInformationDateOfFoundation,
    )
    from ..models.post_groups_response_201_data_information_end_date import (
        PostGroupsResponse201DataInformationEndDate,
    )


T = TypeVar("T", bound="PostGroupsResponse201DataInformation")


@_attrs_define
class PostGroupsResponse201DataInformation:
    """
    Attributes:
        age_group_ids (list[int]):  Example: [1, 2].
        campus_id (int | None):
        chat_status (PostGroupsResponse201DataInformationChatStatus): status of chat room Example: STARTED.
        color (PostGroupsResponse201DataInformationColor): A color in ChurchTools
        date_of_foundation (PostGroupsResponse201DataInformationDateOfFoundation):
        end_date (PostGroupsResponse201DataInformationEndDate):
    ...
    campus_id: int | None
    chat_status: PostGroupsResponse201DataInformationChatStatus
    color: PostGroupsResponse201DataInformationColor
    date_of_foundation: PostGroupsResponse201DataInformationDateOfFoundation
    end_date: PostGroupsResponse201DataInformationEndDate
    group_category_id: int | None
    group_homepage_url: None | str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color = PostGroupsResponse201DataInformationColor(d.pop("color"))

        date_of_foundation = (
            PostGroupsResponse201DataInformationDateOfFoundation.from_dict(
                d.pop("dateOfFoundation")
            )
        )

        end_date = PostGroupsResponse201DataInformationEndDate.from_dict(
            d.pop("endDate")
        )
        ...
        post_groups_response_201_data_information = cls(
        ...
        post_groups_response_201_data_information.additional_properties = d
        return post_groups_response_201_data_information
