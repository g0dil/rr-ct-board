...
T = TypeVar("T", bound="AppointmentCalculatedWithIncludesAppointmentBaseCalendarMeta")


@_attrs_define
class AppointmentCalculatedWithIncludesAppointmentBaseCalendarMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appointment_calculated_with_includes_appointment_base_calendar_meta = cls(
            modified_date=modified_date,
            modified_pid=modified_pid,
        )

        appointment_calculated_with_includes_appointment_base_calendar_meta.additional_properties = d
        return appointment_calculated_with_includes_appointment_base_calendar_meta
