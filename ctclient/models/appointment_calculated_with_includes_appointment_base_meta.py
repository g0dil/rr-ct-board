...
if TYPE_CHECKING:
    from ..models.appointment_calculated_with_includes_appointment_base_meta_created_person import (
        AppointmentCalculatedWithIncludesAppointmentBaseMetaCreatedPerson,
    )
    from ..models.appointment_calculated_with_includes_appointment_base_meta_modified_person import (
        AppointmentCalculatedWithIncludesAppointmentBaseMetaModifiedPerson,
    )


T = TypeVar("T", bound="AppointmentCalculatedWithIncludesAppointmentBaseMeta")


@_attrs_define
class AppointmentCalculatedWithIncludesAppointmentBaseMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (AppointmentCalculatedWithIncludesAppointmentBaseMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (AppointmentCalculatedWithIncludesAppointmentBaseMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        AppointmentCalculatedWithIncludesAppointmentBaseMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            AppointmentCalculatedWithIncludesAppointmentBaseMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = AppointmentCalculatedWithIncludesAppointmentBaseMetaModifiedPerson.from_dict(
                _modified_person
            )

        appointment_calculated_with_includes_appointment_base_meta = cls(
        ...
        appointment_calculated_with_includes_appointment_base_meta.additional_properties = d
        return appointment_calculated_with_includes_appointment_base_meta
