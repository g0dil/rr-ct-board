...
class AccountUpdate:
    """
    Example:
        {'accountGroupId': 4, 'budget': 100000, 'example': 'Donations', 'identifier': 'DE12345678901234567890',
            'isDonationAccount': False, 'isOpeningBalanceAccount': False, 'name': 'the new donations account', 'number':
            '8200'}
