...
T = TypeVar("T", bound="LinkingOpenGraphDataType0MusicSongsItem")


@_attrs_define
class LinkingOpenGraphDataType0MusicSongsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linking_open_graph_data_type_0_music_songs_item = cls(
            disc=disc,
            track=track,
            url=url,
        )

        linking_open_graph_data_type_0_music_songs_item.additional_properties = d
        return linking_open_graph_data_type_0_music_songs_item
