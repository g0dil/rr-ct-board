...
from ..models.post_person_id_events_event_id_services_service_id_exchangerequests_body_requesting_person_invitation_status_type_0 import (
    PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_person_id_events_event_id_services_service_id_exchangerequests_body_requesting_person_emails_item import (
        PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonEmailsItem,
    )
    from ..models.post_person_id_events_event_id_services_service_id_exchangerequests_body_requesting_person_meta import (
        PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonMeta,
    )
    from ..models.post_person_id_events_event_id_services_service_id_exchangerequests_body_requesting_person_privacy_policy_agreement import (
        PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonPrivacyPolicyAgreement,
    )
    from ..models.post_person_id_events_event_id_services_service_id_exchangerequests_body_requesting_person_tags_item import (
...
T = TypeVar(
    "T",
    bound="PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPerson",
)


@_attrs_define
class PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPerson:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonEmailsItem] | Unset):
            ...
            invitation_status (None |
                PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonInvitationStatusType0 | Unset):
            ...
            meta (PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonMeta | Unset):  Example:
            ...
            privacy_policy_agreement
                (PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonTagsItem] | Unset):
            title (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonEmailsItem.from_dict(
                emails_item_data
            )
        ...
        def _parse_invitation_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                invitation_status_type_0 = PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonInvitationStatusType0(
                    data
                )
        ...
        if isinstance(_meta, Unset):
            ...
            meta = PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonMeta.from_dict(
                _meta
            )
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestingPersonTagsItem.from_dict(
                tags_item_data
            )
        ...
        post_person_id_events_event_id_services_service_id_exchangerequests_body_requesting_person = cls(
        ...
        post_person_id_events_event_id_services_service_id_exchangerequests_body_requesting_person.additional_properties = d
        return post_person_id_events_event_id_services_service_id_exchangerequests_body_requesting_person
