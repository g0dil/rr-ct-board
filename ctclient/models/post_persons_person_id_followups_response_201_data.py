...
from ..models.post_persons_person_id_followups_response_201_data_color import (
    PostPersonsPersonIdFollowupsResponse201DataColor,
)
from ..models.post_persons_person_id_followups_response_201_data_origin import (
    PostPersonsPersonIdFollowupsResponse201DataOrigin,
)
from ..models.post_persons_person_id_followups_response_201_data_success_group_member_status_type_0 import (
    PostPersonsPersonIdFollowupsResponse201DataSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_persons_person_id_followups_response_201_data_meta import (
        PostPersonsPersonIdFollowupsResponse201DataMeta,
    )


T = TypeVar("T", bound="PostPersonsPersonIdFollowupsResponse201Data")


@_attrs_define
class PostPersonsPersonIdFollowupsResponse201Data:
    """
    Attributes:
        ...
        meta (PostPersonsPersonIdFollowupsResponse201DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            'createdPerson': {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        origin (PostPersonsPersonIdFollowupsResponse201DataOrigin):
        person_id (int):
        color (PostPersonsPersonIdFollowupsResponse201DataColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (None | PostPersonsPersonIdFollowupsResponse201DataSuccessGroupMemberStatusType0 |
            Unset):
    ...
    id: int
    membership_id: int | None
    meta: PostPersonsPersonIdFollowupsResponse201DataMeta
    origin: PostPersonsPersonIdFollowupsResponse201DataOrigin
    person_id: int
    color: PostPersonsPersonIdFollowupsResponse201DataColor | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = PostPersonsPersonIdFollowupsResponse201DataMeta.from_dict(d.pop("meta"))

        origin = PostPersonsPersonIdFollowupsResponse201DataOrigin(d.pop("origin"))

        person_id = d.pop("personId")

        _color = d.pop("color", UNSET)
        color: PostPersonsPersonIdFollowupsResponse201DataColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = PostPersonsPersonIdFollowupsResponse201DataColor(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = PostPersonsPersonIdFollowupsResponse201DataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        post_persons_person_id_followups_response_201_data = cls(
            title=title,
            done_date=done_date,
        ...
        post_persons_person_id_followups_response_201_data.additional_properties = d
        return post_persons_person_id_followups_response_201_data
