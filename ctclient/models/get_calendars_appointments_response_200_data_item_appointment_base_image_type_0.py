...
if TYPE_CHECKING:
    from ..models.get_calendars_appointments_response_200_data_item_appointment_base_image_type_0_image_option import (
        GetCalendarsAppointmentsResponse200DataItemAppointmentBaseImageType0ImageOption,
    )
    from ..models.get_calendars_appointments_response_200_data_item_appointment_base_image_type_0_meta import (
        GetCalendarsAppointmentsResponse200DataItemAppointmentBaseImageType0Meta,
    )


T = TypeVar(
    "T", bound="GetCalendarsAppointmentsResponse200DataItemAppointmentBaseImageType0"
)


@_attrs_define
class GetCalendarsAppointmentsResponse200DataItemAppointmentBaseImageType0:
    """
    Attributes:
        ...
        id (int):  Example: 6071.
        image_option (GetCalendarsAppointmentsResponse200DataItemAppointmentBaseImageType0ImageOption):
        image_url (str):  Example:
            http://churchtools.test/images/6071/70987c31abdea3986f69a6d601222ac9a388c36a6510564a80fae29311faec89.
        meta (GetCalendarsAppointmentsResponse200DataItemAppointmentBaseImageType0Meta):  Example: {'createdDate':
    ...
    image_url: str
    meta: GetCalendarsAppointmentsResponse200DataItemAppointmentBaseImageType0Meta
    name: str
    relative_url: str
    security_level_id: int | None
    show_only_when_editable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_option = GetCalendarsAppointmentsResponse200DataItemAppointmentBaseImageType0ImageOption.from_dict(
            d.pop("imageOption")
        )

        image_url = d.pop("imageUrl")

        meta = GetCalendarsAppointmentsResponse200DataItemAppointmentBaseImageType0Meta.from_dict(
            d.pop("meta")
        )
        ...
        get_calendars_appointments_response_200_data_item_appointment_base_image_type_0 = cls(
        ...
        get_calendars_appointments_response_200_data_item_appointment_base_image_type_0.additional_properties = d
        return get_calendars_appointments_response_200_data_item_appointment_base_image_type_0
