...
if TYPE_CHECKING:
    from ..models.appointment_base_image_type_0_meta_created_person import (
        AppointmentBaseImageType0MetaCreatedPerson,
    )
    from ..models.appointment_base_image_type_0_meta_modified_person import (
        AppointmentBaseImageType0MetaModifiedPerson,
    )


T = TypeVar("T", bound="AppointmentBaseImageType0Meta")


@_attrs_define
class AppointmentBaseImageType0Meta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (AppointmentBaseImageType0MetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (AppointmentBaseImageType0MetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: AppointmentBaseImageType0MetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: AppointmentBaseImageType0MetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = AppointmentBaseImageType0MetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = AppointmentBaseImageType0MetaModifiedPerson.from_dict(
                _modified_person
            )

        appointment_base_image_type_0_meta = cls(
        ...
        appointment_base_image_type_0_meta.additional_properties = d
        return appointment_base_image_type_0_meta
