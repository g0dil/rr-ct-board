...
if TYPE_CHECKING:
    from ..models.put_dbfields_field_id_response_200_data_field_category import (
        PutDbfieldsFieldIdResponse200DataFieldCategory,
    )
    from ..models.put_dbfields_field_id_response_200_data_field_type import (
        PutDbfieldsFieldIdResponse200DataFieldType,
    )
    from ..models.put_dbfields_field_id_response_200_data_options_item import (
        PutDbfieldsFieldIdResponse200DataOptionsItem,
    )


T = TypeVar("T", bound="PutDbfieldsFieldIdResponse200Data")


@_attrs_define
class PutDbfieldsFieldIdResponse200Data:
    """
    Attributes:
        ...
        field_category (PutDbfieldsFieldIdResponse200DataFieldCategory):
        field_type (PutDbfieldsFieldIdResponse200DataFieldType):
        ...
        shorty (str | Unset):
        options (list[PutDbfieldsFieldIdResponse200DataOptionsItem] | Unset):
    """
    ...
    options: list[PutDbfieldsFieldIdResponse200DataOptionsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_category = PutDbfieldsFieldIdResponse200DataFieldCategory.from_dict(
            d.pop("fieldCategory")
        )

        field_type = PutDbfieldsFieldIdResponse200DataFieldType.from_dict(
            d.pop("fieldType")
        )
        ...
        for options_item_data in _options or []:
            options_item = PutDbfieldsFieldIdResponse200DataOptionsItem.from_dict(
                options_item_data
            )

            options.append(options_item)

        put_dbfields_field_id_response_200_data = cls(
        ...
        put_dbfields_field_id_response_200_data.additional_properties = d
        return put_dbfields_field_id_response_200_data
