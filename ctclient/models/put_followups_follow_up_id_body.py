...
from ..models.put_followups_follow_up_id_body_color import (
    PutFollowupsFollowUpIdBodyColor,
)
from ..models.put_followups_follow_up_id_body_success_group_member_status_type_0 import (
    PutFollowupsFollowUpIdBodySuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutFollowupsFollowUpIdBody")


@_attrs_define
class PutFollowupsFollowUpIdBody:
    """
    Attributes:
        title (str):  Example: Call Peter.
        color (PutFollowupsFollowUpIdBodyColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (None | PutFollowupsFollowUpIdBodySuccessGroupMemberStatusType0 | Unset):
        success_group_of_group_type_id (int | None | Unset):
        success_role_id (int | None | Unset):
    """

    title: str
    color: PutFollowupsFollowUpIdBodyColor | Unset = UNSET
    ...
    success_group_member_status: (
        None | PutFollowupsFollowUpIdBodySuccessGroupMemberStatusType0 | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: PutFollowupsFollowUpIdBodyColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = PutFollowupsFollowUpIdBodyColor(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                ...
                success_group_member_status_type_0 = (
                    PutFollowupsFollowUpIdBodySuccessGroupMemberStatusType0(data)
                )
        ...
        put_followups_follow_up_id_body = cls(
            title=title,
            color=color,
        ...
        put_followups_follow_up_id_body.additional_properties = d
        return put_followups_follow_up_id_body
