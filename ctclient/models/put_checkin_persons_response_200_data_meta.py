...
if TYPE_CHECKING:
    from ..models.put_checkin_persons_response_200_data_meta_created_person import (
        PutCheckinPersonsResponse200DataMetaCreatedPerson,
    )
    from ..models.put_checkin_persons_response_200_data_meta_modified_person import (
        PutCheckinPersonsResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="PutCheckinPersonsResponse200DataMeta")


@_attrs_define
class PutCheckinPersonsResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (PutCheckinPersonsResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (PutCheckinPersonsResponse200DataMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: PutCheckinPersonsResponse200DataMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: PutCheckinPersonsResponse200DataMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = PutCheckinPersonsResponse200DataMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                PutCheckinPersonsResponse200DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        put_checkin_persons_response_200_data_meta = cls(
        ...
        put_checkin_persons_response_200_data_meta.additional_properties = d
        return put_checkin_persons_response_200_data_meta
