...
if TYPE_CHECKING:
    from ..models.dynamic_group_rule_query_params_computed_fields_item import (
        DynamicGroupRuleQueryParamsComputedFieldsItem,
    )
    from ..models.dynamic_group_rule_query_params_filter import (
        DynamicGroupRuleQueryParamsFilter,
    )


T = TypeVar("T", bound="DynamicGroupRuleQueryParams")


@_attrs_define
class DynamicGroupRuleQueryParams:
    """
    Attributes:
        computed_fields (list[DynamicGroupRuleQueryParamsComputedFieldsItem] | Unset):
        description (str | Unset):
        filter_ (DynamicGroupRuleQueryParamsFilter | Unset):
    ...
    computed_fields: list[DynamicGroupRuleQueryParamsComputedFieldsItem] | Unset = UNSET
    description: str | Unset = UNSET
    filter_: DynamicGroupRuleQueryParamsFilter | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for computed_fields_item_data in _computed_fields or []:
            computed_fields_item = (
                DynamicGroupRuleQueryParamsComputedFieldsItem.from_dict(
        ...
        if isinstance(_filter_, Unset):
            ...
            filter_ = DynamicGroupRuleQueryParamsFilter.from_dict(_filter_)
        ...
        dynamic_group_rule_query_params = cls(
        ...
        dynamic_group_rule_query_params.additional_properties = d
        return dynamic_group_rule_query_params
