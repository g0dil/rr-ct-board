...
T = TypeVar(
    "T",
    bound="PutCalendarsCalendarIdAppointmentsAppointmentIdResponse200DataBaseSignupType0",
)


@_attrs_define
class PutCalendarsCalendarIdAppointmentsAppointmentIdResponse200DataBaseSignupType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_calendars_calendar_id_appointments_appointment_id_response_200_data_base_signup_type_0 = cls(
        ...
        put_calendars_calendar_id_appointments_appointment_id_response_200_data_base_signup_type_0.additional_properties = d
        return put_calendars_calendar_id_appointments_appointment_id_response_200_data_base_signup_type_0
