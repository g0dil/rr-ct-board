...
if TYPE_CHECKING:
    from ..models.get_all_accounts_response_200_data_item_meta import (
        GetAllAccountsResponse200DataItemMeta,
    )
    from ..models.get_all_accounts_response_200_data_item_permissions import (
        GetAllAccountsResponse200DataItemPermissions,
    )


T = TypeVar("T", bound="GetAllAccountsResponse200DataItem")


@_attrs_define
class GetAllAccountsResponse200DataItem:
    """
    Attributes:
        ...
        meta (GetAllAccountsResponse200DataItemMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson':
            {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        name (str):  Example: Donations.
        number (str):  Example: 8200.
        permissions (GetAllAccountsResponse200DataItemPermissions):
    ...
    is_opening_balance_account: bool
    meta: GetAllAccountsResponse200DataItemMeta
    name: str
    number: str
    permissions: GetAllAccountsResponse200DataItemPermissions
    tax_rate_id: int | None
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = GetAllAccountsResponse200DataItemMeta.from_dict(d.pop("meta"))

        name = d.pop("name")

        number = d.pop("number")

        permissions = GetAllAccountsResponse200DataItemPermissions.from_dict(
            d.pop("permissions")
        )
        ...
        get_all_accounts_response_200_data_item = cls(
        ...
        get_all_accounts_response_200_data_item.additional_properties = d
        return get_all_accounts_response_200_data_item
