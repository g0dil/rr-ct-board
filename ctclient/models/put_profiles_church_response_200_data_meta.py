...
if TYPE_CHECKING:
    from ..models.put_profiles_church_response_200_data_meta_created_person import (
        PutProfilesChurchResponse200DataMetaCreatedPerson,
    )
    from ..models.put_profiles_church_response_200_data_meta_modified_person import (
        PutProfilesChurchResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="PutProfilesChurchResponse200DataMeta")


@_attrs_define
class PutProfilesChurchResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (PutProfilesChurchResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (PutProfilesChurchResponse200DataMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: PutProfilesChurchResponse200DataMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: PutProfilesChurchResponse200DataMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = PutProfilesChurchResponse200DataMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                PutProfilesChurchResponse200DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        put_profiles_church_response_200_data_meta = cls(
        ...
        put_profiles_church_response_200_data_meta.additional_properties = d
        return put_profiles_church_response_200_data_meta
