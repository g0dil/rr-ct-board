...
T = TypeVar("T", bound="GetGlobalPermissionsResponse200DataChurchcore")


@_attrs_define
class GetGlobalPermissionsResponse200DataChurchcore:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_global_permissions_response_200_data_churchcore = cls(
        ...
        get_global_permissions_response_200_data_churchcore.additional_properties = d
        return get_global_permissions_response_200_data_churchcore
