...
T = TypeVar("T", bound="AppointmentBaseAddress")


@_attrs_define
class AppointmentBaseAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appointment_base_address.additional_properties = d
        return appointment_base_address
