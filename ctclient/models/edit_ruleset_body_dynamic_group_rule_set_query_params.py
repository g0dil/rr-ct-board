...
if TYPE_CHECKING:
    from ..models.edit_ruleset_body_dynamic_group_rule_set_query_params_computed_fields_item import (
        EditRulesetBodyDynamicGroupRuleSetQueryParamsComputedFieldsItem,
    )
    from ..models.edit_ruleset_body_dynamic_group_rule_set_query_params_filter import (
        EditRulesetBodyDynamicGroupRuleSetQueryParamsFilter,
    )


T = TypeVar("T", bound="EditRulesetBodyDynamicGroupRuleSetQueryParams")


@_attrs_define
class EditRulesetBodyDynamicGroupRuleSetQueryParams:
    """
    Attributes:
        computed_fields (list[EditRulesetBodyDynamicGroupRuleSetQueryParamsComputedFieldsItem] | Unset):
        description (str | Unset):
        filter_ (EditRulesetBodyDynamicGroupRuleSetQueryParamsFilter | Unset):
    ...
    computed_fields: (
        list[EditRulesetBodyDynamicGroupRuleSetQueryParamsComputedFieldsItem] | Unset
    ) = UNSET
    description: str | Unset = UNSET
    filter_: EditRulesetBodyDynamicGroupRuleSetQueryParamsFilter | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for computed_fields_item_data in _computed_fields or []:
            computed_fields_item = EditRulesetBodyDynamicGroupRuleSetQueryParamsComputedFieldsItem.from_dict(
        ...
        if isinstance(_filter_, Unset):
            ...
            filter_ = EditRulesetBodyDynamicGroupRuleSetQueryParamsFilter.from_dict(
                _filter_
            )
        ...
        edit_ruleset_body_dynamic_group_rule_set_query_params = cls(
        ...
        edit_ruleset_body_dynamic_group_rule_set_query_params.additional_properties = d
        return edit_ruleset_body_dynamic_group_rule_set_query_params
