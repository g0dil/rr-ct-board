...
if TYPE_CHECKING:
    from ..models.account_class_meta import AccountClassMeta


T = TypeVar("T", bound="AccountClass")
...
class AccountClass:
    ...
    Attributes:
        ...
        include_profit_loss (bool): If true, an additional row is added to that class in the report, which lists the
            profit-loss sum.
        meta (AccountClassMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson': {'id': 1},
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = AccountClassMeta.from_dict(d.pop("meta"))
        ...
        account_class.additional_properties = d
