...
if TYPE_CHECKING:
    from ..models.post_groups_response_201_data_settings_dynamic_group_rule_set_type_0_item_query_params_computed_fields_item import (
        PostGroupsResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParamsComputedFieldsItem,
    )
    from ..models.post_groups_response_201_data_settings_dynamic_group_rule_set_type_0_item_query_params_filter import (
...
T = TypeVar(
    "T",
    bound="PostGroupsResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParams",
)


@_attrs_define
class PostGroupsResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParams:
    """
    Attributes:
        computed_fields
            (list[PostGroupsResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParamsComputedFieldsItem] | Unset):
        description (str | Unset):
        filter_ (PostGroupsResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParamsFilter | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for computed_fields_item_data in _computed_fields or []:
            computed_fields_item = PostGroupsResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParamsComputedFieldsItem.from_dict(
        ...
        if isinstance(_filter_, Unset):
            ...
            filter_ = PostGroupsResponse201DataSettingsDynamicGroupRuleSetType0ItemQueryParamsFilter.from_dict(
                _filter_
            )
        ...
        post_groups_response_201_data_settings_dynamic_group_rule_set_type_0_item_query_params = cls(
        ...
        post_groups_response_201_data_settings_dynamic_group_rule_set_type_0_item_query_params.additional_properties = d
        return post_groups_response_201_data_settings_dynamic_group_rule_set_type_0_item_query_params
