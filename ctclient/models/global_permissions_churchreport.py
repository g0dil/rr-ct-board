...
T = TypeVar("T", bound="GlobalPermissionsChurchreport")


@_attrs_define
class GlobalPermissionsChurchreport:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        global_permissions_churchreport = cls(
            edit_masterdata=edit_masterdata,
            view=view,
            view_query=view_query,
        )

        global_permissions_churchreport.additional_properties = d
        return global_permissions_churchreport
