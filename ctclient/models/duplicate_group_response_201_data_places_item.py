...
T = TypeVar("T", bound="DuplicateGroupResponse201DataPlacesItem")


@_attrs_define
class DuplicateGroupResponse201DataPlacesItem:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        duplicate_group_response_201_data_places_item = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        duplicate_group_response_201_data_places_item.additional_properties = d
        return duplicate_group_response_201_data_places_item
