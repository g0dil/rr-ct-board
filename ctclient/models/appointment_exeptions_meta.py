...
if TYPE_CHECKING:
    from ..models.appointment_exeptions_meta_created_person import (
        AppointmentExeptionsMetaCreatedPerson,
    )
    from ..models.appointment_exeptions_meta_modified_person import (
        AppointmentExeptionsMetaModifiedPerson,
    )


T = TypeVar("T", bound="AppointmentExeptionsMeta")


@_attrs_define
class AppointmentExeptionsMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (AppointmentExeptionsMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (AppointmentExeptionsMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: AppointmentExeptionsMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: AppointmentExeptionsMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = AppointmentExeptionsMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = AppointmentExeptionsMetaModifiedPerson.from_dict(
                _modified_person
            )

        appointment_exeptions_meta = cls(
        ...
        appointment_exeptions_meta.additional_properties = d
        return appointment_exeptions_meta
