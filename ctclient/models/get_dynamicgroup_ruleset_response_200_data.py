...
if TYPE_CHECKING:
    from ..models.get_dynamicgroup_ruleset_response_200_data_process import (
        GetDynamicgroupRulesetResponse200DataProcess,
    )
    from ..models.get_dynamicgroup_ruleset_response_200_data_query import (
        GetDynamicgroupRulesetResponse200DataQuery,
    )


T = TypeVar("T", bound="GetDynamicgroupRulesetResponse200Data")


@_attrs_define
class GetDynamicgroupRulesetResponse200Data:
    """
    Attributes:
        description (str | Unset):
        importance (int | Unset):
        person_id_field_name (str | Unset):
        process (GetDynamicgroupRulesetResponse200DataProcess | Unset):
        query (GetDynamicgroupRulesetResponse200DataQuery | Unset):
        shorty (str | Unset):
    """
    ...
    process: GetDynamicgroupRulesetResponse200DataProcess | Unset = UNSET
    query: GetDynamicgroupRulesetResponse200DataQuery | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_process, Unset):
            ...
            process = GetDynamicgroupRulesetResponse200DataProcess.from_dict(_process)
        ...
        if isinstance(_query, Unset):
            ...
            query = GetDynamicgroupRulesetResponse200DataQuery.from_dict(_query)

        shorty = d.pop("shorty", UNSET)

        get_dynamicgroup_ruleset_response_200_data = cls(
        ...
        get_dynamicgroup_ruleset_response_200_data.additional_properties = d
        return get_dynamicgroup_ruleset_response_200_data
