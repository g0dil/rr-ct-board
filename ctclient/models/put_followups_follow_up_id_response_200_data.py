...
from ..models.put_followups_follow_up_id_response_200_data_color import (
    PutFollowupsFollowUpIdResponse200DataColor,
)
from ..models.put_followups_follow_up_id_response_200_data_origin import (
    PutFollowupsFollowUpIdResponse200DataOrigin,
)
from ..models.put_followups_follow_up_id_response_200_data_success_group_member_status_type_0 import (
    PutFollowupsFollowUpIdResponse200DataSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.put_followups_follow_up_id_response_200_data_meta import (
        PutFollowupsFollowUpIdResponse200DataMeta,
    )


T = TypeVar("T", bound="PutFollowupsFollowUpIdResponse200Data")


@_attrs_define
class PutFollowupsFollowUpIdResponse200Data:
    """
    Attributes:
        ...
        meta (PutFollowupsFollowUpIdResponse200DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            'createdPerson': {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        origin (PutFollowupsFollowUpIdResponse200DataOrigin):
        person_id (int):
        color (PutFollowupsFollowUpIdResponse200DataColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (None | PutFollowupsFollowUpIdResponse200DataSuccessGroupMemberStatusType0 | Unset):
    ...
    id: int
    membership_id: int | None
    meta: PutFollowupsFollowUpIdResponse200DataMeta
    origin: PutFollowupsFollowUpIdResponse200DataOrigin
    person_id: int
    color: PutFollowupsFollowUpIdResponse200DataColor | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = PutFollowupsFollowUpIdResponse200DataMeta.from_dict(d.pop("meta"))

        origin = PutFollowupsFollowUpIdResponse200DataOrigin(d.pop("origin"))

        person_id = d.pop("personId")

        _color = d.pop("color", UNSET)
        color: PutFollowupsFollowUpIdResponse200DataColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = PutFollowupsFollowUpIdResponse200DataColor(_color)
        ...
        put_followups_follow_up_id_response_200_data = cls(
            title=title,
            done_date=done_date,
        ...
        put_followups_follow_up_id_response_200_data.additional_properties = d
        return put_followups_follow_up_id_response_200_data
