...
from ..models.routine_step_create_repeat_children_item_type_0_type_1_action_data_color import (
    RoutineStepCreateRepeatChildrenItemType0Type1ActionDataColor,
)
from ..models.routine_step_create_repeat_children_item_type_0_type_1_action_data_continuation_type import (
    RoutineStepCreateRepeatChildrenItemType0Type1ActionDataContinuationType,
)
from ..models.routine_step_create_repeat_children_item_type_0_type_1_action_data_success_group_member_status_type_0 import (
    RoutineStepCreateRepeatChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RoutineStepCreateRepeatChildrenItemType0Type1ActionData")


@_attrs_define
class RoutineStepCreateRepeatChildrenItemType0Type1ActionData:
    """
    Attributes:
        continuation_type (RoutineStepCreateRepeatChildrenItemType0Type1ActionDataContinuationType):
        description (None | str):
        title (str):
        color (RoutineStepCreateRepeatChildrenItemType0Type1ActionDataColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (None |
            RoutineStepCreateRepeatChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0 | Unset):
    ...
    description: None | str
    title: str
    color: RoutineStepCreateRepeatChildrenItemType0Type1ActionDataColor | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: RoutineStepCreateRepeatChildrenItemType0Type1ActionDataColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = RoutineStepCreateRepeatChildrenItemType0Type1ActionDataColor(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = RoutineStepCreateRepeatChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        routine_step_create_repeat_children_item_type_0_type_1_action_data = cls(
        ...
        routine_step_create_repeat_children_item_type_0_type_1_action_data.additional_properties = d
        return routine_step_create_repeat_children_item_type_0_type_1_action_data
