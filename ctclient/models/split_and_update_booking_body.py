...
if TYPE_CHECKING:
    from ..models.split_and_update_booking_body_additionals_type_0_item import (
        SplitAndUpdateBookingBodyAdditionalsType0Item,
    )
    from ..models.split_and_update_booking_body_exceptions_type_0_item import (
        SplitAndUpdateBookingBodyExceptionsType0Item,
    )


T = TypeVar("T", bound="SplitAndUpdateBookingBody")


@_attrs_define
class SplitAndUpdateBookingBody:
    """
    Attributes:
        ...
        title (str):
        booking_id (int):
        split_date (datetime.date): A simple date in ISO format, e.g. '2022-10-19' Example: 2022-10-19.
        split_until_end (bool):
        additionals (list[SplitAndUpdateBookingBodyAdditionalsType0Item] | None | Unset):
        description (None | str | Unset):
        exceptions (list[SplitAndUpdateBookingBodyExceptionsType0Item] | None | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        split_until_end = self.split_until_end
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        split_date = isoparse(d.pop("splitDate")).date()

        split_until_end = d.pop("splitUntilEnd")

        def _parse_additionals(
            data: object,
        ) -> list[SplitAndUpdateBookingBodyAdditionalsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for additionals_type_0_item_data in _additionals_type_0:
                    additionals_type_0_item = (
                        SplitAndUpdateBookingBodyAdditionalsType0Item.from_dict(
                ...
                pass
            return cast(
                list[SplitAndUpdateBookingBodyAdditionalsType0Item] | None | Unset, data
            )
        ...
        def _parse_exceptions(
            data: object,
        ) -> list[SplitAndUpdateBookingBodyExceptionsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for exceptions_type_0_item_data in _exceptions_type_0:
                    exceptions_type_0_item = (
                        SplitAndUpdateBookingBodyExceptionsType0Item.from_dict(
                ...
                pass
            return cast(
                list[SplitAndUpdateBookingBodyExceptionsType0Item] | None | Unset, data
            )
        ...
        split_and_update_booking_body = cls(
            end_date=end_date,
            ...
            split_until_end=split_until_end,
        ...
        split_and_update_booking_body.additional_properties = d
        return split_and_update_booking_body
