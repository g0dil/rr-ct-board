...
from ..models.post_markdown_response_200_allowcheckin import (
    PostMarkdownResponse200Allowcheckin,
)
from ..models.post_markdown_response_200_allowfinance import (
    PostMarkdownResponse200Allowfinance,
)
from ..models.post_markdown_response_200_allowldap import (
    PostMarkdownResponse200Allowldap,
)
from ..models.post_markdown_response_200_allowoptigemsync import (
    PostMarkdownResponse200Allowoptigemsync,
)
from ..models.post_markdown_response_200_allowsync import (
    PostMarkdownResponse200Allowsync,
)
from ..models.post_markdown_response_200_brand import PostMarkdownResponse200Brand
from ..models.post_markdown_response_200_chrome_active import (
    PostMarkdownResponse200ChromeActive,
)
from ..models.post_markdown_response_200_churchcustommodule_active import (
    PostMarkdownResponse200ChurchcustommoduleActive,
)
from ..models.post_markdown_response_200_currently_mail_sending import (
    PostMarkdownResponse200CurrentlyMailSending,
)
from ..models.post_markdown_response_200_email_server import (
    PostMarkdownResponse200EmailServer,
)
from ..models.post_markdown_response_200_feature_custommodule import (
    PostMarkdownResponse200FeatureCustommodule,
)
from ..models.post_markdown_response_200_finance_inmenu import (
    PostMarkdownResponse200FinanceInmenu,
)
from ..models.post_markdown_response_200_hostingservice import (
    PostMarkdownResponse200Hostingservice,
)
from ..models.post_markdown_response_200_https_only import (
    PostMarkdownResponse200HttpsOnly,
)
from ..models.post_markdown_response_200_language import PostMarkdownResponse200Language
from ..models.post_markdown_response_200_log_debug import (
    PostMarkdownResponse200LogDebug,
)
from ..models.post_markdown_response_200_mail_sending_in_background import (
    PostMarkdownResponse200MailSendingInBackground,
)
from ..models.post_markdown_response_200_memberlist_birthday_full import (
    PostMarkdownResponse200MemberlistBirthdayFull,
)
from ..models.post_markdown_response_200_memberlist_email import (
    PostMarkdownResponse200MemberlistEmail,
)
from ..models.post_markdown_response_200_memberlist_fax import (
    PostMarkdownResponse200MemberlistFax,
)
from ..models.post_markdown_response_200_memberlist_group_couples import (
    PostMarkdownResponse200MemberlistGroupCouples,
)
from ..models.post_markdown_response_200_memberlist_picture import (
    PostMarkdownResponse200MemberlistPicture,
)
from ..models.post_markdown_response_200_memberlist_salutation import (
    PostMarkdownResponse200MemberlistSalutation,
)
from ..models.post_markdown_response_200_memberlist_telefongeschaeftlich import (
    PostMarkdownResponse200MemberlistTelefongeschaeftlich,
)
from ..models.post_markdown_response_200_memberlist_telefonhandy import (
    PostMarkdownResponse200MemberlistTelefonhandy,
)
from ..models.post_markdown_response_200_memberlist_telefonprivat import (
    PostMarkdownResponse200MemberlistTelefonprivat,
)
from ..models.post_markdown_response_200_orderstatus import (
    PostMarkdownResponse200Orderstatus,
)
from ..models.post_markdown_response_200_prevent_change_security_settings import (
    PostMarkdownResponse200PreventChangeSecuritySettings,
)
from ..models.post_markdown_response_200_safe_mode_enable_authorized_persons import (
    PostMarkdownResponse200SafeModeEnableAuthorizedPersons,
)
from ..models.post_markdown_response_200_safe_mode_enable_chat_sync import (
    PostMarkdownResponse200SafeModeEnableChatSync,
)
from ..models.post_markdown_response_200_safe_mode_enable_consolidation import (
    PostMarkdownResponse200SafeModeEnableConsolidation,
)
from ..models.post_markdown_response_200_safe_mode_enable_guid_sync import (
    PostMarkdownResponse200SafeModeEnableGuidSync,
)
from ..models.post_markdown_response_200_safe_mode_enable_job_queueing import (
    PostMarkdownResponse200SafeModeEnableJobQueueing,
)
from ..models.post_markdown_response_200_safe_mode_enable_mail import (
    PostMarkdownResponse200SafeModeEnableMail,
)
from ..models.post_markdown_response_200_safe_mode_enable_newsletter import (
    PostMarkdownResponse200SafeModeEnableNewsletter,
)
from ..models.post_markdown_response_200_safe_mode_enable_notification import (
    PostMarkdownResponse200SafeModeEnableNotification,
)
from ..models.post_markdown_response_200_test import PostMarkdownResponse200Test
from ..models.post_markdown_response_200_verification_status import (
    PostMarkdownResponse200VerificationStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_markdown_response_200_license_settings import (
        PostMarkdownResponse200LicenseSettings,
    )


T = TypeVar("T", bound="PostMarkdownResponse200")


@_attrs_define
class PostMarkdownResponse200:
    """
    Attributes:
        brand (PostMarkdownResponse200Brand):
        chat_server (str):
        finder_url (str):
        is_posts_active (bool):
        verification_status (PostMarkdownResponse200VerificationStatus):
        webchat_link (str):
        ...
        allowcheckin (PostMarkdownResponse200Allowcheckin | Unset): This is a string that can only be true or false.
        ...
        allowfinance (PostMarkdownResponse200Allowfinance | Unset): This is a string that can only be true or false.
        allowldap (PostMarkdownResponse200Allowldap | Unset): This is a string that can only be true or false.
        allowoptigemsync (PostMarkdownResponse200Allowoptigemsync | Unset): This is a string that can only be true or
            false.
        allowsync (PostMarkdownResponse200Allowsync | Unset): This is a string that can only be true or false.
        ...
        chrome_active (PostMarkdownResponse200ChromeActive | Unset): This is a string that can only be true or false.
        ...
        churchcustommodule_active (PostMarkdownResponse200ChurchcustommoduleActive | Unset): This is a string that can
        ...
        currently_mail_sending (PostMarkdownResponse200CurrentlyMailSending | Unset): This is a string that can only be
            true or false.
        ...
        email_server (PostMarkdownResponse200EmailServer | Unset):
        ...
        feature_custommodule (PostMarkdownResponse200FeatureCustommodule | Unset): This is a string that can only be
            true or false.
        finance_active (bool | Unset):
        finance_inmenu (PostMarkdownResponse200FinanceInmenu | Unset): This is a string that can only be true or false.
        ...
        hostingservice (PostMarkdownResponse200Hostingservice | Unset): This is a string that can only be true or false.
        https_only (PostMarkdownResponse200HttpsOnly | Unset): This is a string that can only be true or false.
        ...
        language (PostMarkdownResponse200Language | Unset): The language code is a two-letter code that represents the
        ...
        license_settings (PostMarkdownResponse200LicenseSettings | Unset):
        log_debug (PostMarkdownResponse200LogDebug | Unset): This is a string that can only be true or false.
        login_message (str | Unset):
        mail_enabled (bool | Unset):
        mail_sending_in_background (PostMarkdownResponse200MailSendingInBackground | Unset): This is a string that can
            only be true or false.
        ...
        memberlist_birthday_full (PostMarkdownResponse200MemberlistBirthdayFull | Unset): This is a string that can only
            be true or false.
        memberlist_email (PostMarkdownResponse200MemberlistEmail | Unset): This is a string that can only be true or
            false.
        memberlist_fax (PostMarkdownResponse200MemberlistFax | Unset): This is a string that can only be true or false.
        memberlist_group_couples (PostMarkdownResponse200MemberlistGroupCouples | Unset): This is a string that can only
            be true or false.
        memberlist_picture (PostMarkdownResponse200MemberlistPicture | Unset): This is a string that can only be true or
            false.
        memberlist_salutation (PostMarkdownResponse200MemberlistSalutation | Unset): This is a string that can only be
            true or false.
        memberlist_telefongeschaeftlich (PostMarkdownResponse200MemberlistTelefongeschaeftlich | Unset): This is a
            string that can only be true or false.
        memberlist_telefonhandy (PostMarkdownResponse200MemberlistTelefonhandy | Unset): This is a string that can only
            be true or false.
        memberlist_telefonprivat (PostMarkdownResponse200MemberlistTelefonprivat | Unset): This is a string that can
            only be true or false.
        ...
        orderstatus (PostMarkdownResponse200Orderstatus | Unset):
        ...
        prevent_change_security_settings (PostMarkdownResponse200PreventChangeSecuritySettings | Unset):
        ...
        safe_mode_enable_authorized_persons (PostMarkdownResponse200SafeModeEnableAuthorizedPersons | Unset): This is a
            string that can only be true or false.
        safe_mode_enable_chat_sync (PostMarkdownResponse200SafeModeEnableChatSync | Unset): This is a string that can
            only be true or false.
        safe_mode_enable_consolidation (PostMarkdownResponse200SafeModeEnableConsolidation | Unset): This is a string
            that can only be true or false.
        safe_mode_enable_guid_sync (PostMarkdownResponse200SafeModeEnableGuidSync | Unset): This is a string that can
            only be true or false.
        safe_mode_enable_job_queueing (PostMarkdownResponse200SafeModeEnableJobQueueing | Unset): This is a string that
            can only be true or false.
        safe_mode_enable_mail (PostMarkdownResponse200SafeModeEnableMail | Unset): This is a string that can only be
            true or false.
        safe_mode_enable_newsletter (PostMarkdownResponse200SafeModeEnableNewsletter | Unset): This is a string that can
            only be true or false.
        safe_mode_enable_notification (PostMarkdownResponse200SafeModeEnableNotification | Unset): This is a string that
            can only be true or false.
        ...
        test (PostMarkdownResponse200Test | Unset): This is a string that can only be true or false.
        timezone (str | Unset):
        version (str | Unset):
    ...
    allowcheckin: PostMarkdownResponse200Allowcheckin | Unset = UNSET
    ...
    allowfinance: PostMarkdownResponse200Allowfinance | Unset = UNSET
    allowldap: PostMarkdownResponse200Allowldap | Unset = UNSET
    allowoptigemsync: PostMarkdownResponse200Allowoptigemsync | Unset = UNSET
    allowsync: PostMarkdownResponse200Allowsync | Unset = UNSET
    ...
    chrome_active: PostMarkdownResponse200ChromeActive | Unset = UNSET
    ...
    churchcustommodule_active: (
        PostMarkdownResponse200ChurchcustommoduleActive | Unset
    ) = UNSET
    ...
    currently_mail_sending: PostMarkdownResponse200CurrentlyMailSending | Unset = UNSET
    ...
    email_server: PostMarkdownResponse200EmailServer | Unset = UNSET
    ...
    feature_custommodule: PostMarkdownResponse200FeatureCustommodule | Unset = UNSET
    finance_active: bool | Unset = UNSET
    finance_inmenu: PostMarkdownResponse200FinanceInmenu | Unset = UNSET
    ...
    hostingservice: PostMarkdownResponse200Hostingservice | Unset = UNSET
    https_only: PostMarkdownResponse200HttpsOnly | Unset = UNSET
    ...
    language: PostMarkdownResponse200Language | Unset = UNSET
    ...
    license_settings: PostMarkdownResponse200LicenseSettings | Unset = UNSET
    log_debug: PostMarkdownResponse200LogDebug | Unset = UNSET
    login_message: str | Unset = UNSET
    mail_enabled: bool | Unset = UNSET
    mail_sending_in_background: (
        PostMarkdownResponse200MailSendingInBackground | Unset
    ) = UNSET
    ...
    memberlist_birthday_full: PostMarkdownResponse200MemberlistBirthdayFull | Unset = (
        UNSET
    )
    memberlist_email: PostMarkdownResponse200MemberlistEmail | Unset = UNSET
    memberlist_fax: PostMarkdownResponse200MemberlistFax | Unset = UNSET
    memberlist_group_couples: PostMarkdownResponse200MemberlistGroupCouples | Unset = (
        UNSET
    )
    memberlist_picture: PostMarkdownResponse200MemberlistPicture | Unset = UNSET
    memberlist_salutation: PostMarkdownResponse200MemberlistSalutation | Unset = UNSET
    memberlist_telefongeschaeftlich: (
        PostMarkdownResponse200MemberlistTelefongeschaeftlich | Unset
    ) = UNSET
    memberlist_telefonhandy: PostMarkdownResponse200MemberlistTelefonhandy | Unset = (
        UNSET
    )
    memberlist_telefonprivat: PostMarkdownResponse200MemberlistTelefonprivat | Unset = (
        UNSET
    )
    onboarding_start: datetime.datetime | Unset = UNSET
    openstreetmaps_enabled: bool | Unset = UNSET
    orderstatus: PostMarkdownResponse200Orderstatus | Unset = UNSET
    ...
    prevent_change_security_settings: (
        PostMarkdownResponse200PreventChangeSecuritySettings | Unset
    ) = UNSET
    ...
    safe_mode_enable_authorized_persons: (
        PostMarkdownResponse200SafeModeEnableAuthorizedPersons | Unset
    ) = UNSET
    safe_mode_enable_chat_sync: (
        PostMarkdownResponse200SafeModeEnableChatSync | Unset
    ) = UNSET
    safe_mode_enable_consolidation: (
        PostMarkdownResponse200SafeModeEnableConsolidation | Unset
    ) = UNSET
    safe_mode_enable_guid_sync: (
        PostMarkdownResponse200SafeModeEnableGuidSync | Unset
    ) = UNSET
    safe_mode_enable_job_queueing: (
        PostMarkdownResponse200SafeModeEnableJobQueueing | Unset
    ) = UNSET
    safe_mode_enable_mail: PostMarkdownResponse200SafeModeEnableMail | Unset = UNSET
    safe_mode_enable_newsletter: (
        PostMarkdownResponse200SafeModeEnableNewsletter | Unset
    ) = UNSET
    safe_mode_enable_notification: (
        PostMarkdownResponse200SafeModeEnableNotification | Unset
    ) = UNSET
    ...
    test: PostMarkdownResponse200Test | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        brand = PostMarkdownResponse200Brand(d.pop("brand"))
        ...
        allowcheckin: PostMarkdownResponse200Allowcheckin | Unset
        if isinstance(_allowcheckin, Unset):
            allowcheckin = UNSET
        else:
            allowcheckin = PostMarkdownResponse200Allowcheckin(_allowcheckin)
        ...
        allowfinance: PostMarkdownResponse200Allowfinance | Unset
        if isinstance(_allowfinance, Unset):
            allowfinance = UNSET
        else:
            allowfinance = PostMarkdownResponse200Allowfinance(_allowfinance)

        _allowldap = d.pop("allowldap", UNSET)
        allowldap: PostMarkdownResponse200Allowldap | Unset
        if isinstance(_allowldap, Unset):
            allowldap = UNSET
        else:
            allowldap = PostMarkdownResponse200Allowldap(_allowldap)

        _allowoptigemsync = d.pop("allowoptigemsync", UNSET)
        allowoptigemsync: PostMarkdownResponse200Allowoptigemsync | Unset
        if isinstance(_allowoptigemsync, Unset):
            allowoptigemsync = UNSET
        else:
            allowoptigemsync = PostMarkdownResponse200Allowoptigemsync(
                _allowoptigemsync
            )

        _allowsync = d.pop("allowsync", UNSET)
        allowsync: PostMarkdownResponse200Allowsync | Unset
        if isinstance(_allowsync, Unset):
            allowsync = UNSET
        else:
            allowsync = PostMarkdownResponse200Allowsync(_allowsync)
        ...
        chrome_active: PostMarkdownResponse200ChromeActive | Unset
        if isinstance(_chrome_active, Unset):
            chrome_active = UNSET
        else:
            chrome_active = PostMarkdownResponse200ChromeActive(_chrome_active)
        ...
        if isinstance(_churchcustommodule_active, Unset):
            ...
            churchcustommodule_active = PostMarkdownResponse200ChurchcustommoduleActive(
        ...
        currently_mail_sending: PostMarkdownResponse200CurrentlyMailSending | Unset
        if isinstance(_currently_mail_sending, Unset):
            currently_mail_sending = UNSET
        else:
            currently_mail_sending = PostMarkdownResponse200CurrentlyMailSending(
        ...
        if isinstance(_email_server, Unset):
            ...
            email_server = PostMarkdownResponse200EmailServer(_email_server)
        ...
        feature_custommodule: PostMarkdownResponse200FeatureCustommodule | Unset
        if isinstance(_feature_custommodule, Unset):
            feature_custommodule = UNSET
        else:
            feature_custommodule = PostMarkdownResponse200FeatureCustommodule(
        ...
        finance_inmenu: PostMarkdownResponse200FinanceInmenu | Unset
        if isinstance(_finance_inmenu, Unset):
            finance_inmenu = UNSET
        else:
            finance_inmenu = PostMarkdownResponse200FinanceInmenu(_finance_inmenu)
        ...
        hostingservice: PostMarkdownResponse200Hostingservice | Unset
        if isinstance(_hostingservice, Unset):
            hostingservice = UNSET
        else:
            hostingservice = PostMarkdownResponse200Hostingservice(_hostingservice)

        _https_only = d.pop("https_only", UNSET)
        https_only: PostMarkdownResponse200HttpsOnly | Unset
        if isinstance(_https_only, Unset):
            https_only = UNSET
        else:
            https_only = PostMarkdownResponse200HttpsOnly(_https_only)
        ...
        language: PostMarkdownResponse200Language | Unset
        if isinstance(_language, Unset):
            language = UNSET
        else:
            language = PostMarkdownResponse200Language(_language)
        ...
        if isinstance(_license_settings, Unset):
            ...
            license_settings = PostMarkdownResponse200LicenseSettings.from_dict(
                _license_settings
            )

        _log_debug = d.pop("log_debug", UNSET)
        log_debug: PostMarkdownResponse200LogDebug | Unset
        if isinstance(_log_debug, Unset):
            log_debug = UNSET
        else:
            log_debug = PostMarkdownResponse200LogDebug(_log_debug)
        ...
        if isinstance(_mail_sending_in_background, Unset):
            ...
            mail_sending_in_background = PostMarkdownResponse200MailSendingInBackground(
        ...
        if isinstance(_memberlist_birthday_full, Unset):
            ...
            memberlist_birthday_full = PostMarkdownResponse200MemberlistBirthdayFull(
                _memberlist_birthday_full
            )

        _memberlist_email = d.pop("memberlist_email", UNSET)
        memberlist_email: PostMarkdownResponse200MemberlistEmail | Unset
        if isinstance(_memberlist_email, Unset):
            memberlist_email = UNSET
        else:
            memberlist_email = PostMarkdownResponse200MemberlistEmail(_memberlist_email)

        _memberlist_fax = d.pop("memberlist_fax", UNSET)
        memberlist_fax: PostMarkdownResponse200MemberlistFax | Unset
        if isinstance(_memberlist_fax, Unset):
            memberlist_fax = UNSET
        else:
            memberlist_fax = PostMarkdownResponse200MemberlistFax(_memberlist_fax)
        ...
        if isinstance(_memberlist_group_couples, Unset):
            ...
            memberlist_group_couples = PostMarkdownResponse200MemberlistGroupCouples(
                _memberlist_group_couples
            )

        _memberlist_picture = d.pop("memberlist_picture", UNSET)
        memberlist_picture: PostMarkdownResponse200MemberlistPicture | Unset
        if isinstance(_memberlist_picture, Unset):
            memberlist_picture = UNSET
        else:
            memberlist_picture = PostMarkdownResponse200MemberlistPicture(
                _memberlist_picture
            )

        _memberlist_salutation = d.pop("memberlist_salutation", UNSET)
        memberlist_salutation: PostMarkdownResponse200MemberlistSalutation | Unset
        if isinstance(_memberlist_salutation, Unset):
            memberlist_salutation = UNSET
        else:
            memberlist_salutation = PostMarkdownResponse200MemberlistSalutation(
        ...
        if isinstance(_memberlist_telefonhandy, Unset):
            ...
            memberlist_telefonhandy = PostMarkdownResponse200MemberlistTelefonhandy(
        ...
        if isinstance(_memberlist_telefonprivat, Unset):
            ...
            memberlist_telefonprivat = PostMarkdownResponse200MemberlistTelefonprivat(
        ...
        if isinstance(_orderstatus, Unset):
            ...
            orderstatus = PostMarkdownResponse200Orderstatus(_orderstatus)
        ...
        if isinstance(_safe_mode_enable_chat_sync, Unset):
            ...
            safe_mode_enable_chat_sync = PostMarkdownResponse200SafeModeEnableChatSync(
        ...
        if isinstance(_safe_mode_enable_guid_sync, Unset):
            ...
            safe_mode_enable_guid_sync = PostMarkdownResponse200SafeModeEnableGuidSync(
        ...
        safe_mode_enable_mail: PostMarkdownResponse200SafeModeEnableMail | Unset
        if isinstance(_safe_mode_enable_mail, Unset):
            safe_mode_enable_mail = UNSET
        else:
            safe_mode_enable_mail = PostMarkdownResponse200SafeModeEnableMail(
        ...
        test: PostMarkdownResponse200Test | Unset
        if isinstance(_test, Unset):
            test = UNSET
        else:
            test = PostMarkdownResponse200Test(_test)
        ...
        post_markdown_response_200 = cls(
            brand=brand,
        ...
        post_markdown_response_200.additional_properties = d
        return post_markdown_response_200
