...
if TYPE_CHECKING:
    from ..models.create_meeting_response_201_data_meta_modified_person import (
        CreateMeetingResponse201DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="CreateMeetingResponse201DataMeta")


@_attrs_define
class CreateMeetingResponse201DataMeta:
    """
    Attributes:
        ...
        modified_person (CreateMeetingResponse201DataMetaModifiedPerson | Unset):
    """

    modified_date: datetime.datetime | Unset = UNSET
    modified_person: CreateMeetingResponse201DataMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = CreateMeetingResponse201DataMetaModifiedPerson.from_dict(
                _modified_person
            )

        create_meeting_response_201_data_meta = cls(
            modified_date=modified_date,
            modified_person=modified_person,
        )

        create_meeting_response_201_data_meta.additional_properties = d
        return create_meeting_response_201_data_meta
