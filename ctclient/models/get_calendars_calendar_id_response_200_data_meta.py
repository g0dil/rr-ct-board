...
T = TypeVar("T", bound="GetCalendarsCalendarIdResponse200DataMeta")


@_attrs_define
class GetCalendarsCalendarIdResponse200DataMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_calendars_calendar_id_response_200_data_meta = cls(
            modified_date=modified_date,
            modified_pid=modified_pid,
        )

        get_calendars_calendar_id_response_200_data_meta.additional_properties = d
        return get_calendars_calendar_id_response_200_data_meta
