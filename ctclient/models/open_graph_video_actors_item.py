...
T = TypeVar("T", bound="OpenGraphVideoActorsItem")


@_attrs_define
class OpenGraphVideoActorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        open_graph_video_actors_item = cls(
            profile=profile,
            role=role,
        )

        open_graph_video_actors_item.additional_properties = d
        return open_graph_video_actors_item
