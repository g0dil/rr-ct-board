...
T = TypeVar("T", bound="PostLinkingLinkingsItemType0DataType0Article")


@_attrs_define
class PostLinkingLinkingsItemType0DataType0Article:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_linking_linkings_item_type_0_data_type_0_article = cls(
            authors=authors,
        ...
        post_linking_linkings_item_type_0_data_type_0_article.additional_properties = d
        return post_linking_linkings_item_type_0_data_type_0_article
