...
T = TypeVar("T", bound="RoutineStepCreateEditGroupMembershipActionData")


@_attrs_define
class RoutineStepCreateEditGroupMembershipActionData:
    """
    Attributes:
        group_id (int):
        comment (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        routine_step_create_edit_group_membership_action_data = cls(
            group_id=group_id,
            comment=comment,
        ...
        routine_step_create_edit_group_membership_action_data.additional_properties = d
        return routine_step_create_edit_group_membership_action_data
