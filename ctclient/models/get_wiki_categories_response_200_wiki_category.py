...
T = TypeVar("T", bound="GetWikiCategoriesResponse200WikiCategory")


@_attrs_define
class GetWikiCategoriesResponse200WikiCategory:
    """
    Attributes:
        campus_id (int | None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_wiki_categories_response_200_wiki_category = cls(
            campus_id=campus_id,
        ...
        get_wiki_categories_response_200_wiki_category.additional_properties = d
        return get_wiki_categories_response_200_wiki_category
