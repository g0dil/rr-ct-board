...
from ..models.post_person_id_events_event_id_services_service_id_exchangerequests_body_requested_person_invitation_status_type_0 import (
    PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_person_id_events_event_id_services_service_id_exchangerequests_body_requested_person_emails_item import (
        PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonEmailsItem,
    )
    from ..models.post_person_id_events_event_id_services_service_id_exchangerequests_body_requested_person_meta import (
        PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonMeta,
    )
    from ..models.post_person_id_events_event_id_services_service_id_exchangerequests_body_requested_person_privacy_policy_agreement import (
        PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonPrivacyPolicyAgreement,
    )
    from ..models.post_person_id_events_event_id_services_service_id_exchangerequests_body_requested_person_tags_item import (
...
T = TypeVar(
    "T",
    bound="PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPerson",
)


@_attrs_define
class PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPerson:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonEmailsItem] | Unset):
            ...
            invitation_status (None |
                PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonInvitationStatusType0 | Unset):
            ...
            meta (PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonMeta | Unset):  Example:
            ...
            privacy_policy_agreement
                (PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonTagsItem] | Unset):
            title (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonEmailsItem.from_dict(
                emails_item_data
            )
        ...
        def _parse_invitation_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                invitation_status_type_0 = PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonInvitationStatusType0(
                    data
                )
        ...
        if isinstance(_meta, Unset):
            ...
            meta = PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonMeta.from_dict(
                _meta
            )
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = PostPersonIdEventsEventIdServicesServiceIdExchangerequestsBodyRequestedPersonTagsItem.from_dict(
                tags_item_data
            )
        ...
        post_person_id_events_event_id_services_service_id_exchangerequests_body_requested_person = cls(
        ...
        post_person_id_events_event_id_services_service_id_exchangerequests_body_requested_person.additional_properties = d
        return post_person_id_events_event_id_services_service_id_exchangerequests_body_requested_person
