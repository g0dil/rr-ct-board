...
T = TypeVar("T", bound="DuplicateGroupResponse201DataFollowUp")


@_attrs_define
class DuplicateGroupResponse201DataFollowUp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        duplicate_group_response_201_data_follow_up = cls(
        ...
        duplicate_group_response_201_data_follow_up.additional_properties = d
        return duplicate_group_response_201_data_follow_up
