...
T = TypeVar("T", bound="GetExternalloginsResponse200DataItem")


@_attrs_define
class GetExternalloginsResponse200DataItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_externallogins_response_200_data_item = cls(
            name=name,
        ...
        get_externallogins_response_200_data_item.additional_properties = d
        return get_externallogins_response_200_data_item
