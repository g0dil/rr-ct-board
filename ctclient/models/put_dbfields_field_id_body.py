...
T = TypeVar("T", bound="PutDbfieldsFieldIdBody")


@_attrs_define
class PutDbfieldsFieldIdBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_dbfields_field_id_body = cls(
        ...
        put_dbfields_field_id_body.additional_properties = d
        return put_dbfields_field_id_body
