...
T = TypeVar(
    "T", bound="PostFilesDomainTypeDomainIdentifierLinkResponse201FileOrLinkMeta"
)


@_attrs_define
class PostFilesDomainTypeDomainIdentifierLinkResponse201FileOrLinkMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_files_domain_type_domain_identifier_link_response_201_file_or_link_meta = (
            cls(
        ...
        post_files_domain_type_domain_identifier_link_response_201_file_or_link_meta.additional_properties = d
        return (
            post_files_domain_type_domain_identifier_link_response_201_file_or_link_meta
        )
