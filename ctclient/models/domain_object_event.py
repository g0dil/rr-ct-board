...
from ..models.domain_object_event_domain_type import DomainObjectEventDomainType
from ..models.domain_object_event_icon import DomainObjectEventIcon
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.domain_object_event_color import DomainObjectEventColor
    from ..models.domain_object_event_domain_attributes import (
        DomainObjectEventDomainAttributes,
    )


T = TypeVar("T", bound="DomainObjectEvent")


@_attrs_define
class DomainObjectEvent:
    ...
    Attributes:
        ...
        title (str):
        domain_attributes (DomainObjectEventDomainAttributes):
        domain_type (DomainObjectEventDomainType):
        icon (DomainObjectEventIcon):
        api_url (None | str | Unset):
        color (DomainObjectEventColor | None | Unset):
    ...
    color: DomainObjectEventColor | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.color, Unset):
            color = UNSET
        elif isinstance(self.color, DomainObjectEventColor):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domain_attributes = DomainObjectEventDomainAttributes.from_dict(
            d.pop("domainAttributes")
        )

        domain_type = DomainObjectEventDomainType(d.pop("domainType"))

        icon = DomainObjectEventIcon(d.pop("icon"))
        ...
        def _parse_color(data: object) -> DomainObjectEventColor | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                color_color = DomainObjectEventColor.from_dict(data)

                return color_color
            except:  # noqa: E722
                pass
            return cast(DomainObjectEventColor | None | Unset, data)
        ...
        domain_object_event.additional_properties = d
        return domain_object_event
