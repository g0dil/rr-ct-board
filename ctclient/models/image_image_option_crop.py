...
T = TypeVar("T", bound="ImageImageOptionCrop")


@_attrs_define
class ImageImageOptionCrop:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_image_option_crop.additional_properties = d
        return image_image_option_crop
