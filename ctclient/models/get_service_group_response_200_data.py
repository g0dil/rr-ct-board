...
T = TypeVar("T", bound="GetServiceGroupResponse200Data")


@_attrs_define
class GetServiceGroupResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_service_group_response_200_data = cls(
            campus_id=campus_id,
            id=id,
            name=name,
        ...
        get_service_group_response_200_data.additional_properties = d
        return get_service_group_response_200_data
