...
T = TypeVar("T", bound="PostDomainobjectsBody")


@_attrs_define
class PostDomainobjectsBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_domainobjects_body = cls(
            domain_identifiers=domain_identifiers,
            domain_types=domain_types,
        )

        post_domainobjects_body.additional_properties = d
        return post_domainobjects_body
