...
if TYPE_CHECKING:
    from ..models.dynamic_group_process_sets_group_and_query_result import (
        DynamicGroupProcessSetsGroupAndQueryResult,
    )
    from ..models.dynamic_group_process_sets_group_only import (
        DynamicGroupProcessSetsGroupOnly,
    )
    from ..models.dynamic_group_process_sets_query_result_only import (
        DynamicGroupProcessSetsQueryResultOnly,
    )


T = TypeVar("T", bound="DynamicGroupProcessSets")


@_attrs_define
class DynamicGroupProcessSets:
    """
    Attributes:
        group_and_query_result (DynamicGroupProcessSetsGroupAndQueryResult | Unset):
        group_only (DynamicGroupProcessSetsGroupOnly | Unset):
        query_result_only (DynamicGroupProcessSetsQueryResultOnly | Unset):
    """

    group_and_query_result: DynamicGroupProcessSetsGroupAndQueryResult | Unset = UNSET
    group_only: DynamicGroupProcessSetsGroupOnly | Unset = UNSET
    query_result_only: DynamicGroupProcessSetsQueryResultOnly | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_group_and_query_result, Unset):
            ...
            group_and_query_result = (
                DynamicGroupProcessSetsGroupAndQueryResult.from_dict(
        ...
        if isinstance(_group_only, Unset):
            ...
            group_only = DynamicGroupProcessSetsGroupOnly.from_dict(_group_only)
        ...
        if isinstance(_query_result_only, Unset):
            ...
            query_result_only = DynamicGroupProcessSetsQueryResultOnly.from_dict(
                _query_result_only
            )

        dynamic_group_process_sets = cls(
            group_and_query_result=group_and_query_result,
            group_only=group_only,
            query_result_only=query_result_only,
        )

        dynamic_group_process_sets.additional_properties = d
        return dynamic_group_process_sets
