...
from ..models.duplicate_group_response_201_data_signup_conditions_group_visibility import (
    DuplicateGroupResponse201DataSignupConditionsGroupVisibility,
)

T = TypeVar("T", bound="DuplicateGroupResponse201DataSignupConditions")


@_attrs_define
class DuplicateGroupResponse201DataSignupConditions:
    """
    Attributes:
        ...
        group_visibility (DuplicateGroupResponse201DataSignupConditionsGroupVisibility): The visibility of a group.
    ...
    group_is_open_for_members: bool
    group_is_public: bool
    group_visibility: DuplicateGroupResponse201DataSignupConditionsGroupVisibility
    new_person_department_is_set: bool
    new_person_station_is_set: bool
    new_person_status_is_set: bool
    sign_up_role_set_in_group: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        duplicate_group_response_201_data_signup_conditions = cls(
        ...
        duplicate_group_response_201_data_signup_conditions.additional_properties = d
        return duplicate_group_response_201_data_signup_conditions
