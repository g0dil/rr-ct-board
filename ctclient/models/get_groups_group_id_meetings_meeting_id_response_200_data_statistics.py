...
T = TypeVar("T", bound="GetGroupsGroupIdMeetingsMeetingIdResponse200DataStatistics")


@_attrs_define
class GetGroupsGroupIdMeetingsMeetingIdResponse200DataStatistics:
    """
    Attributes:
        absent (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_groups_group_id_meetings_meeting_id_response_200_data_statistics = cls(
            absent=absent,
        ...
        get_groups_group_id_meetings_meeting_id_response_200_data_statistics.additional_properties = d
        return get_groups_group_id_meetings_meeting_id_response_200_data_statistics
