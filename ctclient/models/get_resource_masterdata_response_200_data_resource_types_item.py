...
T = TypeVar("T", bound="GetResourceMasterdataResponse200DataResourceTypesItem")


@_attrs_define
class GetResourceMasterdataResponse200DataResourceTypesItem:
    """
    Attributes:
        id (int):  Example: 3.
        name_plural_translated (str):  Example: Rooms.
        name_translated (str):  Example: Rooms.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update(
            {
                "id": id,
                "namePluralTranslated": name_plural_translated,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        name_plural_translated = d.pop("namePluralTranslated")
        ...
        get_resource_masterdata_response_200_data_resource_types_item = cls(
            id=id,
        ...
        get_resource_masterdata_response_200_data_resource_types_item.additional_properties = d
        return get_resource_masterdata_response_200_data_resource_types_item
