...
T = TypeVar("T", bound="TranslationKeyTranslationsTranslation")


@_attrs_define
class TranslationKeyTranslationsTranslation:
    """Translation object
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        translation_key_translations_translation = cls(
            translation=translation,
            updated=updated,
            updated_by_church=updated_by_church,
        )

        translation_key_translations_translation.additional_properties = d
        return translation_key_translations_translation
