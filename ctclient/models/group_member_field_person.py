...
if TYPE_CHECKING:
    from ..models.group_member_field_person_db_field import (
        GroupMemberFieldPersonDbField,
    )


T = TypeVar("T", bound="GroupMemberFieldPerson")


@_attrs_define
class GroupMemberFieldPerson:
    """
    Attributes:
        db_field (GroupMemberFieldPersonDbField):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        db_field = GroupMemberFieldPersonDbField.from_dict(d.pop("dbField"))
        ...
        group_member_field_person.additional_properties = d
        return group_member_field_person
