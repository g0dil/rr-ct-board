...
if TYPE_CHECKING:
    from ..models.get_subscriptions_person_id_response_200_data_item_type_3_meta_type_0_created_person import (
        GetSubscriptionsPersonIdResponse200DataItemType3MetaType0CreatedPerson,
    )
    from ..models.get_subscriptions_person_id_response_200_data_item_type_3_meta_type_0_modified_person import (
        GetSubscriptionsPersonIdResponse200DataItemType3MetaType0ModifiedPerson,
    )


T = TypeVar("T", bound="GetSubscriptionsPersonIdResponse200DataItemType3MetaType0")


@_attrs_define
class GetSubscriptionsPersonIdResponse200DataItemType3MetaType0:
    """
    Attributes:
        ...
        created_person (GetSubscriptionsPersonIdResponse200DataItemType3MetaType0CreatedPerson | Unset):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetSubscriptionsPersonIdResponse200DataItemType3MetaType0ModifiedPerson | Unset):
    """

    created_date: datetime.datetime | Unset = UNSET
    created_person: (
        GetSubscriptionsPersonIdResponse200DataItemType3MetaType0CreatedPerson | Unset
    ) = UNSET
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: (
        GetSubscriptionsPersonIdResponse200DataItemType3MetaType0ModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_created_person, Unset):
            ...
            created_person = GetSubscriptionsPersonIdResponse200DataItemType3MetaType0CreatedPerson.from_dict(
                _created_person
            )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GetSubscriptionsPersonIdResponse200DataItemType3MetaType0ModifiedPerson.from_dict(
                _modified_person
            )

        get_subscriptions_person_id_response_200_data_item_type_3_meta_type_0 = cls(
        ...
        get_subscriptions_person_id_response_200_data_item_type_3_meta_type_0.additional_properties = d
        return get_subscriptions_person_id_response_200_data_item_type_3_meta_type_0
