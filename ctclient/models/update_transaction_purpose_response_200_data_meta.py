...
if TYPE_CHECKING:
    from ..models.update_transaction_purpose_response_200_data_meta_created_person import (
        UpdateTransactionPurposeResponse200DataMetaCreatedPerson,
    )
    from ..models.update_transaction_purpose_response_200_data_meta_modified_person import (
        UpdateTransactionPurposeResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="UpdateTransactionPurposeResponse200DataMeta")


@_attrs_define
class UpdateTransactionPurposeResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (UpdateTransactionPurposeResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (UpdateTransactionPurposeResponse200DataMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        UpdateTransactionPurposeResponse200DataMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            UpdateTransactionPurposeResponse200DataMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                UpdateTransactionPurposeResponse200DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        update_transaction_purpose_response_200_data_meta = cls(
        ...
        update_transaction_purpose_response_200_data_meta.additional_properties = d
        return update_transaction_purpose_response_200_data_meta
