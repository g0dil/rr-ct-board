...
from ..models.post_group_roles_body_type import PostGroupRolesBodyType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostGroupRolesBody")


@_attrs_define
class PostGroupRolesBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = PostGroupRolesBodyType(d.pop("type"))

        is_leader = d.pop("isLeader", UNSET)

        post_group_roles_body = cls(
        ...
        post_group_roles_body.additional_properties = d
        return post_group_roles_body
