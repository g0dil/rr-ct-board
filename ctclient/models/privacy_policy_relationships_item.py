...
if TYPE_CHECKING:
    from ..models.privacy_policy_relationships_item_relationship_type import (
        PrivacyPolicyRelationshipsItemRelationshipType,
    )


T = TypeVar("T", bound="PrivacyPolicyRelationshipsItem")


@_attrs_define
class PrivacyPolicyRelationshipsItem:
    """
    Attributes:
        accepted (bool):
        ...
        image (None | str):
        last_name (str):
        relationship_type (PrivacyPolicyRelationshipsItemRelationshipType):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        relationship_type = PrivacyPolicyRelationshipsItemRelationshipType.from_dict(
            d.pop("relationshipType")
        )

        privacy_policy_relationships_item = cls(
            accepted=accepted,
        ...
        privacy_policy_relationships_item.additional_properties = d
        return privacy_policy_relationships_item
