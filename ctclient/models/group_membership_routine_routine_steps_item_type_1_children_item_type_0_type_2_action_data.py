...
T = TypeVar(
    "T",
    bound="GroupMembershipRoutineRoutineStepsItemType1ChildrenItemType0Type2ActionData",
)


@_attrs_define
class GroupMembershipRoutineRoutineStepsItemType1ChildrenItemType0Type2ActionData:
    """
    Attributes:
        group_id (int):
        comment (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group_membership_routine_routine_steps_item_type_1_children_item_type_0_type_2_action_data = cls(
            group_id=group_id,
            comment=comment,
        ...
        group_membership_routine_routine_steps_item_type_1_children_item_type_0_type_2_action_data.additional_properties = d
        return group_membership_routine_routine_steps_item_type_1_children_item_type_0_type_2_action_data
