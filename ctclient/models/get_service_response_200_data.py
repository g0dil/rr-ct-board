...
T = TypeVar("T", bound="GetServiceResponse200Data")


@_attrs_define
class GetServiceResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_service_response_200_data = cls(
        ...
        get_service_response_200_data.additional_properties = d
        return get_service_response_200_data
