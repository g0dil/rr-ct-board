...
T = TypeVar("T", bound="GetPersonsPersonIdPoststatisticsResponse200DataItem")


@_attrs_define
class GetPersonsPersonIdPoststatisticsResponse200DataItem:
    """
    Attributes:
        count_banned (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_persons_person_id_poststatistics_response_200_data_item = cls(
        ...
        get_persons_person_id_poststatistics_response_200_data_item.additional_properties = d
        return get_persons_person_id_poststatistics_response_200_data_item
