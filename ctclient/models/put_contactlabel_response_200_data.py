...
T = TypeVar("T", bound="PutContactlabelResponse200Data")


@_attrs_define
class PutContactlabelResponse200Data:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_contactlabel_response_200_data = cls(
            id=id,
        ...
        put_contactlabel_response_200_data.additional_properties = d
        return put_contactlabel_response_200_data
