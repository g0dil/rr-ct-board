...
if TYPE_CHECKING:
    from ..models.get_calendars_calendar_id_appointments_response_200_data_item_base_image_type_0_image_option import (
        GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseImageType0ImageOption,
    )
    from ..models.get_calendars_calendar_id_appointments_response_200_data_item_base_image_type_0_meta import (
        GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseImageType0Meta,
    )


T = TypeVar(
    "T", bound="GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseImageType0"
)


@_attrs_define
class GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseImageType0:
    """
    Attributes:
        ...
        id (int):  Example: 6071.
        image_option (GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseImageType0ImageOption):
        image_url (str):  Example:
            http://churchtools.test/images/6071/70987c31abdea3986f69a6d601222ac9a388c36a6510564a80fae29311faec89.
        meta (GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseImageType0Meta):  Example: {'createdDate':
    ...
    image_url: str
    meta: GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseImageType0Meta
    name: str
    relative_url: str
    security_level_id: int | None
    show_only_when_editable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_option = GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseImageType0ImageOption.from_dict(
            d.pop("imageOption")
        )

        image_url = d.pop("imageUrl")

        meta = GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseImageType0Meta.from_dict(
            d.pop("meta")
        )
        ...
        get_calendars_calendar_id_appointments_response_200_data_item_base_image_type_0 = cls(
        ...
        get_calendars_calendar_id_appointments_response_200_data_item_base_image_type_0.additional_properties = d
        return get_calendars_calendar_id_appointments_response_200_data_item_base_image_type_0
