...
T = TypeVar("T", bound="CreateNewAccountingPeriodResponse201DataPermissions")


@_attrs_define
class CreateNewAccountingPeriodResponse201DataPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_new_accounting_period_response_201_data_permissions = cls(
            can_use_expert_mode=can_use_expert_mode,
            edit_accounting_period=edit_accounting_period,
        )

        create_new_accounting_period_response_201_data_permissions.additional_properties = d
        return create_new_accounting_period_response_201_data_permissions
