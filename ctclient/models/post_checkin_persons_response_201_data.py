...
from ..models.post_checkin_persons_response_201_data_invitation_status_type_0 import (
    PostCheckinPersonsResponse201DataInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_checkin_persons_response_201_data_emails_item import (
        PostCheckinPersonsResponse201DataEmailsItem,
    )
    from ..models.post_checkin_persons_response_201_data_meta import (
        PostCheckinPersonsResponse201DataMeta,
    )
    from ..models.post_checkin_persons_response_201_data_privacy_policy_agreement import (
        PostCheckinPersonsResponse201DataPrivacyPolicyAgreement,
    )
    from ..models.post_checkin_persons_response_201_data_tags_item import (
        PostCheckinPersonsResponse201DataTagsItem,
    )


T = TypeVar("T", bound="PostCheckinPersonsResponse201Data")


@_attrs_define
class PostCheckinPersonsResponse201Data:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[PostCheckinPersonsResponse201DataEmailsItem] | Unset):
            ...
            invitation_status (None | PostCheckinPersonsResponse201DataInvitationStatusType0 | Unset):
            ...
            meta (PostCheckinPersonsResponse201DataMeta | Unset):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            ...
            privacy_policy_agreement (PostCheckinPersonsResponse201DataPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[PostCheckinPersonsResponse201DataTagsItem] | Unset):
            title (str | Unset):
    ...
    emails: list[PostCheckinPersonsResponse201DataEmailsItem] | Unset = UNSET
    ...
    invitation_status: (
        None | PostCheckinPersonsResponse201DataInvitationStatusType0 | Unset
    ) = UNSET
    ...
    meta: PostCheckinPersonsResponse201DataMeta | Unset = UNSET
    ...
    privacy_policy_agreement: (
        PostCheckinPersonsResponse201DataPrivacyPolicyAgreement | Unset
    ) = UNSET
    ...
    tags: list[PostCheckinPersonsResponse201DataTagsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = PostCheckinPersonsResponse201DataEmailsItem.from_dict(
                emails_item_data
            )
        ...
        def _parse_invitation_status(
            ...
            try:
                ...
                invitation_status_type_0 = (
                    PostCheckinPersonsResponse201DataInvitationStatusType0(data)
                )
        ...
        meta: PostCheckinPersonsResponse201DataMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = PostCheckinPersonsResponse201DataMeta.from_dict(_meta)
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = (
                PostCheckinPersonsResponse201DataPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = PostCheckinPersonsResponse201DataTagsItem.from_dict(
                tags_item_data
            )
        ...
        post_checkin_persons_response_201_data = cls(
        ...
        post_checkin_persons_response_201_data.additional_properties = d
        return post_checkin_persons_response_201_data
