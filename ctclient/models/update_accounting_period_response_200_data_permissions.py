...
T = TypeVar("T", bound="UpdateAccountingPeriodResponse200DataPermissions")


@_attrs_define
class UpdateAccountingPeriodResponse200DataPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_accounting_period_response_200_data_permissions = cls(
            can_use_expert_mode=can_use_expert_mode,
            edit_accounting_period=edit_accounting_period,
        )

        update_accounting_period_response_200_data_permissions.additional_properties = d
        return update_accounting_period_response_200_data_permissions
