...
T = TypeVar("T", bound="ResourceTypeCreate")


@_attrs_define
class ResourceTypeCreate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_type_create.additional_properties = d
        return resource_type_create
