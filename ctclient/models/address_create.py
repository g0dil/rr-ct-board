...
from ..models.address_create_color_type_0 import AddressCreateColorType0
from ..models.address_create_color_type_1 import AddressCreateColorType1
...
class AddressCreate:
    ...
    Attributes:
        ...
        color (AddressCreateColorType0 | AddressCreateColorType1 | None):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        color: None | str
        if isinstance(self.color, AddressCreateColorType0):
            color = self.color.value
        elif isinstance(self.color, AddressCreateColorType1):
            color = self.color.value
        else:
            color = self.color
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_color(
            data: object,
        ) -> AddressCreateColorType0 | AddressCreateColorType1 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                color_type_0 = AddressCreateColorType0(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                color_type_1 = AddressCreateColorType1(data)

                return color_type_1
            except:  # noqa: E722
                pass
            return cast(AddressCreateColorType0 | AddressCreateColorType1 | None, data)
