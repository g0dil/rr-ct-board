...
if TYPE_CHECKING:
    from ..models.put_sync_externalsystems_external_system_id_jobconfigs_response_200_job_configuration_return_create_defaults_es import (
        PutSyncExternalsystemsExternalSystemIdJobconfigsResponse200JobConfigurationReturnCreateDefaultsES,
    )
    from ..models.put_sync_externalsystems_external_system_id_jobconfigs_response_200_job_configuration_return_create_defaults_master import (
        PutSyncExternalsystemsExternalSystemIdJobconfigsResponse200JobConfigurationReturnCreateDefaultsMaster,
    )
    from ..models.put_sync_externalsystems_external_system_id_jobconfigs_response_200_job_configuration_return_external_system import (
...
T = TypeVar(
    "T",
    bound="PutSyncExternalsystemsExternalSystemIdJobconfigsResponse200JobConfigurationReturn",
)


@_attrs_define
class PutSyncExternalsystemsExternalSystemIdJobconfigsResponse200JobConfigurationReturn:
    """
    Attributes:
        ...
        create_defaults_es
            (PutSyncExternalsystemsExternalSystemIdJobconfigsResponse200JobConfigurationReturnCreateDefaultsES | Unset):
        create_defaults_master
            (PutSyncExternalsystemsExternalSystemIdJobconfigsResponse200JobConfigurationReturnCreateDefaultsMaster | Unset):
        delete_behavior_es (str | Unset):
        delete_behavior_master (str | Unset):
        external_system (PutSyncExternalsystemsExternalSystemIdJobconfigsResponse200JobConfigurationReturnExternalSystem
            | Unset):
        id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_create_defaults_es, Unset):
            ...
            create_defaults_es = PutSyncExternalsystemsExternalSystemIdJobconfigsResponse200JobConfigurationReturnCreateDefaultsES.from_dict(
                _create_defaults_es
            )
        ...
        if isinstance(_create_defaults_master, Unset):
            ...
            create_defaults_master = PutSyncExternalsystemsExternalSystemIdJobconfigsResponse200JobConfigurationReturnCreateDefaultsMaster.from_dict(
        ...
        if isinstance(_external_system, Unset):
            ...
            external_system = PutSyncExternalsystemsExternalSystemIdJobconfigsResponse200JobConfigurationReturnExternalSystem.from_dict(
                _external_system
            )
        ...
        put_sync_externalsystems_external_system_id_jobconfigs_response_200_job_configuration_return = cls(
        ...
        put_sync_externalsystems_external_system_id_jobconfigs_response_200_job_configuration_return.additional_properties = d
        return put_sync_externalsystems_external_system_id_jobconfigs_response_200_job_configuration_return
