...
if TYPE_CHECKING:
    from ..models.post_followups_follow_up_id_postpone_response_200_data_meta_created_person import (
        PostFollowupsFollowUpIdPostponeResponse200DataMetaCreatedPerson,
    )
    from ..models.post_followups_follow_up_id_postpone_response_200_data_meta_modified_person import (
        PostFollowupsFollowUpIdPostponeResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="PostFollowupsFollowUpIdPostponeResponse200DataMeta")


@_attrs_define
class PostFollowupsFollowUpIdPostponeResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (PostFollowupsFollowUpIdPostponeResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (PostFollowupsFollowUpIdPostponeResponse200DataMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        PostFollowupsFollowUpIdPostponeResponse200DataMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            PostFollowupsFollowUpIdPostponeResponse200DataMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = PostFollowupsFollowUpIdPostponeResponse200DataMetaModifiedPerson.from_dict(
                _modified_person
            )

        post_followups_follow_up_id_postpone_response_200_data_meta = cls(
        ...
        post_followups_follow_up_id_postpone_response_200_data_meta.additional_properties = d
        return post_followups_follow_up_id_postpone_response_200_data_meta
