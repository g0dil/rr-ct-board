...
T = TypeVar("T", bound="GetAllStatusesResponse200DataItem")


@_attrs_define
class GetAllStatusesResponse200DataItem:
    """
    Attributes:
        id (int): ID of status
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_statuses_response_200_data_item = cls(
            id=id,
            is_member=is_member,
        ...
        get_all_statuses_response_200_data_item.additional_properties = d
        return get_all_statuses_response_200_data_item
