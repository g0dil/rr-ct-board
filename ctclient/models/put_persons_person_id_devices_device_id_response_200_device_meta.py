...
if TYPE_CHECKING:
    from ..models.put_persons_person_id_devices_device_id_response_200_device_meta_created_person import (
        PutPersonsPersonIdDevicesDeviceIdResponse200DeviceMetaCreatedPerson,
    )
    from ..models.put_persons_person_id_devices_device_id_response_200_device_meta_modified_person import (
        PutPersonsPersonIdDevicesDeviceIdResponse200DeviceMetaModifiedPerson,
    )


T = TypeVar("T", bound="PutPersonsPersonIdDevicesDeviceIdResponse200DeviceMeta")


@_attrs_define
class PutPersonsPersonIdDevicesDeviceIdResponse200DeviceMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (PutPersonsPersonIdDevicesDeviceIdResponse200DeviceMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (PutPersonsPersonIdDevicesDeviceIdResponse200DeviceMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        PutPersonsPersonIdDevicesDeviceIdResponse200DeviceMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = PutPersonsPersonIdDevicesDeviceIdResponse200DeviceMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = PutPersonsPersonIdDevicesDeviceIdResponse200DeviceMetaModifiedPerson.from_dict(
                _modified_person
            )

        put_persons_person_id_devices_device_id_response_200_device_meta = cls(
        ...
        put_persons_person_id_devices_device_id_response_200_device_meta.additional_properties = d
        return put_persons_person_id_devices_device_id_response_200_device_meta
