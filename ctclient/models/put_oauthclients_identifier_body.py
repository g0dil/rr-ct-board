...
T = TypeVar("T", bound="PutOauthclientsIdentifierBody")


@_attrs_define
class PutOauthclientsIdentifierBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_oauthclients_identifier_body = cls(
            is_confidential=is_confidential,
            name=name,
            redirect_uri=redirect_uri,
        )

        put_oauthclients_identifier_body.additional_properties = d
        return put_oauthclients_identifier_body
