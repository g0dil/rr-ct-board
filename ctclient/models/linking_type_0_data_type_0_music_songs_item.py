...
T = TypeVar("T", bound="LinkingType0DataType0MusicSongsItem")


@_attrs_define
class LinkingType0DataType0MusicSongsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linking_type_0_data_type_0_music_songs_item = cls(
            disc=disc,
            track=track,
            url=url,
        )

        linking_type_0_data_type_0_music_songs_item.additional_properties = d
        return linking_type_0_data_type_0_music_songs_item
