...
T = TypeVar("T", bound="DeleteGroupAgegroupsAgeGroupIdResponse409DataReferencesItem")


@_attrs_define
class DeleteGroupAgegroupsAgeGroupIdResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_group_agegroups_age_group_id_response_409_data_references_item = cls(
        ...
        delete_group_agegroups_age_group_id_response_409_data_references_item.additional_properties = d
        return delete_group_agegroups_age_group_id_response_409_data_references_item
