...
T = TypeVar("T", bound="GetEventsIcalResponse200Data")


@_attrs_define
class GetEventsIcalResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_events_ical_response_200_data = cls(
            attribute=attribute,
            module=module,
            value=value,
        )

        get_events_ical_response_200_data.additional_properties = d
        return get_events_ical_response_200_data
