...
if TYPE_CHECKING:
    from ..models.create_new_account_class_response_200_data_item_meta_created_person import (
        CreateNewAccountClassResponse200DataItemMetaCreatedPerson,
    )
    from ..models.create_new_account_class_response_200_data_item_meta_modified_person import (
        CreateNewAccountClassResponse200DataItemMetaModifiedPerson,
    )


T = TypeVar("T", bound="CreateNewAccountClassResponse200DataItemMeta")


@_attrs_define
class CreateNewAccountClassResponse200DataItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (CreateNewAccountClassResponse200DataItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (CreateNewAccountClassResponse200DataItemMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        CreateNewAccountClassResponse200DataItemMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            CreateNewAccountClassResponse200DataItemMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                CreateNewAccountClassResponse200DataItemMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        create_new_account_class_response_200_data_item_meta = cls(
        ...
        create_new_account_class_response_200_data_item_meta.additional_properties = d
        return create_new_account_class_response_200_data_item_meta
