...
if TYPE_CHECKING:
    from ..models.get_account_by_id_response_200_data_meta import (
        GetAccountByIdResponse200DataMeta,
    )
    from ..models.get_account_by_id_response_200_data_permissions import (
        GetAccountByIdResponse200DataPermissions,
    )


T = TypeVar("T", bound="GetAccountByIdResponse200Data")


@_attrs_define
class GetAccountByIdResponse200Data:
    """
    Attributes:
        ...
        meta (GetAccountByIdResponse200DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson':
            {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        name (str):  Example: Donations.
        number (str):  Example: 8200.
        permissions (GetAccountByIdResponse200DataPermissions):
    ...
    is_opening_balance_account: bool
    meta: GetAccountByIdResponse200DataMeta
    name: str
    number: str
    permissions: GetAccountByIdResponse200DataPermissions
    tax_rate_id: int | None
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = GetAccountByIdResponse200DataMeta.from_dict(d.pop("meta"))

        name = d.pop("name")

        number = d.pop("number")

        permissions = GetAccountByIdResponse200DataPermissions.from_dict(
            d.pop("permissions")
        )
        ...
        get_account_by_id_response_200_data = cls(
        ...
        get_account_by_id_response_200_data.additional_properties = d
        return get_account_by_id_response_200_data
