...
T = TypeVar("T", bound="PutProfilesChurchBodySocialMedia")


@_attrs_define
class PutProfilesChurchBodySocialMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_profiles_church_body_social_media = cls(
            social_network_name=social_network_name,
        )

        put_profiles_church_body_social_media.additional_properties = d
        return put_profiles_church_body_social_media
