...
if TYPE_CHECKING:
    from ..models.create_tax_type_response_200_data_meta_created_person import (
        CreateTaxTypeResponse200DataMetaCreatedPerson,
    )
    from ..models.create_tax_type_response_200_data_meta_modified_person import (
        CreateTaxTypeResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="CreateTaxTypeResponse200DataMeta")


@_attrs_define
class CreateTaxTypeResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (CreateTaxTypeResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (CreateTaxTypeResponse200DataMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: CreateTaxTypeResponse200DataMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: CreateTaxTypeResponse200DataMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = CreateTaxTypeResponse200DataMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = CreateTaxTypeResponse200DataMetaModifiedPerson.from_dict(
                _modified_person
            )

        create_tax_type_response_200_data_meta = cls(
        ...
        create_tax_type_response_200_data_meta.additional_properties = d
        return create_tax_type_response_200_data_meta
