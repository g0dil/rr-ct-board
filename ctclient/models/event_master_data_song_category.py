...
T = TypeVar("T", bound="EventMasterDataSongCategory")


@_attrs_define
class EventMasterDataSongCategory:
    """
    Attributes:
        campus_id (int | Unset):
        id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_master_data_song_category = cls(
            campus_id=campus_id,
            id=id,
            name=name,
        ...
        event_master_data_song_category.additional_properties = d
        return event_master_data_song_category
