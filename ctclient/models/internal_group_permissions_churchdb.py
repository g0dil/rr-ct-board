...
T = TypeVar("T", bound="InternalGroupPermissionsChurchdb")


@_attrs_define
class InternalGroupPermissionsChurchdb:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        internal_group_permissions_churchdb = cls(
        ...
        internal_group_permissions_churchdb.additional_properties = d
        return internal_group_permissions_churchdb
