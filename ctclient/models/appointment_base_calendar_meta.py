...
T = TypeVar("T", bound="AppointmentBaseCalendarMeta")


@_attrs_define
class AppointmentBaseCalendarMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appointment_base_calendar_meta = cls(
            modified_date=modified_date,
            modified_pid=modified_pid,
        )

        appointment_base_calendar_meta.additional_properties = d
        return appointment_base_calendar_meta
