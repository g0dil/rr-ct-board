...
T = TypeVar("T", bound="PostBulkjobsInfosBody")


@_attrs_define
class PostBulkjobsInfosBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_bulkjobs_infos_body = cls(
            domain_object_identifiers=domain_object_identifiers,
            job_data=job_data,
        )

        post_bulkjobs_infos_body.additional_properties = d
        return post_bulkjobs_infos_body
