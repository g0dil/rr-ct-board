...
if TYPE_CHECKING:
    from ..models.get_events_event_id_facts_response_200_event_fact_meta_created_person import (
        GetEventsEventIdFactsResponse200EventFactMetaCreatedPerson,
    )
    from ..models.get_events_event_id_facts_response_200_event_fact_meta_modified_person import (
        GetEventsEventIdFactsResponse200EventFactMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetEventsEventIdFactsResponse200EventFactMeta")


@_attrs_define
class GetEventsEventIdFactsResponse200EventFactMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetEventsEventIdFactsResponse200EventFactMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetEventsEventIdFactsResponse200EventFactMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        GetEventsEventIdFactsResponse200EventFactMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            GetEventsEventIdFactsResponse200EventFactMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                GetEventsEventIdFactsResponse200EventFactMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        get_events_event_id_facts_response_200_event_fact_meta = cls(
        ...
        get_events_event_id_facts_response_200_event_fact_meta.additional_properties = d
        return get_events_event_id_facts_response_200_event_fact_meta
