...
from ..models.put_songs_song_id_arrangements_arrangement_id_body_key_type_0 import (
    PutSongsSongIdArrangementsArrangementIdBodyKeyType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutSongsSongIdArrangementsArrangementIdBody")


@_attrs_define
class PutSongsSongIdArrangementsArrangementIdBody:
    ...
    Attributes:
        ...
        key (None | PutSongsSongIdArrangementsArrangementIdBodyKeyType0 | Unset):
    ...
    key: None | PutSongsSongIdArrangementsArrangementIdBodyKeyType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.key, Unset):
            key = UNSET
        elif isinstance(self.key, PutSongsSongIdArrangementsArrangementIdBodyKeyType0):
            key = self.key.value
        else:
            key = self.key
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_key(
            data: object,
        ) -> None | PutSongsSongIdArrangementsArrangementIdBodyKeyType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                key_type_0 = PutSongsSongIdArrangementsArrangementIdBodyKeyType0(data)

                return key_type_0
            except:  # noqa: E722
                pass
            return cast(
                None | PutSongsSongIdArrangementsArrangementIdBodyKeyType0 | Unset, data
            )
        ...
        put_songs_song_id_arrangements_arrangement_id_body = cls(
            name=name,
            beat=beat,
        ...
        put_songs_song_id_arrangements_arrangement_id_body.additional_properties = d
        return put_songs_song_id_arrangements_arrangement_id_body
