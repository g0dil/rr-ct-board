...
T = TypeVar(
    "T", bound="DeleteExternalloginsExternalloginidResponse409DataReferencesItem"
)


@_attrs_define
class DeleteExternalloginsExternalloginidResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_externallogins_externalloginid_response_409_data_references_item = cls(
        ...
        delete_externallogins_externalloginid_response_409_data_references_item.additional_properties = d
        return delete_externallogins_externalloginid_response_409_data_references_item
