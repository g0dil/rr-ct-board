...
from ..models.get_groups_group_id_members_routines_response_200_data_item_routine_steps_item_type_1_children_item_type_0_type_1_action_data_color import (
    GetGroupsGroupIdMembersRoutinesResponse200DataItemRoutineStepsItemType1ChildrenItemType0Type1ActionDataColor,
)
from ..models.get_groups_group_id_members_routines_response_200_data_item_routine_steps_item_type_1_children_item_type_0_type_1_action_data_continuation_type import (
    GetGroupsGroupIdMembersRoutinesResponse200DataItemRoutineStepsItemType1ChildrenItemType0Type1ActionDataContinuationType,
)
from ..models.get_groups_group_id_members_routines_response_200_data_item_routine_steps_item_type_1_children_item_type_0_type_1_action_data_success_group_member_status_type_0 import (
...
T = TypeVar(
    "T",
    bound="GetGroupsGroupIdMembersRoutinesResponse200DataItemRoutineStepsItemType1ChildrenItemType0Type1ActionData",
)


@_attrs_define
class GetGroupsGroupIdMembersRoutinesResponse200DataItemRoutineStepsItemType1ChildrenItemType0Type1ActionData:
    """
    Attributes:
        continuation_type (GetGroupsGroupIdMembersRoutinesResponse200DataItemRoutineStepsItemType1ChildrenItemType0Type1
            ActionDataContinuationType):
        description (None | str):
        title (str):
        color
            (GetGroupsGroupIdMembersRoutinesResponse200DataItemRoutineStepsItemType1ChildrenItemType0Type1ActionDataColor |
            Unset): A color in ChurchTools
        ...
        success_group_member_status (GetGroupsGroupIdMembersRoutinesResponse200DataItemRoutineStepsItemType1ChildrenItem
            Type0Type1ActionDataSuccessGroupMemberStatusType0 | None | Unset):
        success_group_of_group_type_id (int | None | Unset):
        success_role_id (int | None | Unset):
    """

    continuation_type: GetGroupsGroupIdMembersRoutinesResponse200DataItemRoutineStepsItemType1ChildrenItemType0Type1ActionDataContinuationType
    description: None | str
    title: str
    color: (
        GetGroupsGroupIdMembersRoutinesResponse200DataItemRoutineStepsItemType1ChildrenItemType0Type1ActionDataColor
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_color, Unset):
            ...
            color = GetGroupsGroupIdMembersRoutinesResponse200DataItemRoutineStepsItemType1ChildrenItemType0Type1ActionDataColor(
                _color
            )
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = GetGroupsGroupIdMembersRoutinesResponse200DataItemRoutineStepsItemType1ChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        get_groups_group_id_members_routines_response_200_data_item_routine_steps_item_type_1_children_item_type_0_type_1_action_data = cls(
        ...
        get_groups_group_id_members_routines_response_200_data_item_routine_steps_item_type_1_children_item_type_0_type_1_action_data.additional_properties = d
        return get_groups_group_id_members_routines_response_200_data_item_routine_steps_item_type_1_children_item_type_0_type_1_action_data
