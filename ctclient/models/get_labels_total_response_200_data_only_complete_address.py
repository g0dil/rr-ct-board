...
T = TypeVar("T", bound="GetLabelsTotalResponse200DataOnlyCompleteAddress")


@_attrs_define
class GetLabelsTotalResponse200DataOnlyCompleteAddress:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_labels_total_response_200_data_only_complete_address = cls(
            combined_labels=combined_labels,
            total_labels=total_labels,
        )

        get_labels_total_response_200_data_only_complete_address.additional_properties = d
        return get_labels_total_response_200_data_only_complete_address
