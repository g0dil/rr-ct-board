...
from ..models.patch_posts_post_id_body_visibility import PatchPostsPostIdBodyVisibility
from ..types import UNSET, Unset

T = TypeVar("T", bound="PatchPostsPostIdBody")


@_attrs_define
class PatchPostsPostIdBody:
    """
    Attributes:
        ...
        title (str | Unset):
        visibility (PatchPostsPostIdBodyVisibility | Unset):
    """
    ...
    visibility: PatchPostsPostIdBodyVisibility | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_visibility, Unset):
            ...
            visibility = PatchPostsPostIdBodyVisibility(_visibility)

        patch_posts_post_id_body = cls(
        ...
        patch_posts_post_id_body.additional_properties = d
        return patch_posts_post_id_body
