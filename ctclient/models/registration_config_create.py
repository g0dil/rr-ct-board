...
if TYPE_CHECKING:
    from ..models.registration_config_create_campuses_item import (
        RegistrationConfigCreateCampusesItem,
    )
    from ..models.registration_config_create_fields_item import (
        RegistrationConfigCreateFieldsItem,
    )


T = TypeVar("T", bound="RegistrationConfigCreate")


@_attrs_define
class RegistrationConfigCreate:
    """
    Attributes:
        blacklist (list[str]):
        campuses (list[RegistrationConfigCreateCampusesItem]):
        department_ids (list[int]):
        fields (list[RegistrationConfigCreateFieldsItem]):
        id (int):
        is_active (bool):
        minimum_age (int):
        show_button (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for campuses_item_data in _campuses:
            campuses_item = RegistrationConfigCreateCampusesItem.from_dict(
                campuses_item_data
            )
        ...
        for fields_item_data in _fields:
            fields_item = RegistrationConfigCreateFieldsItem.from_dict(fields_item_data)
        ...
        registration_config_create = cls(
            blacklist=blacklist,
            campuses=campuses,
        ...
        registration_config_create.additional_properties = d
        return registration_config_create
