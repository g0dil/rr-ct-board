...
if TYPE_CHECKING:
    from ..models.get_grups_id_places_response_200_data_item_meta_created_person import (
        GetGrupsIdPlacesResponse200DataItemMetaCreatedPerson,
    )
    from ..models.get_grups_id_places_response_200_data_item_meta_modified_person import (
        GetGrupsIdPlacesResponse200DataItemMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetGrupsIdPlacesResponse200DataItemMeta")


@_attrs_define
class GetGrupsIdPlacesResponse200DataItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetGrupsIdPlacesResponse200DataItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetGrupsIdPlacesResponse200DataItemMetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = GetGrupsIdPlacesResponse200DataItemMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                GetGrupsIdPlacesResponse200DataItemMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        get_grups_id_places_response_200_data_item_meta = cls(
        ...
        get_grups_id_places_response_200_data_item_meta.additional_properties = d
        return get_grups_id_places_response_200_data_item_meta
