...
T = TypeVar("T", bound="CreateCostCenterBody")


@_attrs_define
class CreateCostCenterBody:
    """
    Example:
        {'accountingPeriodId': 4, 'budget': 2300, 'groupId': 5, 'name': 'Kostenstelle Jugend', 'number': '803'}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_cost_center_body.additional_properties = d
        return create_cost_center_body
