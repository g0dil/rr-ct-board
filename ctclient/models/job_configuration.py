...
if TYPE_CHECKING:
    from ..models.job_configuration_create_defaults_es import (
        JobConfigurationCreateDefaultsES,
    )
    from ..models.job_configuration_create_defaults_master import (
...
class JobConfiguration:
    ...
    Attributes:
        ...
        create_defaults_es (JobConfigurationCreateDefaultsES | Unset):
        create_defaults_master (JobConfigurationCreateDefaultsMaster | Unset):
    ...
    create_defaults_es: JobConfigurationCreateDefaultsES | Unset = UNSET
    create_defaults_master: JobConfigurationCreateDefaultsMaster | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_create_defaults_es, Unset):
            ...
            create_defaults_es = JobConfigurationCreateDefaultsES.from_dict(
                _create_defaults_es
            )
        ...
        if isinstance(_create_defaults_master, Unset):
            ...
            create_defaults_master = JobConfigurationCreateDefaultsMaster.from_dict(
