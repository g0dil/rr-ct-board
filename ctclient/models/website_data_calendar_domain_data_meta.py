...
T = TypeVar("T", bound="WebsiteDataCalendarDomainDataMeta")


@_attrs_define
class WebsiteDataCalendarDomainDataMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        website_data_calendar_domain_data_meta = cls(
            modified_date=modified_date,
            modified_pid=modified_pid,
        )

        website_data_calendar_domain_data_meta.additional_properties = d
        return website_data_calendar_domain_data_meta
