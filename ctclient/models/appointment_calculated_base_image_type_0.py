...
if TYPE_CHECKING:
    from ..models.appointment_calculated_base_image_type_0_image_option import (
        AppointmentCalculatedBaseImageType0ImageOption,
    )
    from ..models.appointment_calculated_base_image_type_0_meta import (
        AppointmentCalculatedBaseImageType0Meta,
    )


T = TypeVar("T", bound="AppointmentCalculatedBaseImageType0")


@_attrs_define
class AppointmentCalculatedBaseImageType0:
    """
    Attributes:
        ...
        id (int):  Example: 6071.
        image_option (AppointmentCalculatedBaseImageType0ImageOption):
        image_url (str):  Example:
            http://churchtools.test/images/6071/70987c31abdea3986f69a6d601222ac9a388c36a6510564a80fae29311faec89.
        meta (AppointmentCalculatedBaseImageType0Meta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
    ...
    image_option: AppointmentCalculatedBaseImageType0ImageOption
    image_url: str
    meta: AppointmentCalculatedBaseImageType0Meta
    name: str
    relative_url: str
    security_level_id: int | None
    show_only_when_editable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_option = AppointmentCalculatedBaseImageType0ImageOption.from_dict(
            d.pop("imageOption")
        )

        image_url = d.pop("imageUrl")

        meta = AppointmentCalculatedBaseImageType0Meta.from_dict(d.pop("meta"))
        ...
        appointment_calculated_base_image_type_0 = cls(
        ...
        appointment_calculated_base_image_type_0.additional_properties = d
        return appointment_calculated_base_image_type_0
