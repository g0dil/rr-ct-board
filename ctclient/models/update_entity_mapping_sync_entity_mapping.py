...
from ..models.update_entity_mapping_sync_entity_mapping_status import (
    UpdateEntityMappingSyncEntityMappingStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_entity_mapping_sync_entity_mapping_meta import (
        UpdateEntityMappingSyncEntityMappingMeta,
    )


T = TypeVar("T", bound="UpdateEntityMappingSyncEntityMapping")


@_attrs_define
class UpdateEntityMappingSyncEntityMapping:
    ...
    Attributes:
        ...
        meta (UpdateEntityMappingSyncEntityMappingMeta | Unset):
        ...
        status (UpdateEntityMappingSyncEntityMappingStatus | Unset): Status of Relationship Example: synced.
    """
    ...
    meta: UpdateEntityMappingSyncEntityMappingMeta | Unset = UNSET
    scope: None | str | Unset = UNSET
    source_entity_id: str | Unset = UNSET
    source_id: int | Unset = UNSET
    status: UpdateEntityMappingSyncEntityMappingStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = UpdateEntityMappingSyncEntityMappingMeta.from_dict(_meta)
        ...
        status: UpdateEntityMappingSyncEntityMappingStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = UpdateEntityMappingSyncEntityMappingStatus(_status)

        update_entity_mapping_sync_entity_mapping = cls(
            domain_id=domain_id,
        ...
        update_entity_mapping_sync_entity_mapping.additional_properties = d
        return update_entity_mapping_sync_entity_mapping
