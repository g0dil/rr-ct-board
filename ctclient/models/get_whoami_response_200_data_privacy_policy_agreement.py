...
T = TypeVar("T", bound="GetWhoamiResponse200DataPrivacyPolicyAgreement")


@_attrs_define
class GetWhoamiResponse200DataPrivacyPolicyAgreement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_whoami_response_200_data_privacy_policy_agreement = cls(
            date=date,
            type_id=type_id,
            who_id=who_id,
        )

        get_whoami_response_200_data_privacy_policy_agreement.additional_properties = d
        return get_whoami_response_200_data_privacy_policy_agreement
