...
T = TypeVar("T", bound="DeleteBillResponse409DataReferencesItem")


@_attrs_define
class DeleteBillResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_bill_response_409_data_references_item = cls(
        ...
        delete_bill_response_409_data_references_item.additional_properties = d
        return delete_bill_response_409_data_references_item
