...
T = TypeVar("T", bound="GroupSettingsNewMember")
...
class GroupSettingsNewMember:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group_settings_new_member = cls(
            campus_id=campus_id,
            department_id=department_id,
            status_id=status_id,
        )

        group_settings_new_member.additional_properties = d
        return group_settings_new_member
