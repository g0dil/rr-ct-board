...
if TYPE_CHECKING:
    from ..models.person_meta_created_person import PersonMetaCreatedPerson
    from ..models.person_meta_modified_person import PersonMetaModifiedPerson


T = TypeVar("T", bound="PersonMeta")
...
class PersonMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = PersonMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = PersonMetaModifiedPerson.from_dict(_modified_person)
        ...
        person_meta.additional_properties = d
        return person_meta
