...
from ..models.place_create_marker_color_type_0 import PlaceCreateMarkerColorType0
from ..models.place_create_marker_color_type_1 import PlaceCreateMarkerColorType1
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlaceCreate")
...
class PlaceCreate:
    ...
    Attributes:
        ...
        marker_color (PlaceCreateMarkerColorType0 | PlaceCreateMarkerColorType1 | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.marker_color, Unset):
            marker_color = UNSET
        elif isinstance(self.marker_color, PlaceCreateMarkerColorType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_marker_color(
            data: object,
        ) -> PlaceCreateMarkerColorType0 | PlaceCreateMarkerColorType1 | Unset:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                marker_color_type_0 = PlaceCreateMarkerColorType0(data)
            ...
            if not isinstance(data, str):
                raise TypeError()
            marker_color_type_1 = PlaceCreateMarkerColorType1(data)
        ...
        place_create.additional_properties = d
        return place_create
