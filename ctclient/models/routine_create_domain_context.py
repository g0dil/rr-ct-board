...
from ..models.routine_create_domain_context_group_member_status import (
    RoutineCreateDomainContextGroupMemberStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RoutineCreateDomainContext")


@_attrs_define
class RoutineCreateDomainContext:
    """Attributes of the context in which this routine is going to be executed.

    Attributes:
        group_id (int):
        group_type_role_id (int):
        group_member_status (RoutineCreateDomainContextGroupMemberStatus | Unset):
    """

    group_id: int
    group_type_role_id: int
    group_member_status: RoutineCreateDomainContextGroupMemberStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_group_member_status, Unset):
            ...
            group_member_status = RoutineCreateDomainContextGroupMemberStatus(
                _group_member_status
            )

        routine_create_domain_context = cls(
            group_id=group_id,
            group_type_role_id=group_type_role_id,
            group_member_status=group_member_status,
        )

        routine_create_domain_context.additional_properties = d
        return routine_create_domain_context
