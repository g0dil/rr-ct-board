...
if TYPE_CHECKING:
    from ..models.get_groups_group_id_response_200_data_follow_up import (
        GetGroupsGroupIdResponse200DataFollowUp,
    )
    from ..models.get_groups_group_id_response_200_data_information import (
        GetGroupsGroupIdResponse200DataInformation,
    )
    from ..models.get_groups_group_id_response_200_data_member_statistics import (
        GetGroupsGroupIdResponse200DataMemberStatistics,
    )
    from ..models.get_groups_group_id_response_200_data_meta import (
        GetGroupsGroupIdResponse200DataMeta,
    )
    from ..models.get_groups_group_id_response_200_data_modified_person import (
        GetGroupsGroupIdResponse200DataModifiedPerson,
    )
    from ..models.get_groups_group_id_response_200_data_permissions import (
        GetGroupsGroupIdResponse200DataPermissions,
    )
    from ..models.get_groups_group_id_response_200_data_places_item import (
        GetGroupsGroupIdResponse200DataPlacesItem,
    )
    from ..models.get_groups_group_id_response_200_data_public_posts_statistic import (
        GetGroupsGroupIdResponse200DataPublicPostsStatistic,
    )
    from ..models.get_groups_group_id_response_200_data_roles_item import (
        GetGroupsGroupIdResponse200DataRolesItem,
    )
    from ..models.get_groups_group_id_response_200_data_settings import (
        GetGroupsGroupIdResponse200DataSettings,
    )
    from ..models.get_groups_group_id_response_200_data_signup_conditions import (
        GetGroupsGroupIdResponse200DataSignupConditions,
    )
    from ..models.get_groups_group_id_response_200_data_tags_item import (
        GetGroupsGroupIdResponse200DataTagsItem,
    )


T = TypeVar("T", bound="GetGroupsGroupIdResponse200Data")


@_attrs_define
class GetGroupsGroupIdResponse200Data:
    ...
    Custom group fields are added to the root level of this model.
        ...
        Attributes:
            follow_up (GetGroupsGroupIdResponse200DataFollowUp):
            guid (str):  Example: 681F54E3-2EB7-40A4-84F0-EFF8E8F05727.
            id (int):  Example: 42.
            information (GetGroupsGroupIdResponse200DataInformation):
            meta (GetGroupsGroupIdResponse200DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson':
                {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
            name (str):  Example: Smallgroup West.
            permissions (GetGroupsGroupIdResponse200DataPermissions):
            security_level_for_group (int): You can see group fields up to this security level. Example: 3.
            settings (GetGroupsGroupIdResponse200DataSettings):
            has_permissions (bool | Unset):
            member_statistics (GetGroupsGroupIdResponse200DataMemberStatistics | Unset):
            modified_date (str | Unset):
            modified_person (GetGroupsGroupIdResponse200DataModifiedPerson | Unset):
            places (list[GetGroupsGroupIdResponse200DataPlacesItem] | Unset):
            public_posts_statistic (GetGroupsGroupIdResponse200DataPublicPostsStatistic | Unset):
            roles (list[GetGroupsGroupIdResponse200DataRolesItem] | Unset):
            signup_conditions (GetGroupsGroupIdResponse200DataSignupConditions | Unset):
            tags (list[GetGroupsGroupIdResponse200DataTagsItem] | Unset):
    """
    ...
    id: int
    information: GetGroupsGroupIdResponse200DataInformation
    meta: GetGroupsGroupIdResponse200DataMeta
    name: str
    permissions: GetGroupsGroupIdResponse200DataPermissions
    security_level_for_group: int
    settings: GetGroupsGroupIdResponse200DataSettings
    has_permissions: bool | Unset = UNSET
    member_statistics: GetGroupsGroupIdResponse200DataMemberStatistics | Unset = UNSET
    modified_date: str | Unset = UNSET
    modified_person: GetGroupsGroupIdResponse200DataModifiedPerson | Unset = UNSET
    places: list[GetGroupsGroupIdResponse200DataPlacesItem] | Unset = UNSET
    public_posts_statistic: (
        GetGroupsGroupIdResponse200DataPublicPostsStatistic | Unset
    ) = UNSET
    roles: list[GetGroupsGroupIdResponse200DataRolesItem] | Unset = UNSET
    signup_conditions: GetGroupsGroupIdResponse200DataSignupConditions | Unset = UNSET
    tags: list[GetGroupsGroupIdResponse200DataTagsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        follow_up = GetGroupsGroupIdResponse200DataFollowUp.from_dict(d.pop("followUp"))

        guid = d.pop("guid")

        id = d.pop("id")

        information = GetGroupsGroupIdResponse200DataInformation.from_dict(
            d.pop("information")
        )

        meta = GetGroupsGroupIdResponse200DataMeta.from_dict(d.pop("meta"))

        name = d.pop("name")

        permissions = GetGroupsGroupIdResponse200DataPermissions.from_dict(
            d.pop("permissions")
        )

        security_level_for_group = d.pop("securityLevelForGroup")

        settings = GetGroupsGroupIdResponse200DataSettings.from_dict(d.pop("settings"))
        ...
        if isinstance(_member_statistics, Unset):
            ...
            member_statistics = (
                GetGroupsGroupIdResponse200DataMemberStatistics.from_dict(
                    _member_statistics
                )
            )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GetGroupsGroupIdResponse200DataModifiedPerson.from_dict(
                _modified_person
            )
        ...
        for places_item_data in _places or []:
            places_item = GetGroupsGroupIdResponse200DataPlacesItem.from_dict(
                places_item_data
            )
        ...
        if isinstance(_public_posts_statistic, Unset):
            ...
            public_posts_statistic = (
                GetGroupsGroupIdResponse200DataPublicPostsStatistic.from_dict(
        ...
        for roles_item_data in _roles or []:
            roles_item = GetGroupsGroupIdResponse200DataRolesItem.from_dict(
                roles_item_data
            )
        ...
        if isinstance(_signup_conditions, Unset):
            ...
            signup_conditions = (
                GetGroupsGroupIdResponse200DataSignupConditions.from_dict(
                    _signup_conditions
                )
            )
        ...
        for tags_item_data in _tags or []:
            tags_item = GetGroupsGroupIdResponse200DataTagsItem.from_dict(
                tags_item_data
            )

            tags.append(tags_item)

        get_groups_group_id_response_200_data = cls(
            follow_up=follow_up,
            guid=guid,
            id=id,
            information=information,
        ...
        get_groups_group_id_response_200_data.additional_properties = d
        return get_groups_group_id_response_200_data
