...
if TYPE_CHECKING:
    from ..models.appointment_calculated_with_includes_appointment_base_exceptions_item_meta_created_person import (
        AppointmentCalculatedWithIncludesAppointmentBaseExceptionsItemMetaCreatedPerson,
    )
    from ..models.appointment_calculated_with_includes_appointment_base_exceptions_item_meta_modified_person import (
        AppointmentCalculatedWithIncludesAppointmentBaseExceptionsItemMetaModifiedPerson,
    )


T = TypeVar(
    "T", bound="AppointmentCalculatedWithIncludesAppointmentBaseExceptionsItemMeta"
)


@_attrs_define
class AppointmentCalculatedWithIncludesAppointmentBaseExceptionsItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (AppointmentCalculatedWithIncludesAppointmentBaseExceptionsItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (AppointmentCalculatedWithIncludesAppointmentBaseExceptionsItemMetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = AppointmentCalculatedWithIncludesAppointmentBaseExceptionsItemMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = AppointmentCalculatedWithIncludesAppointmentBaseExceptionsItemMetaModifiedPerson.from_dict(
                _modified_person
            )

        appointment_calculated_with_includes_appointment_base_exceptions_item_meta = (
            cls(
        ...
        appointment_calculated_with_includes_appointment_base_exceptions_item_meta.additional_properties = d
        return (
            appointment_calculated_with_includes_appointment_base_exceptions_item_meta
        )
