...
if TYPE_CHECKING:
    from ..models.get_post_linkings_response_200_data_item_type_0_data_type_0_music_album import (
        GetPostLinkingsResponse200DataItemType0DataType0MusicAlbum,
    )
    from ..models.get_post_linkings_response_200_data_item_type_0_data_type_0_music_songs_item import (
        GetPostLinkingsResponse200DataItemType0DataType0MusicSongsItem,
    )


T = TypeVar("T", bound="GetPostLinkingsResponse200DataItemType0DataType0Music")


@_attrs_define
class GetPostLinkingsResponse200DataItemType0DataType0Music:
    """
    Attributes:
        album (GetPostLinkingsResponse200DataItemType0DataType0MusicAlbum | Unset):
        ...
        songs (list[GetPostLinkingsResponse200DataItemType0DataType0MusicSongsItem] | Unset):
    """

    album: GetPostLinkingsResponse200DataItemType0DataType0MusicAlbum | Unset = UNSET
    creators: list[str] | Unset = UNSET
    duration: int | Unset = UNSET
    musicians: list[str] | Unset = UNSET
    release_date: datetime.datetime | Unset = UNSET
    songs: (
        list[GetPostLinkingsResponse200DataItemType0DataType0MusicSongsItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_album, Unset):
            ...
            album = (
                GetPostLinkingsResponse200DataItemType0DataType0MusicAlbum.from_dict(
                    _album
                )
            )
        ...
        for songs_item_data in _songs or []:
            songs_item = GetPostLinkingsResponse200DataItemType0DataType0MusicSongsItem.from_dict(
                songs_item_data
            )

            songs.append(songs_item)

        get_post_linkings_response_200_data_item_type_0_data_type_0_music = cls(
            album=album,
            creators=creators,
            duration=duration,
            musicians=musicians,
        ...
        get_post_linkings_response_200_data_item_type_0_data_type_0_music.additional_properties = d
        return get_post_linkings_response_200_data_item_type_0_data_type_0_music
