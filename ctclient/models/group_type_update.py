...
from ..models.group_type_update_color import GroupTypeUpdateColor
from ..types import UNSET, Unset

T = TypeVar("T", bound="GroupTypeUpdate")


@_attrs_define
class GroupTypeUpdate:
    """
    Attributes:
        available_for_new_person (bool):
        color (GroupTypeUpdateColor): A color in ChurchTools
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color = GroupTypeUpdateColor(d.pop("color"))
        ...
        group_type_update.additional_properties = d
        return group_type_update
