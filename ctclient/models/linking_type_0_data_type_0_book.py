...
T = TypeVar("T", bound="LinkingType0DataType0Book")


@_attrs_define
class LinkingType0DataType0Book:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linking_type_0_data_type_0_book = cls(
            authors=authors,
            isbn=isbn,
        ...
        linking_type_0_data_type_0_book.additional_properties = d
        return linking_type_0_data_type_0_book
