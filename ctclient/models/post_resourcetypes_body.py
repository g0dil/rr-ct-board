...
T = TypeVar("T", bound="PostResourcetypesBody")


@_attrs_define
class PostResourcetypesBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_resourcetypes_body.additional_properties = d
        return post_resourcetypes_body
