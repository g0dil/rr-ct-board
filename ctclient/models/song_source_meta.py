...
if TYPE_CHECKING:
    from ..models.song_source_meta_created_person import SongSourceMetaCreatedPerson
    from ..models.song_source_meta_modified_person import SongSourceMetaModifiedPerson


T = TypeVar("T", bound="SongSourceMeta")


@_attrs_define
class SongSourceMeta:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.song_source_meta_created_person import SongSourceMetaCreatedPerson
        from ..models.song_source_meta_modified_person import (
        ...
        created_person = SongSourceMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = SongSourceMetaModifiedPerson.from_dict(_modified_person)

        song_source_meta = cls(
        ...
        song_source_meta.additional_properties = d
        return song_source_meta
