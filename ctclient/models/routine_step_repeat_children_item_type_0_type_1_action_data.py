...
from ..models.routine_step_repeat_children_item_type_0_type_1_action_data_color import (
    RoutineStepRepeatChildrenItemType0Type1ActionDataColor,
)
from ..models.routine_step_repeat_children_item_type_0_type_1_action_data_continuation_type import (
    RoutineStepRepeatChildrenItemType0Type1ActionDataContinuationType,
)
from ..models.routine_step_repeat_children_item_type_0_type_1_action_data_success_group_member_status_type_0 import (
    RoutineStepRepeatChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RoutineStepRepeatChildrenItemType0Type1ActionData")


@_attrs_define
class RoutineStepRepeatChildrenItemType0Type1ActionData:
    """
    Attributes:
        continuation_type (RoutineStepRepeatChildrenItemType0Type1ActionDataContinuationType):
        description (None | str):
        title (str):
        color (RoutineStepRepeatChildrenItemType0Type1ActionDataColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (None |
            RoutineStepRepeatChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0 | Unset):
    ...
    description: None | str
    title: str
    color: RoutineStepRepeatChildrenItemType0Type1ActionDataColor | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: RoutineStepRepeatChildrenItemType0Type1ActionDataColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = RoutineStepRepeatChildrenItemType0Type1ActionDataColor(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = RoutineStepRepeatChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        routine_step_repeat_children_item_type_0_type_1_action_data = cls(
        ...
        routine_step_repeat_children_item_type_0_type_1_action_data.additional_properties = d
        return routine_step_repeat_children_item_type_0_type_1_action_data
