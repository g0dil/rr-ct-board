...
T = TypeVar("T", bound="GetGlobalPermissionsResponse200DataChurchcal")


@_attrs_define
class GetGlobalPermissionsResponse200DataChurchcal:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_global_permissions_response_200_data_churchcal = cls(
        ...
        get_global_permissions_response_200_data_churchcal.additional_properties = d
        return get_global_permissions_response_200_data_churchcal
