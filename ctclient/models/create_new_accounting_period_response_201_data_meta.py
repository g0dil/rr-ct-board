...
if TYPE_CHECKING:
    from ..models.create_new_accounting_period_response_201_data_meta_created_person import (
        CreateNewAccountingPeriodResponse201DataMetaCreatedPerson,
    )
    from ..models.create_new_accounting_period_response_201_data_meta_modified_person import (
        CreateNewAccountingPeriodResponse201DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="CreateNewAccountingPeriodResponse201DataMeta")


@_attrs_define
class CreateNewAccountingPeriodResponse201DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (CreateNewAccountingPeriodResponse201DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (CreateNewAccountingPeriodResponse201DataMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        CreateNewAccountingPeriodResponse201DataMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            CreateNewAccountingPeriodResponse201DataMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                CreateNewAccountingPeriodResponse201DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        create_new_accounting_period_response_201_data_meta = cls(
        ...
        create_new_accounting_period_response_201_data_meta.additional_properties = d
        return create_new_accounting_period_response_201_data_meta
