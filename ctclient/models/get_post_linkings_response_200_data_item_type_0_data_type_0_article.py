...
T = TypeVar("T", bound="GetPostLinkingsResponse200DataItemType0DataType0Article")


@_attrs_define
class GetPostLinkingsResponse200DataItemType0DataType0Article:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_post_linkings_response_200_data_item_type_0_data_type_0_article = cls(
            authors=authors,
        ...
        get_post_linkings_response_200_data_item_type_0_data_type_0_article.additional_properties = d
        return get_post_linkings_response_200_data_item_type_0_data_type_0_article
