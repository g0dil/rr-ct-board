...
if TYPE_CHECKING:
    from ..models.create_new_account_type_response_200_data_item_meta_created_person import (
        CreateNewAccountTypeResponse200DataItemMetaCreatedPerson,
    )
    from ..models.create_new_account_type_response_200_data_item_meta_modified_person import (
        CreateNewAccountTypeResponse200DataItemMetaModifiedPerson,
    )


T = TypeVar("T", bound="CreateNewAccountTypeResponse200DataItemMeta")


@_attrs_define
class CreateNewAccountTypeResponse200DataItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (CreateNewAccountTypeResponse200DataItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (CreateNewAccountTypeResponse200DataItemMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        CreateNewAccountTypeResponse200DataItemMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            CreateNewAccountTypeResponse200DataItemMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                CreateNewAccountTypeResponse200DataItemMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        create_new_account_type_response_200_data_item_meta = cls(
        ...
        create_new_account_type_response_200_data_item_meta.additional_properties = d
        return create_new_account_type_response_200_data_item_meta
