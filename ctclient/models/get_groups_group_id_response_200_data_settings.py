...
from ..models.get_groups_group_id_response_200_data_settings_default_post_notification_scope_type_1 import (
    GetGroupsGroupIdResponse200DataSettingsDefaultPostNotificationScopeType1,
)
from ..models.get_groups_group_id_response_200_data_settings_default_post_notification_scope_type_2_type_1 import (
    GetGroupsGroupIdResponse200DataSettingsDefaultPostNotificationScopeType2Type1,
)
from ..models.get_groups_group_id_response_200_data_settings_default_post_notification_scope_type_3_type_1 import (
    GetGroupsGroupIdResponse200DataSettingsDefaultPostNotificationScopeType3Type1,
)
from ..models.get_groups_group_id_response_200_data_settings_default_post_visibility import (
    GetGroupsGroupIdResponse200DataSettingsDefaultPostVisibility,
)
from ..models.get_groups_group_id_response_200_data_settings_dynamic_group_status_type_1 import (
    GetGroupsGroupIdResponse200DataSettingsDynamicGroupStatusType1,
)
from ..models.get_groups_group_id_response_200_data_settings_dynamic_group_status_type_2_type_1 import (
    GetGroupsGroupIdResponse200DataSettingsDynamicGroupStatusType2Type1,
)
from ..models.get_groups_group_id_response_200_data_settings_dynamic_group_status_type_3_type_1 import (
    GetGroupsGroupIdResponse200DataSettingsDynamicGroupStatusType3Type1,
)
from ..models.get_groups_group_id_response_200_data_settings_visibility import (
    GetGroupsGroupIdResponse200DataSettingsVisibility,
)

if TYPE_CHECKING:
    from ..models.get_groups_group_id_response_200_data_settings_dynamic_group_rule_set_type_0_item import (
        GetGroupsGroupIdResponse200DataSettingsDynamicGroupRuleSetType0Item,
    )
    from ..models.get_groups_group_id_response_200_data_settings_group_meeting import (
        GetGroupsGroupIdResponse200DataSettingsGroupMeeting,
    )
    from ..models.get_groups_group_id_response_200_data_settings_new_member import (
        GetGroupsGroupIdResponse200DataSettingsNewMember,
    )


T = TypeVar("T", bound="GetGroupsGroupIdResponse200DataSettings")


@_attrs_define
class GetGroupsGroupIdResponse200DataSettings:
    """
    Attributes:
        ...
        default_post_notification_scope (GetGroupsGroupIdResponse200DataSettingsDefaultPostNotificationScopeType1 |
            GetGroupsGroupIdResponse200DataSettingsDefaultPostNotificationScopeType2Type1 |
            GetGroupsGroupIdResponse200DataSettingsDefaultPostNotificationScopeType3Type1 | None): Default value for post
            notification scope.
        default_post_placeholder_text (None | str): Default placeholder text for entering post content.
        default_post_visibility (GetGroupsGroupIdResponse200DataSettingsDefaultPostVisibility):
        dynamic_group_rule_set (list[GetGroupsGroupIdResponse200DataSettingsDynamicGroupRuleSetType0Item] | None): Rule
            set for dynamic group update.
        dynamic_group_status (GetGroupsGroupIdResponse200DataSettingsDynamicGroupStatusType1 |
            GetGroupsGroupIdResponse200DataSettingsDynamicGroupStatusType2Type1 |
            GetGroupsGroupIdResponse200DataSettingsDynamicGroupStatusType3Type1 | None): Status of dynamic group update.
        ...
        group_meeting (GetGroupsGroupIdResponse200DataSettingsGroupMeeting):
        in_statistic (bool):
        ...
        new_member (GetGroupsGroupIdResponse200DataSettingsNewMember): Campus, status, and department for newly created
            persons.
        posts_enabled (bool):
        ...
        sign_up_opening_date (datetime.datetime | None): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z'
            Example: 2022-10-19T12:00:00Z.
        visibility (GetGroupsGroupIdResponse200DataSettingsVisibility): The visibility of a group.
    ...
    dynamic_group_rule_set: (
        list[GetGroupsGroupIdResponse200DataSettingsDynamicGroupRuleSetType0Item] | None
    )
    ...
    new_member: GetGroupsGroupIdResponse200DataSettingsNewMember
    posts_enabled: bool
    ...
    visibility: GetGroupsGroupIdResponse200DataSettingsVisibility
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_default_post_notification_scope(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                default_post_notification_scope_type_1 = GetGroupsGroupIdResponse200DataSettingsDefaultPostNotificationScopeType1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                default_post_notification_scope_type_2_type_1 = GetGroupsGroupIdResponse200DataSettingsDefaultPostNotificationScopeType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                default_post_notification_scope_type_3_type_1 = GetGroupsGroupIdResponse200DataSettingsDefaultPostNotificationScopeType3Type1(
                    data
                )
        ...
        def _parse_dynamic_group_rule_set(
            ...
            list[GetGroupsGroupIdResponse200DataSettingsDynamicGroupRuleSetType0Item]
            | None
        ):
            if data is None:
                return data
            try:
                ...
                for (
                    ...
                    dynamic_group_rule_set_type_0_item = GetGroupsGroupIdResponse200DataSettingsDynamicGroupRuleSetType0Item.from_dict(
                        dynamic_group_rule_set_type_0_item_data
                    )
        ...
        def _parse_dynamic_group_status(
            ...
            try:
                ...
                dynamic_group_status_type_1 = (
                    GetGroupsGroupIdResponse200DataSettingsDynamicGroupStatusType1(data)
                )
        ...
        group_meeting = GetGroupsGroupIdResponse200DataSettingsGroupMeeting.from_dict(
            d.pop("groupMeeting")
        )
        ...
        new_member = GetGroupsGroupIdResponse200DataSettingsNewMember.from_dict(
            d.pop("newMember")
        )
        ...
        get_groups_group_id_response_200_data_settings = cls(
        ...
        get_groups_group_id_response_200_data_settings.additional_properties = d
        return get_groups_group_id_response_200_data_settings
