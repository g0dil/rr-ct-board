...
from ..models.group_type_create_color import GroupTypeCreateColor
from ..types import UNSET, Unset

T = TypeVar("T", bound="GroupTypeCreate")


@_attrs_define
class GroupTypeCreate:
    """
    Attributes:
        available_for_new_person (bool):
        color (GroupTypeCreateColor): A color in ChurchTools
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color = GroupTypeCreateColor(d.pop("color"))
        ...
        group_type_create.additional_properties = d
        return group_type_create
