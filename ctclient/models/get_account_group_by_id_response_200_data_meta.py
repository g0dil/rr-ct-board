...
if TYPE_CHECKING:
    from ..models.get_account_group_by_id_response_200_data_meta_created_person import (
        GetAccountGroupByIdResponse200DataMetaCreatedPerson,
    )
    from ..models.get_account_group_by_id_response_200_data_meta_modified_person import (
        GetAccountGroupByIdResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetAccountGroupByIdResponse200DataMeta")


@_attrs_define
class GetAccountGroupByIdResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetAccountGroupByIdResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetAccountGroupByIdResponse200DataMetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = GetAccountGroupByIdResponse200DataMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                GetAccountGroupByIdResponse200DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        get_account_group_by_id_response_200_data_meta = cls(
        ...
        get_account_group_by_id_response_200_data_meta.additional_properties = d
        return get_account_group_by_id_response_200_data_meta
