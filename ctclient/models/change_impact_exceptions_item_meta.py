...
if TYPE_CHECKING:
    from ..models.change_impact_exceptions_item_meta_created_person import (
        ChangeImpactExceptionsItemMetaCreatedPerson,
    )
    from ..models.change_impact_exceptions_item_meta_modified_person import (
        ChangeImpactExceptionsItemMetaModifiedPerson,
    )


T = TypeVar("T", bound="ChangeImpactExceptionsItemMeta")


@_attrs_define
class ChangeImpactExceptionsItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (ChangeImpactExceptionsItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (ChangeImpactExceptionsItemMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: ChangeImpactExceptionsItemMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: ChangeImpactExceptionsItemMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = ChangeImpactExceptionsItemMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = ChangeImpactExceptionsItemMetaModifiedPerson.from_dict(
                _modified_person
            )

        change_impact_exceptions_item_meta = cls(
        ...
        change_impact_exceptions_item_meta.additional_properties = d
        return change_impact_exceptions_item_meta
