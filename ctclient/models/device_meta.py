...
if TYPE_CHECKING:
    from ..models.device_meta_created_person import DeviceMetaCreatedPerson
    from ..models.device_meta_modified_person import DeviceMetaModifiedPerson
...
class DeviceMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = DeviceMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = DeviceMetaModifiedPerson.from_dict(_modified_person)
