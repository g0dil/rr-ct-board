...
T = TypeVar(
    "T", bound="AppointmentCalculatedWithIncludesAppointmentBaseAdditionsItemMeta"
)


@_attrs_define
class AppointmentCalculatedWithIncludesAppointmentBaseAdditionsItemMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appointment_calculated_with_includes_appointment_base_additions_item_meta = cls(
            modified_date=modified_date,
            modified_pid=modified_pid,
        )

        appointment_calculated_with_includes_appointment_base_additions_item_meta.additional_properties = d
        return appointment_calculated_with_includes_appointment_base_additions_item_meta
