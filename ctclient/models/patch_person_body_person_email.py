...
T = TypeVar("T", bound="PatchPersonBodyPersonEmail")


@_attrs_define
class PatchPersonBodyPersonEmail:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_person_body_person_email = cls(
            contact_label_id=contact_label_id,
            email=email,
            is_default=is_default,
        )

        patch_person_body_person_email.additional_properties = d
        return patch_person_body_person_email
