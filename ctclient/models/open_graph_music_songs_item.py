...
T = TypeVar("T", bound="OpenGraphMusicSongsItem")


@_attrs_define
class OpenGraphMusicSongsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        open_graph_music_songs_item = cls(
            disc=disc,
            track=track,
            url=url,
        )

        open_graph_music_songs_item.additional_properties = d
        return open_graph_music_songs_item
