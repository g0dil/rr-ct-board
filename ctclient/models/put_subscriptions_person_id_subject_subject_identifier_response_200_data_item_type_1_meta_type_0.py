...
if TYPE_CHECKING:
    from ..models.put_subscriptions_person_id_subject_subject_identifier_response_200_data_item_type_1_meta_type_0_created_person import (
        PutSubscriptionsPersonIdSubjectSubjectIdentifierResponse200DataItemType1MetaType0CreatedPerson,
    )
    from ..models.put_subscriptions_person_id_subject_subject_identifier_response_200_data_item_type_1_meta_type_0_modified_person import (
...
T = TypeVar(
    "T",
    bound="PutSubscriptionsPersonIdSubjectSubjectIdentifierResponse200DataItemType1MetaType0",
)


@_attrs_define
class PutSubscriptionsPersonIdSubjectSubjectIdentifierResponse200DataItemType1MetaType0:
    """
    Attributes:
        ...
        created_person (PutSubscriptionsPersonIdSubjectSubjectIdentifierResponse200DataItemType1MetaType0CreatedPerson |
            Unset):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (PutSubscriptionsPersonIdSubjectSubjectIdentifierResponse200DataItemType1MetaType0ModifiedPerson
            | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_created_person, Unset):
            ...
            created_person = PutSubscriptionsPersonIdSubjectSubjectIdentifierResponse200DataItemType1MetaType0CreatedPerson.from_dict(
                _created_person
            )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = PutSubscriptionsPersonIdSubjectSubjectIdentifierResponse200DataItemType1MetaType0ModifiedPerson.from_dict(
                _modified_person
            )

        put_subscriptions_person_id_subject_subject_identifier_response_200_data_item_type_1_meta_type_0 = cls(
        ...
        put_subscriptions_person_id_subject_subject_identifier_response_200_data_item_type_1_meta_type_0.additional_properties = d
        return put_subscriptions_person_id_subject_subject_identifier_response_200_data_item_type_1_meta_type_0
