...
T = TypeVar("T", bound="GetGlobalPermissionsResponse200DataChurchdb")


@_attrs_define
class GetGlobalPermissionsResponse200DataChurchdb:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_global_permissions_response_200_data_churchdb = cls(
        ...
        get_global_permissions_response_200_data_churchdb.additional_properties = d
        return get_global_permissions_response_200_data_churchdb
