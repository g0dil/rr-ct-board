...
if TYPE_CHECKING:
    from ..models.get_groups_group_id_memberfields_response_200_data_item_type_0_field_db_field_field_category import (
        GetGroupsGroupIdMemberfieldsResponse200DataItemType0FieldDbFieldFieldCategory,
    )
    from ..models.get_groups_group_id_memberfields_response_200_data_item_type_0_field_db_field_field_type import (
        GetGroupsGroupIdMemberfieldsResponse200DataItemType0FieldDbFieldFieldType,
    )
    from ..models.get_groups_group_id_memberfields_response_200_data_item_type_0_field_db_field_options_item import (
        GetGroupsGroupIdMemberfieldsResponse200DataItemType0FieldDbFieldOptionsItem,
    )


T = TypeVar(
    "T", bound="GetGroupsGroupIdMemberfieldsResponse200DataItemType0FieldDbField"
)


@_attrs_define
class GetGroupsGroupIdMemberfieldsResponse200DataItemType0FieldDbField:
    """
    Attributes:
        ...
        field_category (GetGroupsGroupIdMemberfieldsResponse200DataItemType0FieldDbFieldFieldCategory):
        field_type (GetGroupsGroupIdMemberfieldsResponse200DataItemType0FieldDbFieldFieldType):
        ...
        shorty (str | Unset):
        options (list[GetGroupsGroupIdMemberfieldsResponse200DataItemType0FieldDbFieldOptionsItem] | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_category = GetGroupsGroupIdMemberfieldsResponse200DataItemType0FieldDbFieldFieldCategory.from_dict(
            d.pop("fieldCategory")
        )

        field_type = GetGroupsGroupIdMemberfieldsResponse200DataItemType0FieldDbFieldFieldType.from_dict(
            d.pop("fieldType")
        )
        ...
        for options_item_data in _options or []:
            options_item = GetGroupsGroupIdMemberfieldsResponse200DataItemType0FieldDbFieldOptionsItem.from_dict(
                options_item_data
            )

            options.append(options_item)

        get_groups_group_id_memberfields_response_200_data_item_type_0_field_db_field = cls(
        ...
        get_groups_group_id_memberfields_response_200_data_item_type_0_field_db_field.additional_properties = d
        return get_groups_group_id_memberfields_response_200_data_item_type_0_field_db_field
