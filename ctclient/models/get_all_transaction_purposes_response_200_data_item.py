...
if TYPE_CHECKING:
    from ..models.get_all_transaction_purposes_response_200_data_item_meta import (
        GetAllTransactionPurposesResponse200DataItemMeta,
    )


T = TypeVar("T", bound="GetAllTransactionPurposesResponse200DataItem")


@_attrs_define
class GetAllTransactionPurposesResponse200DataItem:
    """
    Example:
    ...
    Attributes:
        ...
        meta (GetAllTransactionPurposesResponse200DataItemMeta | Unset):  Example: {'createdDate':
    ...
    meta: GetAllTransactionPurposesResponse200DataItemMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta: GetAllTransactionPurposesResponse200DataItemMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = GetAllTransactionPurposesResponse200DataItemMeta.from_dict(_meta)
        ...
        get_all_transaction_purposes_response_200_data_item = cls(
        ...
        get_all_transaction_purposes_response_200_data_item.additional_properties = d
        return get_all_transaction_purposes_response_200_data_item
