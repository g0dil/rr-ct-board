...
if TYPE_CHECKING:
    from ..models.transaction_purpose_meta_created_person import (
        TransactionPurposeMetaCreatedPerson,
    )
    from ..models.transaction_purpose_meta_modified_person import (
        TransactionPurposeMetaModifiedPerson,
    )


T = TypeVar("T", bound="TransactionPurposeMeta")


@_attrs_define
class TransactionPurposeMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (TransactionPurposeMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (TransactionPurposeMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: TransactionPurposeMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: TransactionPurposeMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = TransactionPurposeMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = TransactionPurposeMetaModifiedPerson.from_dict(
                _modified_person
            )

        transaction_purpose_meta = cls(
        ...
        transaction_purpose_meta.additional_properties = d
        return transaction_purpose_meta
