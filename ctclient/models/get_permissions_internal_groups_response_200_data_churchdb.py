...
T = TypeVar("T", bound="GetPermissionsInternalGroupsResponse200DataChurchdb")


@_attrs_define
class GetPermissionsInternalGroupsResponse200DataChurchdb:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_permissions_internal_groups_response_200_data_churchdb = cls(
        ...
        get_permissions_internal_groups_response_200_data_churchdb.additional_properties = d
        return get_permissions_internal_groups_response_200_data_churchdb
