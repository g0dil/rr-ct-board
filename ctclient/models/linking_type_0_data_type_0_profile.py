...
T = TypeVar("T", bound="LinkingType0DataType0Profile")


@_attrs_define
class LinkingType0DataType0Profile:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linking_type_0_data_type_0_profile = cls(
        ...
        linking_type_0_data_type_0_profile.additional_properties = d
        return linking_type_0_data_type_0_profile
