...
T = TypeVar("T", bound="EventMasterDataServiceGroupsItem")


@_attrs_define
class EventMasterDataServiceGroupsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_master_data_service_groups_item = cls(
            campus_id=campus_id,
            id=id,
            name=name,
        ...
        event_master_data_service_groups_item.additional_properties = d
        return event_master_data_service_groups_item
