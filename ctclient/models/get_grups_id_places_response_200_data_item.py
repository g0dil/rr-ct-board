...
from ..models.get_grups_id_places_response_200_data_item_marker_color_type_0 import (
    GetGrupsIdPlacesResponse200DataItemMarkerColorType0,
)
from ..models.get_grups_id_places_response_200_data_item_marker_color_type_1 import (
    GetGrupsIdPlacesResponse200DataItemMarkerColorType1,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_grups_id_places_response_200_data_item_meta import (
        GetGrupsIdPlacesResponse200DataItemMeta,
    )


T = TypeVar("T", bound="GetGrupsIdPlacesResponse200DataItem")


@_attrs_define
class GetGrupsIdPlacesResponse200DataItem:
    """Place wehre e.g. a group meeting takes place

    Attributes:
        id (int):
        meta (GetGrupsIdPlacesResponse200DataItemMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
        ...
        marker_color (GetGrupsIdPlacesResponse200DataItemMarkerColorType0 |
            GetGrupsIdPlacesResponse200DataItemMarkerColorType1 | Unset):
    ...
    id: int
    meta: GetGrupsIdPlacesResponse200DataItemMeta
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.marker_color, Unset):
            ...
            self.marker_color, GetGrupsIdPlacesResponse200DataItemMarkerColorType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = GetGrupsIdPlacesResponse200DataItemMeta.from_dict(d.pop("meta"))
        ...
        def _parse_marker_color(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                marker_color_type_0 = (
                    GetGrupsIdPlacesResponse200DataItemMarkerColorType0(data)
                )
            ...
            if not isinstance(data, str):
                raise TypeError()
            marker_color_type_1 = GetGrupsIdPlacesResponse200DataItemMarkerColorType1(
                data
            )
        ...
        get_grups_id_places_response_200_data_item = cls(
            id=id,
            meta=meta,
            city=city,
            district=district,
        ...
        get_grups_id_places_response_200_data_item.additional_properties = d
        return get_grups_id_places_response_200_data_item
