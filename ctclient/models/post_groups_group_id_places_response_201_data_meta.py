...
if TYPE_CHECKING:
    from ..models.post_groups_group_id_places_response_201_data_meta_created_person import (
        PostGroupsGroupIdPlacesResponse201DataMetaCreatedPerson,
    )
    from ..models.post_groups_group_id_places_response_201_data_meta_modified_person import (
        PostGroupsGroupIdPlacesResponse201DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="PostGroupsGroupIdPlacesResponse201DataMeta")


@_attrs_define
class PostGroupsGroupIdPlacesResponse201DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (PostGroupsGroupIdPlacesResponse201DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (PostGroupsGroupIdPlacesResponse201DataMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        PostGroupsGroupIdPlacesResponse201DataMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            PostGroupsGroupIdPlacesResponse201DataMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                PostGroupsGroupIdPlacesResponse201DataMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        post_groups_group_id_places_response_201_data_meta = cls(
        ...
        post_groups_group_id_places_response_201_data_meta.additional_properties = d
        return post_groups_group_id_places_response_201_data_meta
