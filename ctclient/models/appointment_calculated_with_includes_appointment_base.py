...
from ..models.appointment_calculated_with_includes_appointment_base_repeat_id import (
    AppointmentCalculatedWithIncludesAppointmentBaseRepeatId,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.appointment_calculated_with_includes_appointment_base_additionals_item import (
        AppointmentCalculatedWithIncludesAppointmentBaseAdditionalsItem,
    )
    from ..models.appointment_calculated_with_includes_appointment_base_additions_item import (
        AppointmentCalculatedWithIncludesAppointmentBaseAdditionsItem,
    )
    from ..models.appointment_calculated_with_includes_appointment_base_address import (
        AppointmentCalculatedWithIncludesAppointmentBaseAddress,
    )
    from ..models.appointment_calculated_with_includes_appointment_base_calendar import (
        AppointmentCalculatedWithIncludesAppointmentBaseCalendar,
    )
    from ..models.appointment_calculated_with_includes_appointment_base_exceptions_item import (
        AppointmentCalculatedWithIncludesAppointmentBaseExceptionsItem,
    )
    from ..models.appointment_calculated_with_includes_appointment_base_image_type_0 import (
        AppointmentCalculatedWithIncludesAppointmentBaseImageType0,
    )
    from ..models.appointment_calculated_with_includes_appointment_base_meta import (
        AppointmentCalculatedWithIncludesAppointmentBaseMeta,
    )
    from ..models.appointment_calculated_with_includes_appointment_base_signup_type_0 import (
        AppointmentCalculatedWithIncludesAppointmentBaseSignupType0,
    )


T = TypeVar("T", bound="AppointmentCalculatedWithIncludesAppointmentBase")


@_attrs_define
class AppointmentCalculatedWithIncludesAppointmentBase:
    """
    Attributes:
        additionals (list[AppointmentCalculatedWithIncludesAppointmentBaseAdditionalsItem]):
        address (AppointmentCalculatedWithIncludesAppointmentBaseAddress):
        all_day (bool):
        calendar (AppointmentCalculatedWithIncludesAppointmentBaseCalendar):
        description (None | str):
        end_date (datetime.date | datetime.datetime):
        exceptions (list[AppointmentCalculatedWithIncludesAppointmentBaseExceptionsItem]):
        id (int):
        image (AppointmentCalculatedWithIncludesAppointmentBaseImageType0 | None):
        is_internal (bool):
        link (None | str):
        meta (AppointmentCalculatedWithIncludesAppointmentBaseMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
        ...
        repeat_id (AppointmentCalculatedWithIncludesAppointmentBaseRepeatId): ID of the repeat pattern, NONE = 0, DAILY
            = 1, WEEKLY = 7, MONTHLY_BY_DATE = 31, MONTHLY_BY_WEEKDAY = 32, YEARLY = 365, MANUALLY = 999
        repeat_option (int | None):
        repeat_until (datetime.date | None): A simple date in ISO format, e.g. '2022-10-19' Example: 2022-10-19.
        signup (AppointmentCalculatedWithIncludesAppointmentBaseSignupType0 | None):
        start_date (datetime.date | datetime.datetime):
        subtitle (None | str):
        title (str):
        version (int):
        additions (list[AppointmentCalculatedWithIncludesAppointmentBaseAdditionsItem] | Unset): Use 'additionals'
            instead
    ...
    is_internal: bool
    link: None | str
    meta: AppointmentCalculatedWithIncludesAppointmentBaseMeta
    on_behalf_of_pid: int | None
    repeat_frequency: int | None
    repeat_id: AppointmentCalculatedWithIncludesAppointmentBaseRepeatId
    repeat_option: int | None
    ...
    version: int
    additions: (
        list[AppointmentCalculatedWithIncludesAppointmentBaseAdditionsItem] | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(
            self.image, AppointmentCalculatedWithIncludesAppointmentBaseImageType0
        ):
        ...
        if isinstance(
            self.signup, AppointmentCalculatedWithIncludesAppointmentBaseSignupType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for additionals_item_data in _additionals:
            additionals_item = AppointmentCalculatedWithIncludesAppointmentBaseAdditionalsItem.from_dict(
                additionals_item_data
            )

            additionals.append(additionals_item)

        address = AppointmentCalculatedWithIncludesAppointmentBaseAddress.from_dict(
            d.pop("address")
        )

        all_day = d.pop("allDay")

        calendar = AppointmentCalculatedWithIncludesAppointmentBaseCalendar.from_dict(
            d.pop("calendar")
        )
        ...
        for exceptions_item_data in _exceptions:
            exceptions_item = AppointmentCalculatedWithIncludesAppointmentBaseExceptionsItem.from_dict(
        ...
        def _parse_image(
            data: object,
        ) -> AppointmentCalculatedWithIncludesAppointmentBaseImageType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image_type_0 = AppointmentCalculatedWithIncludesAppointmentBaseImageType0.from_dict(
                    data
                )
                ...
                pass
            return cast(
                AppointmentCalculatedWithIncludesAppointmentBaseImageType0 | None, data
            )
        ...
        meta = AppointmentCalculatedWithIncludesAppointmentBaseMeta.from_dict(
            d.pop("meta")
        )
        ...
        def _parse_signup(
            data: object,
        ) -> AppointmentCalculatedWithIncludesAppointmentBaseSignupType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                signup_type_0 = AppointmentCalculatedWithIncludesAppointmentBaseSignupType0.from_dict(
                    data
                )
                ...
                pass
            return cast(
                AppointmentCalculatedWithIncludesAppointmentBaseSignupType0 | None, data
            )
        ...
        for additions_item_data in _additions or []:
            additions_item = (
                AppointmentCalculatedWithIncludesAppointmentBaseAdditionsItem.from_dict(
                    additions_item_data
                )
            )
        ...
        appointment_calculated_with_includes_appointment_base = cls(
            additionals=additionals,
            address=address,
            all_day=all_day,
            calendar=calendar,
        ...
        appointment_calculated_with_includes_appointment_base.additional_properties = d
        return appointment_calculated_with_includes_appointment_base
