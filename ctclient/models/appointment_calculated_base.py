...
from ..models.appointment_calculated_base_repeat_id import (
    AppointmentCalculatedBaseRepeatId,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.appointment_calculated_base_additionals_item import (
        AppointmentCalculatedBaseAdditionalsItem,
    )
    from ..models.appointment_calculated_base_additions_item import (
        AppointmentCalculatedBaseAdditionsItem,
    )
    from ..models.appointment_calculated_base_address import (
        AppointmentCalculatedBaseAddress,
    )
    from ..models.appointment_calculated_base_calendar import (
        AppointmentCalculatedBaseCalendar,
    )
    from ..models.appointment_calculated_base_exceptions_item import (
        AppointmentCalculatedBaseExceptionsItem,
    )
    from ..models.appointment_calculated_base_image_type_0 import (
        AppointmentCalculatedBaseImageType0,
    )
    from ..models.appointment_calculated_base_meta import AppointmentCalculatedBaseMeta
    from ..models.appointment_calculated_base_signup_type_0 import (
        AppointmentCalculatedBaseSignupType0,
    )


T = TypeVar("T", bound="AppointmentCalculatedBase")


@_attrs_define
class AppointmentCalculatedBase:
    """
    Attributes:
        additionals (list[AppointmentCalculatedBaseAdditionalsItem]):
        address (AppointmentCalculatedBaseAddress):
        all_day (bool):
        calendar (AppointmentCalculatedBaseCalendar):
        description (None | str):
        end_date (datetime.date | datetime.datetime):
        exceptions (list[AppointmentCalculatedBaseExceptionsItem]):
        id (int):
        image (AppointmentCalculatedBaseImageType0 | None):
        is_internal (bool):
        link (None | str):
        meta (AppointmentCalculatedBaseMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson': {'id':
            1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        on_behalf_of_pid (int | None):
        repeat_frequency (int | None):
        repeat_id (AppointmentCalculatedBaseRepeatId): ID of the repeat pattern, NONE = 0, DAILY = 1, WEEKLY = 7,
            MONTHLY_BY_DATE = 31, MONTHLY_BY_WEEKDAY = 32, YEARLY = 365, MANUALLY = 999
        repeat_option (int | None):
        repeat_until (datetime.date | None): A simple date in ISO format, e.g. '2022-10-19' Example: 2022-10-19.
        signup (AppointmentCalculatedBaseSignupType0 | None):
        start_date (datetime.date | datetime.datetime):
        subtitle (None | str):
        title (str):
        version (int):
        additions (list[AppointmentCalculatedBaseAdditionsItem] | Unset): Use 'additionals' instead
    ...
    is_internal: bool
    link: None | str
    meta: AppointmentCalculatedBaseMeta
    on_behalf_of_pid: int | None
    repeat_frequency: int | None
    repeat_id: AppointmentCalculatedBaseRepeatId
    repeat_option: int | None
    ...
    title: str
    version: int
    additions: list[AppointmentCalculatedBaseAdditionsItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.image, AppointmentCalculatedBaseImageType0):
        ...
        if isinstance(self.signup, AppointmentCalculatedBaseSignupType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.appointment_calculated_base_meta import (
        ...
        for additionals_item_data in _additionals:
            additionals_item = AppointmentCalculatedBaseAdditionalsItem.from_dict(
                additionals_item_data
            )

            additionals.append(additionals_item)

        address = AppointmentCalculatedBaseAddress.from_dict(d.pop("address"))

        all_day = d.pop("allDay")

        calendar = AppointmentCalculatedBaseCalendar.from_dict(d.pop("calendar"))
        ...
        for exceptions_item_data in _exceptions:
            exceptions_item = AppointmentCalculatedBaseExceptionsItem.from_dict(
        ...
        def _parse_image(data: object) -> AppointmentCalculatedBaseImageType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image_type_0 = AppointmentCalculatedBaseImageType0.from_dict(data)

                return image_type_0
            except:  # noqa: E722
                pass
            return cast(AppointmentCalculatedBaseImageType0 | None, data)
        ...
        meta = AppointmentCalculatedBaseMeta.from_dict(d.pop("meta"))
        ...
        repeat_id = AppointmentCalculatedBaseRepeatId(d.pop("repeatId"))
        ...
        def _parse_signup(data: object) -> AppointmentCalculatedBaseSignupType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                signup_type_0 = AppointmentCalculatedBaseSignupType0.from_dict(data)

                return signup_type_0
            except:  # noqa: E722
                pass
            return cast(AppointmentCalculatedBaseSignupType0 | None, data)
        ...
        for additions_item_data in _additions or []:
            additions_item = AppointmentCalculatedBaseAdditionsItem.from_dict(
                additions_item_data
            )
        ...
        appointment_calculated_base = cls(
            additionals=additionals,
            address=address,
            all_day=all_day,
            calendar=calendar,
        ...
        appointment_calculated_base.additional_properties = d
        return appointment_calculated_base
