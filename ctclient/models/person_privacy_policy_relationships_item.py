...
if TYPE_CHECKING:
    from ..models.person_privacy_policy_relationships_item_relationship_type import (
        PersonPrivacyPolicyRelationshipsItemRelationshipType,
    )


T = TypeVar("T", bound="PersonPrivacyPolicyRelationshipsItem")


@_attrs_define
class PersonPrivacyPolicyRelationshipsItem:
    """
    Attributes:
        accepted (bool):
        accepted_type (str):
        ...
        image (str | Unset):
        relationship_type (PersonPrivacyPolicyRelationshipsItemRelationshipType | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_relationship_type, Unset):
            ...
            relationship_type = (
                PersonPrivacyPolicyRelationshipsItemRelationshipType.from_dict(
                    _relationship_type
                )
            )

        person_privacy_policy_relationships_item = cls(
            accepted=accepted,
        ...
        person_privacy_policy_relationships_item.additional_properties = d
        return person_privacy_policy_relationships_item
