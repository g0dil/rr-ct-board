...
from ..models.routine_steps_item_type_1_children_item_type_0_type_1_action_data_color import (
    RoutineStepsItemType1ChildrenItemType0Type1ActionDataColor,
)
from ..models.routine_steps_item_type_1_children_item_type_0_type_1_action_data_continuation_type import (
    RoutineStepsItemType1ChildrenItemType0Type1ActionDataContinuationType,
)
from ..models.routine_steps_item_type_1_children_item_type_0_type_1_action_data_success_group_member_status_type_0 import (
    RoutineStepsItemType1ChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RoutineStepsItemType1ChildrenItemType0Type1ActionData")


@_attrs_define
class RoutineStepsItemType1ChildrenItemType0Type1ActionData:
    """
    Attributes:
        continuation_type (RoutineStepsItemType1ChildrenItemType0Type1ActionDataContinuationType):
        description (None | str):
        title (str):
        color (RoutineStepsItemType1ChildrenItemType0Type1ActionDataColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (None |
            RoutineStepsItemType1ChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0 | Unset):
    ...
    description: None | str
    title: str
    color: RoutineStepsItemType1ChildrenItemType0Type1ActionDataColor | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: RoutineStepsItemType1ChildrenItemType0Type1ActionDataColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = RoutineStepsItemType1ChildrenItemType0Type1ActionDataColor(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = RoutineStepsItemType1ChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        routine_steps_item_type_1_children_item_type_0_type_1_action_data = cls(
        ...
        routine_steps_item_type_1_children_item_type_0_type_1_action_data.additional_properties = d
        return routine_steps_item_type_1_children_item_type_0_type_1_action_data
