...
from ..models.get_calendars_appointments_response_200_data_item_appointment_base_repeat_id import (
    GetCalendarsAppointmentsResponse200DataItemAppointmentBaseRepeatId,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_calendars_appointments_response_200_data_item_appointment_base_additionals_item import (
        GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAdditionalsItem,
    )
    from ..models.get_calendars_appointments_response_200_data_item_appointment_base_additions_item import (
        GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAdditionsItem,
    )
    from ..models.get_calendars_appointments_response_200_data_item_appointment_base_address import (
        GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAddress,
    )
    from ..models.get_calendars_appointments_response_200_data_item_appointment_base_calendar import (
        GetCalendarsAppointmentsResponse200DataItemAppointmentBaseCalendar,
    )
    from ..models.get_calendars_appointments_response_200_data_item_appointment_base_exceptions_item import (
        GetCalendarsAppointmentsResponse200DataItemAppointmentBaseExceptionsItem,
    )
    from ..models.get_calendars_appointments_response_200_data_item_appointment_base_image_type_0 import (
        GetCalendarsAppointmentsResponse200DataItemAppointmentBaseImageType0,
    )
    from ..models.get_calendars_appointments_response_200_data_item_appointment_base_meta import (
        GetCalendarsAppointmentsResponse200DataItemAppointmentBaseMeta,
    )
    from ..models.get_calendars_appointments_response_200_data_item_appointment_base_signup_type_0 import (
        GetCalendarsAppointmentsResponse200DataItemAppointmentBaseSignupType0,
    )


T = TypeVar("T", bound="GetCalendarsAppointmentsResponse200DataItemAppointmentBase")


@_attrs_define
class GetCalendarsAppointmentsResponse200DataItemAppointmentBase:
    """
    Attributes:
        additionals (list[GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAdditionalsItem]):
        address (GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAddress):
        all_day (bool):
        calendar (GetCalendarsAppointmentsResponse200DataItemAppointmentBaseCalendar):
        description (None | str):
        end_date (datetime.date | datetime.datetime):
        exceptions (list[GetCalendarsAppointmentsResponse200DataItemAppointmentBaseExceptionsItem]):
        id (int):
        image (GetCalendarsAppointmentsResponse200DataItemAppointmentBaseImageType0 | None):
        is_internal (bool):
        link (None | str):
        meta (GetCalendarsAppointmentsResponse200DataItemAppointmentBaseMeta):  Example: {'createdDate':
        ...
        repeat_id (GetCalendarsAppointmentsResponse200DataItemAppointmentBaseRepeatId): ID of the repeat pattern, NONE =
            0, DAILY = 1, WEEKLY = 7, MONTHLY_BY_DATE = 31, MONTHLY_BY_WEEKDAY = 32, YEARLY = 365, MANUALLY = 999
        repeat_option (int | None):
        repeat_until (datetime.date | None): A simple date in ISO format, e.g. '2022-10-19' Example: 2022-10-19.
        signup (GetCalendarsAppointmentsResponse200DataItemAppointmentBaseSignupType0 | None):
        start_date (datetime.date | datetime.datetime):
        subtitle (None | str):
        title (str):
        version (int):
        additions (list[GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAdditionsItem] | Unset): Use
            'additionals' instead
    ...
    is_internal: bool
    link: None | str
    meta: GetCalendarsAppointmentsResponse200DataItemAppointmentBaseMeta
    on_behalf_of_pid: int | None
    repeat_frequency: int | None
    repeat_id: GetCalendarsAppointmentsResponse200DataItemAppointmentBaseRepeatId
    repeat_option: int | None
    ...
    version: int
    additions: (
        list[GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAdditionsItem]
        | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for additionals_item_data in _additionals:
            additionals_item = GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAdditionalsItem.from_dict(
        ...
        address = (
            GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAddress.from_dict(
                d.pop("address")
            )
        )
        ...
        calendar = GetCalendarsAppointmentsResponse200DataItemAppointmentBaseCalendar.from_dict(
            d.pop("calendar")
        )
        ...
        for exceptions_item_data in _exceptions:
            exceptions_item = GetCalendarsAppointmentsResponse200DataItemAppointmentBaseExceptionsItem.from_dict(
        ...
        def _parse_image(
            ...
            GetCalendarsAppointmentsResponse200DataItemAppointmentBaseImageType0 | None
        ):
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image_type_0 = GetCalendarsAppointmentsResponse200DataItemAppointmentBaseImageType0.from_dict(
                    data
                )
        ...
        meta = GetCalendarsAppointmentsResponse200DataItemAppointmentBaseMeta.from_dict(
            d.pop("meta")
        )
        ...
        def _parse_signup(
            ...
            GetCalendarsAppointmentsResponse200DataItemAppointmentBaseSignupType0 | None
        ):
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                signup_type_0 = GetCalendarsAppointmentsResponse200DataItemAppointmentBaseSignupType0.from_dict(
                    data
                )
        ...
        for additions_item_data in _additions or []:
            additions_item = GetCalendarsAppointmentsResponse200DataItemAppointmentBaseAdditionsItem.from_dict(
                additions_item_data
            )
        ...
        get_calendars_appointments_response_200_data_item_appointment_base = cls(
            additionals=additionals,
            address=address,
            all_day=all_day,
            calendar=calendar,
        ...
        get_calendars_appointments_response_200_data_item_appointment_base.additional_properties = d
        return get_calendars_appointments_response_200_data_item_appointment_base
