...
T = TypeVar("T", bound="PutWikiCategoryResponse200WikiCategory")


@_attrs_define
class PutWikiCategoryResponse200WikiCategory:
    """
    Attributes:
        campus_id (int | None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_wiki_category_response_200_wiki_category = cls(
            campus_id=campus_id,
        ...
        put_wiki_category_response_200_wiki_category.additional_properties = d
        return put_wiki_category_response_200_wiki_category
