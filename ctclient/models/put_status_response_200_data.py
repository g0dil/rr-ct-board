...
T = TypeVar("T", bound="PutStatusResponse200Data")


@_attrs_define
class PutStatusResponse200Data:
    """
    Attributes:
        id (int): ID of status
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_status_response_200_data = cls(
            id=id,
            is_member=is_member,
        ...
        put_status_response_200_data.additional_properties = d
        return put_status_response_200_data
