...
T = TypeVar("T", bound="GetContactlabelsResponse200DataItem")


@_attrs_define
class GetContactlabelsResponse200DataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_contactlabels_response_200_data_item = cls(
            id=id,
        ...
        get_contactlabels_response_200_data_item.additional_properties = d
        return get_contactlabels_response_200_data_item
