...
T = TypeVar("T", bound="GetAllMeetingsResponse200DataItemStatistics")


@_attrs_define
class GetAllMeetingsResponse200DataItemStatistics:
    """
    Attributes:
        absent (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_meetings_response_200_data_item_statistics = cls(
            absent=absent,
        ...
        get_all_meetings_response_200_data_item_statistics.additional_properties = d
        return get_all_meetings_response_200_data_item_statistics
