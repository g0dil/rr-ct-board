...
if TYPE_CHECKING:
    from ..models.db_field_field_category import DbFieldFieldCategory
    from ..models.db_field_field_type import DbFieldFieldType
    from ..models.db_field_options_item import DbFieldOptionsItem


T = TypeVar("T", bound="DbField")
...
class DbField:
    ...
    Attributes:
        ...
        field_category (DbFieldFieldCategory):
        field_type (DbFieldFieldType):
        ...
        shorty (str | Unset):
        options (list[DbFieldOptionsItem] | Unset):
    """
    ...
    options: list[DbFieldOptionsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_category = DbFieldFieldCategory.from_dict(d.pop("fieldCategory"))

        field_type = DbFieldFieldType.from_dict(d.pop("fieldType"))
        ...
        for options_item_data in _options or []:
            options_item = DbFieldOptionsItem.from_dict(options_item_data)
        ...
        db_field.additional_properties = d
        return db_field
