...
T = TypeVar("T", bound="PatchGroupResponse200DataSettingsNewMember")


@_attrs_define
class PatchGroupResponse200DataSettingsNewMember:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_group_response_200_data_settings_new_member = cls(
            campus_id=campus_id,
            department_id=department_id,
            status_id=status_id,
        )

        patch_group_response_200_data_settings_new_member.additional_properties = d
        return patch_group_response_200_data_settings_new_member
