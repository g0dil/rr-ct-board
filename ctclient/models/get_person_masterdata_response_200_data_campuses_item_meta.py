...
if TYPE_CHECKING:
    from ..models.get_person_masterdata_response_200_data_campuses_item_meta_created_person import (
        GetPersonMasterdataResponse200DataCampusesItemMetaCreatedPerson,
    )
    from ..models.get_person_masterdata_response_200_data_campuses_item_meta_modified_person import (
        GetPersonMasterdataResponse200DataCampusesItemMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetPersonMasterdataResponse200DataCampusesItemMeta")


@_attrs_define
class GetPersonMasterdataResponse200DataCampusesItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetPersonMasterdataResponse200DataCampusesItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetPersonMasterdataResponse200DataCampusesItemMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        GetPersonMasterdataResponse200DataCampusesItemMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            GetPersonMasterdataResponse200DataCampusesItemMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GetPersonMasterdataResponse200DataCampusesItemMetaModifiedPerson.from_dict(
                _modified_person
            )

        get_person_masterdata_response_200_data_campuses_item_meta = cls(
        ...
        get_person_masterdata_response_200_data_campuses_item_meta.additional_properties = d
        return get_person_masterdata_response_200_data_campuses_item_meta
