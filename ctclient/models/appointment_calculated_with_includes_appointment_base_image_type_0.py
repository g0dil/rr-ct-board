...
if TYPE_CHECKING:
    from ..models.appointment_calculated_with_includes_appointment_base_image_type_0_image_option import (
        AppointmentCalculatedWithIncludesAppointmentBaseImageType0ImageOption,
    )
    from ..models.appointment_calculated_with_includes_appointment_base_image_type_0_meta import (
        AppointmentCalculatedWithIncludesAppointmentBaseImageType0Meta,
    )


T = TypeVar("T", bound="AppointmentCalculatedWithIncludesAppointmentBaseImageType0")


@_attrs_define
class AppointmentCalculatedWithIncludesAppointmentBaseImageType0:
    """
    Attributes:
        ...
        id (int):  Example: 6071.
        image_option (AppointmentCalculatedWithIncludesAppointmentBaseImageType0ImageOption):
        image_url (str):  Example:
            http://churchtools.test/images/6071/70987c31abdea3986f69a6d601222ac9a388c36a6510564a80fae29311faec89.
        meta (AppointmentCalculatedWithIncludesAppointmentBaseImageType0Meta):  Example: {'createdDate':
    ...
    image_option: AppointmentCalculatedWithIncludesAppointmentBaseImageType0ImageOption
    image_url: str
    meta: AppointmentCalculatedWithIncludesAppointmentBaseImageType0Meta
    name: str
    relative_url: str
    security_level_id: int | None
    show_only_when_editable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_option = AppointmentCalculatedWithIncludesAppointmentBaseImageType0ImageOption.from_dict(
            d.pop("imageOption")
        )

        image_url = d.pop("imageUrl")

        meta = AppointmentCalculatedWithIncludesAppointmentBaseImageType0Meta.from_dict(
            d.pop("meta")
        )
        ...
        appointment_calculated_with_includes_appointment_base_image_type_0 = cls(
        ...
        appointment_calculated_with_includes_appointment_base_image_type_0.additional_properties = d
        return appointment_calculated_with_includes_appointment_base_image_type_0
