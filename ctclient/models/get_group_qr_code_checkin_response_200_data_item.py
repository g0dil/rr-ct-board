...
from ..models.get_group_qr_code_checkin_response_200_data_item_domain_type import (
    GetGroupQRCodeCheckinResponse200DataItemDomainType,
)

T = TypeVar("T", bound="GetGroupQRCodeCheckinResponse200DataItem")


@_attrs_define
class GetGroupQRCodeCheckinResponse200DataItem:
    """
    Attributes:
        domain_id (int):
        domain_type (GetGroupQRCodeCheckinResponse200DataItemDomainType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_group_qr_code_checkin_response_200_data_item = cls(
            domain_id=domain_id,
        ...
        get_group_qr_code_checkin_response_200_data_item.additional_properties = d
        return get_group_qr_code_checkin_response_200_data_item
