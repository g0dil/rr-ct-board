...
T = TypeVar("T", bound="DeleteCostCenterResponse409DataReferencesItem")


@_attrs_define
class DeleteCostCenterResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_cost_center_response_409_data_references_item = cls(
        ...
        delete_cost_center_response_409_data_references_item.additional_properties = d
        return delete_cost_center_response_409_data_references_item
