...
T = TypeVar("T", bound="CreateNewBillBody")


@_attrs_define
class CreateNewBillBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_new_bill_body.additional_properties = d
        return create_new_bill_body
