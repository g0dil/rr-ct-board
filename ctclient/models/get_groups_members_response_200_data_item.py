...
T = TypeVar("T", bound="GetGroupsMembersResponse200DataItem")


@_attrs_define
class GetGroupsMembersResponse200DataItem:
    """
    Attributes:
        group_id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_groups_members_response_200_data_item = cls(
            group_id=group_id,
        ...
        get_groups_members_response_200_data_item.additional_properties = d
        return get_groups_members_response_200_data_item
