...
if TYPE_CHECKING:
    from ..models.group_member_field_person_db_field_field_category import (
        GroupMemberFieldPersonDbFieldFieldCategory,
    )
    from ..models.group_member_field_person_db_field_field_type import (
        GroupMemberFieldPersonDbFieldFieldType,
    )
    from ..models.group_member_field_person_db_field_options_item import (
        GroupMemberFieldPersonDbFieldOptionsItem,
    )


T = TypeVar("T", bound="GroupMemberFieldPersonDbField")


@_attrs_define
class GroupMemberFieldPersonDbField:
    """
    Attributes:
        ...
        field_category (GroupMemberFieldPersonDbFieldFieldCategory):
        field_type (GroupMemberFieldPersonDbFieldFieldType):
        ...
        shorty (str | Unset):
        options (list[GroupMemberFieldPersonDbFieldOptionsItem] | Unset):
    """
    ...
    options: list[GroupMemberFieldPersonDbFieldOptionsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_category = GroupMemberFieldPersonDbFieldFieldCategory.from_dict(
            d.pop("fieldCategory")
        )

        field_type = GroupMemberFieldPersonDbFieldFieldType.from_dict(
            d.pop("fieldType")
        )
        ...
        for options_item_data in _options or []:
            options_item = GroupMemberFieldPersonDbFieldOptionsItem.from_dict(
                options_item_data
            )

            options.append(options_item)

        group_member_field_person_db_field = cls(
        ...
        group_member_field_person_db_field.additional_properties = d
        return group_member_field_person_db_field
