...
T = TypeVar("T", bound="GetInternalPermissionsForPersonResponse200DataChurchdb")


@_attrs_define
class GetInternalPermissionsForPersonResponse200DataChurchdb:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_internal_permissions_for_person_response_200_data_churchdb = cls(
        ...
        get_internal_permissions_for_person_response_200_data_churchdb.additional_properties = d
        return get_internal_permissions_for_person_response_200_data_churchdb
