...
if TYPE_CHECKING:
    from ..models.campus_meta_created_person import CampusMetaCreatedPerson
    from ..models.campus_meta_modified_person import CampusMetaModifiedPerson


T = TypeVar("T", bound="CampusMeta")
...
class CampusMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = CampusMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = CampusMetaModifiedPerson.from_dict(_modified_person)
        ...
        campus_meta.additional_properties = d
        return campus_meta
