...
T = TypeVar("T", bound="DeleteSyncAdaptersIdResponse409DataReferencesItem")


@_attrs_define
class DeleteSyncAdaptersIdResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_sync_adapters_id_response_409_data_references_item = cls(
        ...
        delete_sync_adapters_id_response_409_data_references_item.additional_properties = d
        return delete_sync_adapters_id_response_409_data_references_item
