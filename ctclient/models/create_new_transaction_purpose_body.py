...
T = TypeVar("T", bound="CreateNewTransactionPurposeBody")


@_attrs_define
class CreateNewTransactionPurposeBody:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_new_transaction_purpose_body = cls(
        ...
        create_new_transaction_purpose_body.additional_properties = d
        return create_new_transaction_purpose_body
