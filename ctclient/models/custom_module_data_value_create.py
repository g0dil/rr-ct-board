...
T = TypeVar("T", bound="CustomModuleDataValueCreate")


@_attrs_define
class CustomModuleDataValueCreate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_module_data_value_create = cls(
        ...
        custom_module_data_value_create.additional_properties = d
        return custom_module_data_value_create
