...
from ..models.post_groups_group_id_places_body_marker_color_type_0 import (
    PostGroupsGroupIdPlacesBodyMarkerColorType0,
)
from ..models.post_groups_group_id_places_body_marker_color_type_1 import (
    PostGroupsGroupIdPlacesBodyMarkerColorType1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostGroupsGroupIdPlacesBody")


@_attrs_define
class PostGroupsGroupIdPlacesBody:
    """
    Attributes:
        ...
        marker_color (PostGroupsGroupIdPlacesBodyMarkerColorType0 | PostGroupsGroupIdPlacesBodyMarkerColorType1 |
            Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.marker_color, Unset):
            marker_color = UNSET
        elif isinstance(self.marker_color, PostGroupsGroupIdPlacesBodyMarkerColorType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_marker_color(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                marker_color_type_0 = PostGroupsGroupIdPlacesBodyMarkerColorType0(data)
            ...
            if not isinstance(data, str):
                raise TypeError()
            marker_color_type_1 = PostGroupsGroupIdPlacesBodyMarkerColorType1(data)
        ...
        post_groups_group_id_places_body = cls(
            city=city,
            district=district,
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        post_groups_group_id_places_body.additional_properties = d
        return post_groups_group_id_places_body
