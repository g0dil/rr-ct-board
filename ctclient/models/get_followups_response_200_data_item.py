...
from ..models.get_followups_response_200_data_item_color import (
    GetFollowupsResponse200DataItemColor,
)
from ..models.get_followups_response_200_data_item_origin import (
    GetFollowupsResponse200DataItemOrigin,
)
from ..models.get_followups_response_200_data_item_success_group_member_status_type_0 import (
    GetFollowupsResponse200DataItemSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_followups_response_200_data_item_meta import (
        GetFollowupsResponse200DataItemMeta,
    )


T = TypeVar("T", bound="GetFollowupsResponse200DataItem")


@_attrs_define
class GetFollowupsResponse200DataItem:
    """
    Attributes:
        ...
        meta (GetFollowupsResponse200DataItemMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson':
            {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        origin (GetFollowupsResponse200DataItemOrigin):
        person_id (int):
        color (GetFollowupsResponse200DataItemColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (GetFollowupsResponse200DataItemSuccessGroupMemberStatusType0 | None | Unset):
    ...
    id: int
    membership_id: int | None
    meta: GetFollowupsResponse200DataItemMeta
    origin: GetFollowupsResponse200DataItemOrigin
    person_id: int
    color: GetFollowupsResponse200DataItemColor | Unset = UNSET
    ...
    success_group_member_status: (
        GetFollowupsResponse200DataItemSuccessGroupMemberStatusType0 | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = GetFollowupsResponse200DataItemMeta.from_dict(d.pop("meta"))

        origin = GetFollowupsResponse200DataItemOrigin(d.pop("origin"))

        person_id = d.pop("personId")

        _color = d.pop("color", UNSET)
        color: GetFollowupsResponse200DataItemColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = GetFollowupsResponse200DataItemColor(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                ...
                success_group_member_status_type_0 = (
                    GetFollowupsResponse200DataItemSuccessGroupMemberStatusType0(data)
                )
        ...
        get_followups_response_200_data_item = cls(
            title=title,
            done_date=done_date,
        ...
        get_followups_response_200_data_item.additional_properties = d
        return get_followups_response_200_data_item
