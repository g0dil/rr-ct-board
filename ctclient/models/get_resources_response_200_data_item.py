...
T = TypeVar("T", bound="GetResourcesResponse200DataItem")


@_attrs_define
class GetResourcesResponse200DataItem:
    """
    Attributes:
        id (int):  Example: 7.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_resources_response_200_data_item = cls(
            id=id,
        ...
        get_resources_response_200_data_item.additional_properties = d
        return get_resources_response_200_data_item
