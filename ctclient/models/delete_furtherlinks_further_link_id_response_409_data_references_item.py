...
T = TypeVar("T", bound="DeleteFurtherlinksFurtherLinkIdResponse409DataReferencesItem")


@_attrs_define
class DeleteFurtherlinksFurtherLinkIdResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_furtherlinks_further_link_id_response_409_data_references_item = cls(
        ...
        delete_furtherlinks_further_link_id_response_409_data_references_item.additional_properties = d
        return delete_furtherlinks_further_link_id_response_409_data_references_item
