...
from ..models.group_member_history_entry_previous_membership_status import (
    GroupMemberHistoryEntryPreviousMembershipStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.group_member_history_entry_previous_fields import (
        GroupMemberHistoryEntryPreviousFields,
    )


T = TypeVar("T", bound="GroupMemberHistoryEntryPrevious")


@_attrs_define
class GroupMemberHistoryEntryPrevious:
    """
    Attributes:
        member_role_id (int):
        comment (str | Unset):
        end_date (datetime.date | Unset): A simple date in ISO format, e.g. '2022-10-19' Example: 2022-10-19.
        fields (GroupMemberHistoryEntryPreviousFields | Unset):
        membership_status (GroupMemberHistoryEntryPreviousMembershipStatus | Unset):
    ...
    fields: GroupMemberHistoryEntryPreviousFields | Unset = UNSET
    membership_status: GroupMemberHistoryEntryPreviousMembershipStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_fields, Unset):
            ...
            fields = GroupMemberHistoryEntryPreviousFields.from_dict(_fields)
        ...
        if isinstance(_membership_status, Unset):
            ...
            membership_status = GroupMemberHistoryEntryPreviousMembershipStatus(
                _membership_status
            )
        ...
        group_member_history_entry_previous = cls(
        ...
        group_member_history_entry_previous.additional_properties = d
        return group_member_history_entry_previous
