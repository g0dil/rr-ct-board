...
if TYPE_CHECKING:
    from ..models.subscription_post_meta_type_0_created_person import (
        SubscriptionPostMetaType0CreatedPerson,
    )
    from ..models.subscription_post_meta_type_0_modified_person import (
        SubscriptionPostMetaType0ModifiedPerson,
    )


T = TypeVar("T", bound="SubscriptionPostMetaType0")


@_attrs_define
class SubscriptionPostMetaType0:
    """
    Attributes:
        ...
        created_person (SubscriptionPostMetaType0CreatedPerson | Unset):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (SubscriptionPostMetaType0ModifiedPerson | Unset):
    """

    created_date: datetime.datetime | Unset = UNSET
    created_person: SubscriptionPostMetaType0CreatedPerson | Unset = UNSET
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: SubscriptionPostMetaType0ModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_created_person, Unset):
            ...
            created_person = SubscriptionPostMetaType0CreatedPerson.from_dict(
                _created_person
            )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = SubscriptionPostMetaType0ModifiedPerson.from_dict(
                _modified_person
            )

        subscription_post_meta_type_0 = cls(
        ...
        subscription_post_meta_type_0.additional_properties = d
        return subscription_post_meta_type_0
