...
T = TypeVar("T", bound="GlobalPermissionsChurchwiki")


@_attrs_define
class GlobalPermissionsChurchwiki:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        global_permissions_churchwiki = cls(
        ...
        global_permissions_churchwiki.additional_properties = d
        return global_permissions_churchwiki
