...
if TYPE_CHECKING:
    from ..models.get_registrationconfig_id_response_200_data_fields_item_field_field_category import (
        GetRegistrationconfigIdResponse200DataFieldsItemFieldFieldCategory,
    )
    from ..models.get_registrationconfig_id_response_200_data_fields_item_field_field_type import (
        GetRegistrationconfigIdResponse200DataFieldsItemFieldFieldType,
    )
    from ..models.get_registrationconfig_id_response_200_data_fields_item_field_options_item import (
        GetRegistrationconfigIdResponse200DataFieldsItemFieldOptionsItem,
    )


T = TypeVar("T", bound="GetRegistrationconfigIdResponse200DataFieldsItemField")


@_attrs_define
class GetRegistrationconfigIdResponse200DataFieldsItemField:
    """
    Attributes:
        ...
        field_category (GetRegistrationconfigIdResponse200DataFieldsItemFieldFieldCategory):
        field_type (GetRegistrationconfigIdResponse200DataFieldsItemFieldFieldType):
        ...
        shorty (str | Unset):
        options (list[GetRegistrationconfigIdResponse200DataFieldsItemFieldOptionsItem] | Unset):
    """
    ...
    options: (
        list[GetRegistrationconfigIdResponse200DataFieldsItemFieldOptionsItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_category = GetRegistrationconfigIdResponse200DataFieldsItemFieldFieldCategory.from_dict(
            d.pop("fieldCategory")
        )

        field_type = (
            GetRegistrationconfigIdResponse200DataFieldsItemFieldFieldType.from_dict(
                d.pop("fieldType")
            )
        )
        ...
        for options_item_data in _options or []:
            options_item = GetRegistrationconfigIdResponse200DataFieldsItemFieldOptionsItem.from_dict(
                options_item_data
            )

            options.append(options_item)

        get_registrationconfig_id_response_200_data_fields_item_field = cls(
        ...
        get_registrationconfig_id_response_200_data_fields_item_field.additional_properties = d
        return get_registrationconfig_id_response_200_data_fields_item_field
