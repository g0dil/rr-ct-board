...
T = TypeVar("T", bound="DeleteAccountingPeriodResponse409DataReferencesItem")


@_attrs_define
class DeleteAccountingPeriodResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_accounting_period_response_409_data_references_item = cls(
        ...
        delete_accounting_period_response_409_data_references_item.additional_properties = d
        return delete_accounting_period_response_409_data_references_item
