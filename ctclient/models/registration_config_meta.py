...
if TYPE_CHECKING:
    from ..models.registration_config_meta_created_person import (
        RegistrationConfigMetaCreatedPerson,
    )
    from ..models.registration_config_meta_modified_person import (
        RegistrationConfigMetaModifiedPerson,
    )


T = TypeVar("T", bound="RegistrationConfigMeta")


@_attrs_define
class RegistrationConfigMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (RegistrationConfigMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (RegistrationConfigMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: RegistrationConfigMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: RegistrationConfigMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = RegistrationConfigMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = RegistrationConfigMetaModifiedPerson.from_dict(
                _modified_person
            )

        registration_config_meta = cls(
        ...
        registration_config_meta.additional_properties = d
        return registration_config_meta
