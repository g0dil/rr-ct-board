...
T = TypeVar("T", bound="AppointmentCalculatedWithIncludesAppointmentBaseAddress")


@_attrs_define
class AppointmentCalculatedWithIncludesAppointmentBaseAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appointment_calculated_with_includes_appointment_base_address = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        appointment_calculated_with_includes_appointment_base_address.additional_properties = d
        return appointment_calculated_with_includes_appointment_base_address
