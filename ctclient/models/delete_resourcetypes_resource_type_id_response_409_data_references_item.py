...
T = TypeVar("T", bound="DeleteResourcetypesResourceTypeIdResponse409DataReferencesItem")


@_attrs_define
class DeleteResourcetypesResourceTypeIdResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_resourcetypes_resource_type_id_response_409_data_references_item = cls(
        ...
        delete_resourcetypes_resource_type_id_response_409_data_references_item.additional_properties = d
        return delete_resourcetypes_resource_type_id_response_409_data_references_item
