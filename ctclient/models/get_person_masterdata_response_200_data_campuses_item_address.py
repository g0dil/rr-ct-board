...
T = TypeVar("T", bound="GetPersonMasterdataResponse200DataCampusesItemAddress")


@_attrs_define
class GetPersonMasterdataResponse200DataCampusesItemAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_person_masterdata_response_200_data_campuses_item_address = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        get_person_masterdata_response_200_data_campuses_item_address.additional_properties = d
        return get_person_masterdata_response_200_data_campuses_item_address
