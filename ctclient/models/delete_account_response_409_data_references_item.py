...
T = TypeVar("T", bound="DeleteAccountResponse409DataReferencesItem")


@_attrs_define
class DeleteAccountResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_account_response_409_data_references_item = cls(
        ...
        delete_account_response_409_data_references_item.additional_properties = d
        return delete_account_response_409_data_references_item
