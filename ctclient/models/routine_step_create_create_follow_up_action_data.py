...
from ..models.routine_step_create_create_follow_up_action_data_color import (
    RoutineStepCreateCreateFollowUpActionDataColor,
)
from ..models.routine_step_create_create_follow_up_action_data_continuation_type import (
    RoutineStepCreateCreateFollowUpActionDataContinuationType,
)
from ..models.routine_step_create_create_follow_up_action_data_success_group_member_status_type_0 import (
    RoutineStepCreateCreateFollowUpActionDataSuccessGroupMemberStatusType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RoutineStepCreateCreateFollowUpActionData")


@_attrs_define
class RoutineStepCreateCreateFollowUpActionData:
    """
    Attributes:
        continuation_type (RoutineStepCreateCreateFollowUpActionDataContinuationType):
        description (None | str):
        title (str):
        color (RoutineStepCreateCreateFollowUpActionDataColor | Unset): A color in ChurchTools
        ...
        success_group_member_status (None | RoutineStepCreateCreateFollowUpActionDataSuccessGroupMemberStatusType0 |
            Unset):
    ...
    description: None | str
    title: str
    color: RoutineStepCreateCreateFollowUpActionDataColor | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: RoutineStepCreateCreateFollowUpActionDataColor | Unset
        if isinstance(_color, Unset):
            color = UNSET
        else:
            color = RoutineStepCreateCreateFollowUpActionDataColor(_color)
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = RoutineStepCreateCreateFollowUpActionDataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        routine_step_create_create_follow_up_action_data = cls(
        ...
        routine_step_create_create_follow_up_action_data.additional_properties = d
        return routine_step_create_create_follow_up_action_data
