...
T = TypeVar("T", bound="PostGroupsResponse201DataPlacesItem")


@_attrs_define
class PostGroupsResponse201DataPlacesItem:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_groups_response_201_data_places_item = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        post_groups_response_201_data_places_item.additional_properties = d
        return post_groups_response_201_data_places_item
