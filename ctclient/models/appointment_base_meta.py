...
if TYPE_CHECKING:
    from ..models.appointment_base_meta_created_person import (
        AppointmentBaseMetaCreatedPerson,
    )
    from ..models.appointment_base_meta_modified_person import (
        AppointmentBaseMetaModifiedPerson,
    )


T = TypeVar("T", bound="AppointmentBaseMeta")


@_attrs_define
class AppointmentBaseMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (AppointmentBaseMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (AppointmentBaseMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: AppointmentBaseMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: AppointmentBaseMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = AppointmentBaseMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = AppointmentBaseMetaModifiedPerson.from_dict(
                _modified_person
            )

        appointment_base_meta = cls(
        ...
        appointment_base_meta.additional_properties = d
        return appointment_base_meta
