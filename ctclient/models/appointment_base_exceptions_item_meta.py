...
if TYPE_CHECKING:
    from ..models.appointment_base_exceptions_item_meta_created_person import (
        AppointmentBaseExceptionsItemMetaCreatedPerson,
    )
    from ..models.appointment_base_exceptions_item_meta_modified_person import (
        AppointmentBaseExceptionsItemMetaModifiedPerson,
    )


T = TypeVar("T", bound="AppointmentBaseExceptionsItemMeta")


@_attrs_define
class AppointmentBaseExceptionsItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (AppointmentBaseExceptionsItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (AppointmentBaseExceptionsItemMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: AppointmentBaseExceptionsItemMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: AppointmentBaseExceptionsItemMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = AppointmentBaseExceptionsItemMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = AppointmentBaseExceptionsItemMetaModifiedPerson.from_dict(
                _modified_person
            )

        appointment_base_exceptions_item_meta = cls(
        ...
        appointment_base_exceptions_item_meta.additional_properties = d
        return appointment_base_exceptions_item_meta
