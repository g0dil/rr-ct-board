...
T = TypeVar("T", bound="AppointmentCalculatedCalculated")


@_attrs_define
class AppointmentCalculatedCalculated:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appointment_calculated_calculated = cls(
            end_date=end_date,
            start_date=start_date,
        )

        appointment_calculated_calculated.additional_properties = d
        return appointment_calculated_calculated
