...
T = TypeVar("T", bound="PostGroupsResponse201DataSettingsNewMember")


@_attrs_define
class PostGroupsResponse201DataSettingsNewMember:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_groups_response_201_data_settings_new_member = cls(
            campus_id=campus_id,
            department_id=department_id,
            status_id=status_id,
        )

        post_groups_response_201_data_settings_new_member.additional_properties = d
        return post_groups_response_201_data_settings_new_member
