...
T = TypeVar("T", bound="GetRolesOfGroupResponse200DataItem")


@_attrs_define
class GetRolesOfGroupResponse200DataItem:
    """
    Attributes:
        can_read_chat (bool):
        can_write_chat (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_roles_of_group_response_200_data_item = cls(
        ...
        get_roles_of_group_response_200_data_item.additional_properties = d
        return get_roles_of_group_response_200_data_item
