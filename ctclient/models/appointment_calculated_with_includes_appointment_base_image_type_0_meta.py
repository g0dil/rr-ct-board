...
if TYPE_CHECKING:
    from ..models.appointment_calculated_with_includes_appointment_base_image_type_0_meta_created_person import (
        AppointmentCalculatedWithIncludesAppointmentBaseImageType0MetaCreatedPerson,
    )
    from ..models.appointment_calculated_with_includes_appointment_base_image_type_0_meta_modified_person import (
        AppointmentCalculatedWithIncludesAppointmentBaseImageType0MetaModifiedPerson,
    )


T = TypeVar("T", bound="AppointmentCalculatedWithIncludesAppointmentBaseImageType0Meta")


@_attrs_define
class AppointmentCalculatedWithIncludesAppointmentBaseImageType0Meta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (AppointmentCalculatedWithIncludesAppointmentBaseImageType0MetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (AppointmentCalculatedWithIncludesAppointmentBaseImageType0MetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = AppointmentCalculatedWithIncludesAppointmentBaseImageType0MetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = AppointmentCalculatedWithIncludesAppointmentBaseImageType0MetaModifiedPerson.from_dict(
                _modified_person
            )

        appointment_calculated_with_includes_appointment_base_image_type_0_meta = cls(
        ...
        appointment_calculated_with_includes_appointment_base_image_type_0_meta.additional_properties = d
        return appointment_calculated_with_includes_appointment_base_image_type_0_meta
