...
from ..models.get_sync_mappings_response_200_sync_entity_mapping_status import (
    GetSyncMappingsResponse200SyncEntityMappingStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_sync_mappings_response_200_sync_entity_mapping_meta import (
        GetSyncMappingsResponse200SyncEntityMappingMeta,
    )


T = TypeVar("T", bound="GetSyncMappingsResponse200SyncEntityMapping")


@_attrs_define
class GetSyncMappingsResponse200SyncEntityMapping:
    ...
    Attributes:
        ...
        meta (GetSyncMappingsResponse200SyncEntityMappingMeta | Unset):
        ...
        status (GetSyncMappingsResponse200SyncEntityMappingStatus | Unset): Status of Relationship Example: synced.
    """
    ...
    meta: GetSyncMappingsResponse200SyncEntityMappingMeta | Unset = UNSET
    scope: None | str | Unset = UNSET
    source_entity_id: str | Unset = UNSET
    source_id: int | Unset = UNSET
    status: GetSyncMappingsResponse200SyncEntityMappingStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = GetSyncMappingsResponse200SyncEntityMappingMeta.from_dict(_meta)
        ...
        status: GetSyncMappingsResponse200SyncEntityMappingStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = GetSyncMappingsResponse200SyncEntityMappingStatus(_status)

        get_sync_mappings_response_200_sync_entity_mapping = cls(
            domain_id=domain_id,
        ...
        get_sync_mappings_response_200_sync_entity_mapping.additional_properties = d
        return get_sync_mappings_response_200_sync_entity_mapping
