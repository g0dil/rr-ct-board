...
if TYPE_CHECKING:
    from ..models.create_new_account_group_response_200_data_item_meta import (
        CreateNewAccountGroupResponse200DataItemMeta,
    )


T = TypeVar("T", bound="CreateNewAccountGroupResponse200DataItem")


@_attrs_define
class CreateNewAccountGroupResponse200DataItem:
    """
    Attributes:
        account_class_id (int):  Example: 2.
        id (int):  Example: 1.
        is_cash_asset_account (bool):
        meta (CreateNewAccountGroupResponse200DataItemMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
    ...
    id: int
    is_cash_asset_account: bool
    meta: CreateNewAccountGroupResponse200DataItemMeta
    name: str
    sort_key: int = 0
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = CreateNewAccountGroupResponse200DataItemMeta.from_dict(d.pop("meta"))

        name = d.pop("name")

        sort_key = d.pop("sortKey")

        create_new_account_group_response_200_data_item = cls(
        ...
        create_new_account_group_response_200_data_item.additional_properties = d
        return create_new_account_group_response_200_data_item
