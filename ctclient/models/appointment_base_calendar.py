...
if TYPE_CHECKING:
    from ..models.appointment_base_calendar_meta import AppointmentBaseCalendarMeta


T = TypeVar("T", bound="AppointmentBaseCalendar")


@_attrs_define
class AppointmentBaseCalendar:
    """
    Attributes:
        id (int):
        meta (AppointmentBaseCalendarMeta):
        name_translated (str):
        random_url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = AppointmentBaseCalendarMeta.from_dict(d.pop("meta"))
        ...
        appointment_base_calendar.additional_properties = d
        return appointment_base_calendar
