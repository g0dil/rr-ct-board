...
T = TypeVar("T", bound="GetLogByIdResponse200Log")


@_attrs_define
class GetLogByIdResponse200Log:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_log_by_id_response_200_log = cls(
            date=date,
            domain_id=domain_id,
        ...
        get_log_by_id_response_200_log.additional_properties = d
        return get_log_by_id_response_200_log
