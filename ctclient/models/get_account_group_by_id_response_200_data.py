...
if TYPE_CHECKING:
    from ..models.get_account_group_by_id_response_200_data_meta import (
        GetAccountGroupByIdResponse200DataMeta,
    )


T = TypeVar("T", bound="GetAccountGroupByIdResponse200Data")


@_attrs_define
class GetAccountGroupByIdResponse200Data:
    """
    Attributes:
        account_class_id (int):  Example: 2.
        id (int):  Example: 1.
        is_cash_asset_account (bool):
        meta (GetAccountGroupByIdResponse200DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
    ...
    id: int
    is_cash_asset_account: bool
    meta: GetAccountGroupByIdResponse200DataMeta
    name: str
    sort_key: int = 0
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = GetAccountGroupByIdResponse200DataMeta.from_dict(d.pop("meta"))

        name = d.pop("name")

        sort_key = d.pop("sortKey")

        get_account_group_by_id_response_200_data = cls(
        ...
        get_account_group_by_id_response_200_data.additional_properties = d
        return get_account_group_by_id_response_200_data
