...
T = TypeVar("T", bound="AppointmentCalculatedBaseAdditionalsItemMeta")


@_attrs_define
class AppointmentCalculatedBaseAdditionalsItemMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appointment_calculated_base_additionals_item_meta = cls(
            modified_date=modified_date,
            modified_pid=modified_pid,
        )

        appointment_calculated_base_additionals_item_meta.additional_properties = d
        return appointment_calculated_base_additionals_item_meta
