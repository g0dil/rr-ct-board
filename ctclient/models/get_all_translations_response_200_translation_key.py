...
if TYPE_CHECKING:
    from ..models.get_all_translations_response_200_translation_key_translations import (
        GetAllTranslationsResponse200TranslationKeyTranslations,
    )


T = TypeVar("T", bound="GetAllTranslationsResponse200TranslationKey")


@_attrs_define
class GetAllTranslationsResponse200TranslationKey:
    ...
    Attributes:
        ...
        translations (GetAllTranslationsResponse200TranslationKeyTranslations | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_translations, Unset):
            ...
            translations = (
                GetAllTranslationsResponse200TranslationKeyTranslations.from_dict(
                    _translations
                )
            )
        ...
        get_all_translations_response_200_translation_key = cls(
            id=id,
            key=key,
            module=module,
        ...
        get_all_translations_response_200_translation_key.additional_properties = d
        return get_all_translations_response_200_translation_key
