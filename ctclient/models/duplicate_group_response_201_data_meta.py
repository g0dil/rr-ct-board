...
if TYPE_CHECKING:
    from ..models.duplicate_group_response_201_data_meta_created_person import (
        DuplicateGroupResponse201DataMetaCreatedPerson,
    )
    from ..models.duplicate_group_response_201_data_meta_modified_person import (
        DuplicateGroupResponse201DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="DuplicateGroupResponse201DataMeta")


@_attrs_define
class DuplicateGroupResponse201DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (DuplicateGroupResponse201DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (DuplicateGroupResponse201DataMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: DuplicateGroupResponse201DataMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: DuplicateGroupResponse201DataMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = DuplicateGroupResponse201DataMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = DuplicateGroupResponse201DataMetaModifiedPerson.from_dict(
                _modified_person
            )

        duplicate_group_response_201_data_meta = cls(
        ...
        duplicate_group_response_201_data_meta.additional_properties = d
        return duplicate_group_response_201_data_meta
