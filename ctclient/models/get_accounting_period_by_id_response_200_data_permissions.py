...
T = TypeVar("T", bound="GetAccountingPeriodByIdResponse200DataPermissions")


@_attrs_define
class GetAccountingPeriodByIdResponse200DataPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_accounting_period_by_id_response_200_data_permissions = cls(
            can_use_expert_mode=can_use_expert_mode,
            edit_accounting_period=edit_accounting_period,
        )

        get_accounting_period_by_id_response_200_data_permissions.additional_properties = d
        return get_accounting_period_by_id_response_200_data_permissions
