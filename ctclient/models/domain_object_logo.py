...
from ..models.domain_object_logo_domain_type import DomainObjectLogoDomainType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.domain_object_logo_color import DomainObjectLogoColor


T = TypeVar("T", bound="DomainObjectLogo")


@_attrs_define
class DomainObjectLogo:
    """
    Attributes:
        domain_identifier (str):
        frontend_url (None | str):
        title (str):
        domain_type (DomainObjectLogoDomainType):
        icon (str):
        api_url (None | str | Unset):
        color (DomainObjectLogoColor | None | Unset):
    ...
    color: DomainObjectLogoColor | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.color, Unset):
            color = UNSET
        elif isinstance(self.color, DomainObjectLogoColor):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domain_type = DomainObjectLogoDomainType(d.pop("domainType"))
        ...
        def _parse_color(data: object) -> DomainObjectLogoColor | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                color_color = DomainObjectLogoColor.from_dict(data)

                return color_color
            except:  # noqa: E722
                pass
            return cast(DomainObjectLogoColor | None | Unset, data)
        ...
        domain_object_logo.additional_properties = d
        return domain_object_logo
