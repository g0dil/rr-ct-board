...
if TYPE_CHECKING:
    from ..models.update_tax_rate_response_200_data_meta_created_person import (
        UpdateTaxRateResponse200DataMetaCreatedPerson,
    )
    from ..models.update_tax_rate_response_200_data_meta_modified_person import (
        UpdateTaxRateResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="UpdateTaxRateResponse200DataMeta")


@_attrs_define
class UpdateTaxRateResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (UpdateTaxRateResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (UpdateTaxRateResponse200DataMetaModifiedPerson | Unset):
    """

    created_date: datetime.datetime
    created_person: UpdateTaxRateResponse200DataMetaCreatedPerson
    modified_date: datetime.datetime | Unset = UNSET
    modified_person: UpdateTaxRateResponse200DataMetaModifiedPerson | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = UpdateTaxRateResponse200DataMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = UpdateTaxRateResponse200DataMetaModifiedPerson.from_dict(
                _modified_person
            )

        update_tax_rate_response_200_data_meta = cls(
        ...
        update_tax_rate_response_200_data_meta.additional_properties = d
        return update_tax_rate_response_200_data_meta
