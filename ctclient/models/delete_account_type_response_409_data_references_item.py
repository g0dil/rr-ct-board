...
T = TypeVar("T", bound="DeleteAccountTypeResponse409DataReferencesItem")


@_attrs_define
class DeleteAccountTypeResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_account_type_response_409_data_references_item = cls(
        ...
        delete_account_type_response_409_data_references_item.additional_properties = d
        return delete_account_type_response_409_data_references_item
