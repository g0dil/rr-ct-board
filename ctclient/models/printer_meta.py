...
if TYPE_CHECKING:
    from ..models.printer_meta_created_person import PrinterMetaCreatedPerson
    from ..models.printer_meta_modified_person import PrinterMetaModifiedPerson


T = TypeVar("T", bound="PrinterMeta")
...
class PrinterMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = PrinterMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = PrinterMetaModifiedPerson.from_dict(_modified_person)
        ...
        printer_meta.additional_properties = d
        return printer_meta
