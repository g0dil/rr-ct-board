...
T = TypeVar("T", bound="GetResourcesResourceIdResponse200Data")


@_attrs_define
class GetResourcesResourceIdResponse200Data:
    """
    Attributes:
        id (int):  Example: 7.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_resources_resource_id_response_200_data = cls(
            id=id,
        ...
        get_resources_resource_id_response_200_data.additional_properties = d
        return get_resources_resource_id_response_200_data
