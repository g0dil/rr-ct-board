...
T = TypeVar("T", bound="CreateNewStatusDataBody")


@_attrs_define
class CreateNewStatusDataBody:
    """
    Attributes:
        is_member (bool):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_new_status_data_body = cls(
            is_member=is_member,
            name=name,
            shorty=shorty,
        ...
        create_new_status_data_body.additional_properties = d
        return create_new_status_data_body
