...
if TYPE_CHECKING:
    from ..models.update_account_response_200_data_meta import (
        UpdateAccountResponse200DataMeta,
    )
    from ..models.update_account_response_200_data_permissions import (
        UpdateAccountResponse200DataPermissions,
    )


T = TypeVar("T", bound="UpdateAccountResponse200Data")


@_attrs_define
class UpdateAccountResponse200Data:
    """
    Attributes:
        ...
        meta (UpdateAccountResponse200DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z', 'createdPerson':
            {'id': 1}, 'modifiedDate': '2020-01-01T00:00:00Z', 'modifiedPerson': {'id': 1}}.
        name (str):  Example: Donations.
        number (str):  Example: 8200.
        permissions (UpdateAccountResponse200DataPermissions):
    ...
    is_opening_balance_account: bool
    meta: UpdateAccountResponse200DataMeta
    name: str
    number: str
    permissions: UpdateAccountResponse200DataPermissions
    tax_rate_id: int | None
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = UpdateAccountResponse200DataMeta.from_dict(d.pop("meta"))

        name = d.pop("name")

        number = d.pop("number")

        permissions = UpdateAccountResponse200DataPermissions.from_dict(
            d.pop("permissions")
        )
        ...
        update_account_response_200_data = cls(
        ...
        update_account_response_200_data.additional_properties = d
        return update_account_response_200_data
