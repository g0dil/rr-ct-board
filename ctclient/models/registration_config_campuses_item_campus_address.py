...
T = TypeVar("T", bound="RegistrationConfigCampusesItemCampusAddress")


@_attrs_define
class RegistrationConfigCampusesItemCampusAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        registration_config_campuses_item_campus_address = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        registration_config_campuses_item_campus_address.additional_properties = d
        return registration_config_campuses_item_campus_address
