...
from ..models.put_checkin_persons_response_200_data_invitation_status_type_0 import (
    PutCheckinPersonsResponse200DataInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.put_checkin_persons_response_200_data_emails_item import (
        PutCheckinPersonsResponse200DataEmailsItem,
    )
    from ..models.put_checkin_persons_response_200_data_meta import (
        PutCheckinPersonsResponse200DataMeta,
    )
    from ..models.put_checkin_persons_response_200_data_privacy_policy_agreement import (
        PutCheckinPersonsResponse200DataPrivacyPolicyAgreement,
    )
    from ..models.put_checkin_persons_response_200_data_tags_item import (
        PutCheckinPersonsResponse200DataTagsItem,
    )


T = TypeVar("T", bound="PutCheckinPersonsResponse200Data")


@_attrs_define
class PutCheckinPersonsResponse200Data:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[PutCheckinPersonsResponse200DataEmailsItem] | Unset):
            ...
            invitation_status (None | PutCheckinPersonsResponse200DataInvitationStatusType0 | Unset):
            ...
            meta (PutCheckinPersonsResponse200DataMeta | Unset):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            ...
            privacy_policy_agreement (PutCheckinPersonsResponse200DataPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[PutCheckinPersonsResponse200DataTagsItem] | Unset):
            title (str | Unset):
    ...
    emails: list[PutCheckinPersonsResponse200DataEmailsItem] | Unset = UNSET
    ...
    invitation_status: (
        None | PutCheckinPersonsResponse200DataInvitationStatusType0 | Unset
    ) = UNSET
    ...
    meta: PutCheckinPersonsResponse200DataMeta | Unset = UNSET
    ...
    privacy_policy_agreement: (
        PutCheckinPersonsResponse200DataPrivacyPolicyAgreement | Unset
    ) = UNSET
    ...
    tags: list[PutCheckinPersonsResponse200DataTagsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = PutCheckinPersonsResponse200DataEmailsItem.from_dict(
                emails_item_data
            )
        ...
        def _parse_invitation_status(
            ...
            try:
                ...
                invitation_status_type_0 = (
                    PutCheckinPersonsResponse200DataInvitationStatusType0(data)
                )
        ...
        meta: PutCheckinPersonsResponse200DataMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = PutCheckinPersonsResponse200DataMeta.from_dict(_meta)
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = (
                PutCheckinPersonsResponse200DataPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = PutCheckinPersonsResponse200DataTagsItem.from_dict(
                tags_item_data
            )
        ...
        put_checkin_persons_response_200_data = cls(
        ...
        put_checkin_persons_response_200_data.additional_properties = d
        return put_checkin_persons_response_200_data
