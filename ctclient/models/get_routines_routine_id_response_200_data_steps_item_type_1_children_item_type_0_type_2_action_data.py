...
T = TypeVar(
    "T",
    bound="GetRoutinesRoutineIdResponse200DataStepsItemType1ChildrenItemType0Type2ActionData",
)


@_attrs_define
class GetRoutinesRoutineIdResponse200DataStepsItemType1ChildrenItemType0Type2ActionData:
    """
    Attributes:
        group_id (int):
        comment (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_routines_routine_id_response_200_data_steps_item_type_1_children_item_type_0_type_2_action_data = cls(
            group_id=group_id,
            comment=comment,
        ...
        get_routines_routine_id_response_200_data_steps_item_type_1_children_item_type_0_type_2_action_data.additional_properties = d
        return get_routines_routine_id_response_200_data_steps_item_type_1_children_item_type_0_type_2_action_data
