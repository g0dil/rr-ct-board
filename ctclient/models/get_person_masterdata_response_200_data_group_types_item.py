...
T = TypeVar("T", bound="GetPersonMasterdataResponse200DataGroupTypesItem")


@_attrs_define
class GetPersonMasterdataResponse200DataGroupTypesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_person_masterdata_response_200_data_group_types_item = cls(
            name_plural_translated=name_plural_translated,
            name_translated=name_translated,
        )

        get_person_masterdata_response_200_data_group_types_item.additional_properties = d
        return get_person_masterdata_response_200_data_group_types_item
