...
if TYPE_CHECKING:
    from ..models.post_dbfields_response_201_data_field_category import (
        PostDbfieldsResponse201DataFieldCategory,
    )
    from ..models.post_dbfields_response_201_data_field_type import (
        PostDbfieldsResponse201DataFieldType,
    )
    from ..models.post_dbfields_response_201_data_options_item import (
        PostDbfieldsResponse201DataOptionsItem,
    )


T = TypeVar("T", bound="PostDbfieldsResponse201Data")


@_attrs_define
class PostDbfieldsResponse201Data:
    """
    Attributes:
        ...
        field_category (PostDbfieldsResponse201DataFieldCategory):
        field_type (PostDbfieldsResponse201DataFieldType):
        ...
        shorty (str | Unset):
        options (list[PostDbfieldsResponse201DataOptionsItem] | Unset):
    """
    ...
    options: list[PostDbfieldsResponse201DataOptionsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_category = PostDbfieldsResponse201DataFieldCategory.from_dict(
            d.pop("fieldCategory")
        )

        field_type = PostDbfieldsResponse201DataFieldType.from_dict(d.pop("fieldType"))
        ...
        for options_item_data in _options or []:
            options_item = PostDbfieldsResponse201DataOptionsItem.from_dict(
                options_item_data
            )

            options.append(options_item)

        post_dbfields_response_201_data = cls(
        ...
        post_dbfields_response_201_data.additional_properties = d
        return post_dbfields_response_201_data
