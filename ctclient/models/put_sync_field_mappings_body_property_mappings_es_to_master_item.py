...
if TYPE_CHECKING:
    from ..models.put_sync_field_mappings_body_property_mappings_es_to_master_item_value_mapping import (
        PutSyncFieldMappingsBodyPropertyMappingsESToMasterItemValueMapping,
    )


T = TypeVar("T", bound="PutSyncFieldMappingsBodyPropertyMappingsESToMasterItem")


@_attrs_define
class PutSyncFieldMappingsBodyPropertyMappingsESToMasterItem:
    """
    Attributes:
        from_ (str | Unset):
        ...
        to (str | Unset):
        to_filter (str | Unset):
        value_mapping (PutSyncFieldMappingsBodyPropertyMappingsESToMasterItemValueMapping | Unset):
    """
    ...
    value_mapping: (
        PutSyncFieldMappingsBodyPropertyMappingsESToMasterItemValueMapping | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_value_mapping, Unset):
            ...
            value_mapping = PutSyncFieldMappingsBodyPropertyMappingsESToMasterItemValueMapping.from_dict(
                _value_mapping
            )

        put_sync_field_mappings_body_property_mappings_es_to_master_item = cls(
            from_=from_,
        ...
        put_sync_field_mappings_body_property_mappings_es_to_master_item.additional_properties = d
        return put_sync_field_mappings_body_property_mappings_es_to_master_item
