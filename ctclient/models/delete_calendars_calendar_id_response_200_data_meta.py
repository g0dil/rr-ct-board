...
T = TypeVar("T", bound="DeleteCalendarsCalendarIdResponse200DataMeta")


@_attrs_define
class DeleteCalendarsCalendarIdResponse200DataMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_calendars_calendar_id_response_200_data_meta = cls(
            modified_date=modified_date,
            modified_pid=modified_pid,
        )

        delete_calendars_calendar_id_response_200_data_meta.additional_properties = d
        return delete_calendars_calendar_id_response_200_data_meta
