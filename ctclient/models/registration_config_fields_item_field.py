...
if TYPE_CHECKING:
    from ..models.registration_config_fields_item_field_field_category import (
        RegistrationConfigFieldsItemFieldFieldCategory,
    )
    from ..models.registration_config_fields_item_field_field_type import (
        RegistrationConfigFieldsItemFieldFieldType,
    )
    from ..models.registration_config_fields_item_field_options_item import (
        RegistrationConfigFieldsItemFieldOptionsItem,
    )


T = TypeVar("T", bound="RegistrationConfigFieldsItemField")


@_attrs_define
class RegistrationConfigFieldsItemField:
    """
    Attributes:
        ...
        field_category (RegistrationConfigFieldsItemFieldFieldCategory):
        field_type (RegistrationConfigFieldsItemFieldFieldType):
        ...
        shorty (str | Unset):
        options (list[RegistrationConfigFieldsItemFieldOptionsItem] | Unset):
    """
    ...
    options: list[RegistrationConfigFieldsItemFieldOptionsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_category = RegistrationConfigFieldsItemFieldFieldCategory.from_dict(
            d.pop("fieldCategory")
        )

        field_type = RegistrationConfigFieldsItemFieldFieldType.from_dict(
            d.pop("fieldType")
        )
        ...
        for options_item_data in _options or []:
            options_item = RegistrationConfigFieldsItemFieldOptionsItem.from_dict(
                options_item_data
            )

            options.append(options_item)

        registration_config_fields_item_field = cls(
        ...
        registration_config_fields_item_field.additional_properties = d
        return registration_config_fields_item_field
