...
from ..models.patch_routines_routine_id_response_200_data_steps_item_type_1_children_item_type_0_type_1_action_data_color import (
    PatchRoutinesRoutineIdResponse200DataStepsItemType1ChildrenItemType0Type1ActionDataColor,
)
from ..models.patch_routines_routine_id_response_200_data_steps_item_type_1_children_item_type_0_type_1_action_data_continuation_type import (
    PatchRoutinesRoutineIdResponse200DataStepsItemType1ChildrenItemType0Type1ActionDataContinuationType,
)
from ..models.patch_routines_routine_id_response_200_data_steps_item_type_1_children_item_type_0_type_1_action_data_success_group_member_status_type_0 import (
...
T = TypeVar(
    "T",
    bound="PatchRoutinesRoutineIdResponse200DataStepsItemType1ChildrenItemType0Type1ActionData",
)


@_attrs_define
class PatchRoutinesRoutineIdResponse200DataStepsItemType1ChildrenItemType0Type1ActionData:
    """
    Attributes:
        continuation_type
            (PatchRoutinesRoutineIdResponse200DataStepsItemType1ChildrenItemType0Type1ActionDataContinuationType):
        ...
        title (str):
        color (PatchRoutinesRoutineIdResponse200DataStepsItemType1ChildrenItemType0Type1ActionDataColor | Unset): A
            color in ChurchTools
    ...
    continuation_type: PatchRoutinesRoutineIdResponse200DataStepsItemType1ChildrenItemType0Type1ActionDataContinuationType
    description: None | str
    title: str
    color: (
        PatchRoutinesRoutineIdResponse200DataStepsItemType1ChildrenItemType0Type1ActionDataColor
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_color, Unset):
            ...
            color = PatchRoutinesRoutineIdResponse200DataStepsItemType1ChildrenItemType0Type1ActionDataColor(
                _color
            )
        ...
        def _parse_success_group_member_status(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                success_group_member_status_type_0 = PatchRoutinesRoutineIdResponse200DataStepsItemType1ChildrenItemType0Type1ActionDataSuccessGroupMemberStatusType0(
                    data
                )
        ...
        patch_routines_routine_id_response_200_data_steps_item_type_1_children_item_type_0_type_1_action_data = cls(
        ...
        patch_routines_routine_id_response_200_data_steps_item_type_1_children_item_type_0_type_1_action_data.additional_properties = d
        return patch_routines_routine_id_response_200_data_steps_item_type_1_children_item_type_0_type_1_action_data
