...
if TYPE_CHECKING:
    from ..models.create_person_body_person_email import CreatePersonBodyPersonEmail
    from ..models.create_person_body_privacy_policy_agreement import (
...
class CreatePersonBody:
    ...
    Attributes:
        ...
        department_ids (list[int] | Unset): Department IDs. At least one department MUST be set for a person.
        email (str | Unset):
        emails (list[CreatePersonBodyPersonEmail] | Unset): Save many eMail addresses for person. If `emails` is present
        ...
        privacy_policy_agreement (CreatePersonBodyPrivacyPolicyAgreement | Unset): This object can be optional or
    ...
    emails: list[CreatePersonBodyPersonEmail] | Unset = UNSET
    ...
    privacy_policy_agreement: CreatePersonBodyPrivacyPolicyAgreement | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = CreatePersonBodyPersonEmail.from_dict(emails_item_data)
        ...
        privacy_policy_agreement: CreatePersonBodyPrivacyPolicyAgreement | Unset
        if isinstance(_privacy_policy_agreement, Unset):
            privacy_policy_agreement = UNSET
        else:
            privacy_policy_agreement = CreatePersonBodyPrivacyPolicyAgreement.from_dict(
