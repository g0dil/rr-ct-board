...
T = TypeVar(
    "T", bound="DeleteGroupGroupcategoriesGroupCategoryIdResponse409DataReferencesItem"
)


@_attrs_define
class DeleteGroupGroupcategoriesGroupCategoryIdResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_group_groupcategories_group_category_id_response_409_data_references_item = cls(
        ...
        delete_group_groupcategories_group_category_id_response_409_data_references_item.additional_properties = d
        return delete_group_groupcategories_group_category_id_response_409_data_references_item
