...
from ..models.relationship_type_function_keys_item import (
...
class RelationshipType:
    ...
    Attributes:
        ...
        function_keys (list[RelationshipTypeFunctionKeysItem] | Unset):
    """
    ...
    function_keys: list[RelationshipTypeFunctionKeysItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for function_keys_item_data in _function_keys or []:
            function_keys_item = RelationshipTypeFunctionKeysItem(
        ...
        relationship_type.additional_properties = d
