...
T = TypeVar("T", bound="GetPersonPrivacyPolicyResponse200DataOwner")


@_attrs_define
class GetPersonPrivacyPolicyResponse200DataOwner:
    """
    Attributes:
        accepted (bool):
        accepted_type (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_person_privacy_policy_response_200_data_owner = cls(
            accepted=accepted,
        ...
        get_person_privacy_policy_response_200_data_owner.additional_properties = d
        return get_person_privacy_policy_response_200_data_owner
