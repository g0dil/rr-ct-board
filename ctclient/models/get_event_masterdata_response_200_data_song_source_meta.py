...
if TYPE_CHECKING:
    from ..models.get_event_masterdata_response_200_data_song_source_meta_created_person import (
        GetEventMasterdataResponse200DataSongSourceMetaCreatedPerson,
    )
    from ..models.get_event_masterdata_response_200_data_song_source_meta_modified_person import (
        GetEventMasterdataResponse200DataSongSourceMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetEventMasterdataResponse200DataSongSourceMeta")


@_attrs_define
class GetEventMasterdataResponse200DataSongSourceMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetEventMasterdataResponse200DataSongSourceMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetEventMasterdataResponse200DataSongSourceMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        GetEventMasterdataResponse200DataSongSourceMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            GetEventMasterdataResponse200DataSongSourceMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                GetEventMasterdataResponse200DataSongSourceMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        get_event_masterdata_response_200_data_song_source_meta = cls(
        ...
        get_event_masterdata_response_200_data_song_source_meta.additional_properties = d
        return get_event_masterdata_response_200_data_song_source_meta
