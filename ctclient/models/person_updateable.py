...
if TYPE_CHECKING:
    from ..models.person_updateable_person_email import PersonUpdateablePersonEmail
    from ..models.person_updateable_privacy_policy_agreement import (
        PersonUpdateablePrivacyPolicyAgreement,
    )


T = TypeVar("T", bound="PersonUpdateable")


@_attrs_define
class PersonUpdateable:
    ...
    Attributes:
        ...
        email (str | Unset):
        emails (list[PersonUpdateablePersonEmail] | Unset): Save many eMail addresses for person. If `emails` is present
        ...
        privacy_policy_agreement (PersonUpdateablePrivacyPolicyAgreement | Unset): This object can be optional or
    ...
    emails: list[PersonUpdateablePersonEmail] | Unset = UNSET
    ...
    privacy_policy_agreement: PersonUpdateablePrivacyPolicyAgreement | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = PersonUpdateablePersonEmail.from_dict(emails_item_data)
        ...
        privacy_policy_agreement: PersonUpdateablePrivacyPolicyAgreement | Unset
        if isinstance(_privacy_policy_agreement, Unset):
            privacy_policy_agreement = UNSET
        else:
            privacy_policy_agreement = PersonUpdateablePrivacyPolicyAgreement.from_dict(
        ...
        person_updateable.additional_properties = d
        return person_updateable
