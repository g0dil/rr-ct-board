...
T = TypeVar("T", bound="PutResourcesResourceIdResponse200Data")


@_attrs_define
class PutResourcesResourceIdResponse200Data:
    """
    Attributes:
        id (int):  Example: 7.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_resources_resource_id_response_200_data = cls(
            id=id,
        ...
        put_resources_resource_id_response_200_data.additional_properties = d
        return put_resources_resource_id_response_200_data
