...
T = TypeVar("T", bound="GetGroupsGroupIdResponse200DataRolesItem")


@_attrs_define
class GetGroupsGroupIdResponse200DataRolesItem:
    """
    Attributes:
        can_read_chat (bool):
        can_write_chat (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_groups_group_id_response_200_data_roles_item = cls(
        ...
        get_groups_group_id_response_200_data_roles_item.additional_properties = d
        return get_groups_group_id_response_200_data_roles_item
