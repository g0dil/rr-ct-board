...
if TYPE_CHECKING:
    from ..models.put_sync_externalsystems_external_system_id_jobconfigs_job_id_properties_response_200_data_properties_property_mappings_es_to_master_item import (
        PutSyncExternalsystemsExternalSystemIdJobconfigsJobIdPropertiesResponse200DataPropertiesPropertyMappingsESToMasterItem,
    )
    from ..models.put_sync_externalsystems_external_system_id_jobconfigs_job_id_properties_response_200_data_properties_property_mappings_master_to_es_item import (
...
T = TypeVar(
    "T",
    bound="PutSyncExternalsystemsExternalSystemIdJobconfigsJobIdPropertiesResponse200DataProperties",
)


@_attrs_define
class PutSyncExternalsystemsExternalSystemIdJobconfigsJobIdPropertiesResponse200DataProperties:
    """
    Attributes:
        property_mappings_es_to_master (list[PutSyncExternalsystemsExternalSystemIdJobconfigsJobIdPropertiesResponse200D
            ataPropertiesPropertyMappingsESToMasterItem]):
        property_mappings_master_to_es (list[PutSyncExternalsystemsExternalSystemIdJobconfigsJobIdPropertiesResponse200D
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for property_mappings_es_to_master_item_data in _property_mappings_es_to_master:
            property_mappings_es_to_master_item = PutSyncExternalsystemsExternalSystemIdJobconfigsJobIdPropertiesResponse200DataPropertiesPropertyMappingsESToMasterItem.from_dict(
                property_mappings_es_to_master_item_data
            )
        ...
        for property_mappings_master_to_es_item_data in _property_mappings_master_to_es:
            property_mappings_master_to_es_item = PutSyncExternalsystemsExternalSystemIdJobconfigsJobIdPropertiesResponse200DataPropertiesPropertyMappingsMasterToESItem.from_dict(
                property_mappings_master_to_es_item_data
            )

            property_mappings_master_to_es.append(property_mappings_master_to_es_item)

        put_sync_externalsystems_external_system_id_jobconfigs_job_id_properties_response_200_data_properties = cls(
        ...
        put_sync_externalsystems_external_system_id_jobconfigs_job_id_properties_response_200_data_properties.additional_properties = d
        return put_sync_externalsystems_external_system_id_jobconfigs_job_id_properties_response_200_data_properties
