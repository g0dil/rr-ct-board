...
if TYPE_CHECKING:
    from ..models.place_meta_created_person import PlaceMetaCreatedPerson
    from ..models.place_meta_modified_person import PlaceMetaModifiedPerson


T = TypeVar("T", bound="PlaceMeta")
...
class PlaceMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = PlaceMetaCreatedPerson.from_dict(d.pop("createdPerson"))
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = PlaceMetaModifiedPerson.from_dict(_modified_person)
        ...
        place_meta.additional_properties = d
        return place_meta
