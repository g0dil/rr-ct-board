...
T = TypeVar("T", bound="GetExternalloginExternalLoginIdResponse200Data")


@_attrs_define
class GetExternalloginExternalLoginIdResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_externallogin_external_login_id_response_200_data = cls(
            name=name,
        ...
        get_externallogin_external_login_id_response_200_data.additional_properties = d
        return get_externallogin_external_login_id_response_200_data
