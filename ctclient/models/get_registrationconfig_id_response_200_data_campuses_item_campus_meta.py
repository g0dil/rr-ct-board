...
if TYPE_CHECKING:
    from ..models.get_registrationconfig_id_response_200_data_campuses_item_campus_meta_created_person import (
        GetRegistrationconfigIdResponse200DataCampusesItemCampusMetaCreatedPerson,
    )
    from ..models.get_registrationconfig_id_response_200_data_campuses_item_campus_meta_modified_person import (
        GetRegistrationconfigIdResponse200DataCampusesItemCampusMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetRegistrationconfigIdResponse200DataCampusesItemCampusMeta")


@_attrs_define
class GetRegistrationconfigIdResponse200DataCampusesItemCampusMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetRegistrationconfigIdResponse200DataCampusesItemCampusMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetRegistrationconfigIdResponse200DataCampusesItemCampusMetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = GetRegistrationconfigIdResponse200DataCampusesItemCampusMetaCreatedPerson.from_dict(
            d.pop("createdPerson")
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = GetRegistrationconfigIdResponse200DataCampusesItemCampusMetaModifiedPerson.from_dict(
                _modified_person
            )

        get_registrationconfig_id_response_200_data_campuses_item_campus_meta = cls(
        ...
        get_registrationconfig_id_response_200_data_campuses_item_campus_meta.additional_properties = d
        return get_registrationconfig_id_response_200_data_campuses_item_campus_meta
