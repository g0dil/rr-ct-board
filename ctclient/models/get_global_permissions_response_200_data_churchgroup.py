...
T = TypeVar("T", bound="GetGlobalPermissionsResponse200DataChurchgroup")


@_attrs_define
class GetGlobalPermissionsResponse200DataChurchgroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_global_permissions_response_200_data_churchgroup = cls(
        ...
        get_global_permissions_response_200_data_churchgroup.additional_properties = d
        return get_global_permissions_response_200_data_churchgroup
