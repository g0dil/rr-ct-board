...
if TYPE_CHECKING:
    from ..models.domain_object_color import DomainObjectColor
...
class DomainObject:
    ...
    Attributes:
        ...
        color (DomainObjectColor | None | Unset):
    ...
    color: DomainObjectColor | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.color, Unset):
            color = UNSET
        elif isinstance(self.color, DomainObjectColor):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_color(data: object) -> DomainObjectColor | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                color_color = DomainObjectColor.from_dict(data)

                return color_color
            except:  # noqa: E722
                pass
            return cast(DomainObjectColor | None | Unset, data)
        ...
        domain_object.additional_properties = d
