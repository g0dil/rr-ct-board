...
T = TypeVar("T", bound="GetCampusResponse200DataAddress")


@_attrs_define
class GetCampusResponse200DataAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_campus_response_200_data_address = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        get_campus_response_200_data_address.additional_properties = d
        return get_campus_response_200_data_address
