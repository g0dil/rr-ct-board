...
if TYPE_CHECKING:
    from ..models.create_meeting_response_201_data_attendances import (
        CreateMeetingResponse201DataAttendances,
    )
    from ..models.create_meeting_response_201_data_date_from import (
        CreateMeetingResponse201DataDateFrom,
    )
    from ..models.create_meeting_response_201_data_date_to import (
        CreateMeetingResponse201DataDateTo,
    )
    from ..models.create_meeting_response_201_data_end_date import (
        CreateMeetingResponse201DataEndDate,
    )
    from ..models.create_meeting_response_201_data_meta import (
        CreateMeetingResponse201DataMeta,
    )
    from ..models.create_meeting_response_201_data_poll_result_type_0_item import (
        CreateMeetingResponse201DataPollResultType0Item,
    )
    from ..models.create_meeting_response_201_data_start_date import (
        CreateMeetingResponse201DataStartDate,
    )
    from ..models.create_meeting_response_201_data_statistics import (
        CreateMeetingResponse201DataStatistics,
    )


T = TypeVar("T", bound="CreateMeetingResponse201Data")


@_attrs_define
class CreateMeetingResponse201Data:
    """
    Attributes:
        end_date (CreateMeetingResponse201DataEndDate): End of the group meeting
        group_id (int):
        id (int):
        meta (CreateMeetingResponse201DataMeta):
        start_date (CreateMeetingResponse201DataStartDate): Start of the group meeting
        statistics (CreateMeetingResponse201DataStatistics):
        attendances (CreateMeetingResponse201DataAttendances | Unset): Map of person IDs to attendance status
        comment (None | str | Unset):
        date_from (CreateMeetingResponse201DataDateFrom | Unset):
        date_to (CreateMeetingResponse201DataDateTo | Unset):
        has_editing_started (bool | Unset):
        is_canceled (bool | Unset):
        is_completed (bool | Unset):
        num_guests (int | None | Unset):
        poll_result (list[CreateMeetingResponse201DataPollResultType0Item] | None | Unset):
    """

    end_date: CreateMeetingResponse201DataEndDate
    group_id: int
    id: int
    meta: CreateMeetingResponse201DataMeta
    start_date: CreateMeetingResponse201DataStartDate
    statistics: CreateMeetingResponse201DataStatistics
    attendances: CreateMeetingResponse201DataAttendances | Unset = UNSET
    comment: None | str | Unset = UNSET
    date_from: CreateMeetingResponse201DataDateFrom | Unset = UNSET
    date_to: CreateMeetingResponse201DataDateTo | Unset = UNSET
    ...
    poll_result: (
        list[CreateMeetingResponse201DataPollResultType0Item] | None | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        end_date = CreateMeetingResponse201DataEndDate.from_dict(d.pop("endDate"))

        group_id = d.pop("groupId")

        id = d.pop("id")

        meta = CreateMeetingResponse201DataMeta.from_dict(d.pop("meta"))

        start_date = CreateMeetingResponse201DataStartDate.from_dict(d.pop("startDate"))

        statistics = CreateMeetingResponse201DataStatistics.from_dict(
            d.pop("statistics")
        )

        _attendances = d.pop("attendances", UNSET)
        attendances: CreateMeetingResponse201DataAttendances | Unset
        if isinstance(_attendances, Unset):
            attendances = UNSET
        else:
            attendances = CreateMeetingResponse201DataAttendances.from_dict(
                _attendances
            )
        ...
        if isinstance(_date_from, Unset):
            ...
            date_from = CreateMeetingResponse201DataDateFrom.from_dict(_date_from)
        ...
        if isinstance(_date_to, Unset):
            ...
            date_to = CreateMeetingResponse201DataDateTo.from_dict(_date_to)
            ...
            try:
                ...
                for poll_result_type_0_item_data in _poll_result_type_0:
                    poll_result_type_0_item = (
                        CreateMeetingResponse201DataPollResultType0Item.from_dict(
        ...
        create_meeting_response_201_data = cls(
            end_date=end_date,
            group_id=group_id,
            id=id,
            meta=meta,
        ...
        create_meeting_response_201_data.additional_properties = d
        return create_meeting_response_201_data
