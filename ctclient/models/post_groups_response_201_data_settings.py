...
from ..models.post_groups_response_201_data_settings_default_post_notification_scope_type_1 import (
    PostGroupsResponse201DataSettingsDefaultPostNotificationScopeType1,
)
from ..models.post_groups_response_201_data_settings_default_post_notification_scope_type_2_type_1 import (
    PostGroupsResponse201DataSettingsDefaultPostNotificationScopeType2Type1,
)
from ..models.post_groups_response_201_data_settings_default_post_notification_scope_type_3_type_1 import (
    PostGroupsResponse201DataSettingsDefaultPostNotificationScopeType3Type1,
)
from ..models.post_groups_response_201_data_settings_default_post_visibility import (
    PostGroupsResponse201DataSettingsDefaultPostVisibility,
)
from ..models.post_groups_response_201_data_settings_dynamic_group_status_type_1 import (
    PostGroupsResponse201DataSettingsDynamicGroupStatusType1,
)
from ..models.post_groups_response_201_data_settings_dynamic_group_status_type_2_type_1 import (
    PostGroupsResponse201DataSettingsDynamicGroupStatusType2Type1,
)
from ..models.post_groups_response_201_data_settings_dynamic_group_status_type_3_type_1 import (
    PostGroupsResponse201DataSettingsDynamicGroupStatusType3Type1,
)
from ..models.post_groups_response_201_data_settings_visibility import (
    PostGroupsResponse201DataSettingsVisibility,
)

if TYPE_CHECKING:
    from ..models.post_groups_response_201_data_settings_dynamic_group_rule_set_type_0_item import (
        PostGroupsResponse201DataSettingsDynamicGroupRuleSetType0Item,
    )
    from ..models.post_groups_response_201_data_settings_group_meeting import (
        PostGroupsResponse201DataSettingsGroupMeeting,
    )
    from ..models.post_groups_response_201_data_settings_new_member import (
        PostGroupsResponse201DataSettingsNewMember,
    )


T = TypeVar("T", bound="PostGroupsResponse201DataSettings")


@_attrs_define
class PostGroupsResponse201DataSettings:
    """
    Attributes:
        ...
        default_post_notification_scope (None | PostGroupsResponse201DataSettingsDefaultPostNotificationScopeType1 |
            PostGroupsResponse201DataSettingsDefaultPostNotificationScopeType2Type1 |
            PostGroupsResponse201DataSettingsDefaultPostNotificationScopeType3Type1): Default value for post notification
            scope.
        default_post_placeholder_text (None | str): Default placeholder text for entering post content.
        default_post_visibility (PostGroupsResponse201DataSettingsDefaultPostVisibility):
        dynamic_group_rule_set (list[PostGroupsResponse201DataSettingsDynamicGroupRuleSetType0Item] | None): Rule set
            for dynamic group update.
        dynamic_group_status (None | PostGroupsResponse201DataSettingsDynamicGroupStatusType1 |
            PostGroupsResponse201DataSettingsDynamicGroupStatusType2Type1 |
            PostGroupsResponse201DataSettingsDynamicGroupStatusType3Type1): Status of dynamic group update.
        ...
        group_meeting (PostGroupsResponse201DataSettingsGroupMeeting):
        in_statistic (bool):
        ...
        new_member (PostGroupsResponse201DataSettingsNewMember): Campus, status, and department for newly created
            persons.
        posts_enabled (bool):
        ...
        sign_up_opening_date (datetime.datetime | None): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z'
            Example: 2022-10-19T12:00:00Z.
        visibility (PostGroupsResponse201DataSettingsVisibility): The visibility of a group.
    ...
    dynamic_group_rule_set: (
        list[PostGroupsResponse201DataSettingsDynamicGroupRuleSetType0Item] | None
    )
    ...
    new_member: PostGroupsResponse201DataSettingsNewMember
    posts_enabled: bool
    ...
    visibility: PostGroupsResponse201DataSettingsVisibility
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_default_post_notification_scope(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                default_post_notification_scope_type_2_type_1 = PostGroupsResponse201DataSettingsDefaultPostNotificationScopeType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                default_post_notification_scope_type_3_type_1 = PostGroupsResponse201DataSettingsDefaultPostNotificationScopeType3Type1(
                    data
                )
        ...
        def _parse_dynamic_group_rule_set(
            ...
            try:
                ...
                for (
                    ...
                    dynamic_group_rule_set_type_0_item = PostGroupsResponse201DataSettingsDynamicGroupRuleSetType0Item.from_dict(
                        dynamic_group_rule_set_type_0_item_data
                    )
                ...
                pass
            return cast(
                list[PostGroupsResponse201DataSettingsDynamicGroupRuleSetType0Item]
                | None,
                data,
            )
        ...
        def _parse_dynamic_group_status(
            ...
            try:
                ...
                dynamic_group_status_type_1 = (
                    PostGroupsResponse201DataSettingsDynamicGroupStatusType1(data)
                )
            ...
            try:
                ...
                dynamic_group_status_type_2_type_1 = (
                    PostGroupsResponse201DataSettingsDynamicGroupStatusType2Type1(data)
                )
            ...
            try:
                ...
                dynamic_group_status_type_3_type_1 = (
                    PostGroupsResponse201DataSettingsDynamicGroupStatusType3Type1(data)
                )
        ...
        group_meeting = PostGroupsResponse201DataSettingsGroupMeeting.from_dict(
            d.pop("groupMeeting")
        )
        ...
        new_member = PostGroupsResponse201DataSettingsNewMember.from_dict(
            d.pop("newMember")
        )
        ...
        visibility = PostGroupsResponse201DataSettingsVisibility(d.pop("visibility"))
        ...
        post_groups_response_201_data_settings = cls(
        ...
        post_groups_response_201_data_settings.additional_properties = d
        return post_groups_response_201_data_settings
