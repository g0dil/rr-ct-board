...
from ..models.get_calendars_calendar_id_appointments_response_200_data_item_base_repeat_id import (
    GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseRepeatId,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_calendars_calendar_id_appointments_response_200_data_item_base_additionals_item import (
        GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseAdditionalsItem,
    )
    from ..models.get_calendars_calendar_id_appointments_response_200_data_item_base_additions_item import (
        GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseAdditionsItem,
    )
    from ..models.get_calendars_calendar_id_appointments_response_200_data_item_base_address import (
        GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseAddress,
    )
    from ..models.get_calendars_calendar_id_appointments_response_200_data_item_base_calendar import (
        GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseCalendar,
    )
    from ..models.get_calendars_calendar_id_appointments_response_200_data_item_base_exceptions_item import (
        GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseExceptionsItem,
    )
    from ..models.get_calendars_calendar_id_appointments_response_200_data_item_base_image_type_0 import (
        GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseImageType0,
    )
    from ..models.get_calendars_calendar_id_appointments_response_200_data_item_base_meta import (
        GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseMeta,
    )
    from ..models.get_calendars_calendar_id_appointments_response_200_data_item_base_signup_type_0 import (
        GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseSignupType0,
    )


T = TypeVar("T", bound="GetCalendarsCalendarIdAppointmentsResponse200DataItemBase")


@_attrs_define
class GetCalendarsCalendarIdAppointmentsResponse200DataItemBase:
    """
    Attributes:
        additionals (list[GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseAdditionalsItem]):
        address (GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseAddress):
        all_day (bool):
        calendar (GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseCalendar):
        description (None | str):
        end_date (datetime.date | datetime.datetime):
        exceptions (list[GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseExceptionsItem]):
        id (int):
        image (GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseImageType0 | None):
        is_internal (bool):
        link (None | str):
        meta (GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseMeta):  Example: {'createdDate':
        ...
        repeat_id (GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseRepeatId): ID of the repeat pattern, NONE =
        ...
        signup (GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseSignupType0 | None):
        start_date (datetime.date | datetime.datetime):
        subtitle (None | str):
        title (str):
        version (int):
        additions (list[GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseAdditionsItem] | Unset): Use
            'additionals' instead
    ...
    is_internal: bool
    link: None | str
    meta: GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseMeta
    on_behalf_of_pid: int | None
    repeat_frequency: int | None
    repeat_id: GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseRepeatId
    repeat_option: int | None
    ...
    version: int
    additions: (
        list[GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseAdditionsItem]
        | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for additionals_item_data in _additionals:
            additionals_item = GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseAdditionalsItem.from_dict(
        ...
        address = (
            GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseAddress.from_dict(
                d.pop("address")
            )
        )
        ...
        calendar = (
            GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseCalendar.from_dict(
                d.pop("calendar")
            )
        )
        ...
        for exceptions_item_data in _exceptions:
            exceptions_item = GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseExceptionsItem.from_dict(
        ...
        def _parse_image(
            data: object,
        ) -> GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseImageType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image_type_0 = GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseImageType0.from_dict(
                    data
                )
        ...
        meta = GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseMeta.from_dict(
            d.pop("meta")
        )
        ...
        def _parse_signup(
            ...
            GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseSignupType0 | None
        ):
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                signup_type_0 = GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseSignupType0.from_dict(
                    data
                )
        ...
        for additions_item_data in _additions or []:
            additions_item = GetCalendarsCalendarIdAppointmentsResponse200DataItemBaseAdditionsItem.from_dict(
                additions_item_data
            )
        ...
        get_calendars_calendar_id_appointments_response_200_data_item_base = cls(
            additionals=additionals,
            address=address,
            all_day=all_day,
            calendar=calendar,
        ...
        get_calendars_calendar_id_appointments_response_200_data_item_base.additional_properties = d
        return get_calendars_calendar_id_appointments_response_200_data_item_base
