...
from ..models.get_all_persons_response_200_data_item_invitation_status_type_0 import (
    GetAllPersonsResponse200DataItemInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_all_persons_response_200_data_item_emails_item import (
        GetAllPersonsResponse200DataItemEmailsItem,
    )
    from ..models.get_all_persons_response_200_data_item_meta import (
        GetAllPersonsResponse200DataItemMeta,
    )
    from ..models.get_all_persons_response_200_data_item_privacy_policy_agreement import (
        GetAllPersonsResponse200DataItemPrivacyPolicyAgreement,
    )
    from ..models.get_all_persons_response_200_data_item_tags_item import (
        GetAllPersonsResponse200DataItemTagsItem,
    )


T = TypeVar("T", bound="GetAllPersonsResponse200DataItem")


@_attrs_define
class GetAllPersonsResponse200DataItem:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[GetAllPersonsResponse200DataItemEmailsItem] | Unset):
            ...
            invitation_status (GetAllPersonsResponse200DataItemInvitationStatusType0 | None | Unset):
            ...
            meta (GetAllPersonsResponse200DataItemMeta | Unset):  Example: {'createdDate': '2020-01-01T00:00:00Z',
            ...
            privacy_policy_agreement (GetAllPersonsResponse200DataItemPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[GetAllPersonsResponse200DataItemTagsItem] | Unset):
            title (str | Unset):
    ...
    emails: list[GetAllPersonsResponse200DataItemEmailsItem] | Unset = UNSET
    ...
    invitation_status: (
        GetAllPersonsResponse200DataItemInvitationStatusType0 | None | Unset
    ) = UNSET
    ...
    meta: GetAllPersonsResponse200DataItemMeta | Unset = UNSET
    ...
    privacy_policy_agreement: (
        GetAllPersonsResponse200DataItemPrivacyPolicyAgreement | Unset
    ) = UNSET
    ...
    tags: list[GetAllPersonsResponse200DataItemTagsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = GetAllPersonsResponse200DataItemEmailsItem.from_dict(
                emails_item_data
            )
        ...
        def _parse_invitation_status(
            ...
            try:
                ...
                invitation_status_type_0 = (
                    GetAllPersonsResponse200DataItemInvitationStatusType0(data)
                )
        ...
        meta: GetAllPersonsResponse200DataItemMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = GetAllPersonsResponse200DataItemMeta.from_dict(_meta)
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = (
                GetAllPersonsResponse200DataItemPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = GetAllPersonsResponse200DataItemTagsItem.from_dict(
                tags_item_data
            )
        ...
        get_all_persons_response_200_data_item = cls(
        ...
        get_all_persons_response_200_data_item.additional_properties = d
        return get_all_persons_response_200_data_item
