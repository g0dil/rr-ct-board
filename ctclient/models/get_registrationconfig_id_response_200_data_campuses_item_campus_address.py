...
T = TypeVar(
    "T", bound="GetRegistrationconfigIdResponse200DataCampusesItemCampusAddress"
)


@_attrs_define
class GetRegistrationconfigIdResponse200DataCampusesItemCampusAddress:
    """
    Attributes:
        geo_lat (None | str):
        geo_lng (None | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_registrationconfig_id_response_200_data_campuses_item_campus_address = cls(
            geo_lat=geo_lat,
            geo_lng=geo_lng,
        ...
        get_registrationconfig_id_response_200_data_campuses_item_campus_address.additional_properties = d
        return get_registrationconfig_id_response_200_data_campuses_item_campus_address
