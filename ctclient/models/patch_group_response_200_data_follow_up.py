...
T = TypeVar("T", bound="PatchGroupResponse200DataFollowUp")


@_attrs_define
class PatchGroupResponse200DataFollowUp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_group_response_200_data_follow_up = cls(
        ...
        patch_group_response_200_data_follow_up.additional_properties = d
        return patch_group_response_200_data_follow_up
