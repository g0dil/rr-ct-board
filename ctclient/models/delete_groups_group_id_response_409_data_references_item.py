...
T = TypeVar("T", bound="DeleteGroupsGroupIdResponse409DataReferencesItem")


@_attrs_define
class DeleteGroupsGroupIdResponse409DataReferencesItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_groups_group_id_response_409_data_references_item = cls(
        ...
        delete_groups_group_id_response_409_data_references_item.additional_properties = d
        return delete_groups_group_id_response_409_data_references_item
