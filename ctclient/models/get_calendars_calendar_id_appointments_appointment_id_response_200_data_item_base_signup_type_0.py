...
T = TypeVar(
    "T",
    bound="GetCalendarsCalendarIdAppointmentsAppointmentIdResponse200DataItemBaseSignupType0",
)


@_attrs_define
class GetCalendarsCalendarIdAppointmentsAppointmentIdResponse200DataItemBaseSignupType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_calendars_calendar_id_appointments_appointment_id_response_200_data_item_base_signup_type_0 = cls(
        ...
        get_calendars_calendar_id_appointments_appointment_id_response_200_data_item_base_signup_type_0.additional_properties = d
        return get_calendars_calendar_id_appointments_appointment_id_response_200_data_item_base_signup_type_0
