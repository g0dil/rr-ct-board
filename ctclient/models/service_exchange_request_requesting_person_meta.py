...
if TYPE_CHECKING:
    from ..models.service_exchange_request_requesting_person_meta_created_person import (
        ServiceExchangeRequestRequestingPersonMetaCreatedPerson,
    )
    from ..models.service_exchange_request_requesting_person_meta_modified_person import (
        ServiceExchangeRequestRequestingPersonMetaModifiedPerson,
    )


T = TypeVar("T", bound="ServiceExchangeRequestRequestingPersonMeta")


@_attrs_define
class ServiceExchangeRequestRequestingPersonMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (ServiceExchangeRequestRequestingPersonMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (ServiceExchangeRequestRequestingPersonMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        ServiceExchangeRequestRequestingPersonMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            ServiceExchangeRequestRequestingPersonMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                ServiceExchangeRequestRequestingPersonMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        service_exchange_request_requesting_person_meta = cls(
        ...
        service_exchange_request_requesting_person_meta.additional_properties = d
        return service_exchange_request_requesting_person_meta
