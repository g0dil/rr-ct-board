...
from ..models.post_groups_response_201_data_signup_conditions_group_visibility import (
    PostGroupsResponse201DataSignupConditionsGroupVisibility,
)

T = TypeVar("T", bound="PostGroupsResponse201DataSignupConditions")


@_attrs_define
class PostGroupsResponse201DataSignupConditions:
    """
    Attributes:
        ...
        group_visibility (PostGroupsResponse201DataSignupConditionsGroupVisibility): The visibility of a group.
    ...
    group_is_open_for_members: bool
    group_is_public: bool
    group_visibility: PostGroupsResponse201DataSignupConditionsGroupVisibility
    new_person_department_is_set: bool
    new_person_station_is_set: bool
    new_person_status_is_set: bool
    sign_up_role_set_in_group: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_groups_response_201_data_signup_conditions = cls(
        ...
        post_groups_response_201_data_signup_conditions.additional_properties = d
        return post_groups_response_201_data_signup_conditions
