...
from ..models.put_group_grouptypes_group_type_id_body_color import (
    PutGroupGrouptypesGroupTypeIdBodyColor,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutGroupGrouptypesGroupTypeIdBody")


@_attrs_define
class PutGroupGrouptypesGroupTypeIdBody:
    """
    Attributes:
        available_for_new_person (bool):
        color (PutGroupGrouptypesGroupTypeIdBodyColor): A color in ChurchTools
    ...
    available_for_new_person: bool
    color: PutGroupGrouptypesGroupTypeIdBodyColor
    is_leader_necessary: bool
    name: str
    name_plural: str
    permission_depth: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color = PutGroupGrouptypesGroupTypeIdBodyColor(d.pop("color"))
        ...
        put_group_grouptypes_group_type_id_body = cls(
        ...
        put_group_grouptypes_group_type_id_body.additional_properties = d
        return put_group_grouptypes_group_type_id_body
