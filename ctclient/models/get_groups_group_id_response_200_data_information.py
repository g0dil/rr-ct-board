...
from ..models.get_groups_group_id_response_200_data_information_chat_status import (
    GetGroupsGroupIdResponse200DataInformationChatStatus,
)
from ..models.get_groups_group_id_response_200_data_information_color import (
    GetGroupsGroupIdResponse200DataInformationColor,
)

if TYPE_CHECKING:
    from ..models.get_groups_group_id_response_200_data_information_date_of_foundation import (
        GetGroupsGroupIdResponse200DataInformationDateOfFoundation,
    )
    from ..models.get_groups_group_id_response_200_data_information_end_date import (
        GetGroupsGroupIdResponse200DataInformationEndDate,
    )


T = TypeVar("T", bound="GetGroupsGroupIdResponse200DataInformation")


@_attrs_define
class GetGroupsGroupIdResponse200DataInformation:
    """
    Attributes:
        age_group_ids (list[int]):  Example: [1, 2].
        campus_id (int | None):
        chat_status (GetGroupsGroupIdResponse200DataInformationChatStatus): status of chat room Example: STARTED.
        color (GetGroupsGroupIdResponse200DataInformationColor): A color in ChurchTools
        date_of_foundation (GetGroupsGroupIdResponse200DataInformationDateOfFoundation):
        end_date (GetGroupsGroupIdResponse200DataInformationEndDate):
    ...
    campus_id: int | None
    chat_status: GetGroupsGroupIdResponse200DataInformationChatStatus
    color: GetGroupsGroupIdResponse200DataInformationColor
    date_of_foundation: GetGroupsGroupIdResponse200DataInformationDateOfFoundation
    end_date: GetGroupsGroupIdResponse200DataInformationEndDate
    group_category_id: int | None
    group_homepage_url: None | str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color = GetGroupsGroupIdResponse200DataInformationColor(d.pop("color"))

        date_of_foundation = (
            GetGroupsGroupIdResponse200DataInformationDateOfFoundation.from_dict(
                d.pop("dateOfFoundation")
            )
        )

        end_date = GetGroupsGroupIdResponse200DataInformationEndDate.from_dict(
            d.pop("endDate")
        )
        ...
        get_groups_group_id_response_200_data_information = cls(
        ...
        get_groups_group_id_response_200_data_information.additional_properties = d
        return get_groups_group_id_response_200_data_information
