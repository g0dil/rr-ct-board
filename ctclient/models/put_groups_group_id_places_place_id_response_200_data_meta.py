...
if TYPE_CHECKING:
    from ..models.put_groups_group_id_places_place_id_response_200_data_meta_created_person import (
        PutGroupsGroupIdPlacesPlaceIdResponse200DataMetaCreatedPerson,
    )
    from ..models.put_groups_group_id_places_place_id_response_200_data_meta_modified_person import (
        PutGroupsGroupIdPlacesPlaceIdResponse200DataMetaModifiedPerson,
    )


T = TypeVar("T", bound="PutGroupsGroupIdPlacesPlaceIdResponse200DataMeta")


@_attrs_define
class PutGroupsGroupIdPlacesPlaceIdResponse200DataMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (PutGroupsGroupIdPlacesPlaceIdResponse200DataMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (PutGroupsGroupIdPlacesPlaceIdResponse200DataMetaModifiedPerson | Unset):
    """
    ...
    modified_person: (
        PutGroupsGroupIdPlacesPlaceIdResponse200DataMetaModifiedPerson | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            PutGroupsGroupIdPlacesPlaceIdResponse200DataMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = PutGroupsGroupIdPlacesPlaceIdResponse200DataMetaModifiedPerson.from_dict(
                _modified_person
            )

        put_groups_group_id_places_place_id_response_200_data_meta = cls(
        ...
        put_groups_group_id_places_place_id_response_200_data_meta.additional_properties = d
        return put_groups_group_id_places_place_id_response_200_data_meta
