...
from ..models.get_all_for_person_response_200_item_requesting_person_invitation_status_type_0 import (
    GetAllForPersonResponse200ItemRequestingPersonInvitationStatusType0,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_all_for_person_response_200_item_requesting_person_emails_item import (
        GetAllForPersonResponse200ItemRequestingPersonEmailsItem,
    )
    from ..models.get_all_for_person_response_200_item_requesting_person_meta import (
        GetAllForPersonResponse200ItemRequestingPersonMeta,
    )
    from ..models.get_all_for_person_response_200_item_requesting_person_privacy_policy_agreement import (
        GetAllForPersonResponse200ItemRequestingPersonPrivacyPolicyAgreement,
    )
    from ..models.get_all_for_person_response_200_item_requesting_person_tags_item import (
        GetAllForPersonResponse200ItemRequestingPersonTagsItem,
    )


T = TypeVar("T", bound="GetAllForPersonResponse200ItemRequestingPerson")


@_attrs_define
class GetAllForPersonResponse200ItemRequestingPerson:
    ...
    fields, created by the admin, are also part of the response. Those fields have the same name as the column name.
        ...
        Attributes:
            ...
            emails (list[GetAllForPersonResponse200ItemRequestingPersonEmailsItem] | Unset):
            ...
            invitation_status (GetAllForPersonResponse200ItemRequestingPersonInvitationStatusType0 | None | Unset):
            ...
            meta (GetAllForPersonResponse200ItemRequestingPersonMeta | Unset):  Example: {'createdDate':
            ...
            privacy_policy_agreement (GetAllForPersonResponse200ItemRequestingPersonPrivacyPolicyAgreement | Unset):
            ...
            status_id (int | Unset):
            street (str | Unset):
            tags (list[GetAllForPersonResponse200ItemRequestingPersonTagsItem] | Unset):
            title (str | Unset):
    ...
    meta: GetAllForPersonResponse200ItemRequestingPersonMeta | Unset = UNSET
    ...
    privacy_policy_agreement: (
        GetAllForPersonResponse200ItemRequestingPersonPrivacyPolicyAgreement | Unset
    ) = UNSET
    ...
    tags: list[GetAllForPersonResponse200ItemRequestingPersonTagsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for emails_item_data in _emails or []:
            emails_item = (
                GetAllForPersonResponse200ItemRequestingPersonEmailsItem.from_dict(
                    emails_item_data
                )
            )
        ...
        meta: GetAllForPersonResponse200ItemRequestingPersonMeta | Unset
        if isinstance(_meta, Unset):
            meta = UNSET
        else:
            meta = GetAllForPersonResponse200ItemRequestingPersonMeta.from_dict(_meta)
        ...
        if isinstance(_privacy_policy_agreement, Unset):
            ...
            privacy_policy_agreement = GetAllForPersonResponse200ItemRequestingPersonPrivacyPolicyAgreement.from_dict(
        ...
        for tags_item_data in _tags or []:
            tags_item = (
                GetAllForPersonResponse200ItemRequestingPersonTagsItem.from_dict(
                    tags_item_data
                )
            )
        ...
        get_all_for_person_response_200_item_requesting_person = cls(
        ...
        get_all_for_person_response_200_item_requesting_person.additional_properties = d
        return get_all_for_person_response_200_item_requesting_person
