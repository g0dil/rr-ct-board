...
from ..models.duplicate_group_response_201_data_information_chat_status import (
    DuplicateGroupResponse201DataInformationChatStatus,
)
from ..models.duplicate_group_response_201_data_information_color import (
    DuplicateGroupResponse201DataInformationColor,
)

if TYPE_CHECKING:
    from ..models.duplicate_group_response_201_data_information_date_of_foundation import (
        DuplicateGroupResponse201DataInformationDateOfFoundation,
    )
    from ..models.duplicate_group_response_201_data_information_end_date import (
        DuplicateGroupResponse201DataInformationEndDate,
    )


T = TypeVar("T", bound="DuplicateGroupResponse201DataInformation")


@_attrs_define
class DuplicateGroupResponse201DataInformation:
    """
    Attributes:
        age_group_ids (list[int]):  Example: [1, 2].
        campus_id (int | None):
        chat_status (DuplicateGroupResponse201DataInformationChatStatus): status of chat room Example: STARTED.
        color (DuplicateGroupResponse201DataInformationColor): A color in ChurchTools
        date_of_foundation (DuplicateGroupResponse201DataInformationDateOfFoundation):
        end_date (DuplicateGroupResponse201DataInformationEndDate):
    ...
    campus_id: int | None
    chat_status: DuplicateGroupResponse201DataInformationChatStatus
    color: DuplicateGroupResponse201DataInformationColor
    date_of_foundation: DuplicateGroupResponse201DataInformationDateOfFoundation
    end_date: DuplicateGroupResponse201DataInformationEndDate
    group_category_id: int | None
    group_homepage_url: None | str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color = DuplicateGroupResponse201DataInformationColor(d.pop("color"))

        date_of_foundation = (
            DuplicateGroupResponse201DataInformationDateOfFoundation.from_dict(
                d.pop("dateOfFoundation")
            )
        )

        end_date = DuplicateGroupResponse201DataInformationEndDate.from_dict(
            d.pop("endDate")
        )
        ...
        duplicate_group_response_201_data_information = cls(
        ...
        duplicate_group_response_201_data_information.additional_properties = d
        return duplicate_group_response_201_data_information
