...
if TYPE_CHECKING:
    from ..models.get_all_account_types_response_200_data_item_meta_created_person import (
        GetAllAccountTypesResponse200DataItemMetaCreatedPerson,
    )
    from ..models.get_all_account_types_response_200_data_item_meta_modified_person import (
        GetAllAccountTypesResponse200DataItemMetaModifiedPerson,
    )


T = TypeVar("T", bound="GetAllAccountTypesResponse200DataItemMeta")


@_attrs_define
class GetAllAccountTypesResponse200DataItemMeta:
    """
    Example:
    ...
    Attributes:
        ...
        created_person (GetAllAccountTypesResponse200DataItemMetaCreatedPerson):
        modified_date (datetime.datetime | Unset): A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z' Example:
            2022-10-19T12:00:00Z.
        modified_person (GetAllAccountTypesResponse200DataItemMetaModifiedPerson | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_person = (
            GetAllAccountTypesResponse200DataItemMetaCreatedPerson.from_dict(
                d.pop("createdPerson")
            )
        )
        ...
        if isinstance(_modified_person, Unset):
            ...
            modified_person = (
                GetAllAccountTypesResponse200DataItemMetaModifiedPerson.from_dict(
                    _modified_person
                )
            )

        get_all_account_types_response_200_data_item_meta = cls(
        ...
        get_all_account_types_response_200_data_item_meta.additional_properties = d
        return get_all_account_types_response_200_data_item_meta
