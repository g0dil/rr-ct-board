...
from ..models.post_groups_group_id_places_response_201_data_marker_color_type_0 import (
    PostGroupsGroupIdPlacesResponse201DataMarkerColorType0,
)
from ..models.post_groups_group_id_places_response_201_data_marker_color_type_1 import (
    PostGroupsGroupIdPlacesResponse201DataMarkerColorType1,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_groups_group_id_places_response_201_data_meta import (
        PostGroupsGroupIdPlacesResponse201DataMeta,
    )


T = TypeVar("T", bound="PostGroupsGroupIdPlacesResponse201Data")


@_attrs_define
class PostGroupsGroupIdPlacesResponse201Data:
    """Place wehre e.g. a group meeting takes place

    Attributes:
        id (int):
        meta (PostGroupsGroupIdPlacesResponse201DataMeta):  Example: {'createdDate': '2020-01-01T00:00:00Z',
        ...
        marker_color (PostGroupsGroupIdPlacesResponse201DataMarkerColorType0 |
            PostGroupsGroupIdPlacesResponse201DataMarkerColorType1 | Unset):
    ...
    id: int
    meta: PostGroupsGroupIdPlacesResponse201DataMeta
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.marker_color, Unset):
            ...
            self.marker_color, PostGroupsGroupIdPlacesResponse201DataMarkerColorType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = PostGroupsGroupIdPlacesResponse201DataMeta.from_dict(d.pop("meta"))
        ...
        def _parse_marker_color(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                marker_color_type_0 = (
                    PostGroupsGroupIdPlacesResponse201DataMarkerColorType0(data)
                )
            ...
            if not isinstance(data, str):
                raise TypeError()
            marker_color_type_1 = (
                PostGroupsGroupIdPlacesResponse201DataMarkerColorType1(data)
            )
        ...
        post_groups_group_id_places_response_201_data = cls(
            id=id,
            meta=meta,
            city=city,
            district=district,
        ...
        post_groups_group_id_places_response_201_data.additional_properties = d
        return post_groups_group_id_places_response_201_data
