...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):  Example: 1.
        body (PutStatusBody):  Example: {'isMember': True, 'isSearchable': True, 'name': 'Member',
            'securityLevelId': 1, 'shorty': 'M', 'sortKey': 10}.
