...
from ...models.delete_transaction_include_item import DeleteTransactionIncludeItem
...
def _get_kwargs(
    ...
    *,
    ...
    include: list[DeleteTransactionIncludeItem] | Unset = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        include (list[DeleteTransactionIncludeItem] | Unset):
