...
from ...models.post_event_id_servicerequests_request_id_undo_body import (
...
def _get_kwargs(
    ...
    request_id: int,
    *,
    body: PostEventIdServicerequestsRequestIdUndoBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/events/{event_id}/servicerequests/{request_id}/undo".format(
            event_id=event_id,
