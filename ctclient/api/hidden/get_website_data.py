...
from ...models.get_website_data_include_item import GetWebsiteDataIncludeItem
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    include: list[GetWebsiteDataIncludeItem] | Unset = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        include (list[GetWebsiteDataIncludeItem] | Unset):
