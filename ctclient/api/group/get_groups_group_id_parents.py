...
from ...models.get_groups_group_id_parents_visibility import (
...
def _get_kwargs(
    ...
    *,
    ...
    visibility: GetGroupsGroupIdParentsVisibility
    | Unset = GetGroupsGroupIdParentsVisibility.RESTRICTED,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/groups/{group_id}/parents".format(
            group_id=group_id,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        query (str | Unset):
        visibility (GetGroupsGroupIdParentsVisibility | Unset):  Default:
            GetGroupsGroupIdParentsVisibility.RESTRICTED. Example: restricted.
