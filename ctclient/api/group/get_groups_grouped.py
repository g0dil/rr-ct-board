...
from ...models.get_groups_grouped_group_by import GetGroupsGroupedGroupBy
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    group_by: GetGroupsGroupedGroupBy | Unset = UNSET,
    limit: int | Unset = 10,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    """
    Args:
        group_by (GetGroupsGroupedGroupBy | Unset):
