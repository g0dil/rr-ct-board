...
from ...models.get_groups_ids_response_200 import GetGroupsIdsResponse200
from ...models.get_groups_ids_visibility import GetGroupsIdsVisibility
...
def _get_kwargs(
    *,
    ...
    visibility: GetGroupsIdsVisibility | Unset = GetGroupsIdsVisibility.RESTRICTED,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Any | GetGroupsIdsResponse200 | str | None:
    if response.status_code == 200:
        response_200 = GetGroupsIdsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | GetGroupsIdsResponse200 | str]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get all group ids
     ...
     Returns all group ids the user can see. This includes groups the user is a member of as well as
    subordinate groups the user is allowed to see. Same as `GET /groups` but only returns ids.
    ...
    Args:
        ...
        query (str | Unset):
        visibility (GetGroupsIdsVisibility | Unset):  Default: GetGroupsIdsVisibility.RESTRICTED.
            Example: restricted.
...
def sync(
    *,
    ...
    Returns:
        Any | GetGroupsIdsResponse200 | str
    """
