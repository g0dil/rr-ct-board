...
from ...models.get_groups_hierarchies_visibility import GetGroupsHierarchiesVisibility
...
def _get_kwargs(
    *,
    ...
    visibility: GetGroupsHierarchiesVisibility
    | Unset = GetGroupsHierarchiesVisibility.RESTRICTED,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    """Get all group hierarchies
     ...
     Returns all group hierarchies. The groups not visible for the user only show ids. Note: You have to
    pass at least 2 group IDs for the filter to work. If you only want to see the children of a specific
    group use `GET /groups/{groupId}/children`.
    ...
    Args:
        ...
        query (str | Unset):
        visibility (GetGroupsHierarchiesVisibility | Unset):  Default:
            GetGroupsHierarchiesVisibility.RESTRICTED. Example: restricted.
